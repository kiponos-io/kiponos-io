---
title: "Marketplace: Turn overbooking percent Into Incident Posture"
published: false
...
main_image: https://iili.io/CQKVUE7.jpg
---
...
Domain: seller tiers, fee weights. This essay maps hub key `overbookPercent` to **overbooking percent** so the lesson stays concrete for marketplace operators.
...
```java
var policy = kiponos.path("examples", "ops-marketplace-overbook-pct");
...
1. Name the hub path so humans find it under pressure (`examples/ops-marketplace-overbook-pct/overbookPercent`).  
...
Feature flags are often product gates. This essay is about **ops posture on a hot path**: overbooking percent for marketplace — numbers humans already change verbally in war rooms.
