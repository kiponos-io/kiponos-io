---
main_image: https://iili.io/CpNsHzb.jpg
...
canonical_url: https://github.com/kiponos-io/kiponos-io/blob/master/docs/devto-agentic-dev-0909-am-session-posture.md
---

I have sat next to the shopping-admin wall at 02:14 while Cursor was *this close* to doing the wrong thing.
...
| Belief | Production |
|--------|------------|
| Restart Cursor — it is cheap | Cheap until 02:14 ate cart forensics and the open SKU thread |
...
```text
examples/agentic-dev-0909-am-session-posture/session-posture = shared
```

Runnable proof: [`examples/java/agentic-dev-0909-am-session-posture`](https://github.com/kiponos-io/kiponos-io/tree/master/examples/java/agentic-dev-0909-am-session-posture)
...
```yaml
examples/
  agentic-dev-0909-am-session-posture/
...
Folder gate = kip.getRootFolder()
        ...
        .folderOrCreate("agentic-dev-0909-am-session-posture");
...
try:
    posture = k.get("examples/agentic-dev-0909-am-session-posture/session-posture", "shared")
...
At 02:14 someone said, out loud: **disable inventory writes — keep search**. That sentence is the whole product. If it cannot land in the running Cursor process in seconds, you do not have posture. You have a wiki.
...
3. `cd examples/java/agentic-dev-0909-am-session-posture && cp kiponos.local.env.example kiponos.local.env`
4. `./gradlew test run` — prints `examples/agentic-dev-0909-am-session-posture/session-posture=...`
...
How to try: `examples/java/agentic-dev-0909-am-session-posture` and `./gradlew test`.
