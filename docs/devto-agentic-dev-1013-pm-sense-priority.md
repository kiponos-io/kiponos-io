---
main_image: https://d.uguu.se/TCLAaHQn.jpg
...
canonical_url: https://github.com/kiponos-io/kiponos-io/blob/master/docs/devto-agentic-dev-1013-pm-sense-priority.md
---
...
```text
examples/agentic-dev-1013-pm-sense-priority/priority = live
```

Runnable proof: [`examples/java/agentic-dev-1013-pm-sense-priority`](https://github.com/kiponos-io/kiponos-io/tree/master/examples/java/agentic-dev-1013-pm-sense-priority)
...
```yaml
examples/
  agentic-dev-1013-pm-sense-priority/
...
Folder gate = kip.getRootFolder()
        ...
        .folderOrCreate("agentic-dev-1013-pm-sense-priority");
...
try:
    posture = k.get("examples/agentic-dev-1013-pm-sense-priority/priority", "live")
    if str(posture) == "live":
...
Claude Code is good at calling tools. It is not a control plane. Killing it to flip `priority` teaches the on-call that judgment requires a process ID. The mirror-phone wall already disagrees.
...
3. `cd examples/java/agentic-dev-1013-pm-sense-priority && cp kiponos.local.env.example kiponos.local.env`
4. `./gradlew test run` — prints `examples/agentic-dev-1013-pm-sense-priority/priority=...`
...
How to try: `examples/java/agentic-dev-1013-pm-sense-priority` and `./gradlew test`.
