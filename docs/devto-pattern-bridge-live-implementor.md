---
title: "Bridge as a Super Pattern — Live Implementor Swap"
published: false
...
**The Aha:** Abstraction stable; implementor (pdf|html|json) flips live

Support wants PDF exports for legal and HTML for the app shell — same abstraction, different implementor mid-week.
...
Full tree: [https://github.com/kiponos-io/kiponos-io/tree/master/examples/java/pattern-bridge-live-implementor](https://github.com/kiponos-io/kiponos-io/tree/master/examples/java/pattern-bridge-live-implementor)
...
Bridge freezes the abstraction. Super Bridge frees the implementor choice.
...
*Runnable: [pattern-bridge-live-implementor](https://github.com/kiponos-io/kiponos-io/tree/master/examples/java/pattern-bridge-live-implementor) · [kiponos.io](https://kiponos.io)*
