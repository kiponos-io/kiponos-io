---
title: "Saga Step Retry Budget Should Not Wait for a Redeploy — Retail Live Posture"
published: false
tags: java, retail, devops, kiponos
description: "Live saga step retry budget via Kiponos Python SDK — retail posture without redeploy."
canonical_url: https://github.com/kiponos-io/kiponos-io/blob/master/docs/devto-ops-posture-retail-saga-retry-0040.md
main_image: ./devto-cover-ops-posture-retail-saga-retry-0040.jpg
---
...
Domain: checkout, merchandising, inventory. This essay maps hub key `sagaMaxAttempts` to **saga step retry budget** so the lesson stays concrete for retail operators.
...
```python
policy = kiponos.path("examples", "ops-retail-saga-retry")
...
1. Name the hub path so humans find it under pressure (`examples/ops-retail-saga-retry/sagaMaxAttempts`).  
...
Feature flags are often product gates. This essay is about **ops posture on a hot path**: saga step retry budget for retail — numbers humans already change verbally in war rooms.
