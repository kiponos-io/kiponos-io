---
title: "Canary Traffic Share Should Not Wait for a Redeploy — Gov Live Posture"
published: false
tags: java, architecture, devops, kiponos
description: "Live canary traffic share via Kiponos Java SDK — gov posture without redeploy."
canonical_url: https://github.com/kiponos-io/kiponos-io/blob/master/docs/devto-ops-posture-gov-canary-percent-0860.md
main_image: ./devto-cover-ops-posture-gov-canary-percent-0860.jpg
---
...
Domain: form windows, batch cutoffs. This essay maps hub key `canaryPercent` to **canary traffic share** so the lesson stays concrete for gov operators.
...
```java
var policy = kiponos.path("examples", "ops-gov-canary-percent");
...
1. Name the hub path so humans find it under pressure (`examples/ops-gov-canary-percent/canaryPercent`).  
...
Feature flags are often product gates. This essay is about **ops posture on a hot path**: canary traffic share for gov — numbers humans already change verbally in war rooms.
