---
main_image: https://iili.io/Cputfef.jpg
...
canonical_url: https://github.com/kiponos-io/kiponos-io/blob/master/docs/devto-agentic-dev-0831-pm-budget-turn.md
---

I have sat next to the senses wall at 03:07 while MCP host was *this close* to doing the wrong thing.
...
```text
examples/agentic-dev-0831-pm-budget-turn/max-tokens = 8000
```

Runnable proof: [`examples/java/agentic-dev-0831-pm-budget-turn`](https://github.com/kiponos-io/kiponos-io/tree/master/examples/java/agentic-dev-0831-pm-budget-turn)
...
```yaml
examples/
  agentic-dev-0831-pm-budget-turn/
...
Folder gate = kip.getRootFolder()
        ...
        .folderOrCreate("agentic-dev-0831-pm-budget-turn");
...
try:
    posture = k.get("examples/agentic-dev-0831-pm-budget-turn/max-tokens", "8000")
    if str(posture) == "8000":
...
At 03:07 someone said, out loud: **priority is a leaf, not a restart**. That sentence is the whole product. If it cannot land in the running MCP host process in seconds, you do not have posture. You have a wiki.
...
3. `cd examples/java/agentic-dev-0831-pm-budget-turn && cp kiponos.local.env.example kiponos.local.env`
4. `./gradlew test run` — prints `examples/agentic-dev-0831-pm-budget-turn/max-tokens=...`
...
How to try: `examples/java/agentic-dev-0831-pm-budget-turn` and `./gradlew test`.
