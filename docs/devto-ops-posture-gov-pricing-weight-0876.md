---
title: "We Stopped Shipping Pricing / Promo Weight as a Constant (Gov)"
published: false
tags: java, architecture, devops, kiponos
description: "Live pricing / promo weight via Kiponos Python SDK — gov posture without redeploy."
canonical_url: https://github.com/kiponos-io/kiponos-io/blob/master/docs/devto-ops-posture-gov-pricing-weight-0876.md
main_image: ./devto-cover-ops-posture-gov-pricing-weight-0876.jpg
---
...
Domain: form windows, batch cutoffs. This essay maps hub key `weight` to **pricing / promo weight** so the lesson stays concrete for gov operators.
...
```python
policy = kiponos.path("examples", "ops-gov-pricing-weight")
...
1. Name the hub path so humans find it under pressure (`examples/ops-gov-pricing-weight/weight`).  
...
Feature flags are often product gates. This essay is about **ops posture on a hot path**: pricing / promo weight for gov — numbers humans already change verbally in war rooms.
