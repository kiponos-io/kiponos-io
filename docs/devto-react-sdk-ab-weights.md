...
description: Use the Kiponos React SDK to live-control experiment weight (`checkout/ab-weight-b`) without redeploy. createFromEnv, Java parity, and a runnable Install with `npm install @kiponos/react`. Runnable example included.
