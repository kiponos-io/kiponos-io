---
title: "We Stopped Shipping Pagination Page Size as a Constant (Mlops)"
published: false
tags: java, machinelearning, devops, kiponos
description: "Live pagination page size via Kiponos Python SDK — mlops posture without redeploy."
canonical_url: https://github.com/kiponos-io/kiponos-io/blob/master/docs/devto-ops-posture-mlops-page-size-0971.md
main_image: ./devto-cover-ops-posture-mlops-page-size-0971.jpg
---
...
Domain: batch size, score thresholds. This essay maps hub key `pageSize` to **pagination page size** so the lesson stays concrete for mlops operators.
...
```python
policy = kiponos.path("examples", "ops-mlops-page-size")
...
1. Name the hub path so humans find it under pressure (`examples/ops-mlops-page-size/pageSize`).  
...
Feature flags are often product gates. This essay is about **ops posture on a hot path**: pagination page size for mlops — numbers humans already change verbally in war rooms.
