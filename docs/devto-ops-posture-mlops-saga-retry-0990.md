---
title: "Saga Step Retry Budget Should Not Wait for a Redeploy — Mlops Live Posture"
published: false
tags: java, machinelearning, devops, kiponos
description: "Live saga step retry budget via Kiponos Java SDK — mlops posture without redeploy."
canonical_url: https://github.com/kiponos-io/kiponos-io/blob/master/docs/devto-ops-posture-mlops-saga-retry-0990.md
main_image: ./devto-cover-ops-posture-mlops-saga-retry-0990.jpg
---
...
Domain: batch size, score thresholds. This essay maps hub key `sagaMaxAttempts` to **saga step retry budget** so the lesson stays concrete for mlops operators.
...
```java
Folder policy = kiponos.path("examples", "ops-mlops-saga-retry");
...
1. Name the hub path so humans find it under pressure (`examples/ops-mlops-saga-retry/sagaMaxAttempts`).  
...
Feature flags are often product gates. This essay is about **ops posture on a hot path**: saga step retry budget for mlops — numbers humans already change verbally in war rooms.
