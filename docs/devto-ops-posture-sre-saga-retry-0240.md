---
title: "Saga Step Retry Budget Should Not Wait for a Redeploy — Sre Live Posture"
published: false
tags: java, sre, devops, kiponos
description: "Live saga step retry budget via Kiponos Java SDK — sre posture without redeploy."
canonical_url: https://github.com/kiponos-io/kiponos-io/blob/master/docs/devto-ops-posture-sre-saga-retry-0240.md
main_image: ./devto-cover-ops-posture-sre-saga-retry-0240.jpg
---
...
Domain: canary, drain, error budget. This essay maps hub key `sagaMaxAttempts` to **saga step retry budget** so the lesson stays concrete for sre operators.
...
```java
Folder policy = kiponos.path("examples", "ops-sre-saga-retry");
...
1. Name the hub path so humans find it under pressure (`examples/ops-sre-saga-retry/sagaMaxAttempts`).  
...
Feature flags are often product gates. This essay is about **ops posture on a hot path**: saga step retry budget for sre — numbers humans already change verbally in war rooms.
