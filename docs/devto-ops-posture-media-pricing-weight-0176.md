---
title: "We Stopped Shipping Pricing / Promo Weight as a Constant (Media)"
published: false
...
main_image: https://iili.io/nx24gYF.jpg
---
...
Domain: bitrate, CDN, origin. This essay maps hub key `weight` to **pricing / promo weight** so the lesson stays concrete for media operators.
...
```java
var policy = kiponos.path("examples", "ops-media-pricing-weight");
...
1. Name the hub path so humans find it under pressure (`examples/ops-media-pricing-weight/weight`).  
...
Feature flags are often product gates. This essay is about **ops posture on a hot path**: pricing / promo weight for media — numbers humans already change verbally in war rooms.
