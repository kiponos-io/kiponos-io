---
title: "We Stopped Shipping Cors Max-Age as a Constant (Media)"
published: false
tags: java, streaming, devops, kiponos
description: "Live CORS max-age via Kiponos Java SDK — media posture without redeploy."
canonical_url: https://github.com/kiponos-io/kiponos-io/blob/master/docs/devto-ops-posture-media-cors-max-age-0196.md
main_image: ./devto-cover-ops-posture-media-cors-max-age-0196.jpg
---
...
Domain: bitrate, CDN, origin. This essay maps hub key `corsMaxAgeSec` to **CORS max-age** so the lesson stays concrete for media operators.
...
```java
Folder policy = kiponos.path("examples", "ops-media-cors-max-age");
...
1. Name the hub path so humans find it under pressure (`examples/ops-media-cors-max-age/corsMaxAgeSec`).  
...
Feature flags are often product gates. This essay is about **ops posture on a hot path**: CORS max-age for media — numbers humans already change verbally in war rooms.
