---
title: "The Travel War Room Already Knew bulkheadMax — The Jar Did Not"
published: false
tags: java, travel, architecture, kiponos
description: "Live bulkhead concurrency via Kiponos Python SDK — travel posture without redeploy."
canonical_url: https://github.com/kiponos-io/kiponos-io/blob/master/docs/devto-ops-posture-travel-bulkhead-max-0118.md
main_image: ./devto-cover-ops-posture-travel-bulkhead-max-0118.jpg
---
...
Domain: inventory, overbooking, GDS. This essay maps hub key `bulkheadMax` to **bulkhead concurrency** so the lesson stays concrete for travel operators.
...
```python
policy = kiponos.path("examples", "ops-travel-bulkhead-max")
...
1. Name the hub path so humans find it under pressure (`examples/ops-travel-bulkhead-max/bulkheadMax`).  
...
Feature flags are often product gates. This essay is about **ops posture on a hot path**: bulkhead concurrency for travel — numbers humans already change verbally in war rooms.
