---
main_image: https://h.uguu.se/MPWDfvkQ.jpg
...
canonical_url: https://github.com/kiponos-io/kiponos-io/blob/master/docs/devto-agentic-dev-1102-am-admin-wall.md
---
...
Runnable proof: [`examples/java/agentic-dev-1102-am-admin-wall`](https://github.com/kiponos-io/kiponos-io/tree/master/examples/java/agentic-dev-1102-am-admin-wall)
...
3. `cd examples/java/agentic-dev-1102-am-admin-wall && cp kiponos.local.env.example kiponos.local.env`
4. `./gradlew test run` — prints `examples/agentic-dev-1102-am-admin-wall/wall-focus=...`
