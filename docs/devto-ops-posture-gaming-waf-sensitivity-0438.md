---
title: "The Gaming War Room Already Knew wafSensitivity — The Jar Did Not"
published: false
...
main_image: https://iili.io/Ci7H5Cu.jpg
---
...
Domain: matchmaking, session caps, tick rate. This essay maps hub key `wafSensitivity` to **WAF sensitivity 1-5** so the lesson stays concrete for gaming operators.
...
```python
policy = kiponos.path("examples", "ops-gaming-waf-sensitivity")
...
1. Name the hub path so humans find it under pressure (`examples/ops-gaming-waf-sensitivity/wafSensitivity`).  
...
Feature flags are often product gates. This essay is about **ops posture on a hot path**: WAF sensitivity 1-5 for gaming — numbers humans already change verbally in war rooms.
