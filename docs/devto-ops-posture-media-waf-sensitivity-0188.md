---
title: "The Media War Room Already Knew wafSensitivity — The Jar Did Not"
published: false
tags: java, streaming, devops, kiponos
description: "Live WAF sensitivity 1-5 via Kiponos Java SDK — media posture without redeploy."
canonical_url: https://github.com/kiponos-io/kiponos-io/blob/master/docs/devto-ops-posture-media-waf-sensitivity-0188.md
main_image: ./devto-cover-ops-posture-media-waf-sensitivity-0188.jpg
---
...
Domain: bitrate, CDN, origin. This essay maps hub key `wafSensitivity` to **WAF sensitivity 1-5** so the lesson stays concrete for media operators.
...
```java
var policy = kiponos.path("examples", "ops-media-waf-sensitivity");
...
1. Name the hub path so humans find it under pressure (`examples/ops-media-waf-sensitivity/wafSensitivity`).  
...
Feature flags are often product gates. This essay is about **ops posture on a hot path**: WAF sensitivity 1-5 for media — numbers humans already change verbally in war rooms.
