---
title: "The Media War Room Already Knew velocityCap — The Jar Did Not"
published: false
...
main_image: https://iili.io/nIF2zmX.jpg
---
...
Domain: bitrate, CDN, origin. This essay maps hub key `velocityCap` to **fraud velocity cap** so the lesson stays concrete for media operators.
...
```java
var policy = kiponos.path("examples", "ops-media-velocity-cap");
...
1. Name the hub path so humans find it under pressure (`examples/ops-media-velocity-cap/velocityCap`).  
...
Feature flags are often product gates. This essay is about **ops posture on a hot path**: fraud velocity cap for media — numbers humans already change verbally in war rooms.
