---
title: "We Stopped Shipping Rag Top-K as a Constant (Dataops)"
published: false
tags: java, dataengineering, devops, kiponos
description: "Live RAG top-k via Kiponos Python SDK — dataops posture without redeploy."
canonical_url: https://github.com/kiponos-io/kiponos-io/blob/master/docs/devto-ops-posture-dataops-rag-topk-1086.md
main_image: https://files.catbox.moe/9812ob.jpg
---
...
Domain: batch, lag, checkpoint. This essay maps hub key `topK` to **RAG top-k** so the lesson stays concrete for dataops operators.
...
```python
policy = kiponos.path("examples", "ops-dataops-rag-topk")
...
1. Name the hub path so humans find it under pressure (`examples/ops-dataops-rag-topk/topK`).  
...
Feature flags are often product gates. This essay is about **ops posture on a hot path**: RAG top-k for dataops — numbers humans already change verbally in war rooms.
