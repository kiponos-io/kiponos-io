---
title: "Graphql Query Depth Should Not Wait for a Redeploy — Mlops Live Posture"
published: false
tags: java, machinelearning, devops, kiponos
description: "Live GraphQL query depth via Kiponos Python SDK — mlops posture without redeploy."
canonical_url: https://github.com/kiponos-io/kiponos-io/blob/master/docs/devto-ops-posture-mlops-graphql-depth-1000.md
main_image: ./devto-cover-ops-posture-mlops-graphql-depth-1000.jpg
---
...
Domain: batch size, score thresholds. This essay maps hub key `maxDepth` to **GraphQL query depth** so the lesson stays concrete for mlops operators.
...
```python
policy = kiponos.path("examples", "ops-mlops-graphql-depth")
...
1. Name the hub path so humans find it under pressure (`examples/ops-mlops-graphql-depth/maxDepth`).  
...
Feature flags are often product gates. This essay is about **ops posture on a hot path**: GraphQL query depth for mlops — numbers humans already change verbally in war rooms.
