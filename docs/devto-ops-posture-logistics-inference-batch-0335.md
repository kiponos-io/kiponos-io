---
title: "Inference Batch Size Should Not Wait for a Redeploy — Logistics Live Posture"
published: false
tags: java, logistics, devops, kiponos
description: "Live inference batch size via Kiponos Python SDK — logistics posture without redeploy."
canonical_url: https://github.com/kiponos-io/kiponos-io/blob/master/docs/devto-ops-posture-logistics-inference-batch-0335.md
main_image: ./devto-cover-ops-posture-logistics-inference-batch-0335.jpg
---
...
Domain: routing, SLA windows, fleet. This essay maps hub key `batchSize` to **inference batch size** so the lesson stays concrete for logistics operators.
...
```python
policy = kiponos.path("examples", "ops-logistics-inference-batch")
...
1. Name the hub path so humans find it under pressure (`examples/ops-logistics-inference-batch/batchSize`).  
...
Feature flags are often product gates. This essay is about **ops posture on a hot path**: inference batch size for logistics — numbers humans already change verbally in war rooms.
