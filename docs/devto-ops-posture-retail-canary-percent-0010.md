---
title: "Canary Traffic Share Should Not Wait for a Redeploy — Retail Live Posture"
published: false
tags: java, retail, devops, kiponos
description: "Live canary traffic share via Kiponos Java SDK — retail posture without redeploy."
canonical_url: https://github.com/kiponos-io/kiponos-io/blob/master/docs/devto-ops-posture-retail-canary-percent-0010.md
main_image: ./devto-cover-ops-posture-retail-canary-percent-0010.jpg
---
...
Domain: checkout, merchandising, inventory. This essay maps hub key `canaryPercent` to **canary traffic share** so the lesson stays concrete for retail operators.
...
```java
var policy = kiponos.path("examples", "ops-retail-canary-percent");
...
1. Name the hub path so humans find it under pressure (`examples/ops-retail-canary-percent/canaryPercent`).  
...
Feature flags are often product gates. This essay is about **ops posture on a hot path**: canary traffic share for retail — numbers humans already change verbally in war rooms.
