---
title: "We Stopped Shipping Rag Top-K as a Constant (Energy)"
published: false
tags: java, energy, architecture, kiponos
description: "Live RAG top-k via Kiponos Java SDK — energy posture without redeploy."
canonical_url: https://github.com/kiponos-io/kiponos-io/blob/master/docs/devto-ops-posture-energy-rag-topk-0586.md
main_image: https://files.catbox.moe/8qjgfc.jpg
---
...
Domain: grid dispatch, demand response. This essay maps hub key `topK` to **RAG top-k** so the lesson stays concrete for energy operators.
...
```java
Folder policy = kiponos.path("examples", "ops-energy-rag-topk");
...
1. Name the hub path so humans find it under pressure (`examples/ops-energy-rag-topk/topK`).  
...
Feature flags are often product gates. This essay is about **ops posture on a hot path**: RAG top-k for energy — numbers humans already change verbally in war rooms.
