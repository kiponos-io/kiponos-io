---
title: "Live Trace Sample Per Thousand for Healthcare — Mouth to Process in Seconds"
published: false
tags: java, healthcare, architecture, kiponos
description: "Live trace sample per thousand via Kiponos Java SDK — healthcare posture without redeploy."
canonical_url: https://github.com/kiponos-io/kiponos-io/blob/master/docs/devto-ops-posture-healthcare-trace-sample-0362.md
main_image: ./devto-cover-ops-posture-healthcare-trace-sample-0362.jpg
---
...
Domain: routing, queue depth, triage. This essay maps hub key `samplePerThousand` to **trace sample per thousand** so the lesson stays concrete for healthcare operators.
...
```java
Folder policy = kiponos.path("examples", "ops-healthcare-trace-sample");
...
1. Name the hub path so humans find it under pressure (`examples/ops-healthcare-trace-sample/samplePerThousand`).  
...
Feature flags are often product gates. This essay is about **ops posture on a hot path**: trace sample per thousand for healthcare — numbers humans already change verbally in war rooms.
