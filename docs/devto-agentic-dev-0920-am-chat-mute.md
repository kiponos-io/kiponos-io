---
main_image: https://iili.io/CyzEXDv.jpg
...
canonical_url: https://github.com/kiponos-io/kiponos-io/blob/master/docs/devto-agentic-dev-0920-am-chat-mute.md
---

I have sat next to the travel-coordinator wall at 14:12 while Grok Build was *this close* to doing the wrong thing.
...
| Restart Grok Build — it is cheap | Cheap until 14:12 ate the overbook thread the agent already paid for |
...
```text
examples/agentic-dev-0920-am-chat-mute/chat-mute = muted
```

Runnable proof: [`examples/java/agentic-dev-0920-am-chat-mute`](https://github.com/kiponos-io/kiponos-io/tree/master/examples/java/agentic-dev-0920-am-chat-mute)
...
Folder gate = kip.getRootFolder()
        ...
        .folderOrCreate("agentic-dev-0920-am-chat-mute");
...
try:
    posture = k.get("examples/agentic-dev-0920-am-chat-mute/chat-mute", "muted")
...
At 14:12 someone said, out loud: **mute writes on the noisy room — keep reads**. That sentence is the whole product. If it cannot land in the running Grok Build process in seconds, you do not have posture. You have a wiki.
...
3. `cd examples/java/agentic-dev-0920-am-chat-mute && cp kiponos.local.env.example kiponos.local.env`
4. `./gradlew test run` — prints `examples/agentic-dev-0920-am-chat-mute/chat-mute=...`
...
How to try: `examples/java/agentic-dev-0920-am-chat-mute` and `./gradlew test`.
