---
title: "We Stopped Shipping Cors Max-Age as a Constant (Iot)"
published: false
tags: java, iot, devops, kiponos
description: "Live CORS max-age via Kiponos Java SDK — iot posture without redeploy."
canonical_url: https://github.com/kiponos-io/kiponos-io/blob/master/docs/devto-ops-posture-iot-cors-max-age-0496.md
main_image: ./devto-cover-ops-posture-iot-cors-max-age-0496.jpg
---
...
Domain: device firmware gates, telemetry sample. This essay maps hub key `corsMaxAgeSec` to **CORS max-age** so the lesson stays concrete for iot operators.
...
```java
Folder policy = kiponos.path("examples", "ops-iot-cors-max-age");
...
1. Name the hub path so humans find it under pressure (`examples/ops-iot-cors-max-age/corsMaxAgeSec`).  
...
Feature flags are often product gates. This essay is about **ops posture on a hot path**: CORS max-age for iot — numbers humans already change verbally in war rooms.
