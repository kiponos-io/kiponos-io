---
title: "The Logistics War Room Already Knew degradeMode — The Jar Did Not"
published: false
...
main_image: https://iili.io/CLQOOlI.jpg
---
...
Domain: routing, SLA windows, fleet. This essay maps hub key `degradeMode` to **degradation mode** so the lesson stays concrete for logistics operators.
...
```java
Folder policy = kiponos.path("examples", "ops-logistics-degrade-mode");
...
1. Name the hub path so humans find it under pressure (`examples/ops-logistics-degrade-mode/degradeMode`).  
...
Feature flags are often product gates. This essay is about **ops posture on a hot path**: degradation mode for logistics — numbers humans already change verbally in war rooms.
