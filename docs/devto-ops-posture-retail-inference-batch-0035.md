---
title: "Inference Batch Size Should Not Wait for a Redeploy — Retail Live Posture"
published: false
tags: java, retail, devops, kiponos
description: "Live inference batch size via Kiponos Python SDK — retail posture without redeploy."
canonical_url: https://github.com/kiponos-io/kiponos-io/blob/master/docs/devto-ops-posture-retail-inference-batch-0035.md
main_image: ./devto-cover-ops-posture-retail-inference-batch-0035.jpg
---
...
Domain: checkout, merchandising, inventory. This essay maps hub key `batchSize` to **inference batch size** so the lesson stays concrete for retail operators.
...
```python
policy = kiponos.path("examples", "ops-retail-inference-batch")
...
1. Name the hub path so humans find it under pressure (`examples/ops-retail-inference-batch/batchSize`).  
...
Feature flags are often product gates. This essay is about **ops posture on a hot path**: inference batch size for retail — numbers humans already change verbally in war rooms.
