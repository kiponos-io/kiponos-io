---
title: "We Stopped Shipping Shadow Traffic Share as a Constant (Sre)"
published: false
tags: java, sre, devops, kiponos
description: "Live shadow traffic share via Kiponos Java SDK — sre posture without redeploy."
canonical_url: https://github.com/kiponos-io/kiponos-io/blob/master/docs/devto-ops-posture-sre-shadow-percent-0211.md
main_image: ./devto-cover-ops-posture-sre-shadow-percent-0211.jpg
---
...
Domain: canary, drain, error budget. This essay maps hub key `shadowPercent` to **shadow traffic share** so the lesson stays concrete for sre operators.
...
```java
var policy = kiponos.path("examples", "ops-sre-shadow-percent");
...
1. Name the hub path so humans find it under pressure (`examples/ops-sre-shadow-percent/shadowPercent`).  
...
Feature flags are often product gates. This essay is about **ops posture on a hot path**: shadow traffic share for sre — numbers humans already change verbally in war rooms.
