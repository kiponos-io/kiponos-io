---
title: "We Stopped Shipping Outbox Poll Interval as a Constant (Telecom)"
published: false
tags: java, telecom, sre, kiponos
description: "Live outbox poll interval via Kiponos Java SDK — telecom posture without redeploy."
canonical_url: https://github.com/kiponos-io/kiponos-io/blob/master/docs/devto-ops-posture-telecom-outbox-poll-ms-0541.md
main_image: ./devto-cover-ops-posture-telecom-outbox-poll-ms-0541.jpg
---
...
Domain: QoS, rate classes, trunk limits. This essay maps hub key `outboxPollMs` to **outbox poll interval** so the lesson stays concrete for telecom operators.
...
```java
var policy = kiponos.path("examples", "ops-telecom-outbox-poll-ms");
...
1. Name the hub path so humans find it under pressure (`examples/ops-telecom-outbox-poll-ms/outboxPollMs`).  
...
Feature flags are often product gates. This essay is about **ops posture on a hot path**: outbox poll interval for telecom — numbers humans already change verbally in war rooms.
