---
title: "We Stopped Shipping Cors Max-Age as a Constant (Platform)"
published: false
tags: java, platform, architecture, kiponos
description: "Live CORS max-age via Kiponos Java SDK — platform posture without redeploy."
canonical_url: https://github.com/kiponos-io/kiponos-io/blob/master/docs/devto-ops-posture-platform-cors-max-age-1146.md
main_image: ./devto-cover-ops-posture-platform-cors-max-age-1146.jpg
---
...
Domain: shared libraries, defaults. This essay maps hub key `corsMaxAgeSec` to **CORS max-age** so the lesson stays concrete for platform operators.
...
```java
Folder policy = kiponos.path("examples", "ops-platform-cors-max-age");
...
1. Name the hub path so humans find it under pressure (`examples/ops-platform-cors-max-age/corsMaxAgeSec`).  
...
Feature flags are often product gates. This essay is about **ops posture on a hot path**: CORS max-age for platform — numbers humans already change verbally in war rooms.
