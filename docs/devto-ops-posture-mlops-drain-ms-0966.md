---
title: "We Stopped Shipping Graceful Drain Window as a Constant (Mlops)"
published: false
tags: java, machinelearning, devops, kiponos
description: "Live graceful drain window via Kiponos Python SDK — mlops posture without redeploy."
canonical_url: https://github.com/kiponos-io/kiponos-io/blob/master/docs/devto-ops-posture-mlops-drain-ms-0966.md
main_image: ./devto-cover-ops-posture-mlops-drain-ms-0966.jpg
---
...
Domain: batch size, score thresholds. This essay maps hub key `gracefulShutdownMs` to **graceful drain window** so the lesson stays concrete for mlops operators.
...
```python
policy = kiponos.path("examples", "ops-mlops-drain-ms")
...
1. Name the hub path so humans find it under pressure (`examples/ops-mlops-drain-ms/gracefulShutdownMs`).  
...
Feature flags are often product gates. This essay is about **ops posture on a hot path**: graceful drain window for mlops — numbers humans already change verbally in war rooms.
