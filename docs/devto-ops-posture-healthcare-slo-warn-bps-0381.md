---
title: "We Stopped Shipping Slo Warn Burn Bps as a Constant (Healthcare)"
published: false
tags: java, healthcare, architecture, kiponos
description: "Live SLO warn burn bps via Kiponos Java SDK — healthcare posture without redeploy."
canonical_url: https://github.com/kiponos-io/kiponos-io/blob/master/docs/devto-ops-posture-healthcare-slo-warn-bps-0381.md
main_image: ./devto-cover-ops-posture-healthcare-slo-warn-bps-0381.jpg
---
...
Domain: routing, queue depth, triage. This essay maps hub key `errorBudgetWarnBps` to **SLO warn burn bps** so the lesson stays concrete for healthcare operators.
...
```java
var policy = kiponos.path("examples", "ops-healthcare-slo-warn-bps");
...
1. Name the hub path so humans find it under pressure (`examples/ops-healthcare-slo-warn-bps/errorBudgetWarnBps`).  
...
Feature flags are often product gates. This essay is about **ops posture on a hot path**: SLO warn burn bps for healthcare — numbers humans already change verbally in war rooms.
