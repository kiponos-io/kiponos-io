---
title: "We Stopped Shipping Pricing / Promo Weight as a Constant (Ecommerce)"
published: false
tags: java, ecommerce, devops, kiponos
description: "Live pricing / promo weight via Kiponos Java SDK — ecommerce posture without redeploy."
canonical_url: https://github.com/kiponos-io/kiponos-io/blob/master/docs/devto-ops-posture-ecommerce-pricing-weight-0726.md
main_image: https://files.catbox.moe/8jjzj6.jpg
---
...
Domain: cart, promo weights, stock. This essay maps hub key `weight` to **pricing / promo weight** so the lesson stays concrete for ecommerce operators.
...
```java
var policy = kiponos.path("examples", "ops-ecommerce-pricing-weight");
...
1. Name the hub path so humans find it under pressure (`examples/ops-ecommerce-pricing-weight/weight`).  
...
Feature flags are often product gates. This essay is about **ops posture on a hot path**: pricing / promo weight for ecommerce — numbers humans already change verbally in war rooms.
