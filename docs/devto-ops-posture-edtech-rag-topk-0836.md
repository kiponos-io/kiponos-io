---
title: "We Stopped Shipping Rag Top-K as a Constant (Edtech)"
published: false
tags: java, education, architecture, kiponos
description: "Live RAG top-k via Kiponos Java SDK — edtech posture without redeploy."
canonical_url: https://github.com/kiponos-io/kiponos-io/blob/master/docs/devto-ops-posture-edtech-rag-topk-0836.md
main_image: https://files.catbox.moe/nhwdjh.jpg
---
...
Domain: class size, exam windows. This essay maps hub key `topK` to **RAG top-k** so the lesson stays concrete for edtech operators.
...
```java
var policy = kiponos.path("examples", "ops-edtech-rag-topk");
...
1. Name the hub path so humans find it under pressure (`examples/ops-edtech-rag-topk/topK`).  
...
Feature flags are often product gates. This essay is about **ops posture on a hot path**: RAG top-k for edtech — numbers humans already change verbally in war rooms.
