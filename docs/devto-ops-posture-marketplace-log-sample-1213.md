---
title: "The Marketplace War Room Already Knew logSamplePerThousand — The Jar Did Not"
published: false
tags: java, architecture, devops, kiponos
description: "Live log sample per thousand via Kiponos Java SDK — marketplace posture without redeploy."
canonical_url: https://github.com/kiponos-io/kiponos-io/blob/master/docs/devto-ops-posture-marketplace-log-sample-1213.md
main_image: ./devto-cover-ops-posture-marketplace-log-sample-1213.jpg
---
...
Domain: seller tiers, fee weights. This essay maps hub key `logSamplePerThousand` to **log sample per thousand** so the lesson stays concrete for marketplace operators.
...
```java
var policy = kiponos.path("examples", "ops-marketplace-log-sample");
...
1. Name the hub path so humans find it under pressure (`examples/ops-marketplace-log-sample/logSamplePerThousand`).  
...
Feature flags are often product gates. This essay is about **ops posture on a hot path**: log sample per thousand for marketplace — numbers humans already change verbally in war rooms.
