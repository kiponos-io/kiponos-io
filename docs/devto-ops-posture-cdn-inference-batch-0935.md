---
title: "Inference Batch Size Should Not Wait for a Redeploy — Cdn Live Posture"
published: false
tags: java, networking, devops, kiponos
description: "Live inference batch size via Kiponos Java SDK — cdn posture without redeploy."
canonical_url: https://github.com/kiponos-io/kiponos-io/blob/master/docs/devto-ops-posture-cdn-inference-batch-0935.md
main_image: https://litter.catbox.moe/b0un66.jpg
---
...
Domain: edge rules, cache TTL, purge. This essay maps hub key `batchSize` to **inference batch size** so the lesson stays concrete for cdn operators.
...
```java
var policy = kiponos.path("examples", "ops-cdn-inference-batch");
...
1. Name the hub path so humans find it under pressure (`examples/ops-cdn-inference-batch/batchSize`).  
...
Feature flags are often product gates. This essay is about **ops posture on a hot path**: inference batch size for cdn — numbers humans already change verbally in war rooms.
