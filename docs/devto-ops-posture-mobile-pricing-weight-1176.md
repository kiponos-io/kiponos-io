---
title: "We Stopped Shipping Pricing / Promo Weight as a Constant (Mobile)"
published: false
tags: java, mobile, architecture, kiponos
description: "Live pricing / promo weight via Kiponos Python SDK — mobile posture without redeploy."
canonical_url: https://github.com/kiponos-io/kiponos-io/blob/master/docs/devto-ops-posture-mobile-pricing-weight-1176.md
main_image: ./devto-cover-ops-posture-mobile-pricing-weight-1176.jpg
---
...
Domain: API timeouts, payload caps. This essay maps hub key `weight` to **pricing / promo weight** so the lesson stays concrete for mobile operators.
...
```python
policy = kiponos.path("examples", "ops-mobile-pricing-weight")
...
1. Name the hub path so humans find it under pressure (`examples/ops-mobile-pricing-weight/weight`).  
...
Feature flags are often product gates. This essay is about **ops posture on a hot path**: pricing / promo weight for mobile — numbers humans already change verbally in war rooms.
