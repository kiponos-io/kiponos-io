---
title: "The Insurance War Room Already Knew waitOpenMs — The Jar Did Not"
published: false
...
main_image: https://iili.io/CstyZW7.jpg
---
...
Domain: underwriting, claims velocity. This essay maps hub key `waitOpenMs` to **circuit open duration** so the lesson stays concrete for insurance operators.
...
```java
var policy = kiponos.path("examples", "ops-insurance-circuit-open-ms");
...
1. Name the hub path so humans find it under pressure (`examples/ops-insurance-circuit-open-ms/waitOpenMs`).  
...
Feature flags are often product gates. This essay is about **ops posture on a hot path**: circuit open duration for insurance — numbers humans already change verbally in war rooms.
