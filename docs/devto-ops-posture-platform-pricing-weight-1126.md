---
title: "We Stopped Shipping Pricing / Promo Weight as a Constant (Platform)"
published: false
tags: java, platform, architecture, kiponos
description: "Live pricing / promo weight via Kiponos Java SDK — platform posture without redeploy."
canonical_url: https://github.com/kiponos-io/kiponos-io/blob/master/docs/devto-ops-posture-platform-pricing-weight-1126.md
main_image: ./devto-cover-ops-posture-platform-pricing-weight-1126.jpg
---
...
Domain: shared libraries, defaults. This essay maps hub key `weight` to **pricing / promo weight** so the lesson stays concrete for platform operators.
...
```java
var policy = kiponos.path("examples", "ops-platform-pricing-weight");
...
1. Name the hub path so humans find it under pressure (`examples/ops-platform-pricing-weight/weight`).  
...
Feature flags are often product gates. This essay is about **ops posture on a hot path**: pricing / promo weight for platform — numbers humans already change verbally in war rooms.
