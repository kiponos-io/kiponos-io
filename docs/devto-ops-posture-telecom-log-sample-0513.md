---
title: "The Telecom War Room Already Knew logSamplePerThousand — The Jar Did Not"
published: false
tags: java, telecom, sre, kiponos
description: "Live log sample per thousand via Kiponos Java SDK — telecom posture without redeploy."
canonical_url: https://github.com/kiponos-io/kiponos-io/blob/master/docs/devto-ops-posture-telecom-log-sample-0513.md
main_image: ./devto-cover-ops-posture-telecom-log-sample-0513.jpg
---
...
Domain: QoS, rate classes, trunk limits. This essay maps hub key `logSamplePerThousand` to **log sample per thousand** so the lesson stays concrete for telecom operators.
...
```java
Folder policy = kiponos.path("examples", "ops-telecom-log-sample");
...
1. Name the hub path so humans find it under pressure (`examples/ops-telecom-log-sample/logSamplePerThousand`).  
...
Feature flags are often product gates. This essay is about **ops posture on a hot path**: log sample per thousand for telecom — numbers humans already change verbally in war rooms.
