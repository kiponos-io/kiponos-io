---
title: "Ads: Turn per-tenant quota Into Incident Posture"
published: false
tags: java, advertising, devops, kiponos
description: "Live per-tenant quota via Kiponos Java SDK — ads posture without redeploy."
canonical_url: https://github.com/kiponos-io/kiponos-io/blob/master/docs/devto-ops-posture-ads-tenant-quota-0779.md
main_image: https://files.catbox.moe/b7k91a.jpg
---
...
Domain: bid caps, frequency, pacing. This essay maps hub key `quotaPerMin` to **per-tenant quota** so the lesson stays concrete for ads operators.
...
```java
Folder policy = kiponos.path("examples", "ops-ads-tenant-quota");
...
1. Name the hub path so humans find it under pressure (`examples/ops-ads-tenant-quota/quotaPerMin`).  
...
Feature flags are often product gates. This essay is about **ops posture on a hot path**: per-tenant quota for ads — numbers humans already change verbally in war rooms.
