---
title: "We Stopped Shipping Outbound Call Timeout as a Constant (Logistics)"
published: false
tags: java, logistics, devops, kiponos
description: "Live outbound call timeout via Kiponos Java SDK — logistics posture without redeploy."
canonical_url: https://github.com/kiponos-io/kiponos-io/blob/master/docs/devto-ops-posture-logistics-timeout-ms-0301.md
main_image: ./devto-cover-ops-posture-logistics-timeout-ms-0301.jpg
---
...
Domain: routing, SLA windows, fleet. This essay maps hub key `timeoutMs` to **outbound call timeout** so the lesson stays concrete for logistics operators.
...
```java
Folder policy = kiponos.path("examples", "ops-logistics-timeout-ms");
...
1. Name the hub path so humans find it under pressure (`examples/ops-logistics-timeout-ms/timeoutMs`).  
...
Feature flags are often product gates. This essay is about **ops posture on a hot path**: outbound call timeout for logistics — numbers humans already change verbally in war rooms.
