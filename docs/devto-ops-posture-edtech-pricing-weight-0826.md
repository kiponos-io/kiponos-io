---
title: "We Stopped Shipping Pricing / Promo Weight as a Constant (Edtech)"
published: false
tags: java, education, architecture, kiponos
description: "Live pricing / promo weight via Kiponos Python SDK — edtech posture without redeploy."
canonical_url: https://github.com/kiponos-io/kiponos-io/blob/master/docs/devto-ops-posture-edtech-pricing-weight-0826.md
main_image: https://files.catbox.moe/pvoim3.jpg
---
...
Domain: class size, exam windows. This essay maps hub key `weight` to **pricing / promo weight** so the lesson stays concrete for edtech operators.
...
```python
policy = kiponos.path("examples", "ops-edtech-pricing-weight")
...
1. Name the hub path so humans find it under pressure (`examples/ops-edtech-pricing-weight/weight`).  
...
Feature flags are often product gates. This essay is about **ops posture on a hot path**: pricing / promo weight for edtech — numbers humans already change verbally in war rooms.
