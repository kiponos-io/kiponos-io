---
title: "The Gaming War Room Already Knew logSamplePerThousand — The Jar Did Not"
published: false
tags: java, gaming, devops, kiponos
description: "Live log sample per thousand via Kiponos Java SDK — gaming posture without redeploy."
canonical_url: https://github.com/kiponos-io/kiponos-io/blob/master/docs/devto-ops-posture-gaming-log-sample-0413.md
main_image: https://files.catbox.moe/x9eu7r.jpg
---
...
The partner brownout did not wait for your change-management window. Your log sample per thousand did — until it lived in a hub.

Domain: matchmaking, session caps, tick rate. This essay maps hub key `logSamplePerThousand` to **log sample per thousand** so the lesson stays concrete for gaming operators.
...
```java
var policy = kiponos.path("examples", "ops-gaming-log-sample");
...
1. Name the hub path so humans find it under pressure (`examples/ops-gaming-log-sample/logSamplePerThousand`).  
...
Feature flags are often product gates. This essay is about **ops posture on a hot path**: log sample per thousand for gaming — numbers humans already change verbally in war rooms.
