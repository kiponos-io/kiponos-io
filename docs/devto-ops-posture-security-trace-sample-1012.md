---
title: "Live Trace Sample Per Thousand for Security — Mouth to Process in Seconds"
published: false
tags: java, security, devops, kiponos
description: "Live trace sample per thousand via Kiponos Java SDK — security posture without redeploy."
canonical_url: https://github.com/kiponos-io/kiponos-io/blob/master/docs/devto-ops-posture-security-trace-sample-1012.md
main_image: ./devto-cover-ops-posture-security-trace-sample-1012.jpg
---
...
Domain: WAF, RPS, auth leeway. This essay maps hub key `samplePerThousand` to **trace sample per thousand** so the lesson stays concrete for security operators.
...
```java
Folder policy = kiponos.path("examples", "ops-security-trace-sample");
...
1. Name the hub path so humans find it under pressure (`examples/ops-security-trace-sample/samplePerThousand`).  
...
Feature flags are often product gates. This essay is about **ops posture on a hot path**: trace sample per thousand for security — numbers humans already change verbally in war rooms.
