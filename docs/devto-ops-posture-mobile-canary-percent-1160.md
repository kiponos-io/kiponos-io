---
title: "Canary Traffic Share Should Not Wait for a Redeploy — Mobile Live Posture"
published: false
tags: java, mobile, architecture, kiponos
description: "Live canary traffic share via Kiponos Java SDK — mobile posture without redeploy."
canonical_url: https://github.com/kiponos-io/kiponos-io/blob/master/docs/devto-ops-posture-mobile-canary-percent-1160.md
main_image: ./devto-cover-ops-posture-mobile-canary-percent-1160.jpg
---
...
Domain: API timeouts, payload caps. This essay maps hub key `canaryPercent` to **canary traffic share** so the lesson stays concrete for mobile operators.
...
```java
Folder policy = kiponos.path("examples", "ops-mobile-canary-percent");
...
1. Name the hub path so humans find it under pressure (`examples/ops-mobile-canary-percent/canaryPercent`).  
...
Feature flags are often product gates. This essay is about **ops posture on a hot path**: canary traffic share for mobile — numbers humans already change verbally in war rooms.
