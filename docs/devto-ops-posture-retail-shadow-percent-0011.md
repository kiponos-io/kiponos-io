---
title: "We Stopped Shipping Shadow Traffic Share as a Constant (Retail)"
published: false
tags: java, retail, devops, kiponos
description: "Live shadow traffic share via Kiponos Java SDK — retail posture without redeploy."
canonical_url: https://github.com/kiponos-io/kiponos-io/blob/master/docs/devto-ops-posture-retail-shadow-percent-0011.md
main_image: ./devto-cover-ops-posture-retail-shadow-percent-0011.jpg
---
...
Domain: checkout, merchandising, inventory. This essay maps hub key `shadowPercent` to **shadow traffic share** so the lesson stays concrete for retail operators.
...
```java
var policy = kiponos.path("examples", "ops-retail-shadow-percent");
...
1. Name the hub path so humans find it under pressure (`examples/ops-retail-shadow-percent/shadowPercent`).  
...
Feature flags are often product gates. This essay is about **ops posture on a hot path**: shadow traffic share for retail — numbers humans already change verbally in war rooms.
