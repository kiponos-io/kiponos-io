---
title: "Canary Traffic Share Should Not Wait for a Redeploy — Mlops Live Posture"
published: false
tags: java, machinelearning, devops, kiponos
description: "Live canary traffic share via Kiponos Python SDK — mlops posture without redeploy."
canonical_url: https://github.com/kiponos-io/kiponos-io/blob/master/docs/devto-ops-posture-mlops-canary-percent-0960.md
main_image: ./devto-cover-ops-posture-mlops-canary-percent-0960.jpg
---
...
Domain: batch size, score thresholds. This essay maps hub key `canaryPercent` to **canary traffic share** so the lesson stays concrete for mlops operators.
...
```python
policy = kiponos.path("examples", "ops-mlops-canary-percent")
...
1. Name the hub path so humans find it under pressure (`examples/ops-mlops-canary-percent/canaryPercent`).  
...
Feature flags are often product gates. This essay is about **ops posture on a hot path**: canary traffic share for mlops — numbers humans already change verbally in war rooms.
