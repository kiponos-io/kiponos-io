---
title: "The Iot War Room Already Knew degradeMode — The Jar Did Not"
published: false
tags: java, iot, devops, kiponos
description: "Live degradation mode via Kiponos Python SDK — iot posture without redeploy."
canonical_url: https://github.com/kiponos-io/kiponos-io/blob/master/docs/devto-ops-posture-iot-degrade-mode-0478.md
main_image: ./devto-cover-ops-posture-iot-degrade-mode-0478.jpg
---
...
Domain: device firmware gates, telemetry sample. This essay maps hub key `degradeMode` to **degradation mode** so the lesson stays concrete for iot operators.
...
```python
policy = kiponos.path("examples", "ops-iot-degrade-mode")
...
1. Name the hub path so humans find it under pressure (`examples/ops-iot-degrade-mode/degradeMode`).  
...
Feature flags are often product gates. This essay is about **ops posture on a hot path**: degradation mode for iot — numbers humans already change verbally in war rooms.
