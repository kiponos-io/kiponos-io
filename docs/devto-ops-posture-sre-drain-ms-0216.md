---
title: "We Stopped Shipping Graceful Drain Window as a Constant (Sre)"
published: false
tags: java, sre, devops, kiponos
description: "Live graceful drain window via Kiponos Java SDK — sre posture without redeploy."
canonical_url: https://github.com/kiponos-io/kiponos-io/blob/master/docs/devto-ops-posture-sre-drain-ms-0216.md
main_image: ./devto-cover-ops-posture-sre-drain-ms-0216.jpg
---
...
Domain: canary, drain, error budget. This essay maps hub key `gracefulShutdownMs` to **graceful drain window** so the lesson stays concrete for sre operators.
...
```java
Folder policy = kiponos.path("examples", "ops-sre-drain-ms");
...
1. Name the hub path so humans find it under pressure (`examples/ops-sre-drain-ms/gracefulShutdownMs`).  
...
Feature flags are often product gates. This essay is about **ops posture on a hot path**: graceful drain window for sre — numbers humans already change verbally in war rooms.
