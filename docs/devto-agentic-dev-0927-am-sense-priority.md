...
canonical_url: https://github.com/kiponos-io/kiponos-io/blob/master/docs/devto-agentic-dev-0927-am-sense-priority.md
---

I have sat next to the admin-dashboard wall at 22:19 while MCP host was *this close* to doing the wrong thing.
...
```text
examples/agentic-dev-0927-am-sense-priority/priority = live
```

Runnable proof: [`examples/java/agentic-dev-0927-am-sense-priority`](https://github.com/kiponos-io/kiponos-io/tree/master/examples/java/agentic-dev-0927-am-sense-priority)
...
Folder gate = kip.getRootFolder()
        ...
        .folderOrCreate("agentic-dev-0927-am-sense-priority");
...
try:
    posture = k.get("examples/agentic-dev-0927-am-sense-priority/priority", "live")
    if str(posture) == "live":
...
3. `cd examples/java/agentic-dev-0927-am-sense-priority && cp kiponos.local.env.example kiponos.local.env`
4. `./gradlew test run` — prints `examples/agentic-dev-0927-am-sense-priority/priority=...`
...
How to try: `examples/java/agentic-dev-0927-am-sense-priority` and `./gradlew test`.
