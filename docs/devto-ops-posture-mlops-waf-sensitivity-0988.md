---
title: "The Mlops War Room Already Knew wafSensitivity — The Jar Did Not"
published: false
tags: java, machinelearning, devops, kiponos
description: "Live WAF sensitivity 1-5 via Kiponos Python SDK — mlops posture without redeploy."
canonical_url: https://github.com/kiponos-io/kiponos-io/blob/master/docs/devto-ops-posture-mlops-waf-sensitivity-0988.md
main_image: ./devto-cover-ops-posture-mlops-waf-sensitivity-0988.jpg
---
...
Domain: batch size, score thresholds. This essay maps hub key `wafSensitivity` to **WAF sensitivity 1-5** so the lesson stays concrete for mlops operators.
...
```python
policy = kiponos.path("examples", "ops-mlops-waf-sensitivity")
...
1. Name the hub path so humans find it under pressure (`examples/ops-mlops-waf-sensitivity/wafSensitivity`).  
...
Feature flags are often product gates. This essay is about **ops posture on a hot path**: WAF sensitivity 1-5 for mlops — numbers humans already change verbally in war rooms.
