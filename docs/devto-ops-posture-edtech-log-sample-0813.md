---
title: "The Edtech War Room Already Knew logSamplePerThousand — The Jar Did Not"
published: false
tags: java, education, architecture, kiponos
description: "Live log sample per thousand via Kiponos Java SDK — edtech posture without redeploy."
canonical_url: https://github.com/kiponos-io/kiponos-io/blob/master/docs/devto-ops-posture-edtech-log-sample-0813.md
main_image: https://files.catbox.moe/jc2on0.jpg
---
...
Domain: class size, exam windows. This essay maps hub key `logSamplePerThousand` to **log sample per thousand** so the lesson stays concrete for edtech operators.
...
```java
Folder policy = kiponos.path("examples", "ops-edtech-log-sample");
...
1. Name the hub path so humans find it under pressure (`examples/ops-edtech-log-sample/logSamplePerThousand`).  
...
Feature flags are often product gates. This essay is about **ops posture on a hot path**: log sample per thousand for edtech — numbers humans already change verbally in war rooms.
