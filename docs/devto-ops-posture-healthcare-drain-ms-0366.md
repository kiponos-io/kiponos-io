---
title: "We Stopped Shipping Graceful Drain Window as a Constant (Healthcare)"
published: false
tags: java, healthcare, architecture, kiponos
description: "Live graceful drain window via Kiponos Java SDK — healthcare posture without redeploy."
canonical_url: https://github.com/kiponos-io/kiponos-io/blob/master/docs/devto-ops-posture-healthcare-drain-ms-0366.md
main_image: ./devto-cover-ops-posture-healthcare-drain-ms-0366.jpg
---
...
Domain: routing, queue depth, triage. This essay maps hub key `gracefulShutdownMs` to **graceful drain window** so the lesson stays concrete for healthcare operators.
...
```java
var policy = kiponos.path("examples", "ops-healthcare-drain-ms");
...
1. Name the hub path so humans find it under pressure (`examples/ops-healthcare-drain-ms/gracefulShutdownMs`).  
...
Feature flags are often product gates. This essay is about **ops posture on a hot path**: graceful drain window for healthcare — numbers humans already change verbally in war rooms.
