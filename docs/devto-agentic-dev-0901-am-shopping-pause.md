---
main_image: https://iili.io/CputosS.jpg
...
canonical_url: https://github.com/kiponos-io/kiponos-io/blob/master/docs/devto-agentic-dev-0901-am-shopping-pause.md
---

I have sat next to the mirror-phone wall at 02:14 while Cursor was *this close* to doing the wrong thing.
...
| Belief | Production |
|--------|------------|
| Restart Cursor — it is cheap | Cheap until 02:14 ate live device context and the current tool call |
...
```text
examples/agentic-dev-0901-am-shopping-pause/incident-pause = paused
```

Runnable proof: [`examples/java/agentic-dev-0901-am-shopping-pause`](https://github.com/kiponos-io/kiponos-io/tree/master/examples/java/agentic-dev-0901-am-shopping-pause)
...
```yaml
examples/
  agentic-dev-0901-am-shopping-pause/
...
Folder gate = kip.getRootFolder()
        ...
        .folderOrCreate("agentic-dev-0901-am-shopping-pause");
...
try:
    posture = k.get("examples/agentic-dev-0901-am-shopping-pause/incident-pause", "paused")
...
At 02:14 someone said, out loud: **the phone already knew the posture — the host did not**. That sentence is the whole product. If it cannot land in the running Cursor process in seconds, you do not have posture. You have a wiki.
...
3. `cd examples/java/agentic-dev-0901-am-shopping-pause && cp kiponos.local.env.example kiponos.local.env`
4. `./gradlew test run` — prints `examples/agentic-dev-0901-am-shopping-pause/incident-pause=...`
...
How to try: `examples/java/agentic-dev-0901-am-shopping-pause` and `./gradlew test`.
