---
title: "The Retail War Room Already Knew wafSensitivity — The Jar Did Not"
published: false
tags: java, retail, devops, kiponos
description: "Live WAF sensitivity 1-5 via Kiponos Python SDK — retail posture without redeploy."
canonical_url: https://github.com/kiponos-io/kiponos-io/blob/master/docs/devto-ops-posture-retail-waf-sensitivity-0038.md
main_image: ./devto-cover-ops-posture-retail-waf-sensitivity-0038.jpg
---
...
Domain: checkout, merchandising, inventory. This essay maps hub key `wafSensitivity` to **WAF sensitivity 1-5** so the lesson stays concrete for retail operators.
...
```python
policy = kiponos.path("examples", "ops-retail-waf-sensitivity")
...
1. Name the hub path so humans find it under pressure (`examples/ops-retail-waf-sensitivity/wafSensitivity`).  
...
Feature flags are often product gates. This essay is about **ops posture on a hot path**: WAF sensitivity 1-5 for retail — numbers humans already change verbally in war rooms.
