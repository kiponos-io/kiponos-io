---
main_image: https://iili.io/Cp9JHPt.jpg
...
canonical_url: https://github.com/kiponos-io/kiponos-io/blob/master/docs/devto-agentic-dev-0830-pm-admin-wall.md
---
...
```text
examples/agentic-dev-0830-pm-admin-wall/wall-focus = live
```

Runnable proof: [`examples/java/agentic-dev-0830-pm-admin-wall`](https://github.com/kiponos-io/kiponos-io/tree/master/examples/java/agentic-dev-0830-pm-admin-wall)
...
```yaml
examples/
  agentic-dev-0830-pm-admin-wall/
...
Folder gate = kip.getRootFolder()
        ...
        .folderOrCreate("agentic-dev-0830-pm-admin-wall");
...
try:
    posture = k.get("examples/agentic-dev-0830-pm-admin-wall/wall-focus", "live")
    if str(posture) == "live":
...
3. `cd examples/java/agentic-dev-0830-pm-admin-wall && cp kiponos.local.env.example kiponos.local.env`
4. `./gradlew test run` — prints `examples/agentic-dev-0830-pm-admin-wall/wall-focus=...`
...
How to try: `examples/java/agentic-dev-0830-pm-admin-wall` and `./gradlew test`.
