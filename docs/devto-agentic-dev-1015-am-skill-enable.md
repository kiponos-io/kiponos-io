...
canonical_url: https://github.com/kiponos-io/kiponos-io/blob/master/docs/devto-agentic-dev-1015-am-skill-enable.md
---
...
```text
examples/agentic-dev-1015-am-skill-enable/enabled-set = live
```

Runnable proof: [`examples/java/agentic-dev-1015-am-skill-enable`](https://github.com/kiponos-io/kiponos-io/tree/master/examples/java/agentic-dev-1015-am-skill-enable)
...
```yaml
examples/
  agentic-dev-1015-am-skill-enable/
...
Folder gate = kip.getRootFolder()
        ...
        .folderOrCreate("agentic-dev-1015-am-skill-enable");
...
try:
    posture = k.get("examples/agentic-dev-1015-am-skill-enable/enabled-set", "live")
    if str(posture) == "live":
...
3. `cd examples/java/agentic-dev-1015-am-skill-enable && cp kiponos.local.env.example kiponos.local.env`
4. `./gradlew test run` — prints `examples/agentic-dev-1015-am-skill-enable/enabled-set=...`
...
How to try: `examples/java/agentic-dev-1015-am-skill-enable` and `./gradlew test`.
