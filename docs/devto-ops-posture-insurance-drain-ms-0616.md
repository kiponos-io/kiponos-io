---
title: "We Stopped Shipping Graceful Drain Window as a Constant (Insurance)"
published: false
tags: java, insurance, architecture, kiponos
description: "Live graceful drain window via Kiponos Java SDK — insurance posture without redeploy."
canonical_url: https://github.com/kiponos-io/kiponos-io/blob/master/docs/devto-ops-posture-insurance-drain-ms-0616.md
main_image: ./devto-cover-ops-posture-insurance-drain-ms-0616.jpg
---
...
Domain: underwriting, claims velocity. This essay maps hub key `gracefulShutdownMs` to **graceful drain window** so the lesson stays concrete for insurance operators.
...
```java
Folder policy = kiponos.path("examples", "ops-insurance-drain-ms");
...
1. Name the hub path so humans find it under pressure (`examples/ops-insurance-drain-ms/gracefulShutdownMs`).  
...
Feature flags are often product gates. This essay is about **ops posture on a hot path**: graceful drain window for insurance — numbers humans already change verbally in war rooms.
