---
title: "Live Trace Sample Per Thousand for Saas — Mouth to Process in Seconds"
published: false
tags: java, saas, architecture, kiponos
description: "Live trace sample per thousand via Kiponos Python SDK — saas posture without redeploy."
canonical_url: https://github.com/kiponos-io/kiponos-io/blob/master/docs/devto-ops-posture-saas-trace-sample-0262.md
main_image: ./devto-cover-ops-posture-saas-trace-sample-0262.jpg
---
...
Domain: multi-tenant quotas, feature posture. This essay maps hub key `samplePerThousand` to **trace sample per thousand** so the lesson stays concrete for saas operators.
...
```python
policy = kiponos.path("examples", "ops-saas-trace-sample")
...
1. Name the hub path so humans find it under pressure (`examples/ops-saas-trace-sample/samplePerThousand`).  
...
Feature flags are often product gates. This essay is about **ops posture on a hot path**: trace sample per thousand for saas — numbers humans already change verbally in war rooms.
