---
title: "We Stopped Shipping Shadow Traffic Share as a Constant (Logistics)"
published: false
tags: java, logistics, devops, kiponos
description: "Live shadow traffic share via Kiponos Python SDK — logistics posture without redeploy."
canonical_url: https://github.com/kiponos-io/kiponos-io/blob/master/docs/devto-ops-posture-logistics-shadow-percent-0311.md
main_image: ./devto-cover-ops-posture-logistics-shadow-percent-0311.jpg
---
...
Domain: routing, SLA windows, fleet. This essay maps hub key `shadowPercent` to **shadow traffic share** so the lesson stays concrete for logistics operators.
...
```python
policy = kiponos.path("examples", "ops-logistics-shadow-percent")
...
1. Name the hub path so humans find it under pressure (`examples/ops-logistics-shadow-percent/shadowPercent`).  
...
Feature flags are often product gates. This essay is about **ops posture on a hot path**: shadow traffic share for logistics — numbers humans already change verbally in war rooms.
