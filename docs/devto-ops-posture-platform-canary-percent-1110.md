---
title: "Canary Traffic Share Should Not Wait for a Redeploy — Platform Live Posture"
published: false
tags: java, platform, architecture, kiponos
description: "Live canary traffic share via Kiponos Java SDK — platform posture without redeploy."
canonical_url: https://github.com/kiponos-io/kiponos-io/blob/master/docs/devto-ops-posture-platform-canary-percent-1110.md
main_image: ./devto-cover-ops-posture-platform-canary-percent-1110.jpg
---
...
Domain: shared libraries, defaults. This essay maps hub key `canaryPercent` to **canary traffic share** so the lesson stays concrete for platform operators.
...
```java
Folder policy = kiponos.path("examples", "ops-platform-canary-percent");
...
1. Name the hub path so humans find it under pressure (`examples/ops-platform-canary-percent/canaryPercent`).  
...
Feature flags are often product gates. This essay is about **ops posture on a hot path**: canary traffic share for platform — numbers humans already change verbally in war rooms.
