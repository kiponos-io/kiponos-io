---
main_image: https://iili.io/CyJgaUu.jpg
...
canonical_url: https://github.com/kiponos-io/kiponos-io/blob/master/docs/devto-agentic-dev-0910-pm-budget-turn.md
---
...
```text
examples/agentic-dev-0910-pm-budget-turn/max-tokens = 8000
```

Runnable proof: [`examples/java/agentic-dev-0910-pm-budget-turn`](https://github.com/kiponos-io/kiponos-io/tree/master/examples/java/agentic-dev-0910-pm-budget-turn)
...
```yaml
examples/
  agentic-dev-0910-pm-budget-turn/
...
Folder gate = kip.getRootFolder()
        ...
        .folderOrCreate("agentic-dev-0910-pm-budget-turn");
...
try:
    posture = k.get("examples/agentic-dev-0910-pm-budget-turn/max-tokens", "8000")
    if str(posture) == "8000":
...
3. `cd examples/java/agentic-dev-0910-pm-budget-turn && cp kiponos.local.env.example kiponos.local.env`
4. `./gradlew test run` — prints `examples/agentic-dev-0910-pm-budget-turn/max-tokens=...`
...
How to try: `examples/java/agentic-dev-0910-pm-budget-turn` and `./gradlew test`.
