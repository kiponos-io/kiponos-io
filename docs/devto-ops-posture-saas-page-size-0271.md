---
title: "We Stopped Shipping Pagination Page Size as a Constant (Saas)"
published: false
tags: java, saas, architecture, kiponos
description: "Live pagination page size via Kiponos Python SDK — saas posture without redeploy."
canonical_url: https://github.com/kiponos-io/kiponos-io/blob/master/docs/devto-ops-posture-saas-page-size-0271.md
main_image: ./devto-cover-ops-posture-saas-page-size-0271.jpg
---
...
Domain: multi-tenant quotas, feature posture. This essay maps hub key `pageSize` to **pagination page size** so the lesson stays concrete for saas operators.
...
```python
policy = kiponos.path("examples", "ops-saas-page-size")
...
1. Name the hub path so humans find it under pressure (`examples/ops-saas-page-size/pageSize`).  
...
Feature flags are often product gates. This essay is about **ops posture on a hot path**: pagination page size for saas — numbers humans already change verbally in war rooms.
