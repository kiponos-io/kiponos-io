---
title: "The Cdn War Room Already Knew wafSensitivity — The Jar Did Not"
published: false
tags: java, networking, devops, kiponos
description: "Live WAF sensitivity 1-5 via Kiponos Java SDK — cdn posture without redeploy."
canonical_url: https://github.com/kiponos-io/kiponos-io/blob/master/docs/devto-ops-posture-cdn-waf-sensitivity-0938.md
main_image: https://files.catbox.moe/q4pxzv.jpg
---
...
Domain: edge rules, cache TTL, purge. This essay maps hub key `wafSensitivity` to **WAF sensitivity 1-5** so the lesson stays concrete for cdn operators.
...
```java
Folder policy = kiponos.path("examples", "ops-cdn-waf-sensitivity");
...
1. Name the hub path so humans find it under pressure (`examples/ops-cdn-waf-sensitivity/wafSensitivity`).  
...
Feature flags are often product gates. This essay is about **ops posture on a hot path**: WAF sensitivity 1-5 for cdn — numbers humans already change verbally in war rooms.
