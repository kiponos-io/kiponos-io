---
title: "The Sre War Room Already Knew velocityCap — The Jar Did Not"
published: false
tags: java, sre, devops, kiponos
description: "Live fraud velocity cap via Kiponos Java SDK — sre posture without redeploy."
canonical_url: https://github.com/kiponos-io/kiponos-io/blob/master/docs/devto-ops-posture-sre-velocity-cap-0223.md
main_image: ./devto-cover-ops-posture-sre-velocity-cap-0223.jpg
---
...
Domain: canary, drain, error budget. This essay maps hub key `velocityCap` to **fraud velocity cap** so the lesson stays concrete for sre operators.
...
```java
Folder policy = kiponos.path("examples", "ops-sre-velocity-cap");
...
1. Name the hub path so humans find it under pressure (`examples/ops-sre-velocity-cap/velocityCap`).  
...
Feature flags are often product gates. This essay is about **ops posture on a hot path**: fraud velocity cap for sre — numbers humans already change verbally in war rooms.
