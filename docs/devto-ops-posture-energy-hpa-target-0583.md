---
title: "The Energy War Room Already Knew hpaTarget — The Jar Did Not"
published: false
tags: java, energy, architecture, kiponos
description: "Live HPA CPU target percent via Kiponos Java SDK — energy posture without redeploy."
canonical_url: https://github.com/kiponos-io/kiponos-io/blob/master/docs/devto-ops-posture-energy-hpa-target-0583.md
main_image: https://files.catbox.moe/nlxvgi.jpg
---
...
Domain: grid dispatch, demand response. This essay maps hub key `hpaTarget` to **HPA CPU target percent** so the lesson stays concrete for energy operators.
...
```java
Folder policy = kiponos.path("examples", "ops-energy-hpa-target");
...
1. Name the hub path so humans find it under pressure (`examples/ops-energy-hpa-target/hpaTarget`).  
...
Feature flags are often product gates. This essay is about **ops posture on a hot path**: HPA CPU target percent for energy — numbers humans already change verbally in war rooms.
