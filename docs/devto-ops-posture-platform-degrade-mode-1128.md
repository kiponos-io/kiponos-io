---
title: "The Platform War Room Already Knew degradeMode — The Jar Did Not"
published: false
tags: java, platform, architecture, kiponos
description: "Live degradation mode via Kiponos Java SDK — platform posture without redeploy."
canonical_url: https://github.com/kiponos-io/kiponos-io/blob/master/docs/devto-ops-posture-platform-degrade-mode-1128.md
main_image: ./devto-cover-ops-posture-platform-degrade-mode-1128.jpg
---
...
Domain: shared libraries, defaults. This essay maps hub key `degradeMode` to **degradation mode** so the lesson stays concrete for platform operators.
...
```java
Folder policy = kiponos.path("examples", "ops-platform-degrade-mode");
...
1. Name the hub path so humans find it under pressure (`examples/ops-platform-degrade-mode/degradeMode`).  
...
Feature flags are often product gates. This essay is about **ops posture on a hot path**: degradation mode for platform — numbers humans already change verbally in war rooms.
