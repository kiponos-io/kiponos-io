---
title: "The Ads War Room Already Knew wafSensitivity — The Jar Did Not"
published: false
tags: java, advertising, devops, kiponos
description: "Live WAF sensitivity 1-5 via Kiponos Python SDK — ads posture without redeploy."
canonical_url: https://github.com/kiponos-io/kiponos-io/blob/master/docs/devto-ops-posture-ads-waf-sensitivity-0788.md
main_image: https://files.catbox.moe/r0zben.jpg
---
...
Domain: bid caps, frequency, pacing. This essay maps hub key `wafSensitivity` to **WAF sensitivity 1-5** so the lesson stays concrete for ads operators.
...
```python
policy = kiponos.path("examples", "ops-ads-waf-sensitivity")
...
1. Name the hub path so humans find it under pressure (`examples/ops-ads-waf-sensitivity/wafSensitivity`).  
...
Feature flags are often product gates. This essay is about **ops posture on a hot path**: WAF sensitivity 1-5 for ads — numbers humans already change verbally in war rooms.
