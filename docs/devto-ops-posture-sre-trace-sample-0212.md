---
title: "Live Trace Sample Per Thousand for Sre — Mouth to Process in Seconds"
published: false
tags: java, sre, devops, kiponos
description: "Live trace sample per thousand via Kiponos Java SDK — sre posture without redeploy."
canonical_url: https://github.com/kiponos-io/kiponos-io/blob/master/docs/devto-ops-posture-sre-trace-sample-0212.md
main_image: ./devto-cover-ops-posture-sre-trace-sample-0212.jpg
---
...
Domain: canary, drain, error budget. This essay maps hub key `samplePerThousand` to **trace sample per thousand** so the lesson stays concrete for sre operators.
...
```java
Folder policy = kiponos.path("examples", "ops-sre-trace-sample");
...
1. Name the hub path so humans find it under pressure (`examples/ops-sre-trace-sample/samplePerThousand`).  
...
Feature flags are often product gates. This essay is about **ops posture on a hot path**: trace sample per thousand for sre — numbers humans already change verbally in war rooms.
