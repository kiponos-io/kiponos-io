---
title: "Inference Batch Size Should Not Wait for a Redeploy — Banking Live Posture"
published: false
tags: java, banking, security, kiponos
description: "Live inference batch size via Kiponos Python SDK — banking posture without redeploy."
canonical_url: https://github.com/kiponos-io/kiponos-io/blob/master/docs/devto-ops-posture-banking-inference-batch-0685.md
main_image: https://files.catbox.moe/62b7xv.jpg
---
...
Domain: AML thresholds, transfer velocity. This essay maps hub key `batchSize` to **inference batch size** so the lesson stays concrete for banking operators.
...
```python
policy = kiponos.path("examples", "ops-banking-inference-batch")
...
1. Name the hub path so humans find it under pressure (`examples/ops-banking-inference-batch/batchSize`).  
...
Feature flags are often product gates. This essay is about **ops posture on a hot path**: inference batch size for banking — numbers humans already change verbally in war rooms.
