---
title: "We Stopped Shipping Pagination Page Size as a Constant (Sre)"
published: false
tags: java, sre, devops, kiponos
description: "Live pagination page size via Kiponos Java SDK — sre posture without redeploy."
canonical_url: https://github.com/kiponos-io/kiponos-io/blob/master/docs/devto-ops-posture-sre-page-size-0221.md
main_image: ./devto-cover-ops-posture-sre-page-size-0221.jpg
---
...
Domain: canary, drain, error budget. This essay maps hub key `pageSize` to **pagination page size** so the lesson stays concrete for sre operators.
...
```java
var policy = kiponos.path("examples", "ops-sre-page-size");
...
1. Name the hub path so humans find it under pressure (`examples/ops-sre-page-size/pageSize`).  
...
Feature flags are often product gates. This essay is about **ops posture on a hot path**: pagination page size for sre — numbers humans already change verbally in war rooms.
