---
main_image: https://iili.io/nHcwa72.jpg
...
canonical_url: https://github.com/kiponos-io/kiponos-io/blob/master/docs/devto-agentic-dev-1025-am-skill-enable.md
---

I have sat next to the travel-coordinator wall at 00:40 while MCP host was *this close* to doing the wrong thing.
...
| Belief | Production |
|--------|------------|
| Restart MCP host — it is cheap | Cheap until 00:40 ate the overbook thread the agent already paid for |
...
```text
examples/agentic-dev-1025-am-skill-enable/enabled-set = live
```

Runnable proof: [`examples/java/agentic-dev-1025-am-skill-enable`](https://github.com/kiponos-io/kiponos-io/tree/master/examples/java/agentic-dev-1025-am-skill-enable)
...
```yaml
examples/
  agentic-dev-1025-am-skill-enable/
...
Folder gate = kip.getRootFolder()
        ...
        .folderOrCreate("agentic-dev-1025-am-skill-enable");
...
try:
    posture = k.get("examples/agentic-dev-1025-am-skill-enable/enabled-set", "live")
    if str(posture) == "live":
...
3. `cd examples/java/agentic-dev-1025-am-skill-enable && cp kiponos.local.env.example kiponos.local.env`
4. `./gradlew test run` — prints `examples/agentic-dev-1025-am-skill-enable/enabled-set=...`
...
How to try: `examples/java/agentic-dev-1025-am-skill-enable` and `./gradlew test`.
