---
title: "We Stopped Shipping Pagination Page Size as a Constant (Mobile)"
published: false
tags: java, mobile, architecture, kiponos
description: "Live pagination page size via Kiponos Java SDK — mobile posture without redeploy."
canonical_url: https://github.com/kiponos-io/kiponos-io/blob/master/docs/devto-ops-posture-mobile-page-size-1171.md
main_image: ./devto-cover-ops-posture-mobile-page-size-1171.jpg
---
...
Domain: API timeouts, payload caps. This essay maps hub key `pageSize` to **pagination page size** so the lesson stays concrete for mobile operators.
...
```java
var policy = kiponos.path("examples", "ops-mobile-page-size");
...
1. Name the hub path so humans find it under pressure (`examples/ops-mobile-page-size/pageSize`).  
...
Feature flags are often product gates. This essay is about **ops posture on a hot path**: pagination page size for mobile — numbers humans already change verbally in war rooms.
