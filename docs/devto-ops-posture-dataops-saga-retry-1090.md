---
title: "Saga Step Retry Budget Should Not Wait for a Redeploy — Dataops Live Posture"
published: false
tags: java, dataengineering, devops, kiponos
description: "Live saga step retry budget via Kiponos Java SDK — dataops posture without redeploy."
canonical_url: https://github.com/kiponos-io/kiponos-io/blob/master/docs/devto-ops-posture-dataops-saga-retry-1090.md
main_image: https://files.catbox.moe/09lf70.jpg
---
...
Domain: batch, lag, checkpoint. This essay maps hub key `sagaMaxAttempts` to **saga step retry budget** so the lesson stays concrete for dataops operators.
...
```java
Folder policy = kiponos.path("examples", "ops-dataops-saga-retry");
...
1. Name the hub path so humans find it under pressure (`examples/ops-dataops-saga-retry/sagaMaxAttempts`).  
...
Feature flags are often product gates. This essay is about **ops posture on a hot path**: saga step retry budget for dataops — numbers humans already change verbally in war rooms.
