---
title: "We Stopped Shipping Pricing / Promo Weight as a Constant (Telecom)"
published: false
tags: java, telecom, sre, kiponos
description: "Live pricing / promo weight via Kiponos Java SDK — telecom posture without redeploy."
canonical_url: https://github.com/kiponos-io/kiponos-io/blob/master/docs/devto-ops-posture-telecom-pricing-weight-0526.md
main_image: ./devto-cover-ops-posture-telecom-pricing-weight-0526.jpg
---
...
Domain: QoS, rate classes, trunk limits. This essay maps hub key `weight` to **pricing / promo weight** so the lesson stays concrete for telecom operators.
...
```java
Folder policy = kiponos.path("examples", "ops-telecom-pricing-weight");
...
1. Name the hub path so humans find it under pressure (`examples/ops-telecom-pricing-weight/weight`).  
...
Feature flags are often product gates. This essay is about **ops posture on a hot path**: pricing / promo weight for telecom — numbers humans already change verbally in war rooms.
