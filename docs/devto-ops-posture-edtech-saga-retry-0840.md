---
title: "Saga Step Retry Budget Should Not Wait for a Redeploy — Edtech Live Posture"
published: false
tags: java, education, architecture, kiponos
description: "Live saga step retry budget via Kiponos Python SDK — edtech posture without redeploy."
canonical_url: https://github.com/kiponos-io/kiponos-io/blob/master/docs/devto-ops-posture-edtech-saga-retry-0840.md
main_image: https://files.catbox.moe/e4np7j.jpg
---
...
Domain: class size, exam windows. This essay maps hub key `sagaMaxAttempts` to **saga step retry budget** so the lesson stays concrete for edtech operators.
...
```python
policy = kiponos.path("examples", "ops-edtech-saga-retry")
...
1. Name the hub path so humans find it under pressure (`examples/ops-edtech-saga-retry/sagaMaxAttempts`).  
...
Feature flags are often product gates. This essay is about **ops posture on a hot path**: saga step retry budget for edtech — numbers humans already change verbally in war rooms.
