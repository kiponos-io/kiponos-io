---
title: "The Healthcare War Room Already Knew wafSensitivity — The Jar Did Not"
published: false
tags: java, healthcare, architecture, kiponos
description: "Live WAF sensitivity 1-5 via Kiponos Java SDK — healthcare posture without redeploy."
canonical_url: https://github.com/kiponos-io/kiponos-io/blob/master/docs/devto-ops-posture-healthcare-waf-sensitivity-0388.md
main_image: ./devto-cover-ops-posture-healthcare-waf-sensitivity-0388.jpg
---
...
Domain: routing, queue depth, triage. This essay maps hub key `wafSensitivity` to **WAF sensitivity 1-5** so the lesson stays concrete for healthcare operators.
...
```yaml
examples/
  ops-healthcare-waf-sensitivity/
...
```java
var policy = kiponos.path("examples", "ops-healthcare-waf-sensitivity");
...
1. Name the hub path so humans find it under pressure (`examples/ops-healthcare-waf-sensitivity/wafSensitivity`).  
...
Feature flags are often product gates. This essay is about **ops posture on a hot path**: WAF sensitivity 1-5 for healthcare — numbers humans already change verbally in war rooms.
