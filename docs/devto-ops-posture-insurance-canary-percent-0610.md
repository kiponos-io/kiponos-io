---
title: "Canary Traffic Share Should Not Wait for a Redeploy — Insurance Live Posture"
published: false
tags: java, insurance, architecture, kiponos
description: "Live canary traffic share via Kiponos Java SDK — insurance posture without redeploy."
canonical_url: https://github.com/kiponos-io/kiponos-io/blob/master/docs/devto-ops-posture-insurance-canary-percent-0610.md
main_image: ./devto-cover-ops-posture-insurance-canary-percent-0610.jpg
---
...
Domain: underwriting, claims velocity. This essay maps hub key `canaryPercent` to **canary traffic share** so the lesson stays concrete for insurance operators.
...
```java
var policy = kiponos.path("examples", "ops-insurance-canary-percent");
...
1. Name the hub path so humans find it under pressure (`examples/ops-insurance-canary-percent/canaryPercent`).  
...
Feature flags are often product gates. This essay is about **ops posture on a hot path**: canary traffic share for insurance — numbers humans already change verbally in war rooms.
