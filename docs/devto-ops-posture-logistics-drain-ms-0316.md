---
title: "We Stopped Shipping Graceful Drain Window as a Constant (Logistics)"
published: false
tags: java, logistics, devops, kiponos
description: "Live graceful drain window via Kiponos Java SDK — logistics posture without redeploy."
canonical_url: https://github.com/kiponos-io/kiponos-io/blob/master/docs/devto-ops-posture-logistics-drain-ms-0316.md
main_image: ./devto-cover-ops-posture-logistics-drain-ms-0316.jpg
---
...
Domain: routing, SLA windows, fleet. This essay maps hub key `gracefulShutdownMs` to **graceful drain window** so the lesson stays concrete for logistics operators.
...
```java
var policy = kiponos.path("examples", "ops-logistics-drain-ms");
...
1. Name the hub path so humans find it under pressure (`examples/ops-logistics-drain-ms/gracefulShutdownMs`).  
...
Feature flags are often product gates. This essay is about **ops posture on a hot path**: graceful drain window for logistics — numbers humans already change verbally in war rooms.
