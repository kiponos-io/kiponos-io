---
title: "We Stopped Shipping Shadow Traffic Share as a Constant (Platform)"
published: false
tags: java, platform, architecture, kiponos
description: "Live shadow traffic share via Kiponos Java SDK — platform posture without redeploy."
canonical_url: https://github.com/kiponos-io/kiponos-io/blob/master/docs/devto-ops-posture-platform-shadow-percent-1111.md
main_image: ./devto-cover-ops-posture-platform-shadow-percent-1111.jpg
---
...
Domain: shared libraries, defaults. This essay maps hub key `shadowPercent` to **shadow traffic share** so the lesson stays concrete for platform operators.
...
```java
Folder policy = kiponos.path("examples", "ops-platform-shadow-percent");
...
1. Name the hub path so humans find it under pressure (`examples/ops-platform-shadow-percent/shadowPercent`).  
...
Feature flags are often product gates. This essay is about **ops posture on a hot path**: shadow traffic share for platform — numbers humans already change verbally in war rooms.
