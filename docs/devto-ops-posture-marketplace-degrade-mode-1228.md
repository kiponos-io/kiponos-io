---
title: "The Marketplace War Room Already Knew degradeMode — The Jar Did Not"
published: false
tags: java, architecture, devops, kiponos
description: "Live degradation mode via Kiponos Java SDK — marketplace posture without redeploy."
canonical_url: https://github.com/kiponos-io/kiponos-io/blob/master/docs/devto-ops-posture-marketplace-degrade-mode-1228.md
main_image: ./devto-cover-ops-posture-marketplace-degrade-mode-1228.jpg
---
...
Domain: seller tiers, fee weights. This essay maps hub key `degradeMode` to **degradation mode** so the lesson stays concrete for marketplace operators.
...
```java
Folder policy = kiponos.path("examples", "ops-marketplace-degrade-mode");
...
1. Name the hub path so humans find it under pressure (`examples/ops-marketplace-degrade-mode/degradeMode`).  
...
Feature flags are often product gates. This essay is about **ops posture on a hot path**: degradation mode for marketplace — numbers humans already change verbally in war rooms.
