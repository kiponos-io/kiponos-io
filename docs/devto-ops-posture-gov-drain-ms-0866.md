---
title: "We Stopped Shipping Graceful Drain Window as a Constant (Gov)"
published: false
tags: java, architecture, devops, kiponos
description: "Live graceful drain window via Kiponos Python SDK — gov posture without redeploy."
canonical_url: https://github.com/kiponos-io/kiponos-io/blob/master/docs/devto-ops-posture-gov-drain-ms-0866.md
main_image: ./devto-cover-ops-posture-gov-drain-ms-0866.jpg
---
...
Domain: form windows, batch cutoffs. This essay maps hub key `gracefulShutdownMs` to **graceful drain window** so the lesson stays concrete for gov operators.
...
```python
policy = kiponos.path("examples", "ops-gov-drain-ms")
...
1. Name the hub path so humans find it under pressure (`examples/ops-gov-drain-ms/gracefulShutdownMs`).  
...
Feature flags are often product gates. This essay is about **ops posture on a hot path**: graceful drain window for gov — numbers humans already change verbally in war rooms.
