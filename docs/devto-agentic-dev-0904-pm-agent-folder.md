---
main_image: https://iili.io/CpuZ2Ax.jpg
...
canonical_url: https://github.com/kiponos-io/kiponos-io/blob/master/docs/devto-agentic-dev-0904-pm-agent-folder.md
---
...
```text
examples/agentic-dev-0904-pm-agent-folder/owner-agent = live
```

Runnable proof: [`examples/java/agentic-dev-0904-pm-agent-folder`](https://github.com/kiponos-io/kiponos-io/tree/master/examples/java/agentic-dev-0904-pm-agent-folder)
...
Folder gate = kip.getRootFolder()
        ...
        .folderOrCreate("agentic-dev-0904-pm-agent-folder");
...
try:
    posture = k.get("examples/agentic-dev-0904-pm-agent-folder/owner-agent", "live")
    if str(posture) == "live":
...
3. `cd examples/java/agentic-dev-0904-pm-agent-folder && cp kiponos.local.env.example kiponos.local.env`
4. `./gradlew test run` — prints `examples/agentic-dev-0904-pm-agent-folder/owner-agent=...`
...
How to try: `examples/java/agentic-dev-0904-pm-agent-folder` and `./gradlew test`.
