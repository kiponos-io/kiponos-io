---
title: "We Stopped Shipping Rag Top-K as a Constant (Travel)"
published: false
tags: java, travel, architecture, kiponos
description: "Live RAG top-k via Kiponos Java SDK — travel posture without redeploy."
canonical_url: https://github.com/kiponos-io/kiponos-io/blob/master/docs/devto-ops-posture-travel-rag-topk-0136.md
main_image: ./devto-cover-ops-posture-travel-rag-topk-0136.jpg
---
...
Domain: inventory, overbooking, GDS. This essay maps hub key `topK` to **RAG top-k** so the lesson stays concrete for travel operators.
...
```java
Folder policy = kiponos.path("examples", "ops-travel-rag-topk");
...
1. Name the hub path so humans find it under pressure (`examples/ops-travel-rag-topk/topK`).  
...
Feature flags are often product gates. This essay is about **ops posture on a hot path**: RAG top-k for travel — numbers humans already change verbally in war rooms.
