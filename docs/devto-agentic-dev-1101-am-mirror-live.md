---
main_image: https://d.uguu.se/HBqfLGrB.jpg
...
canonical_url: https://github.com/kiponos-io/kiponos-io/blob/master/docs/devto-agentic-dev-1101-am-mirror-live.md
---
...
Runnable proof: [`examples/java/agentic-dev-1101-am-mirror-live`](https://github.com/kiponos-io/kiponos-io/tree/master/examples/java/agentic-dev-1101-am-mirror-live)
...
3. `cd examples/java/agentic-dev-1101-am-mirror-live && cp kiponos.local.env.example kiponos.local.env`
4. `./gradlew test run` — prints `examples/agentic-dev-1101-am-mirror-live/device-live=...`
