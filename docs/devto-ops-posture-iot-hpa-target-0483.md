---
title: "The Iot War Room Already Knew hpaTarget — The Jar Did Not"
published: false
tags: java, iot, devops, kiponos
description: "Live HPA CPU target percent via Kiponos Java SDK — iot posture without redeploy."
canonical_url: https://github.com/kiponos-io/kiponos-io/blob/master/docs/devto-ops-posture-iot-hpa-target-0483.md
main_image: ./devto-cover-ops-posture-iot-hpa-target-0483.jpg
---
...
Domain: device firmware gates, telemetry sample. This essay maps hub key `hpaTarget` to **HPA CPU target percent** so the lesson stays concrete for iot operators.
...
```java
Folder policy = kiponos.path("examples", "ops-iot-hpa-target");
...
1. Name the hub path so humans find it under pressure (`examples/ops-iot-hpa-target/hpaTarget`).  
...
Feature flags are often product gates. This essay is about **ops posture on a hot path**: HPA CPU target percent for iot — numbers humans already change verbally in war rooms.
