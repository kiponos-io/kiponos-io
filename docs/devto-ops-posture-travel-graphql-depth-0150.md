---
title: "Graphql Query Depth Should Not Wait for a Redeploy — Travel Live Posture"
published: false
tags: java, travel, architecture, kiponos
description: "Live GraphQL query depth via Kiponos Python SDK — travel posture without redeploy."
canonical_url: https://github.com/kiponos-io/kiponos-io/blob/master/docs/devto-ops-posture-travel-graphql-depth-0150.md
main_image: ./devto-cover-ops-posture-travel-graphql-depth-0150.jpg
---
...
Domain: inventory, overbooking, GDS. This essay maps hub key `maxDepth` to **GraphQL query depth** so the lesson stays concrete for travel operators.
...
```python
policy = kiponos.path("examples", "ops-travel-graphql-depth")
...
1. Name the hub path so humans find it under pressure (`examples/ops-travel-graphql-depth/maxDepth`).  
...
Feature flags are often product gates. This essay is about **ops posture on a hot path**: GraphQL query depth for travel — numbers humans already change verbally in war rooms.
