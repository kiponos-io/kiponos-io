...
canonical_url: https://github.com/kiponos-io/kiponos-io/blob/master/docs/devto-agentic-dev-0921-am-shopping-pause.md
---
...
```text
examples/agentic-dev-0921-am-shopping-pause/incident-pause = paused
```

Runnable proof: [`examples/java/agentic-dev-0921-am-shopping-pause`](https://github.com/kiponos-io/kiponos-io/tree/master/examples/java/agentic-dev-0921-am-shopping-pause)
...
```yaml
examples/
  agentic-dev-0921-am-shopping-pause/
...
Folder gate = kip.getRootFolder()
        ...
        .folderOrCreate("agentic-dev-0921-am-shopping-pause");
...
try:
    posture = k.get("examples/agentic-dev-0921-am-shopping-pause/incident-pause", "paused")
...
3. `cd examples/java/agentic-dev-0921-am-shopping-pause && cp kiponos.local.env.example kiponos.local.env`
4. `./gradlew test run` — prints `examples/agentic-dev-0921-am-shopping-pause/incident-pause=...`
...
How to try: `examples/java/agentic-dev-0921-am-shopping-pause` and `./gradlew test`.
