---
title: "We Stopped Shipping Pricing / Promo Weight as a Constant (Gaming)"
published: false
tags: java, gaming, devops, kiponos
description: "Live pricing / promo weight via Kiponos Java SDK — gaming posture without redeploy."
canonical_url: https://github.com/kiponos-io/kiponos-io/blob/master/docs/devto-ops-posture-gaming-pricing-weight-0426.md
main_image: https://files.catbox.moe/io78vd.jpg
---
...
Domain: matchmaking, session caps, tick rate. This essay maps hub key `weight` to **pricing / promo weight** so the lesson stays concrete for gaming operators.
...
```java
var policy = kiponos.path("examples", "ops-gaming-pricing-weight");
...
1. Name the hub path so humans find it under pressure (`examples/ops-gaming-pricing-weight/weight`).  
...
Feature flags are often product gates. This essay is about **ops posture on a hot path**: pricing / promo weight for gaming — numbers humans already change verbally in war rooms.
