---
title: "We Stopped Shipping Pricing / Promo Weight as a Constant (Energy)"
published: false
tags: java, energy, architecture, kiponos
description: "Live pricing / promo weight via Kiponos Java SDK — energy posture without redeploy."
canonical_url: https://github.com/kiponos-io/kiponos-io/blob/master/docs/devto-ops-posture-energy-pricing-weight-0576.md
main_image: https://files.catbox.moe/rz4isv.jpg
---
...
Domain: grid dispatch, demand response. This essay maps hub key `weight` to **pricing / promo weight** so the lesson stays concrete for energy operators.
...
```java
Folder policy = kiponos.path("examples", "ops-energy-pricing-weight");
...
1. Name the hub path so humans find it under pressure (`examples/ops-energy-pricing-weight/weight`).  
...
Feature flags are often product gates. This essay is about **ops posture on a hot path**: pricing / promo weight for energy — numbers humans already change verbally in war rooms.
