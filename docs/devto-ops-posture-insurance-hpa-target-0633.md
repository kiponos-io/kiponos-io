---
title: "The Insurance War Room Already Knew hpaTarget — The Jar Did Not"
published: false
tags: java, insurance, architecture, kiponos
description: "Live HPA CPU target percent via Kiponos Java SDK — insurance posture without redeploy."
canonical_url: https://github.com/kiponos-io/kiponos-io/blob/master/docs/devto-ops-posture-insurance-hpa-target-0633.md
main_image: ./devto-cover-ops-posture-insurance-hpa-target-0633.jpg
---
...
Domain: underwriting, claims velocity. This essay maps hub key `hpaTarget` to **HPA CPU target percent** so the lesson stays concrete for insurance operators.
...
```java
Folder policy = kiponos.path("examples", "ops-insurance-hpa-target");
...
1. Name the hub path so humans find it under pressure (`examples/ops-insurance-hpa-target/hpaTarget`).  
...
Feature flags are often product gates. This essay is about **ops posture on a hot path**: HPA CPU target percent for insurance — numbers humans already change verbally in war rooms.
