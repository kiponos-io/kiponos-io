---
title: "The Banking War Room Already Knew velocityCap — The Jar Did Not"
published: false
...
main_image: https://files.catbox.moe/fe1y8y.jpg
---
...
Domain: AML thresholds, transfer velocity. This essay maps hub key `velocityCap` to **fraud velocity cap** so the lesson stays concrete for banking operators.
...
```java
var policy = kiponos.path("examples", "ops-banking-velocity-cap");
...
1. Name the hub path so humans find it under pressure (`examples/ops-banking-velocity-cap/velocityCap`).  
...
Feature flags are often product gates. This essay is about **ops posture on a hot path**: fraud velocity cap for banking — numbers humans already change verbally in war rooms.
