---
title: "We Stopped Shipping Shadow Traffic Share as a Constant (Energy)"
published: false
tags: java, energy, architecture, kiponos
description: "Live shadow traffic share via Kiponos Python SDK — energy posture without redeploy."
canonical_url: https://github.com/kiponos-io/kiponos-io/blob/master/docs/devto-ops-posture-energy-shadow-percent-0561.md
main_image: https://files.catbox.moe/vwb3a9.jpg
---
...
Domain: grid dispatch, demand response. This essay maps hub key `shadowPercent` to **shadow traffic share** so the lesson stays concrete for energy operators.
...
```python
policy = kiponos.path("examples", "ops-energy-shadow-percent")
...
1. Name the hub path so humans find it under pressure (`examples/ops-energy-shadow-percent/shadowPercent`).  
...
Feature flags are often product gates. This essay is about **ops posture on a hot path**: shadow traffic share for energy — numbers humans already change verbally in war rooms.
