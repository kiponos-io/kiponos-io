---
title: "We Stopped Shipping Rag Top-K as a Constant (Retail)"
published: false
tags: java, retail, devops, kiponos
description: "Live RAG top-k via Kiponos Java SDK — retail posture without redeploy."
canonical_url: https://github.com/kiponos-io/kiponos-io/blob/master/docs/devto-ops-posture-retail-rag-topk-0036.md
main_image: ./devto-cover-ops-posture-retail-rag-topk-0036.jpg
---
...
Domain: checkout, merchandising, inventory. This essay maps hub key `topK` to **RAG top-k** so the lesson stays concrete for retail operators.
...
```java
Folder policy = kiponos.path("examples", "ops-retail-rag-topk");
...
1. Name the hub path so humans find it under pressure (`examples/ops-retail-rag-topk/topK`).  
...
Feature flags are often product gates. This essay is about **ops posture on a hot path**: RAG top-k for retail — numbers humans already change verbally in war rooms.
