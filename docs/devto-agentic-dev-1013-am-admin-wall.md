...
canonical_url: https://github.com/kiponos-io/kiponos-io/blob/master/docs/devto-agentic-dev-1013-am-admin-wall.md
---
...
| Belief | Production |
|--------|------------|
| Restart MCP host — it is cheap | Cheap until 22:19 ate the turn budget and the open investigation |
...
```text
examples/agentic-dev-1013-am-admin-wall/wall-focus = live
```

Runnable proof: [`examples/java/agentic-dev-1013-am-admin-wall`](https://github.com/kiponos-io/kiponos-io/tree/master/examples/java/agentic-dev-1013-am-admin-wall)
...
```yaml
examples/
  agentic-dev-1013-am-admin-wall/
...
Folder gate = kip.getRootFolder()
        ...
        .folderOrCreate("agentic-dev-1013-am-admin-wall");
...
try:
    posture = k.get("examples/agentic-dev-1013-am-admin-wall/wall-focus", "live")
    if str(posture) == "live":
...
3. `cd examples/java/agentic-dev-1013-am-admin-wall && cp kiponos.local.env.example kiponos.local.env`
4. `./gradlew test run` — prints `examples/agentic-dev-1013-am-admin-wall/wall-focus=...`
...
How to try: `examples/java/agentic-dev-1013-am-admin-wall` and `./gradlew test`.
