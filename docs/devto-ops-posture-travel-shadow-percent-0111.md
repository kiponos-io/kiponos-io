---
title: "We Stopped Shipping Shadow Traffic Share as a Constant (Travel)"
published: false
tags: java, travel, architecture, kiponos
description: "Live shadow traffic share via Kiponos Python SDK — travel posture without redeploy."
canonical_url: https://github.com/kiponos-io/kiponos-io/blob/master/docs/devto-ops-posture-travel-shadow-percent-0111.md
main_image: ./devto-cover-ops-posture-travel-shadow-percent-0111.jpg
---
...
Domain: inventory, overbooking, GDS. This essay maps hub key `shadowPercent` to **shadow traffic share** so the lesson stays concrete for travel operators.
...
```python
policy = kiponos.path("examples", "ops-travel-shadow-percent")
...
1. Name the hub path so humans find it under pressure (`examples/ops-travel-shadow-percent/shadowPercent`).  
...
Feature flags are often product gates. This essay is about **ops posture on a hot path**: shadow traffic share for travel — numbers humans already change verbally in war rooms.
