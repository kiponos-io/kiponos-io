---
main_image: https://h.uguu.se/hTwmUpYK.jpg
...
canonical_url: https://github.com/kiponos-io/kiponos-io/blob/master/docs/devto-agentic-dev-1015-pm-session-posture.md
---

I have sat next to the senses wall at 18:45 while Grok Build was *this close* to doing the wrong thing.
...
| Restart Grok Build — it is cheap | Cheap until 18:45 ate the turn budget and the open investigation |
...
```text
examples/agentic-dev-1015-pm-session-posture/session-posture = shared
```

Runnable proof: [`examples/java/agentic-dev-1015-pm-session-posture`](https://github.com/kiponos-io/kiponos-io/tree/master/examples/java/agentic-dev-1015-pm-session-posture)
...
```yaml
examples/
  agentic-dev-1015-pm-session-posture/
...
Folder gate = kip.getRootFolder()
        ...
        .folderOrCreate("agentic-dev-1015-pm-session-posture");
...
try:
    posture = k.get("examples/agentic-dev-1015-pm-session-posture/session-posture", "shared")
...
At 18:45 someone said, out loud: **priority is a leaf, not a restart**. That sentence is the whole product. If it cannot land in the running Grok Build process in seconds, you do not have posture. You have a wiki.
...
3. `cd examples/java/agentic-dev-1015-pm-session-posture && cp kiponos.local.env.example kiponos.local.env`
4. `./gradlew test run` — prints `examples/agentic-dev-1015-pm-session-posture/session-posture=...`
...
How to try: `examples/java/agentic-dev-1015-pm-session-posture` and `./gradlew test`.
