---
main_image: https://iili.io/CycV47s.jpg
...
canonical_url: https://github.com/kiponos-io/kiponos-io/blob/master/docs/devto-agentic-dev-0922-am-mirror-live.md
---

I have sat next to the admin-dashboard wall at 14:12 while Claude Code was *this close* to doing the wrong thing.
...
```text
examples/agentic-dev-0922-am-mirror-live/device-live = live
```

Runnable proof: [`examples/java/agentic-dev-0922-am-mirror-live`](https://github.com/kiponos-io/kiponos-io/tree/master/examples/java/agentic-dev-0922-am-mirror-live)
...
```yaml
examples/
  agentic-dev-0922-am-mirror-live/
...
Folder gate = kip.getRootFolder()
        ...
        .folderOrCreate("agentic-dev-0922-am-mirror-live");
...
try:
    posture = k.get("examples/agentic-dev-0922-am-mirror-live/device-live", "live")
    if str(posture) == "live":
...
At 14:12 someone said, out loud: **the tile is not a rumor. it is the same tree**. That sentence is the whole product. If it cannot land in the running Claude Code process in seconds, you do not have posture. You have a wiki.
...
3. `cd examples/java/agentic-dev-0922-am-mirror-live && cp kiponos.local.env.example kiponos.local.env`
4. `./gradlew test run` — prints `examples/agentic-dev-0922-am-mirror-live/device-live=...`
...
How to try: `examples/java/agentic-dev-0922-am-mirror-live` and `./gradlew test`.
