...
canonical_url: https://github.com/kiponos-io/kiponos-io/blob/master/docs/devto-agentic-dev-0902-am-mirror-live.md
---
...
| Restart Claude Code — it is cheap | Cheap until 03:07 ate the operator's last ten minutes of diagnosis |
...
```text
examples/agentic-dev-0902-am-mirror-live/device-live = live
```

Runnable proof: [`examples/java/agentic-dev-0902-am-mirror-live`](https://github.com/kiponos-io/kiponos-io/tree/master/examples/java/agentic-dev-0902-am-mirror-live)
...
```yaml
examples/
  agentic-dev-0902-am-mirror-live/
...
Folder gate = kip.getRootFolder()
        ...
        .folderOrCreate("agentic-dev-0902-am-mirror-live");
...
try:
    posture = k.get("examples/agentic-dev-0902-am-mirror-live/device-live", "live")
    if str(posture) == "live":
...
3. `cd examples/java/agentic-dev-0902-am-mirror-live && cp kiponos.local.env.example kiponos.local.env`
4. `./gradlew test run` — prints `examples/agentic-dev-0902-am-mirror-live/device-live=...`
...
How to try: `examples/java/agentic-dev-0902-am-mirror-live` and `./gradlew test`.
