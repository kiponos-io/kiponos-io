---
title: "We Stopped Shipping Shadow Traffic Share as a Constant (Ecommerce)"
published: false
tags: java, ecommerce, devops, kiponos
description: "Live shadow traffic share via Kiponos Java SDK — ecommerce posture without redeploy."
canonical_url: https://github.com/kiponos-io/kiponos-io/blob/master/docs/devto-ops-posture-ecommerce-shadow-percent-0711.md
main_image: https://files.catbox.moe/r04vkg.jpg
---
...
The partner brownout did not wait for your change-management window. Your shadow traffic share did — until it lived in a hub.

Domain: cart, promo weights, stock. This essay maps hub key `shadowPercent` to **shadow traffic share** so the lesson stays concrete for ecommerce operators.
...
```java
Folder policy = kiponos.path("examples", "ops-ecommerce-shadow-percent");
...
1. Name the hub path so humans find it under pressure (`examples/ops-ecommerce-shadow-percent/shadowPercent`).  
...
Feature flags are often product gates. This essay is about **ops posture on a hot path**: shadow traffic share for ecommerce — numbers humans already change verbally in war rooms.
