---
title: "We Stopped Shipping Pagination Page Size as a Constant (Ads)"
published: false
tags: java, advertising, devops, kiponos
description: "Live pagination page size via Kiponos Java SDK — ads posture without redeploy."
canonical_url: https://github.com/kiponos-io/kiponos-io/blob/master/docs/devto-ops-posture-ads-page-size-0771.md
main_image: https://files.catbox.moe/wx45z3.jpg
---
...
Domain: bid caps, frequency, pacing. This essay maps hub key `pageSize` to **pagination page size** so the lesson stays concrete for ads operators.
...
```java
var policy = kiponos.path("examples", "ops-ads-page-size");
...
1. Name the hub path so humans find it under pressure (`examples/ops-ads-page-size/pageSize`).  
...
Feature flags are often product gates. This essay is about **ops posture on a hot path**: pagination page size for ads — numbers humans already change verbally in war rooms.
