---
title: "The Security War Room Already Knew wafSensitivity — The Jar Did Not"
published: false
tags: java, security, devops, kiponos
description: "Live WAF sensitivity 1-5 via Kiponos Java SDK — security posture without redeploy."
canonical_url: https://github.com/kiponos-io/kiponos-io/blob/master/docs/devto-ops-posture-security-waf-sensitivity-1038.md
main_image: ./devto-cover-ops-posture-security-waf-sensitivity-1038.jpg
---
...
Domain: WAF, RPS, auth leeway. This essay maps hub key `wafSensitivity` to **WAF sensitivity 1-5** so the lesson stays concrete for security operators.
...
```java
Folder policy = kiponos.path("examples", "ops-security-waf-sensitivity");
...
1. Name the hub path so humans find it under pressure (`examples/ops-security-waf-sensitivity/wafSensitivity`).  
...
Feature flags are often product gates. This essay is about **ops posture on a hot path**: WAF sensitivity 1-5 for security — numbers humans already change verbally in war rooms.
