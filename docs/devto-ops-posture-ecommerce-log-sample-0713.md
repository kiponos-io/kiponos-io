---
title: "The Ecommerce War Room Already Knew logSamplePerThousand — The Jar Did Not"
published: false
tags: java, ecommerce, devops, kiponos
description: "Live log sample per thousand via Kiponos Java SDK — ecommerce posture without redeploy."
canonical_url: https://github.com/kiponos-io/kiponos-io/blob/master/docs/devto-ops-posture-ecommerce-log-sample-0713.md
main_image: https://files.catbox.moe/dbm5bc.jpg
---
...
Domain: cart, promo weights, stock. This essay maps hub key `logSamplePerThousand` to **log sample per thousand** so the lesson stays concrete for ecommerce operators.
...
```java
var policy = kiponos.path("examples", "ops-ecommerce-log-sample");
...
1. Name the hub path so humans find it under pressure (`examples/ops-ecommerce-log-sample/logSamplePerThousand`).  
...
Feature flags are often product gates. This essay is about **ops posture on a hot path**: log sample per thousand for ecommerce — numbers humans already change verbally in war rooms.
