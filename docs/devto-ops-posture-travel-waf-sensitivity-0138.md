---
title: "The Travel War Room Already Knew wafSensitivity — The Jar Did Not"
published: false
tags: java, travel, architecture, kiponos
description: "Live WAF sensitivity 1-5 via Kiponos Java SDK — travel posture without redeploy."
canonical_url: https://github.com/kiponos-io/kiponos-io/blob/master/docs/devto-ops-posture-travel-waf-sensitivity-0138.md
main_image: ./devto-cover-ops-posture-travel-waf-sensitivity-0138.jpg
---
...
Domain: inventory, overbooking, GDS. This essay maps hub key `wafSensitivity` to **WAF sensitivity 1-5** so the lesson stays concrete for travel operators.
...
```java
Folder policy = kiponos.path("examples", "ops-travel-waf-sensitivity");
...
1. Name the hub path so humans find it under pressure (`examples/ops-travel-waf-sensitivity/wafSensitivity`).  
...
Feature flags are often product gates. This essay is about **ops posture on a hot path**: WAF sensitivity 1-5 for travel — numbers humans already change verbally in war rooms.
