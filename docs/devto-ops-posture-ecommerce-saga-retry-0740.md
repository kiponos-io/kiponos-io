---
title: "Saga Step Retry Budget Should Not Wait for a Redeploy — Ecommerce Live Posture"
published: false
tags: java, ecommerce, devops, kiponos
description: "Live saga step retry budget via Kiponos Python SDK — ecommerce posture without redeploy."
canonical_url: https://github.com/kiponos-io/kiponos-io/blob/master/docs/devto-ops-posture-ecommerce-saga-retry-0740.md
main_image: https://files.catbox.moe/3al3hi.jpg
---
...
Domain: cart, promo weights, stock. This essay maps hub key `sagaMaxAttempts` to **saga step retry budget** so the lesson stays concrete for ecommerce operators.
...
```python
policy = kiponos.path("examples", "ops-ecommerce-saga-retry")
...
1. Name the hub path so humans find it under pressure (`examples/ops-ecommerce-saga-retry/sagaMaxAttempts`).  
...
Feature flags are often product gates. This essay is about **ops posture on a hot path**: saga step retry budget for ecommerce — numbers humans already change verbally in war rooms.
