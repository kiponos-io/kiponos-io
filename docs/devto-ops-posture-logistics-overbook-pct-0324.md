---
title: "Logistics: Turn overbooking percent Into Incident Posture"
published: false
tags: java, logistics, devops, kiponos
description: "Live overbooking percent via Kiponos Java SDK — logistics posture without redeploy."
canonical_url: https://github.com/kiponos-io/kiponos-io/blob/master/docs/devto-ops-posture-logistics-overbook-pct-0324.md
main_image: ./devto-cover-ops-posture-logistics-overbook-pct-0324.jpg
---
...
The partner brownout did not wait for your change-management window. Your overbooking percent did — until it lived in a hub.

Domain: routing, SLA windows, fleet. This essay maps hub key `overbookPercent` to **overbooking percent** so the lesson stays concrete for logistics operators.
...
```java
Folder policy = kiponos.path("examples", "ops-logistics-overbook-pct");
...
1. Name the hub path so humans find it under pressure (`examples/ops-logistics-overbook-pct/overbookPercent`).  
...
Feature flags are often product gates. This essay is about **ops posture on a hot path**: overbooking percent for logistics — numbers humans already change verbally in war rooms.
