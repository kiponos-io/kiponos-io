---
title: "The Sre War Room Already Knew hpaTarget — The Jar Did Not"
published: false
tags: java, sre, devops, kiponos
description: "Live HPA CPU target percent via Kiponos Python SDK — sre posture without redeploy."
canonical_url: https://github.com/kiponos-io/kiponos-io/blob/master/docs/devto-ops-posture-sre-hpa-target-0233.md
main_image: ./devto-cover-ops-posture-sre-hpa-target-0233.jpg
---
...
Domain: canary, drain, error budget. This essay maps hub key `hpaTarget` to **HPA CPU target percent** so the lesson stays concrete for sre operators.
...
```python
policy = kiponos.path("examples", "ops-sre-hpa-target")
...
1. Name the hub path so humans find it under pressure (`examples/ops-sre-hpa-target/hpaTarget`).  
...
Feature flags are often product gates. This essay is about **ops posture on a hot path**: HPA CPU target percent for sre — numbers humans already change verbally in war rooms.
