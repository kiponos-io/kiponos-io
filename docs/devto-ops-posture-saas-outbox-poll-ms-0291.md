---
title: "We Stopped Shipping Outbox Poll Interval as a Constant (Saas)"
published: false
tags: java, saas, architecture, kiponos
description: "Live outbox poll interval via Kiponos Java SDK — saas posture without redeploy."
canonical_url: https://github.com/kiponos-io/kiponos-io/blob/master/docs/devto-ops-posture-saas-outbox-poll-ms-0291.md
main_image: ./devto-cover-ops-posture-saas-outbox-poll-ms-0291.jpg
---
...
Domain: multi-tenant quotas, feature posture. This essay maps hub key `outboxPollMs` to **outbox poll interval** so the lesson stays concrete for saas operators.
...
```java
Folder policy = kiponos.path("examples", "ops-saas-outbox-poll-ms");
...
1. Name the hub path so humans find it under pressure (`examples/ops-saas-outbox-poll-ms/outboxPollMs`).  
...
Feature flags are often product gates. This essay is about **ops posture on a hot path**: outbox poll interval for saas — numbers humans already change verbally in war rooms.
