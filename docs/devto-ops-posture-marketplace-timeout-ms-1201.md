---
title: "We Stopped Shipping Outbound Call Timeout as a Constant (Marketplace)"
published: false
tags: java, architecture, devops, kiponos
description: "Live outbound call timeout via Kiponos Java SDK — marketplace posture without redeploy."
canonical_url: https://github.com/kiponos-io/kiponos-io/blob/master/docs/devto-ops-posture-marketplace-timeout-ms-1201.md
main_image: ./devto-cover-ops-posture-marketplace-timeout-ms-1201.jpg
---
...
Domain: seller tiers, fee weights. This essay maps hub key `timeoutMs` to **outbound call timeout** so the lesson stays concrete for marketplace operators.
...
```java
Folder policy = kiponos.path("examples", "ops-marketplace-timeout-ms");
...
1. Name the hub path so humans find it under pressure (`examples/ops-marketplace-timeout-ms/timeoutMs`).  
...
Feature flags are often product gates. This essay is about **ops posture on a hot path**: outbound call timeout for marketplace — numbers humans already change verbally in war rooms.
