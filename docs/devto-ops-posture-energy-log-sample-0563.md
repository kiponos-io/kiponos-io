---
title: "The Energy War Room Already Knew logSamplePerThousand — The Jar Did Not"
published: false
tags: java, energy, architecture, kiponos
description: "Live log sample per thousand via Kiponos Java SDK — energy posture without redeploy."
canonical_url: https://github.com/kiponos-io/kiponos-io/blob/master/docs/devto-ops-posture-energy-log-sample-0563.md
main_image: https://files.catbox.moe/i522sx.jpg
---
...
Domain: grid dispatch, demand response. This essay maps hub key `logSamplePerThousand` to **log sample per thousand** so the lesson stays concrete for energy operators.
...
```java
var policy = kiponos.path("examples", "ops-energy-log-sample");
...
1. Name the hub path so humans find it under pressure (`examples/ops-energy-log-sample/logSamplePerThousand`).  
...
Feature flags are often product gates. This essay is about **ops posture on a hot path**: log sample per thousand for energy — numbers humans already change verbally in war rooms.
