...
canonical_url: https://github.com/kiponos-io/kiponos-io/blob/master/docs/devto-agentic-dev-1104-pm-session-posture.md
---
...
```text
examples/agentic-dev-1104-pm-session-posture/session-posture = shared
```

Runnable proof: [`examples/java/agentic-dev-1104-pm-session-posture`](https://github.com/kiponos-io/kiponos-io/tree/master/examples/java/agentic-dev-1104-pm-session-posture)
...
```yaml
examples/
  agentic-dev-1104-pm-session-posture/
...
Folder gate = kip.getRootFolder()
        ...
        .folderOrCreate("agentic-dev-1104-pm-session-posture");
...
try:
    posture = k.get("examples/agentic-dev-1104-pm-session-posture/session-posture", "shared")
...
3. `cd examples/java/agentic-dev-1104-pm-session-posture && cp kiponos.local.env.example kiponos.local.env`
4. `./gradlew test run` — prints `examples/agentic-dev-1104-pm-session-posture/session-posture=...`
...
How to try: `examples/java/agentic-dev-1104-pm-session-posture` and `./gradlew test`.
