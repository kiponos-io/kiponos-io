---
title: "Live Trace Sample Per Thousand for Logistics — Mouth to Process in Seconds"
published: false
tags: java, logistics, devops, kiponos
description: "Live trace sample per thousand via Kiponos Java SDK — logistics posture without redeploy."
canonical_url: https://github.com/kiponos-io/kiponos-io/blob/master/docs/devto-ops-posture-logistics-trace-sample-0312.md
main_image: ./devto-cover-ops-posture-logistics-trace-sample-0312.jpg
---
...
Domain: routing, SLA windows, fleet. This essay maps hub key `samplePerThousand` to **trace sample per thousand** so the lesson stays concrete for logistics operators.
...
```java
Folder policy = kiponos.path("examples", "ops-logistics-trace-sample");
...
1. Name the hub path so humans find it under pressure (`examples/ops-logistics-trace-sample/samplePerThousand`).  
...
Feature flags are often product gates. This essay is about **ops posture on a hot path**: trace sample per thousand for logistics — numbers humans already change verbally in war rooms.
