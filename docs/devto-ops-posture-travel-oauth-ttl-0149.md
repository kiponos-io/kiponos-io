---
title: "Travel: Turn OAuth token TTL Into Incident Posture"
published: false
tags: java, travel, architecture, kiponos
description: "Live OAuth token TTL via Kiponos Java SDK — travel posture without redeploy."
canonical_url: https://github.com/kiponos-io/kiponos-io/blob/master/docs/devto-ops-posture-travel-oauth-ttl-0149.md
main_image: ./devto-cover-ops-posture-travel-oauth-ttl-0149.jpg
---
...
Domain: inventory, overbooking, GDS. This essay maps hub key `tokenTtlSec` to **OAuth token TTL** so the lesson stays concrete for travel operators.
...
```java
Folder policy = kiponos.path("examples", "ops-travel-oauth-ttl");
...
1. Name the hub path so humans find it under pressure (`examples/ops-travel-oauth-ttl/tokenTtlSec`).  
...
Feature flags are often product gates. This essay is about **ops posture on a hot path**: OAuth token TTL for travel — numbers humans already change verbally in war rooms.
