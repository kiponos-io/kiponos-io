---
title: "The Travel War Room Already Knew webhookMaxAttempts — The Jar Did Not"
published: false
tags: java, travel, architecture, kiponos
description: "Live webhook retry budget via Kiponos Java SDK — travel posture without redeploy."
canonical_url: https://github.com/kiponos-io/kiponos-io/blob/master/docs/devto-ops-posture-travel-webhook-retry-0143.md
main_image: ./devto-cover-ops-posture-travel-webhook-retry-0143.jpg
---
...
Domain: inventory, overbooking, GDS. This essay maps hub key `webhookMaxAttempts` to **webhook retry budget** so the lesson stays concrete for travel operators.
...
```java
Folder policy = kiponos.path("examples", "ops-travel-webhook-retry");
...
1. Name the hub path so humans find it under pressure (`examples/ops-travel-webhook-retry/webhookMaxAttempts`).  
...
Feature flags are often product gates. This essay is about **ops posture on a hot path**: webhook retry budget for travel — numbers humans already change verbally in war rooms.
