---
title: "The Gov War Room Already Knew wafSensitivity — The Jar Did Not"
published: false
tags: java, architecture, devops, kiponos
description: "Live WAF sensitivity 1-5 via Kiponos Java SDK — gov posture without redeploy."
canonical_url: https://github.com/kiponos-io/kiponos-io/blob/master/docs/devto-ops-posture-gov-waf-sensitivity-0888.md
main_image: ./devto-cover-ops-posture-gov-waf-sensitivity-0888.jpg
---
...
Domain: form windows, batch cutoffs. This essay maps hub key `wafSensitivity` to **WAF sensitivity 1-5** so the lesson stays concrete for gov operators.
...
```java
var policy = kiponos.path("examples", "ops-gov-waf-sensitivity");
...
1. Name the hub path so humans find it under pressure (`examples/ops-gov-waf-sensitivity/wafSensitivity`).  
...
Feature flags are often product gates. This essay is about **ops posture on a hot path**: WAF sensitivity 1-5 for gov — numbers humans already change verbally in war rooms.
