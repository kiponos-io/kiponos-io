---
title: "The Banking War Room Already Knew logSamplePerThousand — The Jar Did Not"
published: false
tags: java, banking, security, kiponos
description: "Live log sample per thousand via Kiponos Java SDK — banking posture without redeploy."
canonical_url: https://github.com/kiponos-io/kiponos-io/blob/master/docs/devto-ops-posture-banking-log-sample-0663.md
main_image: https://litter.catbox.moe/6gmgg8.jpg
---
...
Domain: AML thresholds, transfer velocity. This essay maps hub key `logSamplePerThousand` to **log sample per thousand** so the lesson stays concrete for banking operators.
...
```java
Folder policy = kiponos.path("examples", "ops-banking-log-sample");
...
1. Name the hub path so humans find it under pressure (`examples/ops-banking-log-sample/logSamplePerThousand`).  
...
Feature flags are often product gates. This essay is about **ops posture on a hot path**: log sample per thousand for banking — numbers humans already change verbally in war rooms.
