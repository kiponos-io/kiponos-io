---
main_image: https://iili.io/CyJSZ2s.jpg
...
canonical_url: https://github.com/kiponos-io/kiponos-io/blob/master/docs/devto-agentic-dev-0913-pm-sense-priority.md
---
...
```text
examples/agentic-dev-0913-pm-sense-priority/priority = live
```

Runnable proof: [`examples/java/agentic-dev-0913-pm-sense-priority`](https://github.com/kiponos-io/kiponos-io/tree/master/examples/java/agentic-dev-0913-pm-sense-priority)
...
```yaml
examples/
  agentic-dev-0913-pm-sense-priority/
...
Folder gate = kip.getRootFolder()
        ...
        .folderOrCreate("agentic-dev-0913-pm-sense-priority");
...
try:
    posture = k.get("examples/agentic-dev-0913-pm-sense-priority/priority", "live")
    if str(posture) == "live":
...
At 00:40 someone said, out loud: **the phone already knew the posture — the host did not**. That sentence is the whole product. If it cannot land in the running Grok Build process in seconds, you do not have posture. You have a wiki.
...
3. `cd examples/java/agentic-dev-0913-pm-sense-priority && cp kiponos.local.env.example kiponos.local.env`
4. `./gradlew test run` — prints `examples/agentic-dev-0913-pm-sense-priority/priority=...`
...
How to try: `examples/java/agentic-dev-0913-pm-sense-priority` and `./gradlew test`.
