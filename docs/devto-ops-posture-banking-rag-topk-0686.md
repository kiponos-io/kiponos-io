---
title: "We Stopped Shipping Rag Top-K as a Constant (Banking)"
published: false
tags: java, banking, security, kiponos
description: "Live RAG top-k via Kiponos Java SDK — banking posture without redeploy."
canonical_url: https://github.com/kiponos-io/kiponos-io/blob/master/docs/devto-ops-posture-banking-rag-topk-0686.md
main_image: https://litter.catbox.moe/qfk7iz.jpg
---
...
Domain: AML thresholds, transfer velocity. This essay maps hub key `topK` to **RAG top-k** so the lesson stays concrete for banking operators.
...
```java
Folder policy = kiponos.path("examples", "ops-banking-rag-topk");
...
1. Name the hub path so humans find it under pressure (`examples/ops-banking-rag-topk/topK`).  
...
Feature flags are often product gates. This essay is about **ops posture on a hot path**: RAG top-k for banking — numbers humans already change verbally in war rooms.
...
RAG top-k that requires a deploy is optimistic documentation.
