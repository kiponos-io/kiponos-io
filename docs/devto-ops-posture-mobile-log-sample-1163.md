---
title: "The Mobile War Room Already Knew logSamplePerThousand — The Jar Did Not"
published: false
tags: java, mobile, architecture, kiponos
description: "Live log sample per thousand via Kiponos Java SDK — mobile posture without redeploy."
canonical_url: https://github.com/kiponos-io/kiponos-io/blob/master/docs/devto-ops-posture-mobile-log-sample-1163.md
main_image: ./devto-cover-ops-posture-mobile-log-sample-1163.jpg
---
...
Domain: API timeouts, payload caps. This essay maps hub key `logSamplePerThousand` to **log sample per thousand** so the lesson stays concrete for mobile operators.
...
```java
var policy = kiponos.path("examples", "ops-mobile-log-sample");
...
1. Name the hub path so humans find it under pressure (`examples/ops-mobile-log-sample/logSamplePerThousand`).  
...
Feature flags are often product gates. This essay is about **ops posture on a hot path**: log sample per thousand for mobile — numbers humans already change verbally in war rooms.
