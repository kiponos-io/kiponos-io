---
title: "We Stopped Shipping Slo Warn Burn Bps as a Constant (Mlops)"
published: false
tags: java, machinelearning, devops, kiponos
description: "Live SLO warn burn bps via Kiponos Java SDK — mlops posture without redeploy."
canonical_url: https://github.com/kiponos-io/kiponos-io/blob/master/docs/devto-ops-posture-mlops-slo-warn-bps-0981.md
main_image: ./devto-cover-ops-posture-mlops-slo-warn-bps-0981.jpg
---
...
Domain: batch size, score thresholds. This essay maps hub key `errorBudgetWarnBps` to **SLO warn burn bps** so the lesson stays concrete for mlops operators.
...
```java
var policy = kiponos.path("examples", "ops-mlops-slo-warn-bps");
...
1. Name the hub path so humans find it under pressure (`examples/ops-mlops-slo-warn-bps/errorBudgetWarnBps`).  
...
Feature flags are often product gates. This essay is about **ops posture on a hot path**: SLO warn burn bps for mlops — numbers humans already change verbally in war rooms.
