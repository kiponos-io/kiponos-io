...
description: "email → slack mid-incident is a hub write, not a deploy"
canonical_url: https://github.com/kiponos-io/kiponos-io/blob/master/docs/devto-super-pattern-factory.md
main_image: https://files.catbox.moe/a9w9e4.jpg
...
**The Aha:** email → slack mid-incident is a hub write, not a deploy

An incident needs pages in Slack now, not after pipeline green. Factory Method without live product id is still a release.
...
```yaml
patterns/factory/notify/
  # live knobs
  product: email|sms|push|slack
```

Hot path (local memory after connect — WebSocket deltas, no per-request hub RTT):

```java
Folder policy = kiponos.path('patterns', 'factory', 'notify');
...
Full tree: [https://github.com/kiponos-io/kiponos-io/tree/master/examples/java/pattern-factory-live-channel](https://github.com/kiponos-io/kiponos-io/tree/master/examples/java/pattern-factory-live-channel)
...
*Runnable: [pattern-factory-live-channel](https://github.com/kiponos-io/kiponos-io/tree/master/examples/java/pattern-factory-live-channel) · [kiponos.io](https://kiponos.io)*
