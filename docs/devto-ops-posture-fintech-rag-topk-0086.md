---
title: "We Stopped Shipping Rag Top-K as a Constant (Fintech)"
published: false
tags: java, fintech, security, kiponos
description: "Live RAG top-k via Kiponos Java SDK — fintech posture without redeploy."
canonical_url: https://github.com/kiponos-io/kiponos-io/blob/master/docs/devto-ops-posture-fintech-rag-topk-0086.md
main_image: https://files.catbox.moe/uyn5h8.jpg
---
...
Domain: payments, fraud, ledger. This essay maps hub key `topK` to **RAG top-k** so the lesson stays concrete for fintech operators.
...
```java
Folder policy = kiponos.path("examples", "ops-fintech-rag-topk");
...
1. Name the hub path so humans find it under pressure (`examples/ops-fintech-rag-topk/topK`).  
...
Feature flags are often product gates. This essay is about **ops posture on a hot path**: RAG top-k for fintech — numbers humans already change verbally in war rooms.
