---
title: "We Stopped Shipping Rag Top-K as a Constant (Healthcare)"
published: false
tags: java, healthcare, architecture, kiponos
description: "Live RAG top-k via Kiponos Python SDK — healthcare posture without redeploy."
canonical_url: https://github.com/kiponos-io/kiponos-io/blob/master/docs/devto-ops-posture-healthcare-rag-topk-0386.md
main_image: ./devto-cover-ops-posture-healthcare-rag-topk-0386.jpg
---
...
Domain: routing, queue depth, triage. This essay maps hub key `topK` to **RAG top-k** so the lesson stays concrete for healthcare operators.
...
```python
policy = kiponos.path("examples", "ops-healthcare-rag-topk")
...
1. Name the hub path so humans find it under pressure (`examples/ops-healthcare-rag-topk/topK`).  
...
Feature flags are often product gates. This essay is about **ops posture on a hot path**: RAG top-k for healthcare — numbers humans already change verbally in war rooms.
