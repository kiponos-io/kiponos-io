---
title: "Insurance: Turn overbooking percent Into Incident Posture"
published: false
tags: java, insurance, architecture, kiponos
description: "Live overbooking percent via Kiponos Java SDK — insurance posture without redeploy."
canonical_url: https://github.com/kiponos-io/kiponos-io/blob/master/docs/devto-ops-posture-insurance-overbook-pct-0624.md
main_image: ./devto-cover-ops-posture-insurance-overbook-pct-0624.jpg
---
...
Domain: underwriting, claims velocity. This essay maps hub key `overbookPercent` to **overbooking percent** so the lesson stays concrete for insurance operators.
...
```java
var policy = kiponos.path("examples", "ops-insurance-overbook-pct");
...
1. Name the hub path so humans find it under pressure (`examples/ops-insurance-overbook-pct/overbookPercent`).  
...
Feature flags are often product gates. This essay is about **ops posture on a hot path**: overbooking percent for insurance — numbers humans already change verbally in war rooms.
