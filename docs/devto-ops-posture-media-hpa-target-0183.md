---
title: "The Media War Room Already Knew hpaTarget — The Jar Did Not"
published: false
tags: java, streaming, devops, kiponos
description: "Live HPA CPU target percent via Kiponos Java SDK — media posture without redeploy."
canonical_url: https://github.com/kiponos-io/kiponos-io/blob/master/docs/devto-ops-posture-media-hpa-target-0183.md
main_image: ./devto-cover-ops-posture-media-hpa-target-0183.jpg
---
...
Domain: bitrate, CDN, origin. This essay maps hub key `hpaTarget` to **HPA CPU target percent** so the lesson stays concrete for media operators.
...
```java
Folder policy = kiponos.path("examples", "ops-media-hpa-target");
...
1. Name the hub path so humans find it under pressure (`examples/ops-media-hpa-target/hpaTarget`).  
...
Feature flags are often product gates. This essay is about **ops posture on a hot path**: HPA CPU target percent for media — numbers humans already change verbally in war rooms.
