---
main_image: https://iili.io/nHNzdrl.jpg
...
canonical_url: https://github.com/kiponos-io/kiponos-io/blob/master/docs/devto-agentic-dev-1021-am-shopping-pause.md
---

I have sat next to the mirror-phone wall at 03:07 while MCP host was *this close* to doing the wrong thing.
...
```text
examples/agentic-dev-1021-am-shopping-pause/incident-pause = paused
```

Runnable proof: [`examples/java/agentic-dev-1021-am-shopping-pause`](https://github.com/kiponos-io/kiponos-io/tree/master/examples/java/agentic-dev-1021-am-shopping-pause)
...
```yaml
examples/
  agentic-dev-1021-am-shopping-pause/
...
Folder gate = kip.getRootFolder()
        ...
        .folderOrCreate("agentic-dev-1021-am-shopping-pause");
...
try:
    posture = k.get("examples/agentic-dev-1021-am-shopping-pause/incident-pause", "paused")
...
At 03:07 someone said, out loud: **the phone already knew the posture — the host did not**. That sentence is the whole product. If it cannot land in the running MCP host process in seconds, you do not have posture. You have a wiki.

## Pair `incident-pause` with a sister dial

`incident-pause` rarely moves alone on the mirror-phone wall. Pair it with a timeout, a mute, or a pause so you do not fix Shopping incident pause as a leaf by inventing a second incident.
...
3. `cd examples/java/agentic-dev-1021-am-shopping-pause && cp kiponos.local.env.example kiponos.local.env`
4. `./gradlew test run` — prints `examples/agentic-dev-1021-am-shopping-pause/incident-pause=...`
...
How to try: `examples/java/agentic-dev-1021-am-shopping-pause` and `./gradlew test`.
