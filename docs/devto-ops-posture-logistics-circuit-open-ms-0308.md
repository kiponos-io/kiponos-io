---
title: "The Logistics War Room Already Knew waitOpenMs — The Jar Did Not"
published: false
tags: java, logistics, devops, kiponos
description: "Live circuit open duration via Kiponos Java SDK — logistics posture without redeploy."
canonical_url: https://github.com/kiponos-io/kiponos-io/blob/master/docs/devto-ops-posture-logistics-circuit-open-ms-0308.md
main_image: ./devto-cover-ops-posture-logistics-circuit-open-ms-0308.jpg
---
...
Domain: routing, SLA windows, fleet. This essay maps hub key `waitOpenMs` to **circuit open duration** so the lesson stays concrete for logistics operators.
...
```java
Folder policy = kiponos.path("examples", "ops-logistics-circuit-open-ms");
...
1. Name the hub path so humans find it under pressure (`examples/ops-logistics-circuit-open-ms/waitOpenMs`).  
...
Feature flags are often product gates. This essay is about **ops posture on a hot path**: circuit open duration for logistics — numbers humans already change verbally in war rooms.
