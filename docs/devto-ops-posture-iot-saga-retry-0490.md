---
title: "Saga Step Retry Budget Should Not Wait for a Redeploy — Iot Live Posture"
published: false
tags: java, iot, devops, kiponos
description: "Live saga step retry budget via Kiponos Java SDK — iot posture without redeploy."
canonical_url: https://github.com/kiponos-io/kiponos-io/blob/master/docs/devto-ops-posture-iot-saga-retry-0490.md
main_image: ./devto-cover-ops-posture-iot-saga-retry-0490.jpg
---
...
Domain: device firmware gates, telemetry sample. This essay maps hub key `sagaMaxAttempts` to **saga step retry budget** so the lesson stays concrete for iot operators.
...
```java
var policy = kiponos.path("examples", "ops-iot-saga-retry");
...
1. Name the hub path so humans find it under pressure (`examples/ops-iot-saga-retry/sagaMaxAttempts`).  
...
Feature flags are often product gates. This essay is about **ops posture on a hot path**: saga step retry budget for iot — numbers humans already change verbally in war rooms.
