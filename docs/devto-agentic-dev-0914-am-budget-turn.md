---
main_image: https://iili.io/CpDTq5G.jpg
...
canonical_url: https://github.com/kiponos-io/kiponos-io/blob/master/docs/devto-agentic-dev-0914-am-budget-turn.md
---

I have sat next to the shopping-admin wall at 02:14 while Claude Code was *this close* to doing the wrong thing.
...
```text
examples/agentic-dev-0914-am-budget-turn/max-tokens = 8000
```

Runnable proof: [`examples/java/agentic-dev-0914-am-budget-turn`](https://github.com/kiponos-io/kiponos-io/tree/master/examples/java/agentic-dev-0914-am-budget-turn)
...
```yaml
examples/
  agentic-dev-0914-am-budget-turn/
...
Folder gate = kip.getRootFolder()
        ...
        .folderOrCreate("agentic-dev-0914-am-budget-turn");
...
try:
    posture = k.get("examples/agentic-dev-0914-am-budget-turn/max-tokens", "8000")
    if str(posture) == "8000":
...
At 02:14 someone said, out loud: **disable inventory writes — keep search**. That sentence is the whole product. If it cannot land in the running Claude Code process in seconds, you do not have posture. You have a wiki.
...
3. `cd examples/java/agentic-dev-0914-am-budget-turn && cp kiponos.local.env.example kiponos.local.env`
4. `./gradlew test run` — prints `examples/agentic-dev-0914-am-budget-turn/max-tokens=...`
...
How to try: `examples/java/agentic-dev-0914-am-budget-turn` and `./gradlew test`.
