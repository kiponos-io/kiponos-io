---
title: "Security: Turn OAuth token TTL Into Incident Posture"
published: false
...
1. Name the hub path so humans find it under pressure (`examples/ops-security-oauth-ttl/tokenTtlSec`).  
