---
title: "The Edtech War Room Already Knew bulkheadMax — The Jar Did Not"
published: false
tags: java, education, architecture, kiponos
description: "Live bulkhead concurrency via Kiponos Java SDK — edtech posture without redeploy."
canonical_url: https://github.com/kiponos-io/kiponos-io/blob/master/docs/devto-ops-posture-edtech-bulkhead-max-0818.md
main_image: https://files.catbox.moe/hqpuup.jpg
---
...
Domain: class size, exam windows. This essay maps hub key `bulkheadMax` to **bulkhead concurrency** so the lesson stays concrete for edtech operators.
...
```java
var policy = kiponos.path("examples", "ops-edtech-bulkhead-max");
...
1. Name the hub path so humans find it under pressure (`examples/ops-edtech-bulkhead-max/bulkheadMax`).  
...
Feature flags are often product gates. This essay is about **ops posture on a hot path**: bulkhead concurrency for edtech — numbers humans already change verbally in war rooms.
