---
main_image: https://iili.io/n9bu82p.jpg
...
canonical_url: https://github.com/kiponos-io/kiponos-io/blob/master/docs/devto-agentic-dev-1008-pm-mirror-live.md
---
...
```text
examples/agentic-dev-1008-pm-mirror-live/device-live = live
```

Runnable proof: [`examples/java/agentic-dev-1008-pm-mirror-live`](https://github.com/kiponos-io/kiponos-io/tree/master/examples/java/agentic-dev-1008-pm-mirror-live)
...
```yaml
examples/
  agentic-dev-1008-pm-mirror-live/
...
Folder gate = kip.getRootFolder()
        ...
        .folderOrCreate("agentic-dev-1008-pm-mirror-live");
...
try:
    posture = k.get("examples/agentic-dev-1008-pm-mirror-live/device-live", "live")
    if str(posture) == "live":
...
3. `cd examples/java/agentic-dev-1008-pm-mirror-live && cp kiponos.local.env.example kiponos.local.env`
4. `./gradlew test run` — prints `examples/agentic-dev-1008-pm-mirror-live/device-live=...`
...
How to try: `examples/java/agentic-dev-1008-pm-mirror-live` and `./gradlew test`.
