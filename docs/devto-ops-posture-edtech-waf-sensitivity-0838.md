---
title: "The Edtech War Room Already Knew wafSensitivity — The Jar Did Not"
published: false
tags: java, education, architecture, kiponos
description: "Live WAF sensitivity 1-5 via Kiponos Python SDK — edtech posture without redeploy."
canonical_url: https://github.com/kiponos-io/kiponos-io/blob/master/docs/devto-ops-posture-edtech-waf-sensitivity-0838.md
main_image: https://files.catbox.moe/9vbde7.jpg
---
...
Domain: class size, exam windows. This essay maps hub key `wafSensitivity` to **WAF sensitivity 1-5** so the lesson stays concrete for edtech operators.
...
```python
policy = kiponos.path("examples", "ops-edtech-waf-sensitivity")
...
1. Name the hub path so humans find it under pressure (`examples/ops-edtech-waf-sensitivity/wafSensitivity`).  
...
Feature flags are often product gates. This essay is about **ops posture on a hot path**: WAF sensitivity 1-5 for edtech — numbers humans already change verbally in war rooms.
