---
title: "The Mobile War Room Already Knew hpaTarget — The Jar Did Not"
published: false
tags: java, mobile, architecture, kiponos
description: "Live HPA CPU target percent via Kiponos Java SDK — mobile posture without redeploy."
canonical_url: https://github.com/kiponos-io/kiponos-io/blob/master/docs/devto-ops-posture-mobile-hpa-target-1183.md
main_image: ./devto-cover-ops-posture-mobile-hpa-target-1183.jpg
---
...
Domain: API timeouts, payload caps. This essay maps hub key `hpaTarget` to **HPA CPU target percent** so the lesson stays concrete for mobile operators.
...
```java
Folder policy = kiponos.path("examples", "ops-mobile-hpa-target");
...
1. Name the hub path so humans find it under pressure (`examples/ops-mobile-hpa-target/hpaTarget`).  
...
Feature flags are often product gates. This essay is about **ops posture on a hot path**: HPA CPU target percent for mobile — numbers humans already change verbally in war rooms.
