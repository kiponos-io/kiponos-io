---
title: "We Stopped Shipping Shadow Traffic Share as a Constant (Telecom)"
published: false
...
main_image: https://iili.io/CD71Vcu.jpg
---
...
Domain: QoS, rate classes, trunk limits. This essay maps hub key `shadowPercent` to **shadow traffic share** so the lesson stays concrete for telecom operators.
...
```java
var policy = kiponos.path("examples", "ops-telecom-shadow-percent");
...
1. Name the hub path so humans find it under pressure (`examples/ops-telecom-shadow-percent/shadowPercent`).  
...
Feature flags are often product gates. This essay is about **ops posture on a hot path**: shadow traffic share for telecom — numbers humans already change verbally in war rooms.
