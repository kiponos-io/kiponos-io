---
title: "Saga Step Retry Budget Should Not Wait for a Redeploy — Media Live Posture"
published: false
tags: java, streaming, devops, kiponos
description: "Live saga step retry budget via Kiponos Java SDK — media posture without redeploy."
canonical_url: https://github.com/kiponos-io/kiponos-io/blob/master/docs/devto-ops-posture-media-saga-retry-0190.md
main_image: ./devto-cover-ops-posture-media-saga-retry-0190.jpg
---
...
Domain: bitrate, CDN, origin. This essay maps hub key `sagaMaxAttempts` to **saga step retry budget** so the lesson stays concrete for media operators.
...
```java
Folder policy = kiponos.path("examples", "ops-media-saga-retry");
...
1. Name the hub path so humans find it under pressure (`examples/ops-media-saga-retry/sagaMaxAttempts`).  
...
Feature flags are often product gates. This essay is about **ops posture on a hot path**: saga step retry budget for media — numbers humans already change verbally in war rooms.
