---
title: "We Stopped Shipping Shadow Traffic Share as a Constant (Saas)"
published: false
tags: java, saas, architecture, kiponos
description: "Live shadow traffic share via Kiponos Java SDK — saas posture without redeploy."
canonical_url: https://github.com/kiponos-io/kiponos-io/blob/master/docs/devto-ops-posture-saas-shadow-percent-0261.md
main_image: ./devto-cover-ops-posture-saas-shadow-percent-0261.jpg
---
...
Domain: multi-tenant quotas, feature posture. This essay maps hub key `shadowPercent` to **shadow traffic share** so the lesson stays concrete for saas operators.
...
```java
Folder policy = kiponos.path("examples", "ops-saas-shadow-percent");
...
1. Name the hub path so humans find it under pressure (`examples/ops-saas-shadow-percent/shadowPercent`).  
...
Feature flags are often product gates. This essay is about **ops posture on a hot path**: shadow traffic share for saas — numbers humans already change verbally in war rooms.
