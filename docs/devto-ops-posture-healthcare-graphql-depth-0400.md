---
title: "Graphql Query Depth Should Not Wait for a Redeploy — Healthcare Live Posture"
published: false
tags: java, healthcare, architecture, kiponos
description: "Live GraphQL query depth via Kiponos Python SDK — healthcare posture without redeploy."
canonical_url: https://github.com/kiponos-io/kiponos-io/blob/master/docs/devto-ops-posture-healthcare-graphql-depth-0400.md
main_image: ./devto-cover-ops-posture-healthcare-graphql-depth-0400.jpg
---
...
Domain: routing, queue depth, triage. This essay maps hub key `maxDepth` to **GraphQL query depth** so the lesson stays concrete for healthcare operators.
...
```python
policy = kiponos.path("examples", "ops-healthcare-graphql-depth")
...
1. Name the hub path so humans find it under pressure (`examples/ops-healthcare-graphql-depth/maxDepth`).  
...
Feature flags are often product gates. This essay is about **ops posture on a hot path**: GraphQL query depth for healthcare — numbers humans already change verbally in war rooms.
