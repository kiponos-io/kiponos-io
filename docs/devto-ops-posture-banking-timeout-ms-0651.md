---
title: "We Stopped Shipping Outbound Call Timeout as a Constant (Banking)"
published: false
tags: java, banking, security, kiponos
description: "Live outbound call timeout via Kiponos Python SDK — banking posture without redeploy."
canonical_url: https://github.com/kiponos-io/kiponos-io/blob/master/docs/devto-ops-posture-banking-timeout-ms-0651.md
main_image: https://litter.catbox.moe/g00u2a.jpg
---
...
Domain: AML thresholds, transfer velocity. This essay maps hub key `timeoutMs` to **outbound call timeout** so the lesson stays concrete for banking operators.
...
```python
policy = kiponos.path("examples", "ops-banking-timeout-ms")
...
1. Name the hub path so humans find it under pressure (`examples/ops-banking-timeout-ms/timeoutMs`).  
...
Feature flags are often product gates. This essay is about **ops posture on a hot path**: outbound call timeout for banking — numbers humans already change verbally in war rooms.
