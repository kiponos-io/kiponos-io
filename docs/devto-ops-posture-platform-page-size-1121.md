---
title: "We Stopped Shipping Pagination Page Size as a Constant (Platform)"
published: false
tags: java, platform, architecture, kiponos
description: "Live pagination page size via Kiponos Java SDK — platform posture without redeploy."
canonical_url: https://github.com/kiponos-io/kiponos-io/blob/master/docs/devto-ops-posture-platform-page-size-1121.md
main_image: ./devto-cover-ops-posture-platform-page-size-1121.jpg
---
...
Domain: shared libraries, defaults. This essay maps hub key `pageSize` to **pagination page size** so the lesson stays concrete for platform operators.
...
```java
Folder policy = kiponos.path("examples", "ops-platform-page-size");
...
1. Name the hub path so humans find it under pressure (`examples/ops-platform-page-size/pageSize`).  
...
Feature flags are often product gates. This essay is about **ops posture on a hot path**: pagination page size for platform — numbers humans already change verbally in war rooms.
