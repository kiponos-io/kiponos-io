---
title: "We Stopped Shipping Consumer Prefetch as a Constant (Marketplace)"
published: false
tags: java, architecture, devops, kiponos
description: "Live consumer prefetch via Kiponos Java SDK — marketplace posture without redeploy."
canonical_url: https://github.com/kiponos-io/kiponos-io/blob/master/docs/devto-ops-posture-marketplace-queue-prefetch-1206.md
main_image: ./devto-cover-ops-posture-marketplace-queue-prefetch-1206.jpg
---
...
Domain: seller tiers, fee weights. This essay maps hub key `prefetch` to **consumer prefetch** so the lesson stays concrete for marketplace operators.
...
```yaml
examples/
  ops-marketplace-queue-prefetch/
...
```java
Folder policy = kiponos.path("examples", "ops-marketplace-queue-prefetch");
...
1. Name the hub path so humans find it under pressure (`examples/ops-marketplace-queue-prefetch/prefetch`).  
...
Feature flags are often product gates. This essay is about **ops posture on a hot path**: consumer prefetch for marketplace — numbers humans already change verbally in war rooms.
