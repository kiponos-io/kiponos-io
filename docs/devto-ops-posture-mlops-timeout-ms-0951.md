---
title: "We Stopped Shipping Outbound Call Timeout as a Constant (Mlops)"
published: false
tags: java, machinelearning, devops, kiponos
description: "Live outbound call timeout via Kiponos Java SDK — mlops posture without redeploy."
canonical_url: https://github.com/kiponos-io/kiponos-io/blob/master/docs/devto-ops-posture-mlops-timeout-ms-0951.md
main_image: ./devto-cover-ops-posture-mlops-timeout-ms-0951.jpg
---
...
Domain: batch size, score thresholds. This essay maps hub key `timeoutMs` to **outbound call timeout** so the lesson stays concrete for mlops operators.
...
```java
Folder policy = kiponos.path("examples", "ops-mlops-timeout-ms");
...
1. Name the hub path so humans find it under pressure (`examples/ops-mlops-timeout-ms/timeoutMs`).  
...
Feature flags are often product gates. This essay is about **ops posture on a hot path**: outbound call timeout for mlops — numbers humans already change verbally in war rooms.
