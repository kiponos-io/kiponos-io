---
title: "We Stopped Shipping Pagination Page Size as a Constant (Insurance)"
published: false
tags: java, insurance, architecture, kiponos
description: "Live pagination page size via Kiponos Java SDK — insurance posture without redeploy."
canonical_url: https://github.com/kiponos-io/kiponos-io/blob/master/docs/devto-ops-posture-insurance-page-size-0621.md
main_image: ./devto-cover-ops-posture-insurance-page-size-0621.jpg
---
...
Domain: underwriting, claims velocity. This essay maps hub key `pageSize` to **pagination page size** so the lesson stays concrete for insurance operators.
...
```java
var policy = kiponos.path("examples", "ops-insurance-page-size");
...
1. Name the hub path so humans find it under pressure (`examples/ops-insurance-page-size/pageSize`).  
...
Feature flags are often product gates. This essay is about **ops posture on a hot path**: pagination page size for insurance — numbers humans already change verbally in war rooms.
