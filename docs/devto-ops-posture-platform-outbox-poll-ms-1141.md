---
title: "We Stopped Shipping Outbox Poll Interval as a Constant (Platform)"
published: false
tags: java, platform, architecture, kiponos
description: "Live outbox poll interval via Kiponos Java SDK — platform posture without redeploy."
canonical_url: https://github.com/kiponos-io/kiponos-io/blob/master/docs/devto-ops-posture-platform-outbox-poll-ms-1141.md
main_image: ./devto-cover-ops-posture-platform-outbox-poll-ms-1141.jpg
---
...
Domain: shared libraries, defaults. This essay maps hub key `outboxPollMs` to **outbox poll interval** so the lesson stays concrete for platform operators.
...
```java
var policy = kiponos.path("examples", "ops-platform-outbox-poll-ms");
...
1. Name the hub path so humans find it under pressure (`examples/ops-platform-outbox-poll-ms/outboxPollMs`).  
...
Feature flags are often product gates. This essay is about **ops posture on a hot path**: outbox poll interval for platform — numbers humans already change verbally in war rooms.
