...
canonical_url: https://github.com/kiponos-io/kiponos-io/blob/master/docs/devto-agentic-dev-1020-am-chat-mute.md
---
...
```text
examples/agentic-dev-1020-am-chat-mute/chat-mute = muted
```

Runnable proof: [`examples/java/agentic-dev-1020-am-chat-mute`](https://github.com/kiponos-io/kiponos-io/tree/master/examples/java/agentic-dev-1020-am-chat-mute)
...
Folder gate = kip.getRootFolder()
        ...
        .folderOrCreate("agentic-dev-1020-am-chat-mute");
...
try:
    posture = k.get("examples/agentic-dev-1020-am-chat-mute/chat-mute", "muted")
...
3. `cd examples/java/agentic-dev-1020-am-chat-mute && cp kiponos.local.env.example kiponos.local.env`
4. `./gradlew test run` — prints `examples/agentic-dev-1020-am-chat-mute/chat-mute=...`
...
How to try: `examples/java/agentic-dev-1020-am-chat-mute` and `./gradlew test`.
