---
title: "Live Trace Sample Per Thousand for Travel — Mouth to Process in Seconds"
published: false
tags: java, travel, architecture, kiponos
description: "Live trace sample per thousand via Kiponos Java SDK — travel posture without redeploy."
canonical_url: https://github.com/kiponos-io/kiponos-io/blob/master/docs/devto-ops-posture-travel-trace-sample-0112.md
main_image: ./devto-cover-ops-posture-travel-trace-sample-0112.jpg
---
...
Domain: inventory, overbooking, GDS. This essay maps hub key `samplePerThousand` to **trace sample per thousand** so the lesson stays concrete for travel operators.
...
```java
Folder policy = kiponos.path("examples", "ops-travel-trace-sample");
...
1. Name the hub path so humans find it under pressure (`examples/ops-travel-trace-sample/samplePerThousand`).  
...
Feature flags are often product gates. This essay is about **ops posture on a hot path**: trace sample per thousand for travel — numbers humans already change verbally in war rooms.
