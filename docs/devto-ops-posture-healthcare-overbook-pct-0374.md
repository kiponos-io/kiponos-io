---
title: "Healthcare: Turn overbooking percent Into Incident Posture"
published: false
tags: java, healthcare, architecture, kiponos
description: "Live overbooking percent via Kiponos Java SDK — healthcare posture without redeploy."
canonical_url: https://github.com/kiponos-io/kiponos-io/blob/master/docs/devto-ops-posture-healthcare-overbook-pct-0374.md
main_image: ./devto-cover-ops-posture-healthcare-overbook-pct-0374.jpg
---
...
Domain: routing, queue depth, triage. This essay maps hub key `overbookPercent` to **overbooking percent** so the lesson stays concrete for healthcare operators.
...
```java
Folder policy = kiponos.path("examples", "ops-healthcare-overbook-pct");
...
1. Name the hub path so humans find it under pressure (`examples/ops-healthcare-overbook-pct/overbookPercent`).  
...
Feature flags are often product gates. This essay is about **ops posture on a hot path**: overbooking percent for healthcare — numbers humans already change verbally in war rooms.
