---
title: "We Stopped Shipping Slo Warn Burn Bps as a Constant (Travel)"
published: false
tags: java, travel, architecture, kiponos
description: "Live SLO warn burn bps via Kiponos Java SDK — travel posture without redeploy."
canonical_url: https://github.com/kiponos-io/kiponos-io/blob/master/docs/devto-ops-posture-travel-slo-warn-bps-0131.md
main_image: ./devto-cover-ops-posture-travel-slo-warn-bps-0131.jpg
---
...
Domain: inventory, overbooking, GDS. This essay maps hub key `errorBudgetWarnBps` to **SLO warn burn bps** so the lesson stays concrete for travel operators.
...
```java
var policy = kiponos.path("examples", "ops-travel-slo-warn-bps");
...
1. Name the hub path so humans find it under pressure (`examples/ops-travel-slo-warn-bps/errorBudgetWarnBps`).  
...
Feature flags are often product gates. This essay is about **ops posture on a hot path**: SLO warn burn bps for travel — numbers humans already change verbally in war rooms.
