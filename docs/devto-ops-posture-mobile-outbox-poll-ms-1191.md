---
title: "We Stopped Shipping Outbox Poll Interval as a Constant (Mobile)"
published: false
tags: java, mobile, architecture, kiponos
description: "Live outbox poll interval via Kiponos Java SDK — mobile posture without redeploy."
canonical_url: https://github.com/kiponos-io/kiponos-io/blob/master/docs/devto-ops-posture-mobile-outbox-poll-ms-1191.md
main_image: ./devto-cover-ops-posture-mobile-outbox-poll-ms-1191.jpg
---
...
Domain: API timeouts, payload caps. This essay maps hub key `outboxPollMs` to **outbox poll interval** so the lesson stays concrete for mobile operators.
...
```java
Folder policy = kiponos.path("examples", "ops-mobile-outbox-poll-ms");
...
1. Name the hub path so humans find it under pressure (`examples/ops-mobile-outbox-poll-ms/outboxPollMs`).  
...
Feature flags are often product gates. This essay is about **ops posture on a hot path**: outbox poll interval for mobile — numbers humans already change verbally in war rooms.
