---
title: "We Stopped Shipping Shadow Traffic Share as a Constant (Media)"
published: false
tags: java, streaming, devops, kiponos
description: "Live shadow traffic share via Kiponos Java SDK — media posture without redeploy."
canonical_url: https://github.com/kiponos-io/kiponos-io/blob/master/docs/devto-ops-posture-media-shadow-percent-0161.md
main_image: ./devto-cover-ops-posture-media-shadow-percent-0161.jpg
---
...
Domain: bitrate, CDN, origin. This essay maps hub key `shadowPercent` to **shadow traffic share** so the lesson stays concrete for media operators.
...
```java
var policy = kiponos.path("examples", "ops-media-shadow-percent");
...
1. Name the hub path so humans find it under pressure (`examples/ops-media-shadow-percent/shadowPercent`).  
...
Feature flags are often product gates. This essay is about **ops posture on a hot path**: shadow traffic share for media — numbers humans already change verbally in war rooms.
