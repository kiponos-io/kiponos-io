---
main_image: https://h.uguu.se/ZyCgHEVD.jpg
...
canonical_url: https://github.com/kiponos-io/kiponos-io/blob/master/docs/devto-agentic-dev-1016-am-mcp-gate.md
---
...
```text
examples/agentic-dev-1016-am-mcp-gate/tools-allow = search,read
```

Runnable proof: [`examples/java/agentic-dev-1016-am-mcp-gate`](https://github.com/kiponos-io/kiponos-io/tree/master/examples/java/agentic-dev-1016-am-mcp-gate)
...
Folder gate = kip.getRootFolder()
        ...
        .folderOrCreate("agentic-dev-1016-am-mcp-gate");
...
try:
    posture = k.get("examples/agentic-dev-1016-am-mcp-gate/tools-allow", "search,read")
...
In staging: set a painful `tools-allow`, prove Claude Code recovers without a host kill, prove clamps reject nonsense, prove last-known-good when the hub is firewalled. That drill ends half the architecture arguments about MCP write tool gated live.
...
3. `cd examples/java/agentic-dev-1016-am-mcp-gate && cp kiponos.local.env.example kiponos.local.env`
4. `./gradlew test run` — prints `examples/agentic-dev-1016-am-mcp-gate/tools-allow=...`
...
How to try: `examples/java/agentic-dev-1016-am-mcp-gate` and `./gradlew test`.
