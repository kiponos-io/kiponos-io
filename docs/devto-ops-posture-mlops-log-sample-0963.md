---
title: "The Mlops War Room Already Knew logSamplePerThousand — The Jar Did Not"
published: false
tags: java, machinelearning, devops, kiponos
description: "Live log sample per thousand via Kiponos Python SDK — mlops posture without redeploy."
canonical_url: https://github.com/kiponos-io/kiponos-io/blob/master/docs/devto-ops-posture-mlops-log-sample-0963.md
main_image: ./devto-cover-ops-posture-mlops-log-sample-0963.jpg
---
...
Domain: batch size, score thresholds. This essay maps hub key `logSamplePerThousand` to **log sample per thousand** so the lesson stays concrete for mlops operators.
...
```python
policy = kiponos.path("examples", "ops-mlops-log-sample")
...
1. Name the hub path so humans find it under pressure (`examples/ops-mlops-log-sample/logSamplePerThousand`).  
...
Feature flags are often product gates. This essay is about **ops posture on a hot path**: log sample per thousand for mlops — numbers humans already change verbally in war rooms.
