---
title: "The Retail War Room Already Knew logSamplePerThousand — The Jar Did Not"
published: false
tags: java, retail, devops, kiponos
description: "Live log sample per thousand via Kiponos Python SDK — retail posture without redeploy."
canonical_url: https://github.com/kiponos-io/kiponos-io/blob/master/docs/devto-ops-posture-retail-log-sample-0013.md
main_image: ./devto-cover-ops-posture-retail-log-sample-0013.jpg
---
...
Domain: checkout, merchandising, inventory. This essay maps hub key `logSamplePerThousand` to **log sample per thousand** so the lesson stays concrete for retail operators.
...
```python
policy = kiponos.path("examples", "ops-retail-log-sample")
...
1. Name the hub path so humans find it under pressure (`examples/ops-retail-log-sample/logSamplePerThousand`).  
...
Feature flags are often product gates. This essay is about **ops posture on a hot path**: log sample per thousand for retail — numbers humans already change verbally in war rooms.
