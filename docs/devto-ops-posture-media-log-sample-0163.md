---
title: "The Media War Room Already Knew logSamplePerThousand — The Jar Did Not"
published: false
tags: java, streaming, devops, kiponos
description: "Live log sample per thousand via Kiponos Python SDK — media posture without redeploy."
canonical_url: https://github.com/kiponos-io/kiponos-io/blob/master/docs/devto-ops-posture-media-log-sample-0163.md
main_image: ./devto-cover-ops-posture-media-log-sample-0163.jpg
---
...
Domain: bitrate, CDN, origin. This essay maps hub key `logSamplePerThousand` to **log sample per thousand** so the lesson stays concrete for media operators.
...
```python
policy = kiponos.path("examples", "ops-media-log-sample")
...
1. Name the hub path so humans find it under pressure (`examples/ops-media-log-sample/logSamplePerThousand`).  
...
Feature flags are often product gates. This essay is about **ops posture on a hot path**: log sample per thousand for media — numbers humans already change verbally in war rooms.
