---
title: "Live Feature Kill Switch for Healthcare — Mouth to Process in Seconds"
published: false
...
main_image: https://iili.io/nFL0VwX.jpg
---
...
Domain: routing, queue depth, triage. This essay maps hub key `killSwitch` to **feature kill switch** so the lesson stays concrete for healthcare operators.
...
```java
var policy = kiponos.path("examples", "ops-healthcare-feature-kill");
...
1. Name the hub path so humans find it under pressure (`examples/ops-healthcare-feature-kill/killSwitch`).  
...
Feature flags are often product gates. This essay is about **ops posture on a hot path**: feature kill switch for healthcare — numbers humans already change verbally in war rooms.
