---
title: "The Saas War Room Already Knew hpaTarget — The Jar Did Not"
published: false
...
main_image: https://iili.io/Ctfg0OJ.jpg
---
...
Domain: multi-tenant quotas, feature posture. This essay maps hub key `hpaTarget` to **HPA CPU target percent** so the lesson stays concrete for saas operators.
...
```java
var policy = kiponos.path("examples", "ops-saas-hpa-target");
...
1. Name the hub path so humans find it under pressure (`examples/ops-saas-hpa-target/hpaTarget`).  
...
Feature flags are often product gates. This essay is about **ops posture on a hot path**: HPA CPU target percent for saas — numbers humans already change verbally in war rooms.
