---
title: "We Stopped Shipping Pagination Page Size as a Constant (Edtech)"
published: false
tags: java, education, architecture, kiponos
description: "Live pagination page size via Kiponos Java SDK — edtech posture without redeploy."
canonical_url: https://github.com/kiponos-io/kiponos-io/blob/master/docs/devto-ops-posture-edtech-page-size-0821.md
main_image: https://files.catbox.moe/f6s7sl.jpg
---
...
Domain: class size, exam windows. This essay maps hub key `pageSize` to **pagination page size** so the lesson stays concrete for edtech operators.
...
```java
Folder policy = kiponos.path("examples", "ops-edtech-page-size");
...
1. Name the hub path so humans find it under pressure (`examples/ops-edtech-page-size/pageSize`).  
...
Feature flags are often product gates. This essay is about **ops posture on a hot path**: pagination page size for edtech — numbers humans already change verbally in war rooms.
