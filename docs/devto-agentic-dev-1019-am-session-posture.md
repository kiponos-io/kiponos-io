---
main_image: https://h.uguu.se/oCVJeKPx.jpg
...
canonical_url: https://github.com/kiponos-io/kiponos-io/blob/master/docs/devto-agentic-dev-1019-am-session-posture.md
---
...
```text
examples/agentic-dev-1019-am-session-posture/session-posture = shared
```

Runnable proof: [`examples/java/agentic-dev-1019-am-session-posture`](https://github.com/kiponos-io/kiponos-io/tree/master/examples/java/agentic-dev-1019-am-session-posture)
...
```yaml
examples/
  agentic-dev-1019-am-session-posture/
...
Folder gate = kip.getRootFolder()
        ...
        .folderOrCreate("agentic-dev-1019-am-session-posture");
...
try:
    posture = k.get("examples/agentic-dev-1019-am-session-posture/session-posture", "shared")
...
Cursor is good at calling tools. It is not a control plane. Killing it to flip `session-posture` teaches the on-call that judgment requires a process ID. The shopping-admin wall already disagrees.
...
3. `cd examples/java/agentic-dev-1019-am-session-posture && cp kiponos.local.env.example kiponos.local.env`
4. `./gradlew test run` — prints `examples/agentic-dev-1019-am-session-posture/session-posture=...`
...
How to try: `examples/java/agentic-dev-1019-am-session-posture` and `./gradlew test`.
