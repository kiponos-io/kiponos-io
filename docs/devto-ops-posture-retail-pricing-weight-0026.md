---
title: "We Stopped Shipping Pricing / Promo Weight as a Constant (Retail)"
published: false
...
main_image: https://iili.io/nRf6ca2.jpg
---
...
Domain: checkout, merchandising, inventory. This essay maps hub key `weight` to **pricing / promo weight** so the lesson stays concrete for retail operators.
...
```java
Folder policy = kiponos.path("examples", "ops-retail-pricing-weight");
...
1. Name the hub path so humans find it under pressure (`examples/ops-retail-pricing-weight/weight`).  
...
Feature flags are often product gates. This essay is about **ops posture on a hot path**: pricing / promo weight for retail — numbers humans already change verbally in war rooms.
