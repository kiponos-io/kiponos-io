---
title: "We Stopped Shipping Pagination Page Size as a Constant (Telecom)"
published: false
tags: java, telecom, sre, kiponos
description: "Live pagination page size via Kiponos Python SDK — telecom posture without redeploy."
canonical_url: https://github.com/kiponos-io/kiponos-io/blob/master/docs/devto-ops-posture-telecom-page-size-0521.md
main_image: ./devto-cover-ops-posture-telecom-page-size-0521.jpg
---
...
Domain: QoS, rate classes, trunk limits. This essay maps hub key `pageSize` to **pagination page size** so the lesson stays concrete for telecom operators.
...
```python
policy = kiponos.path("examples", "ops-telecom-page-size")
...
1. Name the hub path so humans find it under pressure (`examples/ops-telecom-page-size/pageSize`).  
...
Feature flags are often product gates. This essay is about **ops posture on a hot path**: pagination page size for telecom — numbers humans already change verbally in war rooms.
