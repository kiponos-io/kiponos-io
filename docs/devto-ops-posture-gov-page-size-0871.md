---
title: "We Stopped Shipping Pagination Page Size as a Constant (Gov)"
published: false
tags: java, architecture, devops, kiponos
description: "Live pagination page size via Kiponos Python SDK — gov posture without redeploy."
canonical_url: https://github.com/kiponos-io/kiponos-io/blob/master/docs/devto-ops-posture-gov-page-size-0871.md
main_image: ./devto-cover-ops-posture-gov-page-size-0871.jpg
---
...
Domain: form windows, batch cutoffs. This essay maps hub key `pageSize` to **pagination page size** so the lesson stays concrete for gov operators.
...
```python
policy = kiponos.path("examples", "ops-gov-page-size")
...
1. Name the hub path so humans find it under pressure (`examples/ops-gov-page-size/pageSize`).  
...
Feature flags are often product gates. This essay is about **ops posture on a hot path**: pagination page size for gov — numbers humans already change verbally in war rooms.
