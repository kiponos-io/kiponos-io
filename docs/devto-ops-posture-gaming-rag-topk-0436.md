---
title: "We Stopped Shipping Rag Top-K as a Constant (Gaming)"
published: false
tags: java, gaming, devops, kiponos
description: "Live RAG top-k via Kiponos Java SDK — gaming posture without redeploy."
canonical_url: https://github.com/kiponos-io/kiponos-io/blob/master/docs/devto-ops-posture-gaming-rag-topk-0436.md
main_image: https://files.catbox.moe/ugz08s.jpg
---
...
Domain: matchmaking, session caps, tick rate. This essay maps hub key `topK` to **RAG top-k** so the lesson stays concrete for gaming operators.
...
```java
var policy = kiponos.path("examples", "ops-gaming-rag-topk");
...
1. Name the hub path so humans find it under pressure (`examples/ops-gaming-rag-topk/topK`).  
...
Feature flags are often product gates. This essay is about **ops posture on a hot path**: RAG top-k for gaming — numbers humans already change verbally in war rooms.
