---
title: "Media: Turn overbooking percent Into Incident Posture"
published: false
tags: java, streaming, devops, kiponos
description: "Live overbooking percent via Kiponos Java SDK — media posture without redeploy."
canonical_url: https://github.com/kiponos-io/kiponos-io/blob/master/docs/devto-ops-posture-media-overbook-pct-0174.md
main_image: ./devto-cover-ops-posture-media-overbook-pct-0174.jpg
---
...
Domain: bitrate, CDN, origin. This essay maps hub key `overbookPercent` to **overbooking percent** so the lesson stays concrete for media operators.
...
```java
var policy = kiponos.path("examples", "ops-media-overbook-pct");
...
1. Name the hub path so humans find it under pressure (`examples/ops-media-overbook-pct/overbookPercent`).  
...
Feature flags are often product gates. This essay is about **ops posture on a hot path**: overbooking percent for media — numbers humans already change verbally in war rooms.
...
overbooking percent that requires a deploy is optimistic documentation.
