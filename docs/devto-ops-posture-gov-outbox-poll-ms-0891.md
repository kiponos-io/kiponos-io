---
title: "We Stopped Shipping Outbox Poll Interval as a Constant (Gov)"
published: false
tags: java, architecture, devops, kiponos
description: "Live outbox poll interval via Kiponos Java SDK — gov posture without redeploy."
canonical_url: https://github.com/kiponos-io/kiponos-io/blob/master/docs/devto-ops-posture-gov-outbox-poll-ms-0891.md
main_image: ./devto-cover-ops-posture-gov-outbox-poll-ms-0891.jpg
---
...
Domain: form windows, batch cutoffs. This essay maps hub key `outboxPollMs` to **outbox poll interval** so the lesson stays concrete for gov operators.
...
```java
var policy = kiponos.path("examples", "ops-gov-outbox-poll-ms");
...
1. Name the hub path so humans find it under pressure (`examples/ops-gov-outbox-poll-ms/outboxPollMs`).  
...
Feature flags are often product gates. This essay is about **ops posture on a hot path**: outbox poll interval for gov — numbers humans already change verbally in war rooms.
