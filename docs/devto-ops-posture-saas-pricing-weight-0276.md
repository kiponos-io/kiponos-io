---
title: "We Stopped Shipping Pricing / Promo Weight as a Constant (Saas)"
published: false
tags: java, saas, architecture, kiponos
description: "Live pricing / promo weight via Kiponos Python SDK — saas posture without redeploy."
canonical_url: https://github.com/kiponos-io/kiponos-io/blob/master/docs/devto-ops-posture-saas-pricing-weight-0276.md
main_image: ./devto-cover-ops-posture-saas-pricing-weight-0276.jpg
---
...
Domain: multi-tenant quotas, feature posture. This essay maps hub key `weight` to **pricing / promo weight** so the lesson stays concrete for saas operators.
...
```python
policy = kiponos.path("examples", "ops-saas-pricing-weight")
...
1. Name the hub path so humans find it under pressure (`examples/ops-saas-pricing-weight/weight`).  
...
Feature flags are often product gates. This essay is about **ops posture on a hot path**: pricing / promo weight for saas — numbers humans already change verbally in war rooms.
