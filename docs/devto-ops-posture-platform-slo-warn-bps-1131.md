---
title: "We Stopped Shipping Slo Warn Burn Bps as a Constant (Platform)"
published: false
tags: java, platform, architecture, kiponos
description: "Live SLO warn burn bps via Kiponos Java SDK — platform posture without redeploy."
canonical_url: https://github.com/kiponos-io/kiponos-io/blob/master/docs/devto-ops-posture-platform-slo-warn-bps-1131.md
main_image: ./devto-cover-ops-posture-platform-slo-warn-bps-1131.jpg
---
...
Domain: shared libraries, defaults. This essay maps hub key `errorBudgetWarnBps` to **SLO warn burn bps** so the lesson stays concrete for platform operators.
...
```java
Folder policy = kiponos.path("examples", "ops-platform-slo-warn-bps");
...
1. Name the hub path so humans find it under pressure (`examples/ops-platform-slo-warn-bps/errorBudgetWarnBps`).  
...
Feature flags are often product gates. This essay is about **ops posture on a hot path**: SLO warn burn bps for platform — numbers humans already change verbally in war rooms.
