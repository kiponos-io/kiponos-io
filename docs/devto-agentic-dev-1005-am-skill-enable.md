...
canonical_url: https://github.com/kiponos-io/kiponos-io/blob/master/docs/devto-agentic-dev-1005-am-skill-enable.md
---
...
```text
examples/agentic-dev-1005-am-skill-enable/enabled-set = live
```

Runnable proof: [`examples/java/agentic-dev-1005-am-skill-enable`](https://github.com/kiponos-io/kiponos-io/tree/master/examples/java/agentic-dev-1005-am-skill-enable)
...
```yaml
examples/
  agentic-dev-1005-am-skill-enable/
...
Folder gate = kip.getRootFolder()
        ...
        .folderOrCreate("agentic-dev-1005-am-skill-enable");
...
try:
    posture = k.get("examples/agentic-dev-1005-am-skill-enable/enabled-set", "live")
    if str(posture) == "live":
...
In staging: set a painful `enabled-set`, prove MCP host recovers without a host kill, prove clamps reject nonsense, prove last-known-good when the hub is firewalled. That drill ends half the architecture arguments about Skill enable set without restart.
...
3. `cd examples/java/agentic-dev-1005-am-skill-enable && cp kiponos.local.env.example kiponos.local.env`
4. `./gradlew test run` — prints `examples/agentic-dev-1005-am-skill-enable/enabled-set=...`
...
How to try: `examples/java/agentic-dev-1005-am-skill-enable` and `./gradlew test`.
