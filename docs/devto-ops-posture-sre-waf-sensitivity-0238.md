---
title: "The Sre War Room Already Knew wafSensitivity — The Jar Did Not"
published: false
tags: java, sre, devops, kiponos
description: "Live WAF sensitivity 1-5 via Kiponos Java SDK — sre posture without redeploy."
canonical_url: https://github.com/kiponos-io/kiponos-io/blob/master/docs/devto-ops-posture-sre-waf-sensitivity-0238.md
main_image: ./devto-cover-ops-posture-sre-waf-sensitivity-0238.jpg
---
...
Domain: canary, drain, error budget. This essay maps hub key `wafSensitivity` to **WAF sensitivity 1-5** so the lesson stays concrete for sre operators.
...
```java
Folder policy = kiponos.path("examples", "ops-sre-waf-sensitivity");
...
1. Name the hub path so humans find it under pressure (`examples/ops-sre-waf-sensitivity/wafSensitivity`).  
...
Feature flags are often product gates. This essay is about **ops posture on a hot path**: WAF sensitivity 1-5 for sre — numbers humans already change verbally in war rooms.
