---
title: "Graphql Query Depth Should Not Wait for a Redeploy — Media Live Posture"
published: false
tags: java, streaming, devops, kiponos
description: "Live GraphQL query depth via Kiponos Python SDK — media posture without redeploy."
canonical_url: https://github.com/kiponos-io/kiponos-io/blob/master/docs/devto-ops-posture-media-graphql-depth-0200.md
main_image: ./devto-cover-ops-posture-media-graphql-depth-0200.jpg
---
...
Domain: bitrate, CDN, origin. This essay maps hub key `maxDepth` to **GraphQL query depth** so the lesson stays concrete for media operators.
...
```python
policy = kiponos.path("examples", "ops-media-graphql-depth")
...
1. Name the hub path so humans find it under pressure (`examples/ops-media-graphql-depth/maxDepth`).  
...
Feature flags are often product gates. This essay is about **ops posture on a hot path**: GraphQL query depth for media — numbers humans already change verbally in war rooms.
