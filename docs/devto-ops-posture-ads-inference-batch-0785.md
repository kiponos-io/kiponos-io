---
title: "Inference Batch Size Should Not Wait for a Redeploy — Ads Live Posture"
published: false
tags: java, advertising, devops, kiponos
description: "Live inference batch size via Kiponos Java SDK — ads posture without redeploy."
canonical_url: https://github.com/kiponos-io/kiponos-io/blob/master/docs/devto-ops-posture-ads-inference-batch-0785.md
main_image: https://files.catbox.moe/nvv1wl.jpg
---
...
Domain: bid caps, frequency, pacing. This essay maps hub key `batchSize` to **inference batch size** so the lesson stays concrete for ads operators.
...
```java
Folder policy = kiponos.path("examples", "ops-ads-inference-batch");
...
1. Name the hub path so humans find it under pressure (`examples/ops-ads-inference-batch/batchSize`).  
...
Feature flags are often product gates. This essay is about **ops posture on a hot path**: inference batch size for ads — numbers humans already change verbally in war rooms.
