---
title: "We Stopped Shipping Cors Max-Age as a Constant (Logistics)"
published: false
tags: java, logistics, devops, kiponos
description: "Live CORS max-age via Kiponos Java SDK — logistics posture without redeploy."
canonical_url: https://github.com/kiponos-io/kiponos-io/blob/master/docs/devto-ops-posture-logistics-cors-max-age-0346.md
main_image: ./devto-cover-ops-posture-logistics-cors-max-age-0346.jpg
---
...
Domain: routing, SLA windows, fleet. This essay maps hub key `corsMaxAgeSec` to **CORS max-age** so the lesson stays concrete for logistics operators.
...
```java
Folder policy = kiponos.path("examples", "ops-logistics-cors-max-age");
...
1. Name the hub path so humans find it under pressure (`examples/ops-logistics-cors-max-age/corsMaxAgeSec`).  
...
Feature flags are often product gates. This essay is about **ops posture on a hot path**: CORS max-age for logistics — numbers humans already change verbally in war rooms.
