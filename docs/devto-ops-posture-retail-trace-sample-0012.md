---
title: "Live Trace Sample Per Thousand for Retail — Mouth to Process in Seconds"
published: false
tags: java, retail, devops, kiponos
description: "Live trace sample per thousand via Kiponos Java SDK — retail posture without redeploy."
canonical_url: https://github.com/kiponos-io/kiponos-io/blob/master/docs/devto-ops-posture-retail-trace-sample-0012.md
main_image: ./devto-cover-ops-posture-retail-trace-sample-0012.jpg
---
...
Domain: checkout, merchandising, inventory. This essay maps hub key `samplePerThousand` to **trace sample per thousand** so the lesson stays concrete for retail operators.
...
```java
var policy = kiponos.path("examples", "ops-retail-trace-sample");
...
1. Name the hub path so humans find it under pressure (`examples/ops-retail-trace-sample/samplePerThousand`).  
...
Feature flags are often product gates. This essay is about **ops posture on a hot path**: trace sample per thousand for retail — numbers humans already change verbally in war rooms.
