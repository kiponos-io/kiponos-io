---
main_image: https://iili.io/ndedzZJ.jpg
...
canonical_url: https://github.com/kiponos-io/kiponos-io/blob/master/docs/devto-agentic-dev-1027-pm-shopping-pause.md
---
...
```text
examples/agentic-dev-1027-pm-shopping-pause/incident-pause = paused
```

Runnable proof: [`examples/java/agentic-dev-1027-pm-shopping-pause`](https://github.com/kiponos-io/kiponos-io/tree/master/examples/java/agentic-dev-1027-pm-shopping-pause)
...
```yaml
examples/
  agentic-dev-1027-pm-shopping-pause/
...
Folder gate = kip.getRootFolder()
        ...
        .folderOrCreate("agentic-dev-1027-pm-shopping-pause");
...
try:
    posture = k.get("examples/agentic-dev-1027-pm-shopping-pause/incident-pause", "paused")
...
3. `cd examples/java/agentic-dev-1027-pm-shopping-pause && cp kiponos.local.env.example kiponos.local.env`
4. `./gradlew test run` — prints `examples/agentic-dev-1027-pm-shopping-pause/incident-pause=...`
...
How to try: `examples/java/agentic-dev-1027-pm-shopping-pause` and `./gradlew test`.
