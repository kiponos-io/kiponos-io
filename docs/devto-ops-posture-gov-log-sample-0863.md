---
title: "The Gov War Room Already Knew logSamplePerThousand — The Jar Did Not"
published: false
tags: java, architecture, devops, kiponos
description: "Live log sample per thousand via Kiponos Python SDK — gov posture without redeploy."
canonical_url: https://github.com/kiponos-io/kiponos-io/blob/master/docs/devto-ops-posture-gov-log-sample-0863.md
main_image: ./devto-cover-ops-posture-gov-log-sample-0863.jpg
---
...
Domain: form windows, batch cutoffs. This essay maps hub key `logSamplePerThousand` to **log sample per thousand** so the lesson stays concrete for gov operators.
...
```python
policy = kiponos.path("examples", "ops-gov-log-sample")
...
1. Name the hub path so humans find it under pressure (`examples/ops-gov-log-sample/logSamplePerThousand`).  
...
Feature flags are often product gates. This essay is about **ops posture on a hot path**: log sample per thousand for gov — numbers humans already change verbally in war rooms.
