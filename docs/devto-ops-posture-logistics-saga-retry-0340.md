---
title: "Saga Step Retry Budget Should Not Wait for a Redeploy — Logistics Live Posture"
published: false
tags: java, logistics, devops, kiponos
description: "Live saga step retry budget via Kiponos Java SDK — logistics posture without redeploy."
canonical_url: https://github.com/kiponos-io/kiponos-io/blob/master/docs/devto-ops-posture-logistics-saga-retry-0340.md
main_image: ./devto-cover-ops-posture-logistics-saga-retry-0340.jpg
---
...
Domain: routing, SLA windows, fleet. This essay maps hub key `sagaMaxAttempts` to **saga step retry budget** so the lesson stays concrete for logistics operators.
...
```java
Folder policy = kiponos.path("examples", "ops-logistics-saga-retry");
...
1. Name the hub path so humans find it under pressure (`examples/ops-logistics-saga-retry/sagaMaxAttempts`).  
...
Feature flags are often product gates. This essay is about **ops posture on a hot path**: saga step retry budget for logistics — numbers humans already change verbally in war rooms.
