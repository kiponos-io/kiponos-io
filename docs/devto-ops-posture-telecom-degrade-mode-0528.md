---
title: "The Telecom War Room Already Knew degradeMode — The Jar Did Not"
published: false
tags: java, telecom, sre, kiponos
description: "Live degradation mode via Kiponos Java SDK — telecom posture without redeploy."
canonical_url: https://github.com/kiponos-io/kiponos-io/blob/master/docs/devto-ops-posture-telecom-degrade-mode-0528.md
main_image: ./devto-cover-ops-posture-telecom-degrade-mode-0528.jpg
---
...
Domain: QoS, rate classes, trunk limits. This essay maps hub key `degradeMode` to **degradation mode** so the lesson stays concrete for telecom operators.
...
```java
Folder policy = kiponos.path("examples", "ops-telecom-degrade-mode");
...
1. Name the hub path so humans find it under pressure (`examples/ops-telecom-degrade-mode/degradeMode`).  
...
Feature flags are often product gates. This essay is about **ops posture on a hot path**: degradation mode for telecom — numbers humans already change verbally in war rooms.
