---
title: "We Stopped Shipping Rag Top-K as a Constant (Ads)"
published: false
tags: java, advertising, devops, kiponos
description: "Live RAG top-k via Kiponos Python SDK — ads posture without redeploy."
canonical_url: https://github.com/kiponos-io/kiponos-io/blob/master/docs/devto-ops-posture-ads-rag-topk-0786.md
main_image: https://files.catbox.moe/kusuv8.jpg
---
...
Domain: bid caps, frequency, pacing. This essay maps hub key `topK` to **RAG top-k** so the lesson stays concrete for ads operators.
...
```python
policy = kiponos.path("examples", "ops-ads-rag-topk")
...
1. Name the hub path so humans find it under pressure (`examples/ops-ads-rag-topk/topK`).  
...
Feature flags are often product gates. This essay is about **ops posture on a hot path**: RAG top-k for ads — numbers humans already change verbally in war rooms.
