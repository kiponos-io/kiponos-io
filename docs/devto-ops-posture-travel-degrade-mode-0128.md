---
title: "The Travel War Room Already Knew degradeMode — The Jar Did Not"
published: false
tags: java, travel, architecture, kiponos
description: "Live degradation mode via Kiponos Python SDK — travel posture without redeploy."
canonical_url: https://github.com/kiponos-io/kiponos-io/blob/master/docs/devto-ops-posture-travel-degrade-mode-0128.md
main_image: ./devto-cover-ops-posture-travel-degrade-mode-0128.jpg
---
...
Domain: inventory, overbooking, GDS. This essay maps hub key `degradeMode` to **degradation mode** so the lesson stays concrete for travel operators.
...
```python
policy = kiponos.path("examples", "ops-travel-degrade-mode")
...
1. Name the hub path so humans find it under pressure (`examples/ops-travel-degrade-mode/degradeMode`).  
...
Feature flags are often product gates. This essay is about **ops posture on a hot path**: degradation mode for travel — numbers humans already change verbally in war rooms.
