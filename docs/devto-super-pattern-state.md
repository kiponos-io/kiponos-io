---
title: "State Machines With a Live Transition Matrix"
published: false
tags: java, designpatterns, devops, kiponos
---

# State Machines With a Live Transition Matrix

Freeze paid→cancelled from the dashboard. Keep draft→paid hot.
