---
title: "Builder as a Super Pattern — Live Defaults"
published: false
...
**The Aha:** Default field values from the hub

Builders hide construction. Defaults should still move when product changes free-trial days mid-campaign.
...
```java
Folder policy = kiponos.path('patterns', 'builder', 'defaults');
// local gets — never remote on the money path
builder.trialDays(d.getInt("trial-days")).plan(d.getString("plan"));
```
...
Full tree: [https://github.com/kiponos-io/kiponos-io/tree/master/examples/java/pattern-builder-live-defaults](https://github.com/kiponos-io/kiponos-io/tree/master/examples/java/pattern-builder-live-defaults)
...
Builders construct. Super Builders default from live policy.
...
*Runnable: [pattern-builder-live-defaults](https://github.com/kiponos-io/kiponos-io/tree/master/examples/java/pattern-builder-live-defaults) · [kiponos.io](https://kiponos.io)*
