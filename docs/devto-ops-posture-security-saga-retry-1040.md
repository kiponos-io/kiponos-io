---
title: "Saga Step Retry Budget Should Not Wait for a Redeploy — Security Live Posture"
published: false
tags: java, security, devops, kiponos
description: "Live saga step retry budget via Kiponos Java SDK — security posture without redeploy."
canonical_url: https://github.com/kiponos-io/kiponos-io/blob/master/docs/devto-ops-posture-security-saga-retry-1040.md
main_image: ./devto-cover-ops-posture-security-saga-retry-1040.jpg
---
...
Domain: WAF, RPS, auth leeway. This essay maps hub key `sagaMaxAttempts` to **saga step retry budget** so the lesson stays concrete for security operators.
...
```java
Folder policy = kiponos.path("examples", "ops-security-saga-retry");
...
1. Name the hub path so humans find it under pressure (`examples/ops-security-saga-retry/sagaMaxAttempts`).  
...
Feature flags are often product gates. This essay is about **ops posture on a hot path**: saga step retry budget for security — numbers humans already change verbally in war rooms.
