---
main_image: https://iili.io/CyMKN9e.jpg
...
canonical_url: https://github.com/kiponos-io/kiponos-io/blob/master/docs/devto-agentic-dev-0925-pm-session-posture.md
---
...
| Restart Grok Build — it is cheap | Cheap until 02:14 ate the turn budget and the open investigation |
...
```text
examples/agentic-dev-0925-pm-session-posture/session-posture = shared
```

Runnable proof: [`examples/java/agentic-dev-0925-pm-session-posture`](https://github.com/kiponos-io/kiponos-io/tree/master/examples/java/agentic-dev-0925-pm-session-posture)
...
```yaml
examples/
  agentic-dev-0925-pm-session-posture/
...
Folder gate = kip.getRootFolder()
        ...
        .folderOrCreate("agentic-dev-0925-pm-session-posture");
...
try:
    posture = k.get("examples/agentic-dev-0925-pm-session-posture/session-posture", "shared")
...
3. `cd examples/java/agentic-dev-0925-pm-session-posture && cp kiponos.local.env.example kiponos.local.env`
4. `./gradlew test run` — prints `examples/agentic-dev-0925-pm-session-posture/session-posture=...`
...
How to try: `examples/java/agentic-dev-0925-pm-session-posture` and `./gradlew test`.
