# The Observer Pattern Subscribe Topology Live — Cdn War Room

*A traveler’s note from the edge ops: purge storm, frozen YAML, and the Super Pattern that lets ops move **subscribe topology live** without a jar.*

---

At **03:41**, the cdn war room already knew the number. The process still believed last week’s properties file.
...
For cdn, the painful dial was **subscribe topology live** (`active`). Default in the jar: `baseline`. Correct for a demo. Wrong for a brownout.
...
<!-- medium-img: diagram-medium-observer-cdn-live-gof-vs-live.png -->
...
```bash
examples/java/medium-observer-cdn-live
./gradlew test run
```
...
<!-- medium-img: diagram-medium-observer-cdn-live-hub-flow.png -->
...
*Series: Kiponos Medium Super Patterns · Example: [`examples/java/medium-observer-cdn-live`](https://github.com/kiponos-io/kiponos-io/tree/master/examples/java/medium-observer-cdn-live) · Product: [kiponos.io](https://kiponos.io)*
