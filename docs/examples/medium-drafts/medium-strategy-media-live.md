# The Strategy Pattern Swap Algorithms Live — Media War Room

*A traveler’s note from the origin ops: bitrate storm, frozen YAML, and the Super Pattern that lets ops move **swap algorithms live** without a jar.*

---

At **03:41**, the media war room already knew the number. The process still believed last week’s properties file.
...
For media, the painful dial was **swap algorithms live** (`active`). Default in the jar: `baseline`. Correct for a demo. Wrong for a brownout.
...
<!-- medium-img: diagram-medium-strategy-media-live-gof-vs-live.png -->

---

## The night bitrate storm met a fossil
...
```bash
examples/java/medium-strategy-media-live
./gradlew test run
```
...
<!-- medium-img: diagram-medium-strategy-media-live-hub-flow.png -->
...
*Series: Kiponos Medium Super Patterns · Example: [`examples/java/medium-strategy-media-live`](https://github.com/kiponos-io/kiponos-io/tree/master/examples/java/medium-strategy-media-live) · Product: [kiponos.io](https://kiponos.io)*
