# The Factory Pattern Select Product Channel Live — Security War Room

*A traveler’s note from the WAF desk: auth leeway fight, frozen YAML, and the Super Pattern that lets ops move **select product channel live** without a jar.*
...
For security, the painful dial was **select product channel live** (`active`). Default in the jar: `baseline`. Correct for a demo. Wrong for a brownout.
...
<!-- medium-img: diagram-medium-factory-security-live-gof-vs-live.png -->
...
```bash
examples/java/medium-factory-security-live
./gradlew test run
```
...
<!-- medium-img: diagram-medium-factory-security-live-hub-flow.png -->
...
*Series: Kiponos Medium Super Patterns · Example: [`examples/java/medium-factory-security-live`](https://github.com/kiponos-io/kiponos-io/tree/master/examples/java/medium-factory-security-live) · Product: [kiponos.io](https://kiponos.io)*
