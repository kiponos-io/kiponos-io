# The Chain of Responsibility Pattern Reorder Handlers Live — Fintech War Room

*A traveler’s note from the payments SOC: acquirer brownout, frozen YAML, and the Super Pattern that lets ops move **reorder handlers live** without a jar.*

---

At **22:09**, the fintech war room already knew the number. The process still believed last week’s properties file.
...
For fintech, the painful dial was **reorder handlers live** (`active`). Default in the jar: `baseline`. Correct for a demo. Wrong for a brownout.
...
<!-- medium-img: diagram-medium-chain-fintech-live-gof-vs-live.png -->
...
```bash
examples/java/medium-chain-fintech-live
./gradlew test run
```
...
<!-- medium-img: diagram-medium-chain-fintech-live-hub-flow.png -->
...
*Series: Kiponos Medium Super Patterns · Example: [`examples/java/medium-chain-fintech-live`](https://github.com/kiponos-io/kiponos-io/tree/master/examples/java/medium-chain-fintech-live) · Product: [kiponos.io](https://kiponos.io)*
