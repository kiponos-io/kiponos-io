# The Proxy Pattern Gate Access Live — Fintech War Room

*A traveler’s note from the payments SOC: acquirer brownout, frozen YAML, and the Super Pattern that lets ops move **gate access live** without a jar.*
...
For fintech, the painful dial was **gate access live** (`active`). Default in the jar: `baseline`. Correct for a demo. Wrong for a brownout.
...
<!-- medium-img: diagram-medium-proxy-fintech-live-gof-vs-live.png -->
...
```bash
examples/java/medium-proxy-fintech-live
./gradlew test run
```
...
<!-- medium-img: diagram-medium-proxy-fintech-live-hub-flow.png -->
...
*Series: Kiponos Medium Super Patterns · Example: [`examples/java/medium-proxy-fintech-live`](https://github.com/kiponos-io/kiponos-io/tree/master/examples/java/medium-proxy-fintech-live) · Product: [kiponos.io](https://kiponos.io)*
