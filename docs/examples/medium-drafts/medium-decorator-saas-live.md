# The Decorator Pattern Rebuild Wrapper Chains Live — Saas War Room

*A traveler’s note from the tenant ops: noisy neighbor, frozen YAML, and the Super Pattern that lets ops move **rebuild wrapper chains live** without a jar.*

---

At **00:33**, the saas war room already knew the number. The process still believed last week’s properties file.
...
For saas, the painful dial was **rebuild wrapper chains live** (`active`). Default in the jar: `baseline`. Correct for a demo. Wrong for a brownout.
...
<!-- medium-img: diagram-medium-decorator-saas-live-gof-vs-live.png -->

---

## The night noisy neighbor met a fossil
...
```bash
examples/java/medium-decorator-saas-live
./gradlew test run
```
...
<!-- medium-img: diagram-medium-decorator-saas-live-hub-flow.png -->
...
*Series: Kiponos Medium Super Patterns · Example: [`examples/java/medium-decorator-saas-live`](https://github.com/kiponos-io/kiponos-io/tree/master/examples/java/medium-decorator-saas-live) · Product: [kiponos.io](https://kiponos.io)*
