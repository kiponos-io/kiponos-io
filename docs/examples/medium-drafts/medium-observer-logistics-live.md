# The Observer Pattern Subscribe Topology Live — Logistics War Room

*A traveler’s note from the dispatch floor: SLA breach window, frozen YAML, and the Super Pattern that lets ops move **subscribe topology live** without a jar.*

---

At **00:33**, the logistics war room already knew the number. The process still believed last week’s properties file.
...
For logistics, the painful dial was **subscribe topology live** (`active`). Default in the jar: `baseline`. Correct for a demo. Wrong for a brownout.
...
<!-- medium-img: diagram-medium-observer-logistics-live-gof-vs-live.png -->

---

## The night SLA breach window met a fossil
...
```bash
examples/java/medium-observer-logistics-live
./gradlew test run
```
...
<!-- medium-img: diagram-medium-observer-logistics-live-hub-flow.png -->
...
*Series: Kiponos Medium Super Patterns · Example: [`examples/java/medium-observer-logistics-live`](https://github.com/kiponos-io/kiponos-io/tree/master/examples/java/medium-observer-logistics-live) · Product: [kiponos.io](https://kiponos.io)*
