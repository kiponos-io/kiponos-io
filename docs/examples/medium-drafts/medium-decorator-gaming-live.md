# The Decorator Pattern Rebuild Wrapper Chains Live — Gaming War Room

*A traveler’s note from the matchmaking ops: session flood, frozen YAML, and the Super Pattern that lets ops move **rebuild wrapper chains live** without a jar.*

---

At **03:41**, the gaming war room already knew the number. The process still believed last week’s properties file.
...
For gaming, the painful dial was **rebuild wrapper chains live** (`active`). Default in the jar: `baseline`. Correct for a demo. Wrong for a brownout.
...
<!-- medium-img: diagram-medium-decorator-gaming-live-gof-vs-live.png -->
...
```bash
examples/java/medium-decorator-gaming-live
./gradlew test run
```
...
<!-- medium-img: diagram-medium-decorator-gaming-live-hub-flow.png -->
...
*Series: Kiponos Medium Super Patterns · Example: [`examples/java/medium-decorator-gaming-live`](https://github.com/kiponos-io/kiponos-io/tree/master/examples/java/medium-decorator-gaming-live) · Product: [kiponos.io](https://kiponos.io)*
