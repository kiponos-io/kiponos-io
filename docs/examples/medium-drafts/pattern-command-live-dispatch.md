# GoF Command as a Super Pattern — Live Policy Without Redeploy
...
---
*Example: https://github.com/kiponos-io/kiponos-io/tree/master/examples/java/pattern-command-live-dispatch*
