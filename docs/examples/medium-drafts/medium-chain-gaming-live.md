# The Chain of Responsibility Pattern Reorder Handlers Live — Gaming War Room

*A traveler’s note from the matchmaking ops: session flood, frozen YAML, and the Super Pattern that lets ops move **reorder handlers live** without a jar.*

---

At **16:52**, the gaming war room already knew the number. The process still believed last week’s properties file.
...
For gaming, the painful dial was **reorder handlers live** (`active`). Default in the jar: `baseline`. Correct for a demo. Wrong for a brownout.
...
<!-- medium-img: diagram-medium-chain-gaming-live-gof-vs-live.png -->
...
```bash
examples/java/medium-chain-gaming-live
./gradlew test run
```
...
<!-- medium-img: diagram-medium-chain-gaming-live-hub-flow.png -->
...
*Series: Kiponos Medium Super Patterns · Example: [`examples/java/medium-chain-gaming-live`](https://github.com/kiponos-io/kiponos-io/tree/master/examples/java/medium-chain-gaming-live) · Product: [kiponos.io](https://kiponos.io)*
