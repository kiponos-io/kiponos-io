# The Chain of Responsibility Pattern Reorder Handlers Live — Security War Room

*A traveler’s note from the WAF desk: auth leeway fight, frozen YAML, and the Super Pattern that lets ops move **reorder handlers live** without a jar.*
...
For security, the painful dial was **reorder handlers live** (`active`). Default in the jar: `baseline`. Correct for a demo. Wrong for a brownout.
...
<!-- medium-img: diagram-medium-chain-security-live-gof-vs-live.png -->
...
```bash
examples/java/medium-chain-security-live
./gradlew test run
```
...
<!-- medium-img: diagram-medium-chain-security-live-hub-flow.png -->
...
*Series: Kiponos Medium Super Patterns · Example: [`examples/java/medium-chain-security-live`](https://github.com/kiponos-io/kiponos-io/tree/master/examples/java/medium-chain-security-live) · Product: [kiponos.io](https://kiponos.io)*
