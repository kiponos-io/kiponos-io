# The Strategy Pattern Swap Algorithms Live — Security War Room

*A traveler’s note from the WAF desk: auth leeway fight, frozen YAML, and the Super Pattern that lets ops move **swap algorithms live** without a jar.*
...
For security, the painful dial was **swap algorithms live** (`active`). Default in the jar: `baseline`. Correct for a demo. Wrong for a brownout.
...
<!-- medium-img: diagram-medium-strategy-security-live-gof-vs-live.png -->
...
```bash
examples/java/medium-strategy-security-live
./gradlew test run
```
...
<!-- medium-img: diagram-medium-strategy-security-live-hub-flow.png -->
...
*Series: Kiponos Medium Super Patterns · Example: [`examples/java/medium-strategy-security-live`](https://github.com/kiponos-io/kiponos-io/tree/master/examples/java/medium-strategy-security-live) · Product: [kiponos.io](https://kiponos.io)*
