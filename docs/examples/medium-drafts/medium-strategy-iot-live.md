# The Strategy Pattern Swap Algorithms Live — Iot War Room

*A traveler’s note from the device fleet: firmware gate jam, frozen YAML, and the Super Pattern that lets ops move **swap algorithms live** without a jar.*

---

At **00:33**, the iot war room already knew the number. The process still believed last week’s properties file.
...
For iot, the painful dial was **swap algorithms live** (`active`). Default in the jar: `baseline`. Correct for a demo. Wrong for a brownout.
...
<!-- medium-img: diagram-medium-strategy-iot-live-gof-vs-live.png -->

---

## The night firmware gate jam met a fossil
...
```bash
examples/java/medium-strategy-iot-live
./gradlew test run
```
...
<!-- medium-img: diagram-medium-strategy-iot-live-hub-flow.png -->
...
*Series: Kiponos Medium Super Patterns · Example: [`examples/java/medium-strategy-iot-live`](https://github.com/kiponos-io/kiponos-io/tree/master/examples/java/medium-strategy-iot-live) · Product: [kiponos.io](https://kiponos.io)*
