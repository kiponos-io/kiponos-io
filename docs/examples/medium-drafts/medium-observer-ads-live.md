# The Observer Pattern Subscribe Topology Live — Ads War Room

*A traveler’s note from the pacing ops: bid cap thrash, frozen YAML, and the Super Pattern that lets ops move **subscribe topology live** without a jar.*

---

At **11:08**, the ads war room already knew the number. The process still believed last week’s properties file.
...
For ads, the painful dial was **subscribe topology live** (`active`). Default in the jar: `baseline`. Correct for a demo. Wrong for a brownout.
...
<!-- medium-img: diagram-medium-observer-ads-live-gof-vs-live.png -->
...
```bash
examples/java/medium-observer-ads-live
./gradlew test run
```
...
<!-- medium-img: diagram-medium-observer-ads-live-hub-flow.png -->
...
*Series: Kiponos Medium Super Patterns · Example: [`examples/java/medium-observer-ads-live`](https://github.com/kiponos-io/kiponos-io/tree/master/examples/java/medium-observer-ads-live) · Product: [kiponos.io](https://kiponos.io)*
