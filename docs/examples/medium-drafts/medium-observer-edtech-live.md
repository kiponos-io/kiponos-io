# The Observer Pattern Subscribe Topology Live — Edtech War Room

*A traveler’s note from the exam window: class-size shock, frozen YAML, and the Super Pattern that lets ops move **subscribe topology live** without a jar.*
...
For edtech, the painful dial was **subscribe topology live** (`active`). Default in the jar: `baseline`. Correct for a demo. Wrong for a brownout.
...
<!-- medium-img: diagram-medium-observer-edtech-live-gof-vs-live.png -->
...
```bash
examples/java/medium-observer-edtech-live
./gradlew test run
```
...
<!-- medium-img: diagram-medium-observer-edtech-live-hub-flow.png -->
...
*Series: Kiponos Medium Super Patterns · Example: [`examples/java/medium-observer-edtech-live`](https://github.com/kiponos-io/kiponos-io/tree/master/examples/java/medium-observer-edtech-live) · Product: [kiponos.io](https://kiponos.io)*
