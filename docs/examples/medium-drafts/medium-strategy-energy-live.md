# The Strategy Pattern Swap Algorithms Live — Energy War Room

*A traveler’s note from the dispatch board: demand response, frozen YAML, and the Super Pattern that lets ops move **swap algorithms live** without a jar.*
...
For energy, the painful dial was **swap algorithms live** (`active`). Default in the jar: `baseline`. Correct for a demo. Wrong for a brownout.
...
<!-- medium-img: diagram-medium-strategy-energy-live-gof-vs-live.png -->
...
```bash
examples/java/medium-strategy-energy-live
./gradlew test run
```
...
<!-- medium-img: diagram-medium-strategy-energy-live-hub-flow.png -->
...
*Series: Kiponos Medium Super Patterns · Example: [`examples/java/medium-strategy-energy-live`](https://github.com/kiponos-io/kiponos-io/tree/master/examples/java/medium-strategy-energy-live) · Product: [kiponos.io](https://kiponos.io)*
