...
How to try: open `sdks/kiponos-angular-sdk`, `npm test`, then `provideKiponos({{ client }})` from a server-created client. Companion: `examples/java/angular-sdk-incident-pause`.
