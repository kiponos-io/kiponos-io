# The Strategy Pattern Swap Algorithms Live — Saas War Room

*A traveler’s note from the tenant ops: noisy neighbor, frozen YAML, and the Super Pattern that lets ops move **swap algorithms live** without a jar.*
...
For saas, the painful dial was **swap algorithms live** (`active`). Default in the jar: `baseline`. Correct for a demo. Wrong for a brownout.
...
<!-- medium-img: diagram-medium-strategy-saas-live-gof-vs-live.png -->
...
```bash
examples/java/medium-strategy-saas-live
./gradlew test run
```
...
<!-- medium-img: diagram-medium-strategy-saas-live-hub-flow.png -->
...
*Series: Kiponos Medium Super Patterns · Example: [`examples/java/medium-strategy-saas-live`](https://github.com/kiponos-io/kiponos-io/tree/master/examples/java/medium-strategy-saas-live) · Product: [kiponos.io](https://kiponos.io)*
