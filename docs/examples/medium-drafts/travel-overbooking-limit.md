...
<!-- medium-img: diagram-travel-overbooking-limit-gof-vs-live.png -->
<!-- medium-img: diagram-travel-overbooking-limit-hub-flow.png -->
...
If `overbook-pct` only moves through a release train, every product conversation becomes a ceremony debate: who owns the PR, who merges, who rolls, who watches. That tax compounds across regions and on-call rotations.
