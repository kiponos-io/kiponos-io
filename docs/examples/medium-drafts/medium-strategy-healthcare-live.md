# The Strategy Pattern Swap Algorithms Live — Healthcare War Room

*A traveler’s note from the triage desk: queue depth spike, frozen YAML, and the Super Pattern that lets ops move **swap algorithms live** without a jar.*

---

At **02:17**, the healthcare war room already knew the number. The process still believed last week’s properties file.
...
For healthcare, the painful dial was **swap algorithms live** (`active`). Default in the jar: `baseline`. Correct for a demo. Wrong for a brownout.
...
<!-- medium-img: diagram-medium-strategy-healthcare-live-gof-vs-live.png -->
...
```bash
examples/java/medium-strategy-healthcare-live
./gradlew test run
```
...
<!-- medium-img: diagram-medium-strategy-healthcare-live-hub-flow.png -->
...
*Series: Kiponos Medium Super Patterns · Example: [`examples/java/medium-strategy-healthcare-live`](https://github.com/kiponos-io/kiponos-io/tree/master/examples/java/medium-strategy-healthcare-live) · Product: [kiponos.io](https://kiponos.io)*
