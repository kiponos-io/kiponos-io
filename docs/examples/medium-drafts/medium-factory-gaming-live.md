# The Factory Pattern Select Product Channel Live — Gaming War Room

*A traveler’s note from the matchmaking ops: session flood, frozen YAML, and the Super Pattern that lets ops move **select product channel live** without a jar.*

---

At **00:33**, the gaming war room already knew the number. The process still believed last week’s properties file.
...
For gaming, the painful dial was **select product channel live** (`active`). Default in the jar: `baseline`. Correct for a demo. Wrong for a brownout.
...
<!-- medium-img: diagram-medium-factory-gaming-live-gof-vs-live.png -->

---

## The night session flood met a fossil
...
```bash
examples/java/medium-factory-gaming-live
./gradlew test run
```
...
<!-- medium-img: diagram-medium-factory-gaming-live-hub-flow.png -->
...
*Series: Kiponos Medium Super Patterns · Example: [`examples/java/medium-factory-gaming-live`](https://github.com/kiponos-io/kiponos-io/tree/master/examples/java/medium-factory-gaming-live) · Product: [kiponos.io](https://kiponos.io)*
