...
<!-- medium-img: diagram-sre-feature-kill-switch-gof-vs-live.png -->
<!-- medium-img: diagram-sre-feature-kill-switch-hub-flow.png -->
...
If `enabled` only moves through a release train, every product conversation becomes a ceremony debate: who owns the PR, who merges, who rolls, who watches. That tax compounds across regions and on-call rotations.
