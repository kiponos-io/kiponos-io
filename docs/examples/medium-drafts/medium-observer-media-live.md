# The Observer Pattern Subscribe Topology Live — Media War Room

*A traveler’s note from the origin ops: bitrate storm, frozen YAML, and the Super Pattern that lets ops move **subscribe topology live** without a jar.*
...
For media, the painful dial was **subscribe topology live** (`active`). Default in the jar: `baseline`. Correct for a demo. Wrong for a brownout.
...
<!-- medium-img: diagram-medium-observer-media-live-gof-vs-live.png -->
...
```bash
examples/java/medium-observer-media-live
./gradlew test run
```
...
<!-- medium-img: diagram-medium-observer-media-live-hub-flow.png -->
...
*Series: Kiponos Medium Super Patterns · Example: [`examples/java/medium-observer-media-live`](https://github.com/kiponos-io/kiponos-io/tree/master/examples/java/medium-observer-media-live) · Product: [kiponos.io](https://kiponos.io)*
