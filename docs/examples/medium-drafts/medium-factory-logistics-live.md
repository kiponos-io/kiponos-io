# The Factory Pattern Select Product Channel Live — Logistics War Room

*A traveler’s note from the dispatch floor: SLA breach window, frozen YAML, and the Super Pattern that lets ops move **select product channel live** without a jar.*

---

At **16:52**, the logistics war room already knew the number. The process still believed last week’s properties file.
...
For logistics, the painful dial was **select product channel live** (`active`). Default in the jar: `baseline`. Correct for a demo. Wrong for a brownout.
...
<!-- medium-img: diagram-medium-factory-logistics-live-gof-vs-live.png -->
...
```bash
examples/java/medium-factory-logistics-live
./gradlew test run
```
...
<!-- medium-img: diagram-medium-factory-logistics-live-hub-flow.png -->
...
*Series: Kiponos Medium Super Patterns · Example: [`examples/java/medium-factory-logistics-live`](https://github.com/kiponos-io/kiponos-io/tree/master/examples/java/medium-factory-logistics-live) · Product: [kiponos.io](https://kiponos.io)*
