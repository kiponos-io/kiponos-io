...
<!-- medium-img: diagram-sre-trace-sampling-rate-gof-vs-live.png -->
<!-- medium-img: diagram-sre-trace-sampling-rate-hub-flow.png -->
...
If `sample-rate` only moves through a release train, every product conversation becomes a ceremony debate: who owns the PR, who merges, who rolls, who watches. That tax compounds across regions and on-call rotations.
