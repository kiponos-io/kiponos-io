# Retail Dynamic Pricing Weights Live

*A traveler’s note: pricing weight live.*
...
Redeploying a jar to change `sale-weight` is how teams invent 3am folklore.
...
```text
examples/retail-dynamic-pricing-knob/sale-weight = 1.0
```
...
```java
    public static void main(String[] args) throws Exception {
        ...
        try {
            Folder p = ensure(k);
            System.out.println("sale-weight=" + read(p, "sale-weight", "1.0"));
            System.out.println("pricing weight live");
            Thread.sleep(1500L);
        } finally {
            k.disconnect();
        }
    ...
    static Folder ensure(Kiponos k) {
        Folder f = k.getRootFolder().folderOrCreate("examples").folderOrCreate("retail-dynamic-pricing-knob");
        if (!f.hasKey("sale-weight")) {
            f.set("sale-weight", "1.0");
        }
        return f;
    }
...
Full source + tests: [https://github.com/kiponos-io/kiponos-io/tree/master/examples/java/retail-dynamic-pricing-knob](https://github.com/kiponos-io/kiponos-io/tree/master/examples/java/retail-dynamic-pricing-knob)
...
*Example + tests: [https://github.com/kiponos-io/kiponos-io/tree/master/examples/java/retail-dynamic-pricing-knob](https://github.com/kiponos-io/kiponos-io/tree/master/examples/java/retail-dynamic-pricing-knob)*

<!-- medium-img: diagram-retail-dynamic-pricing-knob-gof-vs-live.png -->
<!-- medium-img: diagram-retail-dynamic-pricing-knob-hub-flow.png -->
...
If `sale-weight` only moves through a release train, every product conversation becomes a ceremony debate: who owns the PR, who merges, who rolls, who watches. That tax compounds across regions and on-call rotations.
