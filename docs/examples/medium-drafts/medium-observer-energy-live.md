# The Observer Pattern Subscribe Topology Live — Energy War Room

*A traveler’s note from the dispatch board: demand response, frozen YAML, and the Super Pattern that lets ops move **subscribe topology live** without a jar.*

---

At **11:08**, the energy war room already knew the number. The process still believed last week’s properties file.
...
For energy, the painful dial was **subscribe topology live** (`active`). Default in the jar: `baseline`. Correct for a demo. Wrong for a brownout.
...
<!-- medium-img: diagram-medium-observer-energy-live-gof-vs-live.png -->

---

## The night demand response met a fossil
...
```bash
examples/java/medium-observer-energy-live
./gradlew test run
```
...
<!-- medium-img: diagram-medium-observer-energy-live-hub-flow.png -->
...
*Series: Kiponos Medium Super Patterns · Example: [`examples/java/medium-observer-energy-live`](https://github.com/kiponos-io/kiponos-io/tree/master/examples/java/medium-observer-energy-live) · Product: [kiponos.io](https://kiponos.io)*
