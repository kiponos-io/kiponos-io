...
*A traveler’s note from the exam window: class-size shock, frozen YAML, and the Super Pattern that lets ops move **select product channel live** without a jar.*
...
For edtech, the painful dial was **select product channel live** (`active`). Default in the jar: `baseline`. Correct for a demo. Wrong for a brownout.
...
<!-- medium-img: diagram-medium-factory-edtech-live-gof-vs-live.png -->
...
```bash
examples/java/medium-factory-edtech-live
./gradlew test run
```
...
<!-- medium-img: diagram-medium-factory-edtech-live-hub-flow.png -->
...
*Series: Kiponos Medium Super Patterns · Example: [`examples/java/medium-factory-edtech-live`](https://github.com/kiponos-io/kiponos-io/tree/master/examples/java/medium-factory-edtech-live) · Product: [kiponos.io](https://kiponos.io)*
