# The Strategy Pattern Swap Algorithms Live — Gaming War Room

*A traveler’s note from the matchmaking ops: session flood, frozen YAML, and the Super Pattern that lets ops move **swap algorithms live** without a jar.*
...
For gaming, the painful dial was **swap algorithms live** (`active`). Default in the jar: `baseline`. Correct for a demo. Wrong for a brownout.
...
<!-- medium-img: diagram-medium-strategy-gaming-live-gof-vs-live.png -->
...
```bash
examples/java/medium-strategy-gaming-live
./gradlew test run
```
...
<!-- medium-img: diagram-medium-strategy-gaming-live-hub-flow.png -->
...
*Series: Kiponos Medium Super Patterns · Example: [`examples/java/medium-strategy-gaming-live`](https://github.com/kiponos-io/kiponos-io/tree/master/examples/java/medium-strategy-gaming-live) · Product: [kiponos.io](https://kiponos.io)*
