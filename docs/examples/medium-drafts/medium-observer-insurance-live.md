# The Observer Pattern Subscribe Topology Live — Insurance War Room

*A traveler’s note from the claims floor: velocity fraud, frozen YAML, and the Super Pattern that lets ops move **subscribe topology live** without a jar.*
...
For insurance, the painful dial was **subscribe topology live** (`active`). Default in the jar: `baseline`. Correct for a demo. Wrong for a brownout.
...
<!-- medium-img: diagram-medium-observer-insurance-live-gof-vs-live.png -->
...
```bash
examples/java/medium-observer-insurance-live
./gradlew test run
```
...
<!-- medium-img: diagram-medium-observer-insurance-live-hub-flow.png -->
...
*Series: Kiponos Medium Super Patterns · Example: [`examples/java/medium-observer-insurance-live`](https://github.com/kiponos-io/kiponos-io/tree/master/examples/java/medium-observer-insurance-live) · Product: [kiponos.io](https://kiponos.io)*
