# Media Bitrate Ceiling Live

*A traveler’s note: bitrate ceiling live.*

---

There is a class of production decisions that are **too small for a release** and **too important for a wiki**.

bitrate ceiling live

Redeploying a jar to change `max-kbps` is how teams invent 3am folklore.
...
Full source + tests: [https://github.com/kiponos-io/kiponos-io/tree/master/examples/java/media-bitrate-ceiling](https://github.com/kiponos-io/kiponos-io/tree/master/examples/java/media-bitrate-ceiling)
...
*Example + tests: [https://github.com/kiponos-io/kiponos-io/tree/master/examples/java/media-bitrate-ceiling](https://github.com/kiponos-io/kiponos-io/tree/master/examples/java/media-bitrate-ceiling)*

<!-- medium-img: diagram-media-bitrate-ceiling-gof-vs-live.png -->
<!-- medium-img: diagram-media-bitrate-ceiling-hub-flow.png -->
...
If `max-kbps` only moves through a release train, every product conversation becomes a ceremony debate: who owns the PR, who merges, who rolls, who watches. That tax compounds across regions and on-call rotations.
