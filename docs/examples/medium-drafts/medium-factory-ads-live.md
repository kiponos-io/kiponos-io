# The Factory Pattern Select Product Channel Live — Ads War Room

*A traveler’s note from the pacing ops: bid cap thrash, frozen YAML, and the Super Pattern that lets ops move **select product channel live** without a jar.*

---

At **22:09**, the ads war room already knew the number. The process still believed last week’s properties file.
...
For ads, the painful dial was **select product channel live** (`active`). Default in the jar: `baseline`. Correct for a demo. Wrong for a brownout.
...
<!-- medium-img: diagram-medium-factory-ads-live-gof-vs-live.png -->
...
```bash
examples/java/medium-factory-ads-live
./gradlew test run
```
...
<!-- medium-img: diagram-medium-factory-ads-live-hub-flow.png -->
...
*Series: Kiponos Medium Super Patterns · Example: [`examples/java/medium-factory-ads-live`](https://github.com/kiponos-io/kiponos-io/tree/master/examples/java/medium-factory-ads-live) · Product: [kiponos.io](https://kiponos.io)*
