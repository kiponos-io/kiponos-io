# The Decorator Pattern Rebuild Wrapper Chains Live — Travel War Room

*A traveler’s note from the inventory desk: overbooking spike, frozen YAML, and the Super Pattern that lets ops move **rebuild wrapper chains live** without a jar.*

---

At **03:41**, the travel war room already knew the number. The process still believed last week’s properties file.
...
For travel, the painful dial was **rebuild wrapper chains live** (`active`). Default in the jar: `baseline`. Correct for a demo. Wrong for a brownout.
...
<!-- medium-img: diagram-medium-decorator-travel-live-gof-vs-live.png -->

---

## The night overbooking spike met a fossil
...
```bash
examples/java/medium-decorator-travel-live
./gradlew test run
```
...
<!-- medium-img: diagram-medium-decorator-travel-live-hub-flow.png -->
...
*Series: Kiponos Medium Super Patterns · Example: [`examples/java/medium-decorator-travel-live`](https://github.com/kiponos-io/kiponos-io/tree/master/examples/java/medium-decorator-travel-live) · Product: [kiponos.io](https://kiponos.io)*
