# The Strategy Pattern Swap Algorithms Live — Ads War Room

*A traveler’s note from the pacing ops: bid cap thrash, frozen YAML, and the Super Pattern that lets ops move **swap algorithms live** without a jar.*

---

At **03:41**, the ads war room already knew the number. The process still believed last week’s properties file.
...
For ads, the painful dial was **swap algorithms live** (`active`). Default in the jar: `baseline`. Correct for a demo. Wrong for a brownout.
...
<!-- medium-img: diagram-medium-strategy-ads-live-gof-vs-live.png -->

---

## The night bid cap thrash met a fossil
...
```bash
examples/java/medium-strategy-ads-live
./gradlew test run
```
...
<!-- medium-img: diagram-medium-strategy-ads-live-hub-flow.png -->
...
*Series: Kiponos Medium Super Patterns · Example: [`examples/java/medium-strategy-ads-live`](https://github.com/kiponos-io/kiponos-io/tree/master/examples/java/medium-strategy-ads-live) · Product: [kiponos.io](https://kiponos.io)*
