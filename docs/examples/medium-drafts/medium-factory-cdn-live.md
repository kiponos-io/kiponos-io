# The Factory Pattern Select Product Channel Live — Cdn War Room

*A traveler’s note from the edge ops: purge storm, frozen YAML, and the Super Pattern that lets ops move **select product channel live** without a jar.*

---

At **02:17**, the cdn war room already knew the number. The process still believed last week’s properties file.
...
For cdn, the painful dial was **select product channel live** (`active`). Default in the jar: `baseline`. Correct for a demo. Wrong for a brownout.
...
<!-- medium-img: diagram-medium-factory-cdn-live-gof-vs-live.png -->

---

## The night purge storm met a fossil
...
```bash
examples/java/medium-factory-cdn-live
./gradlew test run
```
...
<!-- medium-img: diagram-medium-factory-cdn-live-hub-flow.png -->
...
*Series: Kiponos Medium Super Patterns · Example: [`examples/java/medium-factory-cdn-live`](https://github.com/kiponos-io/kiponos-io/tree/master/examples/java/medium-factory-cdn-live) · Product: [kiponos.io](https://kiponos.io)*
