# The Observer Pattern Subscribe Topology Live — Saas War Room

*A traveler’s note from the tenant ops: noisy neighbor, frozen YAML, and the Super Pattern that lets ops move **subscribe topology live** without a jar.*
...
For saas, the painful dial was **subscribe topology live** (`active`). Default in the jar: `baseline`. Correct for a demo. Wrong for a brownout.
...
<!-- medium-img: diagram-medium-observer-saas-live-gof-vs-live.png -->
...
```bash
examples/java/medium-observer-saas-live
./gradlew test run
```
...
<!-- medium-img: diagram-medium-observer-saas-live-hub-flow.png -->
...
*Series: Kiponos Medium Super Patterns · Example: [`examples/java/medium-observer-saas-live`](https://github.com/kiponos-io/kiponos-io/tree/master/examples/java/medium-observer-saas-live) · Product: [kiponos.io](https://kiponos.io)*
