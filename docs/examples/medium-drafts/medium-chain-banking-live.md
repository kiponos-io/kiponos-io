# The Chain of Responsibility Pattern Reorder Handlers Live — Banking War Room

*A traveler’s note from the AML desk: transfer storm, frozen YAML, and the Super Pattern that lets ops move **reorder handlers live** without a jar.*
...
For banking, the painful dial was **reorder handlers live** (`active`). Default in the jar: `baseline`. Correct for a demo. Wrong for a brownout.
...
<!-- medium-img: diagram-medium-chain-banking-live-gof-vs-live.png -->
...
```bash
examples/java/medium-chain-banking-live
./gradlew test run
```
...
<!-- medium-img: diagram-medium-chain-banking-live-hub-flow.png -->
...
*Series: Kiponos Medium Super Patterns · Example: [`examples/java/medium-chain-banking-live`](https://github.com/kiponos-io/kiponos-io/tree/master/examples/java/medium-chain-banking-live) · Product: [kiponos.io](https://kiponos.io)*
