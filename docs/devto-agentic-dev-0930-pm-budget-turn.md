...
canonical_url: https://github.com/kiponos-io/kiponos-io/blob/master/docs/devto-agentic-dev-0930-pm-budget-turn.md
---
...
```text
examples/agentic-dev-0930-pm-budget-turn/max-tokens = 8000
```

Runnable proof: [`examples/java/agentic-dev-0930-pm-budget-turn`](https://github.com/kiponos-io/kiponos-io/tree/master/examples/java/agentic-dev-0930-pm-budget-turn)
...
```yaml
examples/
  agentic-dev-0930-pm-budget-turn/
...
Folder gate = kip.getRootFolder()
        ...
        .folderOrCreate("agentic-dev-0930-pm-budget-turn");
...
try:
    posture = k.get("examples/agentic-dev-0930-pm-budget-turn/max-tokens", "8000")
    if str(posture) == "8000":
...
In staging: set a painful `max-tokens`, prove Cursor recovers without a host kill, prove clamps reject nonsense, prove last-known-good when the hub is firewalled. That drill ends half the architecture arguments about Token budget mid-session.
...
3. `cd examples/java/agentic-dev-0930-pm-budget-turn && cp kiponos.local.env.example kiponos.local.env`
4. `./gradlew test run` — prints `examples/agentic-dev-0930-pm-budget-turn/max-tokens=...`
...
How to try: `examples/java/agentic-dev-0930-pm-budget-turn` and `./gradlew test`.
