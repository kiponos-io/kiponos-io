---
title: "We Stopped Shipping Shadow Traffic Share as a Constant (Healthcare)"
published: false
tags: java, healthcare, architecture, kiponos
description: "Live shadow traffic share via Kiponos Java SDK — healthcare posture without redeploy."
canonical_url: https://github.com/kiponos-io/kiponos-io/blob/master/docs/devto-ops-posture-healthcare-shadow-percent-0361.md
main_image: ./devto-cover-ops-posture-healthcare-shadow-percent-0361.jpg
---
...
Domain: routing, queue depth, triage. This essay maps hub key `shadowPercent` to **shadow traffic share** so the lesson stays concrete for healthcare operators.
...
```java
Folder policy = kiponos.path("examples", "ops-healthcare-shadow-percent");
...
1. Name the hub path so humans find it under pressure (`examples/ops-healthcare-shadow-percent/shadowPercent`).  
...
Feature flags are often product gates. This essay is about **ops posture on a hot path**: shadow traffic share for healthcare — numbers humans already change verbally in war rooms.
