---
title: "We Stopped Shipping Outbound Call Timeout as a Constant (Saas)"
published: false
tags: java, saas, architecture, kiponos
description: "Live outbound call timeout via Kiponos Java SDK — saas posture without redeploy."
canonical_url: https://github.com/kiponos-io/kiponos-io/blob/master/docs/devto-ops-posture-saas-timeout-ms-0251.md
main_image: ./devto-cover-ops-posture-saas-timeout-ms-0251.jpg
---
...
Domain: multi-tenant quotas, feature posture. This essay maps hub key `timeoutMs` to **outbound call timeout** so the lesson stays concrete for saas operators.
...
```java
Folder policy = kiponos.path("examples", "ops-saas-timeout-ms");
...
1. Name the hub path so humans find it under pressure (`examples/ops-saas-timeout-ms/timeoutMs`).  
...
Feature flags are often product gates. This essay is about **ops posture on a hot path**: outbound call timeout for saas — numbers humans already change verbally in war rooms.
