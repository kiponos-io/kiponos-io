---
title: "Iot: Turn overbooking percent Into Incident Posture"
published: false
tags: java, iot, devops, kiponos
description: "Live overbooking percent via Kiponos Java SDK — iot posture without redeploy."
canonical_url: https://github.com/kiponos-io/kiponos-io/blob/master/docs/devto-ops-posture-iot-overbook-pct-0474.md
main_image: ./devto-cover-ops-posture-iot-overbook-pct-0474.jpg
---
...
Domain: device firmware gates, telemetry sample. This essay maps hub key `overbookPercent` to **overbooking percent** so the lesson stays concrete for iot operators.
...
```java
var policy = kiponos.path("examples", "ops-iot-overbook-pct");
...
1. Name the hub path so humans find it under pressure (`examples/ops-iot-overbook-pct/overbookPercent`).  
...
Feature flags are often product gates. This essay is about **ops posture on a hot path**: overbooking percent for iot — numbers humans already change verbally in war rooms.
...
2. Move `overbookPercent` to the emergency value (documented floor/ceiling).  
