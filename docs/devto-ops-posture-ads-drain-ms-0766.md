---
title: "We Stopped Shipping Graceful Drain Window as a Constant (Ads)"
published: false
tags: java, advertising, devops, kiponos
description: "Live graceful drain window via Kiponos Python SDK — ads posture without redeploy."
canonical_url: https://github.com/kiponos-io/kiponos-io/blob/master/docs/devto-ops-posture-ads-drain-ms-0766.md
main_image: https://files.catbox.moe/zx4n5k.jpg
---
...
Domain: bid caps, frequency, pacing. This essay maps hub key `gracefulShutdownMs` to **graceful drain window** so the lesson stays concrete for ads operators.
...
```python
policy = kiponos.path("examples", "ops-ads-drain-ms")
...
1. Name the hub path so humans find it under pressure (`examples/ops-ads-drain-ms/gracefulShutdownMs`).  
...
Feature flags are often product gates. This essay is about **ops posture on a hot path**: graceful drain window for ads — numbers humans already change verbally in war rooms.
