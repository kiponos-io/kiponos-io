---
title: "We Stopped Shipping Shadow Traffic Share as a Constant (Iot)"
published: false
tags: java, iot, devops, kiponos
description: "Live shadow traffic share via Kiponos Java SDK — iot posture without redeploy."
canonical_url: https://github.com/kiponos-io/kiponos-io/blob/master/docs/devto-ops-posture-iot-shadow-percent-0461.md
main_image: ./devto-cover-ops-posture-iot-shadow-percent-0461.jpg
---
...
Domain: device firmware gates, telemetry sample. This essay maps hub key `shadowPercent` to **shadow traffic share** so the lesson stays concrete for iot operators.
...
```java
Folder policy = kiponos.path("examples", "ops-iot-shadow-percent");
...
1. Name the hub path so humans find it under pressure (`examples/ops-iot-shadow-percent/shadowPercent`).  
...
Feature flags are often product gates. This essay is about **ops posture on a hot path**: shadow traffic share for iot — numbers humans already change verbally in war rooms.
...
shadow traffic share that requires a deploy is optimistic documentation.
