---
title: "We Stopped Shipping Rag Top-K as a Constant (Iot)"
published: false
tags: java, iot, devops, kiponos
description: "Live RAG top-k via Kiponos Java SDK — iot posture without redeploy."
canonical_url: https://github.com/kiponos-io/kiponos-io/blob/master/docs/devto-ops-posture-iot-rag-topk-0486.md
main_image: ./devto-cover-ops-posture-iot-rag-topk-0486.jpg
---
...
Domain: device firmware gates, telemetry sample. This essay maps hub key `topK` to **RAG top-k** so the lesson stays concrete for iot operators.
...
```java
Folder policy = kiponos.path("examples", "ops-iot-rag-topk");
...
1. Name the hub path so humans find it under pressure (`examples/ops-iot-rag-topk/topK`).  
...
Feature flags are often product gates. This essay is about **ops posture on a hot path**: RAG top-k for iot — numbers humans already change verbally in war rooms.
