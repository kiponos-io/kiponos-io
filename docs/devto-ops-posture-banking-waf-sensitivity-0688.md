---
title: "The Banking War Room Already Knew wafSensitivity — The Jar Did Not"
published: false
...
main_image: https://files.catbox.moe/mqygn9.jpg
---
...
Domain: AML thresholds, transfer velocity. This essay maps hub key `wafSensitivity` to **WAF sensitivity 1-5** so the lesson stays concrete for banking operators.
...
```python
policy = kiponos.path("examples", "ops-banking-waf-sensitivity")
...
1. Name the hub path so humans find it under pressure (`examples/ops-banking-waf-sensitivity/wafSensitivity`).  
...
Feature flags are often product gates. This essay is about **ops posture on a hot path**: WAF sensitivity 1-5 for banking — numbers humans already change verbally in war rooms.
