---
title: "Saga Step Retry Budget Should Not Wait for a Redeploy — Mobile Live Posture"
published: false
tags: java, mobile, architecture, kiponos
description: "Live saga step retry budget via Kiponos Java SDK — mobile posture without redeploy."
canonical_url: https://github.com/kiponos-io/kiponos-io/blob/master/docs/devto-ops-posture-mobile-saga-retry-1190.md
main_image: ./devto-cover-ops-posture-mobile-saga-retry-1190.jpg
---
...
Domain: API timeouts, payload caps. This essay maps hub key `sagaMaxAttempts` to **saga step retry budget** so the lesson stays concrete for mobile operators.
...
```java
var policy = kiponos.path("examples", "ops-mobile-saga-retry");
...
1. Name the hub path so humans find it under pressure (`examples/ops-mobile-saga-retry/sagaMaxAttempts`).  
...
Feature flags are often product gates. This essay is about **ops posture on a hot path**: saga step retry budget for mobile — numbers humans already change verbally in war rooms.
