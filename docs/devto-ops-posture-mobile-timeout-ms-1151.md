---
title: "We Stopped Shipping Outbound Call Timeout as a Constant (Mobile)"
published: false
tags: java, mobile, architecture, kiponos
description: "Live outbound call timeout via Kiponos Java SDK — mobile posture without redeploy."
canonical_url: https://github.com/kiponos-io/kiponos-io/blob/master/docs/devto-ops-posture-mobile-timeout-ms-1151.md
main_image: ./devto-cover-ops-posture-mobile-timeout-ms-1151.jpg
---
...
Domain: API timeouts, payload caps. This essay maps hub key `timeoutMs` to **outbound call timeout** so the lesson stays concrete for mobile operators.
...
```java
Folder policy = kiponos.path("examples", "ops-mobile-timeout-ms");
...
1. Name the hub path so humans find it under pressure (`examples/ops-mobile-timeout-ms/timeoutMs`).  
...
Feature flags are often product gates. This essay is about **ops posture on a hot path**: outbound call timeout for mobile — numbers humans already change verbally in war rooms.
