---
main_image: https://h.uguu.se/iFgBsTkC.jpg
...
canonical_url: https://github.com/kiponos-io/kiponos-io/blob/master/docs/devto-agentic-dev-1105-am-mcp-gate.md
---

I have sat next to the mirror-phone wall at 18:45 while Grok Build was *this close* to doing the wrong thing.
...
| Restart Grok Build — it is cheap | Cheap until 18:45 ate live device context and the current tool call |
...
```text
examples/agentic-dev-1105-am-mcp-gate/tools-allow = search,read
```

Runnable proof: [`examples/java/agentic-dev-1105-am-mcp-gate`](https://github.com/kiponos-io/kiponos-io/tree/master/examples/java/agentic-dev-1105-am-mcp-gate)
...
Folder gate = kip.getRootFolder()
        ...
        .folderOrCreate("agentic-dev-1105-am-mcp-gate");
...
try:
    posture = k.get("examples/agentic-dev-1105-am-mcp-gate/tools-allow", "search,read")
...
At 18:45 someone said, out loud: **the phone already knew the posture — the host did not**. That sentence is the whole product. If it cannot land in the running Grok Build process in seconds, you do not have posture. You have a wiki.
...
3. `cd examples/java/agentic-dev-1105-am-mcp-gate && cp kiponos.local.env.example kiponos.local.env`
4. `./gradlew test run` — prints `examples/agentic-dev-1105-am-mcp-gate/tools-allow=...`
...
How to try: `examples/java/agentic-dev-1105-am-mcp-gate` and `./gradlew test`.
