---
title: "The Platform War Room Already Knew hpaTarget — The Jar Did Not"
published: false
tags: java, platform, architecture, kiponos
description: "Live HPA CPU target percent via Kiponos Python SDK — platform posture without redeploy."
canonical_url: https://github.com/kiponos-io/kiponos-io/blob/master/docs/devto-ops-posture-platform-hpa-target-1133.md
main_image: ./devto-cover-ops-posture-platform-hpa-target-1133.jpg
---
...
Domain: shared libraries, defaults. This essay maps hub key `hpaTarget` to **HPA CPU target percent** so the lesson stays concrete for platform operators.
...
```python
policy = kiponos.path("examples", "ops-platform-hpa-target")
...
1. Name the hub path so humans find it under pressure (`examples/ops-platform-hpa-target/hpaTarget`).  
...
Feature flags are often product gates. This essay is about **ops posture on a hot path**: HPA CPU target percent for platform — numbers humans already change verbally in war rooms.
