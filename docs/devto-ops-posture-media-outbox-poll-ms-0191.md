---
title: "We Stopped Shipping Outbox Poll Interval as a Constant (Media)"
published: false
tags: java, streaming, devops, kiponos
description: "Live outbox poll interval via Kiponos Java SDK — media posture without redeploy."
canonical_url: https://github.com/kiponos-io/kiponos-io/blob/master/docs/devto-ops-posture-media-outbox-poll-ms-0191.md
main_image: ./devto-cover-ops-posture-media-outbox-poll-ms-0191.jpg
---
...
Domain: bitrate, CDN, origin. This essay maps hub key `outboxPollMs` to **outbox poll interval** so the lesson stays concrete for media operators.
...
```java
Folder policy = kiponos.path("examples", "ops-media-outbox-poll-ms");
...
1. Name the hub path so humans find it under pressure (`examples/ops-media-outbox-poll-ms/outboxPollMs`).  
...
Feature flags are often product gates. This essay is about **ops posture on a hot path**: outbox poll interval for media — numbers humans already change verbally in war rooms.
