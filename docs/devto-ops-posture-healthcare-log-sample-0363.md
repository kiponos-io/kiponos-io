---
title: "The Healthcare War Room Already Knew logSamplePerThousand — The Jar Did Not"
published: false
tags: java, healthcare, architecture, kiponos
description: "Live log sample per thousand via Kiponos Python SDK — healthcare posture without redeploy."
canonical_url: https://github.com/kiponos-io/kiponos-io/blob/master/docs/devto-ops-posture-healthcare-log-sample-0363.md
main_image: ./devto-cover-ops-posture-healthcare-log-sample-0363.jpg
---
...
Domain: routing, queue depth, triage. This essay maps hub key `logSamplePerThousand` to **log sample per thousand** so the lesson stays concrete for healthcare operators.
...
```python
policy = kiponos.path("examples", "ops-healthcare-log-sample")
...
1. Name the hub path so humans find it under pressure (`examples/ops-healthcare-log-sample/logSamplePerThousand`).  
...
Feature flags are often product gates. This essay is about **ops posture on a hot path**: log sample per thousand for healthcare — numbers humans already change verbally in war rooms.
