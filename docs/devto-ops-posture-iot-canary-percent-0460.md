---
title: "Canary Traffic Share Should Not Wait for a Redeploy — Iot Live Posture"
published: false
tags: java, iot, devops, kiponos
description: "Live canary traffic share via Kiponos Java SDK — iot posture without redeploy."
canonical_url: https://github.com/kiponos-io/kiponos-io/blob/master/docs/devto-ops-posture-iot-canary-percent-0460.md
main_image: ./devto-cover-ops-posture-iot-canary-percent-0460.jpg
---
...
Domain: device firmware gates, telemetry sample. This essay maps hub key `canaryPercent` to **canary traffic share** so the lesson stays concrete for iot operators.
...
```java
Folder policy = kiponos.path("examples", "ops-iot-canary-percent");
...
1. Name the hub path so humans find it under pressure (`examples/ops-iot-canary-percent/canaryPercent`).  
...
Feature flags are often product gates. This essay is about **ops posture on a hot path**: canary traffic share for iot — numbers humans already change verbally in war rooms.
