---
title: "We Stopped Shipping Cors Max-Age as a Constant (Security)"
published: false
tags: java, security, devops, kiponos
description: "Live CORS max-age via Kiponos Java SDK — security posture without redeploy."
canonical_url: https://github.com/kiponos-io/kiponos-io/blob/master/docs/devto-ops-posture-security-cors-max-age-1046.md
main_image: ./devto-cover-ops-posture-security-cors-max-age-1046.jpg
---
...
Domain: WAF, RPS, auth leeway. This essay maps hub key `corsMaxAgeSec` to **CORS max-age** so the lesson stays concrete for security operators.
...
```java
Folder policy = kiponos.path("examples", "ops-security-cors-max-age");
...
1. Name the hub path so humans find it under pressure (`examples/ops-security-cors-max-age/corsMaxAgeSec`).  
...
Feature flags are often product gates. This essay is about **ops posture on a hot path**: CORS max-age for security — numbers humans already change verbally in war rooms.
