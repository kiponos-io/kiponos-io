---
title: "The Retail War Room Already Knew hpaTarget — The Jar Did Not"
published: false
tags: java, retail, devops, kiponos
description: "Live HPA CPU target percent via Kiponos Python SDK — retail posture without redeploy."
canonical_url: https://github.com/kiponos-io/kiponos-io/blob/master/docs/devto-ops-posture-retail-hpa-target-0033.md
main_image: ./devto-cover-ops-posture-retail-hpa-target-0033.jpg
---
...
Domain: checkout, merchandising, inventory. This essay maps hub key `hpaTarget` to **HPA CPU target percent** so the lesson stays concrete for retail operators.
...
```python
policy = kiponos.path("examples", "ops-retail-hpa-target")
...
1. Name the hub path so humans find it under pressure (`examples/ops-retail-hpa-target/hpaTarget`).  
...
Feature flags are often product gates. This essay is about **ops posture on a hot path**: HPA CPU target percent for retail — numbers humans already change verbally in war rooms.
