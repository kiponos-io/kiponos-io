---
title: "Live Trace Sample Per Thousand for Platform — Mouth to Process in Seconds"
published: false
tags: java, platform, architecture, kiponos
description: "Live trace sample per thousand via Kiponos Python SDK — platform posture without redeploy."
canonical_url: https://github.com/kiponos-io/kiponos-io/blob/master/docs/devto-ops-posture-platform-trace-sample-1112.md
main_image: ./devto-cover-ops-posture-platform-trace-sample-1112.jpg
---
...
Domain: shared libraries, defaults. This essay maps hub key `samplePerThousand` to **trace sample per thousand** so the lesson stays concrete for platform operators.
...
```python
policy = kiponos.path("examples", "ops-platform-trace-sample")
...
1. Name the hub path so humans find it under pressure (`examples/ops-platform-trace-sample/samplePerThousand`).  
...
Feature flags are often product gates. This essay is about **ops posture on a hot path**: trace sample per thousand for platform — numbers humans already change verbally in war rooms.
