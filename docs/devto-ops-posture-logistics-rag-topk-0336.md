---
title: "We Stopped Shipping Rag Top-K as a Constant (Logistics)"
published: false
tags: java, logistics, devops, kiponos
description: "Live RAG top-k via Kiponos Java SDK — logistics posture without redeploy."
canonical_url: https://github.com/kiponos-io/kiponos-io/blob/master/docs/devto-ops-posture-logistics-rag-topk-0336.md
main_image: ./devto-cover-ops-posture-logistics-rag-topk-0336.jpg
---
...
Domain: routing, SLA windows, fleet. This essay maps hub key `topK` to **RAG top-k** so the lesson stays concrete for logistics operators.
...
```java
Folder policy = kiponos.path("examples", "ops-logistics-rag-topk");
...
1. Name the hub path so humans find it under pressure (`examples/ops-logistics-rag-topk/topK`).  
...
Feature flags are often product gates. This essay is about **ops posture on a hot path**: RAG top-k for logistics — numbers humans already change verbally in war rooms.
