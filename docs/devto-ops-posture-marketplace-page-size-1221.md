---
title: "We Stopped Shipping Pagination Page Size as a Constant (Marketplace)"
published: false
tags: java, architecture, devops, kiponos
description: "Live pagination page size via Kiponos Python SDK — marketplace posture without redeploy."
canonical_url: https://github.com/kiponos-io/kiponos-io/blob/master/docs/devto-ops-posture-marketplace-page-size-1221.md
main_image: ./devto-cover-ops-posture-marketplace-page-size-1221.jpg
---
...
Domain: seller tiers, fee weights. This essay maps hub key `pageSize` to **pagination page size** so the lesson stays concrete for marketplace operators.
...
```python
policy = kiponos.path("examples", "ops-marketplace-page-size")
...
1. Name the hub path so humans find it under pressure (`examples/ops-marketplace-page-size/pageSize`).  
...
Feature flags are often product gates. This essay is about **ops posture on a hot path**: pagination page size for marketplace — numbers humans already change verbally in war rooms.
