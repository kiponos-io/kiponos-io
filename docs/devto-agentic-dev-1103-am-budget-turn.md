---
main_image: https://h.uguu.se/zYcHwoZa.jpg
...
canonical_url: https://github.com/kiponos-io/kiponos-io/blob/master/docs/devto-agentic-dev-1103-am-budget-turn.md
---
...
```text
examples/agentic-dev-1103-am-budget-turn/max-tokens = 8000
```

Runnable proof: [`examples/java/agentic-dev-1103-am-budget-turn`](https://github.com/kiponos-io/kiponos-io/tree/master/examples/java/agentic-dev-1103-am-budget-turn)
...
```yaml
examples/
  agentic-dev-1103-am-budget-turn/
...
Folder gate = kip.getRootFolder()
        ...
        .folderOrCreate("agentic-dev-1103-am-budget-turn");
...
try:
    posture = k.get("examples/agentic-dev-1103-am-budget-turn/max-tokens", "8000")
    if str(posture) == "8000":
...
3. `cd examples/java/agentic-dev-1103-am-budget-turn && cp kiponos.local.env.example kiponos.local.env`
4. `./gradlew test run` — prints `examples/agentic-dev-1103-am-budget-turn/max-tokens=...`
...
How to try: `examples/java/agentic-dev-1103-am-budget-turn` and `./gradlew test`.
