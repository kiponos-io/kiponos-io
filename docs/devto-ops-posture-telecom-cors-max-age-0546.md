---
title: "We Stopped Shipping Cors Max-Age as a Constant (Telecom)"
published: false
tags: java, telecom, sre, kiponos
description: "Live CORS max-age via Kiponos Java SDK — telecom posture without redeploy."
canonical_url: https://github.com/kiponos-io/kiponos-io/blob/master/docs/devto-ops-posture-telecom-cors-max-age-0546.md
main_image: ./devto-cover-ops-posture-telecom-cors-max-age-0546.jpg
---
...
Domain: QoS, rate classes, trunk limits. This essay maps hub key `corsMaxAgeSec` to **CORS max-age** so the lesson stays concrete for telecom operators.
...
```java
Folder policy = kiponos.path("examples", "ops-telecom-cors-max-age");
...
1. Name the hub path so humans find it under pressure (`examples/ops-telecom-cors-max-age/corsMaxAgeSec`).  
...
Feature flags are often product gates. This essay is about **ops posture on a hot path**: CORS max-age for telecom — numbers humans already change verbally in war rooms.
