...
description: "Claude Code on travel-coordinator wall: Code-mode / defer as a hub leaf, not a vendor rewrite. Cloudflare's native MCP consumed 1.17M tokens; they shipped Code "
canonical_url: https://github.com/kiponos-io/kiponos-io/blob/master/docs/devto-agentic-mcp-0917-pm-code-mode.md
---
...
**The Aha:** `code-mode=on` is your leaf today. The tool becomes a small program, not a schema dump. Real-time nested state is now a **primitive** — as native as a hashmap — via [Kiponos.io](https://kiponos.io). The host stays up. The leaf moves. The next tool call already obeys.
