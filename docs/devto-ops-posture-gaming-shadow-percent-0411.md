---
title: "We Stopped Shipping Shadow Traffic Share as a Constant (Gaming)"
published: false
tags: java, gaming, devops, kiponos
description: "Live shadow traffic share via Kiponos Java SDK — gaming posture without redeploy."
canonical_url: https://github.com/kiponos-io/kiponos-io/blob/master/docs/devto-ops-posture-gaming-shadow-percent-0411.md
main_image: https://files.catbox.moe/3ohhpd.jpg
---
...
Domain: matchmaking, session caps, tick rate. This essay maps hub key `shadowPercent` to **shadow traffic share** so the lesson stays concrete for gaming operators.
...
```java
Folder policy = kiponos.path("examples", "ops-gaming-shadow-percent");
...
1. Name the hub path so humans find it under pressure (`examples/ops-gaming-shadow-percent/shadowPercent`).  
...
Feature flags are often product gates. This essay is about **ops posture on a hot path**: shadow traffic share for gaming — numbers humans already change verbally in war rooms.
