...
canonical_url: https://github.com/kiponos-io/kiponos-io/blob/master/docs/devto-agentic-dev-1009-pm-admin-wall.md
---
...
```text
examples/agentic-dev-1009-pm-admin-wall/wall-focus = live
```

Runnable proof: [`examples/java/agentic-dev-1009-pm-admin-wall`](https://github.com/kiponos-io/kiponos-io/tree/master/examples/java/agentic-dev-1009-pm-admin-wall)
...
Folder gate = kip.getRootFolder()
        ...
        .folderOrCreate("agentic-dev-1009-pm-admin-wall");
...
try:
    posture = k.get("examples/agentic-dev-1009-pm-admin-wall/wall-focus", "live")
    if str(posture) == "live":
...
Claude Code is good at calling tools. It is not a control plane. Killing it to flip `wall-focus` teaches the on-call that judgment requires a process ID. The admin-dashboard wall already disagrees.
...
3. `cd examples/java/agentic-dev-1009-pm-admin-wall && cp kiponos.local.env.example kiponos.local.env`
4. `./gradlew test run` — prints `examples/agentic-dev-1009-pm-admin-wall/wall-focus=...`
...
How to try: `examples/java/agentic-dev-1009-pm-admin-wall` and `./gradlew test`.
