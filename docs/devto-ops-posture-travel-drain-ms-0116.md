---
title: "We Stopped Shipping Graceful Drain Window as a Constant (Travel)"
published: false
tags: java, travel, architecture, kiponos
description: "Live graceful drain window via Kiponos Python SDK — travel posture without redeploy."
canonical_url: https://github.com/kiponos-io/kiponos-io/blob/master/docs/devto-ops-posture-travel-drain-ms-0116.md
main_image: ./devto-cover-ops-posture-travel-drain-ms-0116.jpg
---
...
Domain: inventory, overbooking, GDS. This essay maps hub key `gracefulShutdownMs` to **graceful drain window** so the lesson stays concrete for travel operators.
...
```python
policy = kiponos.path("examples", "ops-travel-drain-ms")
...
1. Name the hub path so humans find it under pressure (`examples/ops-travel-drain-ms/gracefulShutdownMs`).  
...
Feature flags are often product gates. This essay is about **ops posture on a hot path**: graceful drain window for travel — numbers humans already change verbally in war rooms.
