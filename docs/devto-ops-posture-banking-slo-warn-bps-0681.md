---
title: "We Stopped Shipping Slo Warn Burn Bps as a Constant (Banking)"
published: false
...
main_image: https://files.catbox.moe/pyd5wt.jpg
---
...
Domain: AML thresholds, transfer velocity. This essay maps hub key `errorBudgetWarnBps` to **SLO warn burn bps** so the lesson stays concrete for banking operators.
...
```java
var policy = kiponos.path("examples", "ops-banking-slo-warn-bps");
...
1. Name the hub path so humans find it under pressure (`examples/ops-banking-slo-warn-bps/errorBudgetWarnBps`).  
...
Feature flags are often product gates. This essay is about **ops posture on a hot path**: SLO warn burn bps for banking — numbers humans already change verbally in war rooms.
