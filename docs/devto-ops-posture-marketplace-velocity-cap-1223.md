---
title: "The Marketplace War Room Already Knew velocityCap — The Jar Did Not"
published: false
tags: java, architecture, devops, kiponos
description: "Live fraud velocity cap via Kiponos Java SDK — marketplace posture without redeploy."
canonical_url: https://github.com/kiponos-io/kiponos-io/blob/master/docs/devto-ops-posture-marketplace-velocity-cap-1223.md
main_image: ./devto-cover-ops-posture-marketplace-velocity-cap-1223.jpg
---
...
Domain: seller tiers, fee weights. This essay maps hub key `velocityCap` to **fraud velocity cap** so the lesson stays concrete for marketplace operators.
...
```java
Folder policy = kiponos.path("examples", "ops-marketplace-velocity-cap");
...
1. Name the hub path so humans find it under pressure (`examples/ops-marketplace-velocity-cap/velocityCap`).  
...
Feature flags are often product gates. This essay is about **ops posture on a hot path**: fraud velocity cap for marketplace — numbers humans already change verbally in war rooms.
