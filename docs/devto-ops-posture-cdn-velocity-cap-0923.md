---
title: "The Cdn War Room Already Knew velocityCap — The Jar Did Not"
published: false
...
main_image: https://iili.io/CUrNXAF.jpg
---
...
Domain: edge rules, cache TTL, purge. This essay maps hub key `velocityCap` to **fraud velocity cap** so the lesson stays concrete for cdn operators.
...
```java
Folder policy = kiponos.path("examples", "ops-cdn-velocity-cap");
...
1. Name the hub path so humans find it under pressure (`examples/ops-cdn-velocity-cap/velocityCap`).  
...
Feature flags are often product gates. This essay is about **ops posture on a hot path**: fraud velocity cap for cdn — numbers humans already change verbally in war rooms.
