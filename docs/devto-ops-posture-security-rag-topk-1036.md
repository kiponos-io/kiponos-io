---
title: "We Stopped Shipping Rag Top-K as a Constant (Security)"
published: false
tags: java, security, devops, kiponos
description: "Live RAG top-k via Kiponos Java SDK — security posture without redeploy."
canonical_url: https://github.com/kiponos-io/kiponos-io/blob/master/docs/devto-ops-posture-security-rag-topk-1036.md
main_image: ./devto-cover-ops-posture-security-rag-topk-1036.jpg
---
...
Domain: WAF, RPS, auth leeway. This essay maps hub key `topK` to **RAG top-k** so the lesson stays concrete for security operators.
...
```java
var policy = kiponos.path("examples", "ops-security-rag-topk");
...
1. Name the hub path so humans find it under pressure (`examples/ops-security-rag-topk/topK`).  
...
Feature flags are often product gates. This essay is about **ops posture on a hot path**: RAG top-k for security — numbers humans already change verbally in war rooms.
