---
main_image: https://iili.io/CyJUQoB.jpg
...
canonical_url: https://github.com/kiponos-io/kiponos-io/blob/master/docs/devto-agentic-dev-0907-pm-shopping-pause.md
---
...
```text
examples/agentic-dev-0907-pm-shopping-pause/incident-pause = paused
```

Runnable proof: [`examples/java/agentic-dev-0907-pm-shopping-pause`](https://github.com/kiponos-io/kiponos-io/tree/master/examples/java/agentic-dev-0907-pm-shopping-pause)
...
```yaml
examples/
  agentic-dev-0907-pm-shopping-pause/
...
Folder gate = kip.getRootFolder()
        ...
        .folderOrCreate("agentic-dev-0907-pm-shopping-pause");
...
try:
    posture = k.get("examples/agentic-dev-0907-pm-shopping-pause/incident-pause", "paused")
...
In staging: set a painful `incident-pause`, prove Claude Code recovers without a host kill, prove clamps reject nonsense, prove last-known-good when the hub is firewalled. That drill ends half the architecture arguments about Shopping incident pause as a leaf.
...
3. `cd examples/java/agentic-dev-0907-pm-shopping-pause && cp kiponos.local.env.example kiponos.local.env`
4. `./gradlew test run` — prints `examples/agentic-dev-0907-pm-shopping-pause/incident-pause=...`
...
How to try: `examples/java/agentic-dev-0907-pm-shopping-pause` and `./gradlew test`.
