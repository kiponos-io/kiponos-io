---
main_image: https://iili.io/CyP2RyP.jpg
...
canonical_url: https://github.com/kiponos-io/kiponos-io/blob/master/docs/devto-agentic-dev-0930-am-chat-mute.md
---

I have sat next to the travel-coordinator wall at 03:07 while Claude Code was *this close* to doing the wrong thing.
...
```text
examples/agentic-dev-0930-am-chat-mute/chat-mute = muted
```

Runnable proof: [`examples/java/agentic-dev-0930-am-chat-mute`](https://github.com/kiponos-io/kiponos-io/tree/master/examples/java/agentic-dev-0930-am-chat-mute)
...
Folder gate = kip.getRootFolder()
        ...
        .folderOrCreate("agentic-dev-0930-am-chat-mute");
...
try:
    posture = k.get("examples/agentic-dev-0930-am-chat-mute/chat-mute", "muted")
...
At 03:07 someone said, out loud: **mute writes on the noisy room — keep reads**. That sentence is the whole product. If it cannot land in the running Claude Code process in seconds, you do not have posture. You have a wiki.
...
3. `cd examples/java/agentic-dev-0930-am-chat-mute && cp kiponos.local.env.example kiponos.local.env`
4. `./gradlew test run` — prints `examples/agentic-dev-0930-am-chat-mute/chat-mute=...`
...
How to try: `examples/java/agentic-dev-0930-am-chat-mute` and `./gradlew test`.
