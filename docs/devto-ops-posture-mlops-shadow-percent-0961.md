---
title: "We Stopped Shipping Shadow Traffic Share as a Constant (Mlops)"
published: false
tags: java, machinelearning, devops, kiponos
description: "Live shadow traffic share via Kiponos Java SDK — mlops posture without redeploy."
canonical_url: https://github.com/kiponos-io/kiponos-io/blob/master/docs/devto-ops-posture-mlops-shadow-percent-0961.md
main_image: ./devto-cover-ops-posture-mlops-shadow-percent-0961.jpg
---
...
Domain: batch size, score thresholds. This essay maps hub key `shadowPercent` to **shadow traffic share** so the lesson stays concrete for mlops operators.
...
```java
Folder policy = kiponos.path("examples", "ops-mlops-shadow-percent");
...
1. Name the hub path so humans find it under pressure (`examples/ops-mlops-shadow-percent/shadowPercent`).  
...
Feature flags are often product gates. This essay is about **ops posture on a hot path**: shadow traffic share for mlops — numbers humans already change verbally in war rooms.
