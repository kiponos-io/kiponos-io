---
title: "Saga Step Retry Budget Should Not Wait for a Redeploy — Ads Live Posture"
published: false
tags: java, advertising, devops, kiponos
description: "Live saga step retry budget via Kiponos Java SDK — ads posture without redeploy."
canonical_url: https://github.com/kiponos-io/kiponos-io/blob/master/docs/devto-ops-posture-ads-saga-retry-0790.md
main_image: https://files.catbox.moe/uhswir.jpg
---
...
Domain: bid caps, frequency, pacing. This essay maps hub key `sagaMaxAttempts` to **saga step retry budget** so the lesson stays concrete for ads operators.
...
```java
Folder policy = kiponos.path("examples", "ops-ads-saga-retry");
...
1. Name the hub path so humans find it under pressure (`examples/ops-ads-saga-retry/sagaMaxAttempts`).  
...
Feature flags are often product gates. This essay is about **ops posture on a hot path**: saga step retry budget for ads — numbers humans already change verbally in war rooms.
