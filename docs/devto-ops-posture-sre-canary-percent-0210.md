---
title: "Canary Traffic Share Should Not Wait for a Redeploy — Sre Live Posture"
published: false
tags: java, sre, devops, kiponos
description: "Live canary traffic share via Kiponos Java SDK — sre posture without redeploy."
canonical_url: https://github.com/kiponos-io/kiponos-io/blob/master/docs/devto-ops-posture-sre-canary-percent-0210.md
main_image: ./devto-cover-ops-posture-sre-canary-percent-0210.jpg
---
...
Domain: canary, drain, error budget. This essay maps hub key `canaryPercent` to **canary traffic share** so the lesson stays concrete for sre operators.
...
```java
Folder policy = kiponos.path("examples", "ops-sre-canary-percent");
...
1. Name the hub path so humans find it under pressure (`examples/ops-sre-canary-percent/canaryPercent`).  
...
Feature flags are often product gates. This essay is about **ops posture on a hot path**: canary traffic share for sre — numbers humans already change verbally in war rooms.
