---
title: "We Stopped Shipping Shadow Traffic Share as a Constant (Insurance)"
published: false
tags: java, insurance, architecture, kiponos
description: "Live shadow traffic share via Kiponos Python SDK — insurance posture without redeploy."
canonical_url: https://github.com/kiponos-io/kiponos-io/blob/master/docs/devto-ops-posture-insurance-shadow-percent-0611.md
main_image: ./devto-cover-ops-posture-insurance-shadow-percent-0611.jpg
---
...
Domain: underwriting, claims velocity. This essay maps hub key `shadowPercent` to **shadow traffic share** so the lesson stays concrete for insurance operators.
...
```python
policy = kiponos.path("examples", "ops-insurance-shadow-percent")
...
1. Name the hub path so humans find it under pressure (`examples/ops-insurance-shadow-percent/shadowPercent`).  
...
Feature flags are often product gates. This essay is about **ops posture on a hot path**: shadow traffic share for insurance — numbers humans already change verbally in war rooms.
