---
title: "Canary Traffic Share Should Not Wait for a Redeploy — Logistics Live Posture"
published: false
tags: java, logistics, devops, kiponos
description: "Live canary traffic share via Kiponos Java SDK — logistics posture without redeploy."
canonical_url: https://github.com/kiponos-io/kiponos-io/blob/master/docs/devto-ops-posture-logistics-canary-percent-0310.md
main_image: ./devto-cover-ops-posture-logistics-canary-percent-0310.jpg
---
...
Domain: routing, SLA windows, fleet. This essay maps hub key `canaryPercent` to **canary traffic share** so the lesson stays concrete for logistics operators.
...
```java
Folder policy = kiponos.path("examples", "ops-logistics-canary-percent");
...
1. Name the hub path so humans find it under pressure (`examples/ops-logistics-canary-percent/canaryPercent`).  
...
Feature flags are often product gates. This essay is about **ops posture on a hot path**: canary traffic share for logistics — numbers humans already change verbally in war rooms.
