---
title: "We Stopped Shipping Shadow Traffic Share as a Constant (Dataops)"
published: false
tags: java, dataengineering, devops, kiponos
description: "Live shadow traffic share via Kiponos Python SDK — dataops posture without redeploy."
canonical_url: https://github.com/kiponos-io/kiponos-io/blob/master/docs/devto-ops-posture-dataops-shadow-percent-1061.md
main_image: https://files.catbox.moe/z4mvck.jpg
---
...
Domain: batch, lag, checkpoint. This essay maps hub key `shadowPercent` to **shadow traffic share** so the lesson stays concrete for dataops operators.
...
```python
policy = kiponos.path("examples", "ops-dataops-shadow-percent")
...
1. Name the hub path so humans find it under pressure (`examples/ops-dataops-shadow-percent/shadowPercent`).  
...
Feature flags are often product gates. This essay is about **ops posture on a hot path**: shadow traffic share for dataops — numbers humans already change verbally in war rooms.
