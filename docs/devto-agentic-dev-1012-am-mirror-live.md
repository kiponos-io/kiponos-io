---
main_image: https://iili.io/n9v8aaV.jpg
title: "Claude Code Finished the Turn Blind — Mirror Phone live device leaf on the Admin Dashboard Path"
published: false
tags: java, python, devops, ai, kiponos
description: "Claude Code kept finishing the turn blind on admin-dashboard wall. Mirror Phone live device leaf is a live hub leaf."
canonical_url: https://github.com/kiponos-io/kiponos-io/blob/master/docs/devto-agentic-dev-1012-am-mirror-live.md
---

I have sat next to the admin-dashboard wall at 02:14 while Claude Code was *this close* to doing the wrong thing.
...
| Restart Claude Code — it is cheap | Cheap until 02:14 ate the operator's last ten minutes of diagnosis |
...
```text
examples/agentic-dev-1012-am-mirror-live/device-live = live
```

Runnable proof: [`examples/java/agentic-dev-1012-am-mirror-live`](https://github.com/kiponos-io/kiponos-io/tree/master/examples/java/agentic-dev-1012-am-mirror-live)
...
```yaml
examples/
  agentic-dev-1012-am-mirror-live/
...
Folder gate = kip.getRootFolder()
        ...
        .folderOrCreate("agentic-dev-1012-am-mirror-live");
...
try:
    posture = k.get("examples/agentic-dev-1012-am-mirror-live/device-live", "live")
    if str(posture) == "live":
...
At 02:14 someone said, out loud: **the tile is not a rumor. it is the same tree**. That sentence is the whole product. If it cannot land in the running Claude Code process in seconds, you do not have posture. You have a wiki.
...
3. `cd examples/java/agentic-dev-1012-am-mirror-live && cp kiponos.local.env.example kiponos.local.env`
4. `./gradlew test run` — prints `examples/agentic-dev-1012-am-mirror-live/device-live=...`
5. In the dashboard, change `device-live`. Keep the process up. No rebuild.
6. Point your Claude Code tool at the same leaf. Do not ship a new server binary to flip Mirror Phone live device leaf.
...
How to try: `examples/java/agentic-dev-1012-am-mirror-live` and `./gradlew test`.
