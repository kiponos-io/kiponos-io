---
title: "We Stopped Shipping Pagination Page Size as a Constant (Dataops)"
published: false
tags: java, dataengineering, devops, kiponos
description: "Live pagination page size via Kiponos Java SDK — dataops posture without redeploy."
canonical_url: https://github.com/kiponos-io/kiponos-io/blob/master/docs/devto-ops-posture-dataops-page-size-1071.md
main_image: https://litter.catbox.moe/gk5wh7.jpg
---
...
Domain: batch, lag, checkpoint. This essay maps hub key `pageSize` to **pagination page size** so the lesson stays concrete for dataops operators.
...
```java
Folder policy = kiponos.path("examples", "ops-dataops-page-size");
...
1. Name the hub path so humans find it under pressure (`examples/ops-dataops-page-size/pageSize`).  
...
Feature flags are often product gates. This essay is about **ops posture on a hot path**: pagination page size for dataops — numbers humans already change verbally in war rooms.
