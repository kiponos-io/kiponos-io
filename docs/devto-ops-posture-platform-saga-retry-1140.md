---
title: "Saga Step Retry Budget Should Not Wait for a Redeploy — Platform Live Posture"
published: false
tags: java, platform, architecture, kiponos
description: "Live saga step retry budget via Kiponos Java SDK — platform posture without redeploy."
canonical_url: https://github.com/kiponos-io/kiponos-io/blob/master/docs/devto-ops-posture-platform-saga-retry-1140.md
main_image: ./devto-cover-ops-posture-platform-saga-retry-1140.jpg
---
...
Domain: shared libraries, defaults. This essay maps hub key `sagaMaxAttempts` to **saga step retry budget** so the lesson stays concrete for platform operators.
...
```java
Folder policy = kiponos.path("examples", "ops-platform-saga-retry");
...
1. Name the hub path so humans find it under pressure (`examples/ops-platform-saga-retry/sagaMaxAttempts`).  
...
Feature flags are often product gates. This essay is about **ops posture on a hot path**: saga step retry budget for platform — numbers humans already change verbally in war rooms.
