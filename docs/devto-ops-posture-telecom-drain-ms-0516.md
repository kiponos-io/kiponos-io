---
title: "We Stopped Shipping Graceful Drain Window as a Constant (Telecom)"
published: false
tags: java, telecom, sre, kiponos
description: "Live graceful drain window via Kiponos Java SDK — telecom posture without redeploy."
canonical_url: https://github.com/kiponos-io/kiponos-io/blob/master/docs/devto-ops-posture-telecom-drain-ms-0516.md
main_image: ./devto-cover-ops-posture-telecom-drain-ms-0516.jpg
---
...
Domain: QoS, rate classes, trunk limits. This essay maps hub key `gracefulShutdownMs` to **graceful drain window** so the lesson stays concrete for telecom operators.
...
```java
var policy = kiponos.path("examples", "ops-telecom-drain-ms");
...
1. Name the hub path so humans find it under pressure (`examples/ops-telecom-drain-ms/gracefulShutdownMs`).  
...
Feature flags are often product gates. This essay is about **ops posture on a hot path**: graceful drain window for telecom — numbers humans already change verbally in war rooms.
