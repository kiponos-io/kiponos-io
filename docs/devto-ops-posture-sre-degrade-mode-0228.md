---
title: "The Sre War Room Already Knew degradeMode — The Jar Did Not"
published: false
tags: java, sre, devops, kiponos
description: "Live degradation mode via Kiponos Java SDK — sre posture without redeploy."
canonical_url: https://github.com/kiponos-io/kiponos-io/blob/master/docs/devto-ops-posture-sre-degrade-mode-0228.md
main_image: ./devto-cover-ops-posture-sre-degrade-mode-0228.jpg
---
...
Domain: canary, drain, error budget. This essay maps hub key `degradeMode` to **degradation mode** so the lesson stays concrete for sre operators.
...
```java
var policy = kiponos.path("examples", "ops-sre-degrade-mode");
...
1. Name the hub path so humans find it under pressure (`examples/ops-sre-degrade-mode/degradeMode`).  
...
Feature flags are often product gates. This essay is about **ops posture on a hot path**: degradation mode for sre — numbers humans already change verbally in war rooms.
