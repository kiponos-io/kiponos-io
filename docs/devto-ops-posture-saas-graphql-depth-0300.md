---
title: "Graphql Query Depth Should Not Wait for a Redeploy — Saas Live Posture"
published: false
tags: java, saas, architecture, kiponos
description: "Live GraphQL query depth via Kiponos Python SDK — saas posture without redeploy."
canonical_url: https://github.com/kiponos-io/kiponos-io/blob/master/docs/devto-ops-posture-saas-graphql-depth-0300.md
main_image: ./devto-cover-ops-posture-saas-graphql-depth-0300.jpg
---
...
Domain: multi-tenant quotas, feature posture. This essay maps hub key `maxDepth` to **GraphQL query depth** so the lesson stays concrete for saas operators.
...
```python
policy = kiponos.path("examples", "ops-saas-graphql-depth")
...
1. Name the hub path so humans find it under pressure (`examples/ops-saas-graphql-depth/maxDepth`).  
...
Feature flags are often product gates. This essay is about **ops posture on a hot path**: GraphQL query depth for saas — numbers humans already change verbally in war rooms.
