---
title: "We Stopped Shipping Graceful Drain Window as a Constant (Security)"
published: false
tags: java, security, devops, kiponos
description: "Live graceful drain window via Kiponos Java SDK — security posture without redeploy."
canonical_url: https://github.com/kiponos-io/kiponos-io/blob/master/docs/devto-ops-posture-security-drain-ms-1016.md
main_image: ./devto-cover-ops-posture-security-drain-ms-1016.jpg
---
...
Domain: WAF, RPS, auth leeway. This essay maps hub key `gracefulShutdownMs` to **graceful drain window** so the lesson stays concrete for security operators.
...
```java
Folder policy = kiponos.path("examples", "ops-security-drain-ms");
...
1. Name the hub path so humans find it under pressure (`examples/ops-security-drain-ms/gracefulShutdownMs`).  
...
Feature flags are often product gates. This essay is about **ops posture on a hot path**: graceful drain window for security — numbers humans already change verbally in war rooms.
