---
title: "We Stopped Shipping Pricing / Promo Weight as a Constant (Travel)"
published: false
tags: java, travel, architecture, kiponos
description: "Live pricing / promo weight via Kiponos Python SDK — travel posture without redeploy."
canonical_url: https://github.com/kiponos-io/kiponos-io/blob/master/docs/devto-ops-posture-travel-pricing-weight-0126.md
main_image: ./devto-cover-ops-posture-travel-pricing-weight-0126.jpg
---
...
Domain: inventory, overbooking, GDS. This essay maps hub key `weight` to **pricing / promo weight** so the lesson stays concrete for travel operators.
...
```python
policy = kiponos.path("examples", "ops-travel-pricing-weight")
...
1. Name the hub path so humans find it under pressure (`examples/ops-travel-pricing-weight/weight`).  
...
Feature flags are often product gates. This essay is about **ops posture on a hot path**: pricing / promo weight for travel — numbers humans already change verbally in war rooms.
