---
title: "We Stopped Shipping Pricing / Promo Weight as a Constant (Cdn)"
published: false
tags: java, networking, devops, kiponos
description: "Live pricing / promo weight via Kiponos Python SDK — cdn posture without redeploy."
canonical_url: https://github.com/kiponos-io/kiponos-io/blob/master/docs/devto-ops-posture-cdn-pricing-weight-0926.md
main_image: https://files.catbox.moe/ciefqo.jpg
---
...
Domain: edge rules, cache TTL, purge. This essay maps hub key `weight` to **pricing / promo weight** so the lesson stays concrete for cdn operators.
...
```python
policy = kiponos.path("examples", "ops-cdn-pricing-weight")
...
1. Name the hub path so humans find it under pressure (`examples/ops-cdn-pricing-weight/weight`).  
...
Feature flags are often product gates. This essay is about **ops posture on a hot path**: pricing / promo weight for cdn — numbers humans already change verbally in war rooms.
