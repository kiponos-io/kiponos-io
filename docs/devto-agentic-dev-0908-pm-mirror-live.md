---
main_image: https://iili.io/CyJgdtp.jpg
...
canonical_url: https://github.com/kiponos-io/kiponos-io/blob/master/docs/devto-agentic-dev-0908-pm-mirror-live.md
---
...
| Restart MCP host — it is cheap | Cheap until 03:07 ate live device context and the current tool call |
...
```text
examples/agentic-dev-0908-pm-mirror-live/device-live = live
```

Runnable proof: [`examples/java/agentic-dev-0908-pm-mirror-live`](https://github.com/kiponos-io/kiponos-io/tree/master/examples/java/agentic-dev-0908-pm-mirror-live)
...
```yaml
examples/
  agentic-dev-0908-pm-mirror-live/
...
Folder gate = kip.getRootFolder()
        ...
        .folderOrCreate("agentic-dev-0908-pm-mirror-live");
...
try:
    posture = k.get("examples/agentic-dev-0908-pm-mirror-live/device-live", "live")
    if str(posture) == "live":
...
3. `cd examples/java/agentic-dev-0908-pm-mirror-live && cp kiponos.local.env.example kiponos.local.env`
4. `./gradlew test run` — prints `examples/agentic-dev-0908-pm-mirror-live/device-live=...`
...
How to try: `examples/java/agentic-dev-0908-pm-mirror-live` and `./gradlew test`.
