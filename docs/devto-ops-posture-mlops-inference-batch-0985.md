---
title: "Inference Batch Size Should Not Wait for a Redeploy — Mlops Live Posture"
published: false
tags: java, machinelearning, devops, kiponos
description: "Live inference batch size via Kiponos Python SDK — mlops posture without redeploy."
canonical_url: https://github.com/kiponos-io/kiponos-io/blob/master/docs/devto-ops-posture-mlops-inference-batch-0985.md
main_image: ./devto-cover-ops-posture-mlops-inference-batch-0985.jpg
---
...
Domain: batch size, score thresholds. This essay maps hub key `batchSize` to **inference batch size** so the lesson stays concrete for mlops operators.
...
```python
policy = kiponos.path("examples", "ops-mlops-inference-batch")
...
1. Name the hub path so humans find it under pressure (`examples/ops-mlops-inference-batch/batchSize`).  
...
Feature flags are often product gates. This essay is about **ops posture on a hot path**: inference batch size for mlops — numbers humans already change verbally in war rooms.
