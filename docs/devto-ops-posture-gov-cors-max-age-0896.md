---
title: "We Stopped Shipping Cors Max-Age as a Constant (Gov)"
published: false
tags: java, architecture, devops, kiponos
description: "Live CORS max-age via Kiponos Java SDK — gov posture without redeploy."
canonical_url: https://github.com/kiponos-io/kiponos-io/blob/master/docs/devto-ops-posture-gov-cors-max-age-0896.md
main_image: ./devto-cover-ops-posture-gov-cors-max-age-0896.jpg
---
...
Domain: form windows, batch cutoffs. This essay maps hub key `corsMaxAgeSec` to **CORS max-age** so the lesson stays concrete for gov operators.
...
```java
Folder policy = kiponos.path("examples", "ops-gov-cors-max-age");
...
1. Name the hub path so humans find it under pressure (`examples/ops-gov-cors-max-age/corsMaxAgeSec`).  
...
Feature flags are often product gates. This essay is about **ops posture on a hot path**: CORS max-age for gov — numbers humans already change verbally in war rooms.
