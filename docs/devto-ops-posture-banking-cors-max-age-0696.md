---
title: "We Stopped Shipping Cors Max-Age as a Constant (Banking)"
published: false
tags: java, banking, security, kiponos
description: "Live CORS max-age via Kiponos Python SDK — banking posture without redeploy."
canonical_url: https://github.com/kiponos-io/kiponos-io/blob/master/docs/devto-ops-posture-banking-cors-max-age-0696.md
main_image: https://files.catbox.moe/bqnlrm.jpg
---
...
Domain: AML thresholds, transfer velocity. This essay maps hub key `corsMaxAgeSec` to **CORS max-age** so the lesson stays concrete for banking operators.
...
```python
policy = kiponos.path("examples", "ops-banking-cors-max-age")
...
1. Name the hub path so humans find it under pressure (`examples/ops-banking-cors-max-age/corsMaxAgeSec`).  
...
Feature flags are often product gates. This essay is about **ops posture on a hot path**: CORS max-age for banking — numbers humans already change verbally in war rooms.
