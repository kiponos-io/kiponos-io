---
title: "The Mlops War Room Already Knew hpaTarget — The Jar Did Not"
published: false
tags: java, machinelearning, devops, kiponos
description: "Live HPA CPU target percent via Kiponos Java SDK — mlops posture without redeploy."
canonical_url: https://github.com/kiponos-io/kiponos-io/blob/master/docs/devto-ops-posture-mlops-hpa-target-0983.md
main_image: ./devto-cover-ops-posture-mlops-hpa-target-0983.jpg
---
...
Domain: batch size, score thresholds. This essay maps hub key `hpaTarget` to **HPA CPU target percent** so the lesson stays concrete for mlops operators.
...
```java
Folder policy = kiponos.path("examples", "ops-mlops-hpa-target");
...
1. Name the hub path so humans find it under pressure (`examples/ops-mlops-hpa-target/hpaTarget`).  
...
Feature flags are often product gates. This essay is about **ops posture on a hot path**: HPA CPU target percent for mlops — numbers humans already change verbally in war rooms.
