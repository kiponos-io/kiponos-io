---
title: "Canary Traffic Share Should Not Wait for a Redeploy — Telecom Live Posture"
published: false
tags: java, telecom, sre, kiponos
description: "Live canary traffic share via Kiponos Java SDK — telecom posture without redeploy."
canonical_url: https://github.com/kiponos-io/kiponos-io/blob/master/docs/devto-ops-posture-telecom-canary-percent-0510.md
main_image: ./devto-cover-ops-posture-telecom-canary-percent-0510.jpg
---
...
Domain: QoS, rate classes, trunk limits. This essay maps hub key `canaryPercent` to **canary traffic share** so the lesson stays concrete for telecom operators.
...
```java
var policy = kiponos.path("examples", "ops-telecom-canary-percent");
...
1. Name the hub path so humans find it under pressure (`examples/ops-telecom-canary-percent/canaryPercent`).  
...
Feature flags are often product gates. This essay is about **ops posture on a hot path**: canary traffic share for telecom — numbers humans already change verbally in war rooms.
