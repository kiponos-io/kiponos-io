---
title: "We Stopped Shipping Consumer Prefetch as a Constant (Travel)"
published: false
tags: java, travel, architecture, kiponos
description: "Live consumer prefetch via Kiponos Java SDK — travel posture without redeploy."
canonical_url: https://github.com/kiponos-io/kiponos-io/blob/master/docs/devto-ops-posture-travel-queue-prefetch-0106.md
main_image: ./devto-cover-ops-posture-travel-queue-prefetch-0106.jpg
---
...
Domain: inventory, overbooking, GDS. This essay maps hub key `prefetch` to **consumer prefetch** so the lesson stays concrete for travel operators.
...
```java
Folder policy = kiponos.path("examples", "ops-travel-queue-prefetch");
...
1. Name the hub path so humans find it under pressure (`examples/ops-travel-queue-prefetch/prefetch`).  
...
Feature flags are often product gates. This essay is about **ops posture on a hot path**: consumer prefetch for travel — numbers humans already change verbally in war rooms.
