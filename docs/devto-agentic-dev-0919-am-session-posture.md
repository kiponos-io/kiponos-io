---
main_image: https://iili.io/CyBexfV.jpg
...
canonical_url: https://github.com/kiponos-io/kiponos-io/blob/master/docs/devto-agentic-dev-0919-am-session-posture.md
---
...
```text
examples/agentic-dev-0919-am-session-posture/session-posture = shared
```

Runnable proof: [`examples/java/agentic-dev-0919-am-session-posture`](https://github.com/kiponos-io/kiponos-io/tree/master/examples/java/agentic-dev-0919-am-session-posture)
...
```yaml
examples/
  agentic-dev-0919-am-session-posture/
...
Folder gate = kip.getRootFolder()
        ...
        .folderOrCreate("agentic-dev-0919-am-session-posture");
...
try:
    posture = k.get("examples/agentic-dev-0919-am-session-posture/session-posture", "shared")
...
3. `cd examples/java/agentic-dev-0919-am-session-posture && cp kiponos.local.env.example kiponos.local.env`
4. `./gradlew test run` — prints `examples/agentic-dev-0919-am-session-posture/session-posture=...`
...
How to try: `examples/java/agentic-dev-0919-am-session-posture` and `./gradlew test`.
