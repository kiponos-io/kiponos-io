---
main_image: https://d.uguu.se/RVekOxnX.jpg
...
canonical_url: https://github.com/kiponos-io/kiponos-io/blob/master/docs/devto-agentic-dev-1101-pm-mcp-gate.md
---
...
```text
examples/agentic-dev-1101-pm-mcp-gate/tools-allow = search,read
```

Runnable proof: [`examples/java/agentic-dev-1101-pm-mcp-gate`](https://github.com/kiponos-io/kiponos-io/tree/master/examples/java/agentic-dev-1101-pm-mcp-gate)
...
Folder gate = kip.getRootFolder()
        ...
        .folderOrCreate("agentic-dev-1101-pm-mcp-gate");
...
try:
    posture = k.get("examples/agentic-dev-1101-pm-mcp-gate/tools-allow", "search,read")
...
3. `cd examples/java/agentic-dev-1101-pm-mcp-gate && cp kiponos.local.env.example kiponos.local.env`
4. `./gradlew test run` — prints `examples/agentic-dev-1101-pm-mcp-gate/tools-allow=...`
...
How to try: `examples/java/agentic-dev-1101-pm-mcp-gate` and `./gradlew test`.
