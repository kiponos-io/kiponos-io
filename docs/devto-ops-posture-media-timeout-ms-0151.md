---
title: "We Stopped Shipping Outbound Call Timeout as a Constant (Media)"
published: false
tags: java, streaming, devops, kiponos
description: "Live outbound call timeout via Kiponos Java SDK — media posture without redeploy."
canonical_url: https://github.com/kiponos-io/kiponos-io/blob/master/docs/devto-ops-posture-media-timeout-ms-0151.md
main_image: ./devto-cover-ops-posture-media-timeout-ms-0151.jpg
---
...
Domain: bitrate, CDN, origin. This essay maps hub key `timeoutMs` to **outbound call timeout** so the lesson stays concrete for media operators.
...
```java
var policy = kiponos.path("examples", "ops-media-timeout-ms");
...
1. Name the hub path so humans find it under pressure (`examples/ops-media-timeout-ms/timeoutMs`).  
...
Feature flags are often product gates. This essay is about **ops posture on a hot path**: outbound call timeout for media — numbers humans already change verbally in war rooms.
