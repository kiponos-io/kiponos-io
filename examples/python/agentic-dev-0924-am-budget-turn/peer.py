...
Hub: examples/agentic-dev-0924-am-budget-turn/max-tokens (default 8000)
...
KEY = "max-tokens"
DEFAULT = "8000"
PATH = "examples/agentic-dev-0924-am-budget-turn/max-tokens"
...
def _live(d: dict) -> None:
    ...
    try:
        k.ensure_path("examples/agentic-dev-0924-am-budget-turn")
