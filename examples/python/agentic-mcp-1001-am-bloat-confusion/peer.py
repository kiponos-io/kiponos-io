...
Hub: examples/agentic-mcp-1001-am-bloat-confusion/schema-budget (default 4000)
...
KEY = "schema-budget"
DEFAULT = "4000"
PATH = "examples/agentic-mcp-1001-am-bloat-confusion/schema-budget"
...
def decide(value: str | None) -> dict:
    ...
    try:
        ...
        cap = 4000
    proceed = cap > 0
    return {"path": PATH, "key": KEY, "value": str(cap), "action": "schema_within_budget" if proceed else "schema_dump_blocked", "proceed": proceed, "peers": PEERS}
...
def _live(d: dict) -> None:
    ...
    try:
        k.ensure_path("examples/agentic-mcp-1001-am-bloat-confusion")
