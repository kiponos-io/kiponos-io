...
Hub: examples/agentic-med-0908-mi-admin-wall/wall-focus (default checkout)
...
KEY = "wall-focus"
DEFAULT = "checkout"
PATH = "examples/agentic-med-0908-mi-admin-wall/wall-focus"
...
def decide(value: str | None) -> dict:
    v = normalize(value)
    proceed = bool(v) and v.lower() != "idle"
    return {"path": PATH, "key": KEY, "value": v, "action": "admin_wall_focus" if proceed else "admin_wall_idle", "proceed": proceed, "peers": PEERS}
...
def _live(d: dict) -> None:
    ...
    try:
        k.ensure_path("examples/agentic-med-0908-mi-admin-wall")
