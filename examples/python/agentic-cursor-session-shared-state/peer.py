...
Hub: examples/agentic-cursor-session-shared-state/session-posture (default focus=admin-wall,shopping-pause=off)
...
PATH = "examples/agentic-cursor-session-shared-state/session-posture"
...
def _live(d: dict) -> None:
    ...
    try:
        k.ensure_path("examples/agentic-cursor-session-shared-state")
