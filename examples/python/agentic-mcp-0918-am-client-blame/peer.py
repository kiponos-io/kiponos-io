...
Hub: examples/agentic-mcp-0918-am-client-blame/tool-search (default on)
...
KEY = "tool-search"
DEFAULT = "on"
PATH = "examples/agentic-mcp-0918-am-client-blame/tool-search"
...
def _live(d: dict) -> None:
    ...
    try:
        k.ensure_path("examples/agentic-mcp-0918-am-client-blame")
