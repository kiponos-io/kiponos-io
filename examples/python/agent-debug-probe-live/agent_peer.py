"""Python agent peer for agent-debug-probe-live.

Reads/writes examples/agent-debug-probe-live/verbose live via Kiponos Python SDK.
...
KEY = "verbose"
DEFAULT = "off"
FOLDER = ("examples", "agent-debug-probe-live")
...
def main() -> None:
    ...
    try:
        ...
        print(f"agent peer online; leaf examples/agent-debug-probe-live/{KEY} default={DEFAULT}")
