...
Hub: examples/agentic-med-1008-af-mcp-gate/tools-allow (default search,read)
...
KEY = "tools-allow"
DEFAULT = "search,read"
PATH = "examples/agentic-med-1008-af-mcp-gate/tools-allow"
...
def _live(d: dict) -> None:
    ...
    try:
        k.ensure_path("examples/agentic-med-1008-af-mcp-gate")
