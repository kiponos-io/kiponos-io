"""Python agent peer for quad-sdk-live-mesh.

Reads/writes examples/quad-sdk-live-mesh/mode live via Kiponos Python SDK.
...
KEY = "mode"
DEFAULT = "steady"
FOLDER = ("examples", "quad-sdk-live-mesh")
...
def main() -> None:
    ...
    try:
        ...
        print(f"agent peer online; leaf examples/quad-sdk-live-mesh/{KEY} default={DEFAULT}")
