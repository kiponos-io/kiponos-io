...
Hub: examples/agentic-mcp-0911-am-zombie-drain/mcp-drain (default off)
...
KEY = "mcp-drain"
DEFAULT = "off"
PATH = "examples/agentic-mcp-0911-am-zombie-drain/mcp-drain"
...
def _live(d: dict) -> None:
    ...
    try:
        k.ensure_path("examples/agentic-mcp-0911-am-zombie-drain")
