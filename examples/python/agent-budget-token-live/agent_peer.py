"""Python agent peer for agent-budget-token-live.

Reads/writes examples/agent-budget-token-live/max-tokens-per-turn live via Kiponos Python SDK.
...
KEY = "max-tokens-per-turn"
DEFAULT = "4000"
FOLDER = ("examples", "agent-budget-token-live")
...
def main() -> None:
    ...
    try:
        ...
        print(f"agent peer online; leaf examples/agent-budget-token-live/{KEY} default={DEFAULT}")
