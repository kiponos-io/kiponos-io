...
Hub: examples/agentic-mcp-0916-am-argv-frozen/tools-allow (default search,read)
...
KEY = "tools-allow"
DEFAULT = "search,read"
PATH = "examples/agentic-mcp-0916-am-argv-frozen/tools-allow"
...
def _live(d: dict) -> None:
    ...
    try:
        k.ensure_path("examples/agentic-mcp-0916-am-argv-frozen")
