...
Hub: examples/agentic-dev-0902-pm-mcp-gate/tools-allow (default search,read)
...
KEY = "tools-allow"
DEFAULT = "search,read"
PATH = "examples/agentic-dev-0902-pm-mcp-gate/tools-allow"
...
def _live(d: dict) -> None:
    ...
    try:
        k.ensure_path("examples/agentic-dev-0902-pm-mcp-gate")
