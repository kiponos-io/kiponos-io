...
Hub: examples/agentic-dev-1025-am-skill-enable/enabled-set (default research,notify)
...
PATH = "examples/agentic-dev-1025-am-skill-enable/enabled-set"
...
def _live(d: dict) -> None:
    ...
    try:
        k.ensure_path("examples/agentic-dev-1025-am-skill-enable")
