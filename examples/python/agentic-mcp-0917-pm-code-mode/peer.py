...
Hub: examples/agentic-mcp-0917-pm-code-mode/code-mode (default off)
...
KEY = "code-mode"
DEFAULT = "off"
PATH = "examples/agentic-mcp-0917-pm-code-mode/code-mode"
...
def decide(value: str | None) -> dict:
    ...
    return {"path": PATH, "key": KEY, "value": v, "action": "code_mode_on" if live else "schema_dump_mode", "proceed": live, "peers": PEERS}
...
def _live(d: dict) -> None:
    ...
    try:
        k.ensure_path("examples/agentic-mcp-0917-pm-code-mode")
