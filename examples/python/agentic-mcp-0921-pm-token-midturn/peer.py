...
Hub: examples/agentic-mcp-0921-pm-token-midturn/max-tokens (default 8000)
...
KEY = "max-tokens"
DEFAULT = "8000"
PATH = "examples/agentic-mcp-0921-pm-token-midturn/max-tokens"
...
def _live(d: dict) -> None:
    ...
    try:
        k.ensure_path("examples/agentic-mcp-0921-pm-token-midturn")
