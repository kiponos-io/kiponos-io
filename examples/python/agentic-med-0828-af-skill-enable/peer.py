...
Hub: examples/agentic-med-0828-af-skill-enable/enabled-set (default research,notify)
...
PATH = "examples/agentic-med-0828-af-skill-enable/enabled-set"
...
def _live(d: dict) -> None:
    ...
    try:
        k.ensure_path("examples/agentic-med-0828-af-skill-enable")
