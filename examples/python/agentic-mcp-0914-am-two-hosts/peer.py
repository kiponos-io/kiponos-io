...
Hub: examples/agentic-mcp-0914-am-two-hosts/session-posture (default focus=admin-wall,shopping-pause=off)
...
PATH = "examples/agentic-mcp-0914-am-two-hosts/session-posture"
...
def _live(d: dict) -> None:
    ...
    try:
        k.ensure_path("examples/agentic-mcp-0914-am-two-hosts")
