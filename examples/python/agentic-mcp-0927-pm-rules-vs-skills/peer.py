...
Hub: examples/agentic-mcp-0927-pm-rules-vs-skills/enabled-set (default research,notify)
...
PATH = "examples/agentic-mcp-0927-pm-rules-vs-skills/enabled-set"
...
def _live(d: dict) -> None:
    ...
    try:
        k.ensure_path("examples/agentic-mcp-0927-pm-rules-vs-skills")
