...
Hub: examples/agentic-mcp-0930-pm-plugin-vs-hub/enabled-set (default research,notify)
...
PATH = "examples/agentic-mcp-0930-pm-plugin-vs-hub/enabled-set"
...
def _live(d: dict) -> None:
    ...
    try:
        k.ensure_path("examples/agentic-mcp-0930-pm-plugin-vs-hub")
