...
Hub: examples/agentic-dev-1007-pm-shopping-pause/incident-pause (default off)
...
KEY = "incident-pause"
DEFAULT = "off"
PATH = "examples/agentic-dev-1007-pm-shopping-pause/incident-pause"
...
def _live(d: dict) -> None:
    ...
    try:
        k.ensure_path("examples/agentic-dev-1007-pm-shopping-pause")
