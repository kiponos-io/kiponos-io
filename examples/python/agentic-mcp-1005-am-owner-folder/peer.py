...
Hub: examples/agentic-mcp-1005-am-owner-folder/owner-agent (default travel-coordinator)
...
PATH = "examples/agentic-mcp-1005-am-owner-folder/owner-agent"
...
def _live(d: dict) -> None:
    ...
    try:
        k.ensure_path("examples/agentic-mcp-1005-am-owner-folder")
