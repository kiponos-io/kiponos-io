...
Hub: examples/agentic-mcp-0928-am-parallel-stale/inherit-posture (default on)
...
KEY = "inherit-posture"
DEFAULT = "on"
PATH = "examples/agentic-mcp-0928-am-parallel-stale/inherit-posture"
...
def _live(d: dict) -> None:
    ...
    try:
        k.ensure_path("examples/agentic-mcp-0928-am-parallel-stale")
