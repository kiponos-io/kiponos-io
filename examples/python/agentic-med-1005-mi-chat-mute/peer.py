...
Hub: examples/agentic-med-1005-mi-chat-mute/chat-mute (default none)
...
KEY = "chat-mute"
DEFAULT = "none"
PATH = "examples/agentic-med-1005-mi-chat-mute/chat-mute"
...
def _live(d: dict) -> None:
    ...
    try:
        k.ensure_path("examples/agentic-med-1005-mi-chat-mute")
