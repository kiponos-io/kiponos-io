...
Hub: examples/agentic-mcp-0915-am-execute-gate/execute-gate (default plan)
...
KEY = "execute-gate"
DEFAULT = "plan"
PATH = "examples/agentic-mcp-0915-am-execute-gate/execute-gate"
...
def decide(value: str | None) -> dict:
    ...
    return {"path": PATH, "key": KEY, "value": v, "action": "execute_allowed" if proceed else "stay_in_plan", "proceed": proceed, "peers": PEERS}
...
def _live(d: dict) -> None:
    ...
    try:
        k.ensure_path("examples/agentic-mcp-0915-am-execute-gate")
