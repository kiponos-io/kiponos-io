...
Hub: examples/agentic-mcp-1004-pm-streaming-noise/result-cap (default 2000)
...
KEY = "result-cap"
DEFAULT = "2000"
PATH = "examples/agentic-mcp-1004-pm-streaming-noise/result-cap"
...
def _live(d: dict) -> None:
    ...
    try:
        k.ensure_path("examples/agentic-mcp-1004-pm-streaming-noise")
