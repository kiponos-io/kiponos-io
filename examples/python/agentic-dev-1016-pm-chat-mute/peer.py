...
Hub: examples/agentic-dev-1016-pm-chat-mute/chat-mute (default none)
...
KEY = "chat-mute"
DEFAULT = "none"
PATH = "examples/agentic-dev-1016-pm-chat-mute/chat-mute"
...
def _live(d: dict) -> None:
    ...
    try:
        k.ensure_path("examples/agentic-dev-1016-pm-chat-mute")
