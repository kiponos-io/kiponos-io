...
Hub: examples/agentic-med-0909-af-sense-priority/priority (default P3)
...
KEY = "priority"
DEFAULT = "P3"
PATH = "examples/agentic-med-0909-af-sense-priority/priority"
...
def _live(d: dict) -> None:
    ...
    try:
        k.ensure_path("examples/agentic-med-0909-af-sense-priority")
