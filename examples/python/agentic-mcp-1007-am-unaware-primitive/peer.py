...
Hub: examples/agentic-mcp-1007-am-unaware-primitive/shared-truth (default live)
...
KEY = "shared-truth"
DEFAULT = "live"
PATH = "examples/agentic-mcp-1007-am-unaware-primitive/shared-truth"
...
def _live(d: dict) -> None:
    ...
    try:
        k.ensure_path("examples/agentic-mcp-1007-am-unaware-primitive")
