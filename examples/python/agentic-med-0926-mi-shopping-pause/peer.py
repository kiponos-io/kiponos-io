...
Hub: examples/agentic-med-0926-mi-shopping-pause/incident-pause (default off)
...
KEY = "incident-pause"
DEFAULT = "off"
PATH = "examples/agentic-med-0926-mi-shopping-pause/incident-pause"
...
def _live(d: dict) -> None:
    ...
    try:
        k.ensure_path("examples/agentic-med-0926-mi-shopping-pause")
