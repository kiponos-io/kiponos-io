...
Hub: examples/agentic-mcp-0923-pm-lazy-schema/schema-budget (default 4000)
...
KEY = "schema-budget"
DEFAULT = "4000"
PATH = "examples/agentic-mcp-0923-pm-lazy-schema/schema-budget"
...
def _live(d: dict) -> None:
    ...
    try:
        k.ensure_path("examples/agentic-mcp-0923-pm-lazy-schema")
