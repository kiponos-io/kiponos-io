...
Hub: examples/agentic-dev-0912-am-mirror-live/device-live (default yes)
...
KEY = "device-live"
DEFAULT = "yes"
PATH = "examples/agentic-dev-0912-am-mirror-live/device-live"
...
def _live(d: dict) -> None:
    ...
    try:
        k.ensure_path("examples/agentic-dev-0912-am-mirror-live")
