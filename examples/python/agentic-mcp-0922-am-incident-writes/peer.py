...
Hub: examples/agentic-mcp-0922-am-incident-writes/incident-pause (default off)
...
KEY = "incident-pause"
DEFAULT = "off"
PATH = "examples/agentic-mcp-0922-am-incident-writes/incident-pause"
...
def _live(d: dict) -> None:
    ...
    try:
        k.ensure_path("examples/agentic-mcp-0922-am-incident-writes")
