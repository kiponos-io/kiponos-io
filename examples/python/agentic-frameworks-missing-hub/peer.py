...
Hub: examples/agentic-frameworks-missing-hub/shared-truth (default live)
...
KEY = "shared-truth"
DEFAULT = "live"
PATH = "examples/agentic-frameworks-missing-hub/shared-truth"
...
def _live(d: dict) -> None:
    ...
    try:
        k.ensure_path("examples/agentic-frameworks-missing-hub")
