...
Hub: examples/agentic-travel-group-chat-live/chat-mute (default none)
...
KEY = "chat-mute"
DEFAULT = "none"
PATH = "examples/agentic-travel-group-chat-live/chat-mute"
...
def _live(d: dict) -> None:
    ...
    try:
        k.ensure_path("examples/agentic-travel-group-chat-live")
