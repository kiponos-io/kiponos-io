...
Hub: examples/agentic-mcp-0913-pm-llm-skill-budget/skill-budget (default on)
...
KEY = "skill-budget"
DEFAULT = "on"
PATH = "examples/agentic-mcp-0913-pm-llm-skill-budget/skill-budget"
...
def decide(value: str | None) -> dict:
    ...
    return {"path": PATH, "key": KEY, "value": v, "action": "generated_skills_blocked" if paused else "generated_skills_ok", "proceed": not paused, "peers": PEERS}
...
def _live(d: dict) -> None:
    ...
    try:
        k.ensure_path("examples/agentic-mcp-0913-pm-llm-skill-budget")
