...
Hub: examples/agentic-mcp-1001-pm-exact-count/result-cap (default 2000)
...
KEY = "result-cap"
DEFAULT = "2000"
PATH = "examples/agentic-mcp-1001-pm-exact-count/result-cap"
...
def decide(value: str | None) -> dict:
    ...
    try:
        ...
        cap = 2000
    proceed = cap > 0
    return {"path": PATH, "key": KEY, "value": str(cap), "action": "result_projected" if proceed else "result_too_fat", "proceed": proceed, "peers": PEERS}
...
def _live(d: dict) -> None:
    ...
    try:
        k.ensure_path("examples/agentic-mcp-1001-pm-exact-count")
