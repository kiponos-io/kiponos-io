...
Hub: examples/agentic-med-1026-af-budget-turn/max-tokens (default 8000)
...
KEY = "max-tokens"
DEFAULT = "8000"
PATH = "examples/agentic-med-1026-af-budget-turn/max-tokens"
...
def _live(d: dict) -> None:
    ...
    try:
        k.ensure_path("examples/agentic-med-1026-af-budget-turn")
