...
Hub: examples/agentic-mcp-1007-pm-turn-clock/max-tokens (default 8000)
...
KEY = "max-tokens"
DEFAULT = "8000"
PATH = "examples/agentic-mcp-1007-pm-turn-clock/max-tokens"
...
def _live(d: dict) -> None:
    ...
    try:
        k.ensure_path("examples/agentic-mcp-1007-pm-turn-clock")
