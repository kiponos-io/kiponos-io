...
Hub: examples/agentic-mcp-0912-am-skill-once/enabled-set (default research,notify)
...
PATH = "examples/agentic-mcp-0912-am-skill-once/enabled-set"
...
def _live(d: dict) -> None:
    ...
    try:
        k.ensure_path("examples/agentic-mcp-0912-am-skill-once")
