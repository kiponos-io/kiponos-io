...
Hub: examples/agentic-med-1001-mi-mcp-gate/tools-allow (default search,read)
Product: shopping · Agent host: Claude Code
...
KEY = "tools-allow"
DEFAULT = "search,read"
PATH = "examples/agentic-med-1001-mi-mcp-gate/tools-allow"
...
def decide(value: str | None) -> dict:
    ...
    proceed = "write" not in parts
    return {"path": PATH, "key": KEY, "value": v, "action": "allow_listed_tools" if proceed else "deny_write_no_mcp_restart", "proceed": proceed, "peers": PEERS}
...
def _live(d: dict) -> None:
    ...
    try:
        k.ensure_path("examples/agentic-med-1001-mi-mcp-gate")
