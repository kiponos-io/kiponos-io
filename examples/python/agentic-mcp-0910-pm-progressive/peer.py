...
Hub: examples/agentic-mcp-0910-pm-progressive/tool-search (default on)
...
KEY = "tool-search"
DEFAULT = "on"
PATH = "examples/agentic-mcp-0910-pm-progressive/tool-search"
...
def _live(d: dict) -> None:
    ...
    try:
        k.ensure_path("examples/agentic-mcp-0910-pm-progressive")
