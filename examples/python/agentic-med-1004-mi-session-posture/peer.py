...
Hub: examples/agentic-med-1004-mi-session-posture/session-posture (default focus=admin-wall,shopping-pause=off)
...
PATH = "examples/agentic-med-1004-mi-session-posture/session-posture"
...
def _live(d: dict) -> None:
    ...
    try:
        k.ensure_path("examples/agentic-med-1004-mi-session-posture")
