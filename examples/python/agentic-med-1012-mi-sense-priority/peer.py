...
Hub: examples/agentic-med-1012-mi-sense-priority/priority (default P3)
...
KEY = "priority"
DEFAULT = "P3"
PATH = "examples/agentic-med-1012-mi-sense-priority/priority"
...
def _live(d: dict) -> None:
    ...
    try:
        k.ensure_path("examples/agentic-med-1012-mi-sense-priority")
