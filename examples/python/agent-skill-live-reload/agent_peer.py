"""Python agent peer for agent-skill-live-reload.

Reads/writes examples/agent-skill-live-reload/enabled-set live via Kiponos Python SDK.
...
FOLDER = ("examples", "agent-skill-live-reload")
...
def main() -> None:
    ...
    try:
        ...
        print(f"agent peer online; leaf examples/agent-skill-live-reload/{KEY} default={DEFAULT}")
