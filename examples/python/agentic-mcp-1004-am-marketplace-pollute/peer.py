...
Hub: examples/agentic-mcp-1004-am-marketplace-pollute/skill-trust (default core,reviewed)
...
KEY = "skill-trust"
DEFAULT = "core,reviewed"
PATH = "examples/agentic-mcp-1004-am-marketplace-pollute/skill-trust"
...
def decide(value: str | None) -> dict:
    v = normalize(value)
    proceed = bool(v)
    return {"path": PATH, "key": KEY, "value": v, "action": "honor_trusted_skills" if proceed else "skill_not_trusted", "proceed": proceed, "peers": PEERS}
...
def _live(d: dict) -> None:
    ...
    try:
        k.ensure_path("examples/agentic-mcp-1004-am-marketplace-pollute")
