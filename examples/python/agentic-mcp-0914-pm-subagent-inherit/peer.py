...
Hub: examples/agentic-mcp-0914-pm-subagent-inherit/inherit-posture (default on)
...
KEY = "inherit-posture"
DEFAULT = "on"
PATH = "examples/agentic-mcp-0914-pm-subagent-inherit/inherit-posture"
...
def decide(value: str | None) -> dict:
    ...
    return {"path": PATH, "key": KEY, "value": v, "action": "child_reads_hub" if live else "child_frozen_argv", "proceed": live, "peers": PEERS}
...
def _live(d: dict) -> None:
    ...
    try:
        k.ensure_path("examples/agentic-mcp-0914-pm-subagent-inherit")
