...
Hub: examples/agentic-mcp-0913-am-skill-trust/skill-trust (default core,reviewed)
...
PATH = "examples/agentic-mcp-0913-am-skill-trust/skill-trust"
...
def _live(d: dict) -> None:
    ...
    try:
        k.ensure_path("examples/agentic-mcp-0913-am-skill-trust")
