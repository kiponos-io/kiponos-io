...
Hub: examples/agentic-dev-1023-pm-sense-priority/priority (default P3)
...
KEY = "priority"
DEFAULT = "P3"
PATH = "examples/agentic-dev-1023-pm-sense-priority/priority"
...
def _live(d: dict) -> None:
    ...
    try:
        k.ensure_path("examples/agentic-dev-1023-pm-sense-priority")
