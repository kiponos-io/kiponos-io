...
Hub: examples/agentic-mcp-0922-pm-sense-stale/priority (default P3)
...
KEY = "priority"
DEFAULT = "P3"
PATH = "examples/agentic-mcp-0922-pm-sense-stale/priority"
...
def _live(d: dict) -> None:
    ...
    try:
        k.ensure_path("examples/agentic-mcp-0922-pm-sense-stale")
