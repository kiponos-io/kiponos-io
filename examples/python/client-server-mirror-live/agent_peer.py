"""Python agent peer for client-server-mirror-live.

Reads/writes examples/client-server-mirror-live/status live via Kiponos Python SDK.
...
KEY = "status"
DEFAULT = "ok"
FOLDER = ("examples", "client-server-mirror-live")
...
def main() -> None:
    ...
    try:
        ...
        print(f"agent peer online; leaf examples/client-server-mirror-live/{KEY} default={DEFAULT}")
