...
Hub: examples/agentic-mcp-0910-am-result-cap/result-cap (default 2000)
...
KEY = "result-cap"
DEFAULT = "2000"
PATH = "examples/agentic-mcp-0910-am-result-cap/result-cap"
...
def _live(d: dict) -> None:
    ...
    try:
        k.ensure_path("examples/agentic-mcp-0910-am-result-cap")
