...
Hub: examples/agentic-med-1025-af-admin-wall/wall-focus (default checkout)
...
KEY = "wall-focus"
DEFAULT = "checkout"
PATH = "examples/agentic-med-1025-af-admin-wall/wall-focus"
...
def _live(d: dict) -> None:
    ...
    try:
        k.ensure_path("examples/agentic-med-1025-af-admin-wall")
