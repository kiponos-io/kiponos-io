...
Hub: examples/agentic-mcp-0912-pm-skill-vs-mcp/shared-truth (default live)
...
KEY = "shared-truth"
DEFAULT = "live"
PATH = "examples/agentic-mcp-0912-pm-skill-vs-mcp/shared-truth"
...
def _live(d: dict) -> None:
    ...
    try:
        k.ensure_path("examples/agentic-mcp-0912-pm-skill-vs-mcp")
