...
Hub: examples/agentic-mcp-0915-pm-cancel-mcp/cancel-token (default off)
...
KEY = "cancel-token"
DEFAULT = "off"
PATH = "examples/agentic-mcp-0915-pm-cancel-mcp/cancel-token"
...
def decide(value: str | None) -> dict:
    ...
    return {"path": PATH, "key": KEY, "value": v, "action": "cancel_mcp_task" if paused else "mcp_task_live", "proceed": not paused, "peers": PEERS}
...
def _live(d: dict) -> None:
    ...
    try:
        k.ensure_path("examples/agentic-mcp-0915-pm-cancel-mcp")
