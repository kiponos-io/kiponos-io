...
Hub: examples/agentic-dev-1005-pm-session-posture/session-posture (default focus=admin-wall,shopping-pause=off)
...
PATH = "examples/agentic-dev-1005-pm-session-posture/session-posture"
...
def _live(d: dict) -> None:
    ...
    try:
        k.ensure_path("examples/agentic-dev-1005-pm-session-posture")
