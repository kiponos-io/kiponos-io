...
Hub: examples/agentic-mcp-0927-am-install-this-week/tools-allow (default search,read)
...
KEY = "tools-allow"
DEFAULT = "search,read"
PATH = "examples/agentic-mcp-0927-am-install-this-week/tools-allow"
...
def _live(d: dict) -> None:
    ...
    try:
        k.ensure_path("examples/agentic-mcp-0927-am-install-this-week")
