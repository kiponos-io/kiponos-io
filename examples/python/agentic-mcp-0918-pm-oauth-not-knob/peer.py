...
Hub: examples/agentic-mcp-0918-pm-oauth-not-knob/session-posture (default focus=admin-wall,shopping-pause=off)
...
PATH = "examples/agentic-mcp-0918-pm-oauth-not-knob/session-posture"
...
def _live(d: dict) -> None:
    ...
    try:
        k.ensure_path("examples/agentic-mcp-0918-pm-oauth-not-knob")
