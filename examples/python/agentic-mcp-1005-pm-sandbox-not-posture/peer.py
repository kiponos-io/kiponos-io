...
Hub: examples/agentic-mcp-1005-pm-sandbox-not-posture/execute-gate (default plan)
...
KEY = "execute-gate"
DEFAULT = "plan"
PATH = "examples/agentic-mcp-1005-pm-sandbox-not-posture/execute-gate"
...
def _live(d: dict) -> None:
    ...
    try:
        k.ensure_path("examples/agentic-mcp-1005-pm-sandbox-not-posture")
