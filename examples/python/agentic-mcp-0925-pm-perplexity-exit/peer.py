...
Hub: examples/agentic-mcp-0925-pm-perplexity-exit/shared-truth (default live)
...
KEY = "shared-truth"
DEFAULT = "live"
PATH = "examples/agentic-mcp-0925-pm-perplexity-exit/shared-truth"
...
def _live(d: dict) -> None:
    ...
    try:
        k.ensure_path("examples/agentic-mcp-0925-pm-perplexity-exit")
