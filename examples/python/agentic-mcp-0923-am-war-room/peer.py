...
Hub: examples/agentic-mcp-0923-am-war-room/session-posture (default focus=admin-wall,shopping-pause=off)
...
PATH = "examples/agentic-mcp-0923-am-war-room/session-posture"
...
def _live(d: dict) -> None:
    ...
    try:
        k.ensure_path("examples/agentic-mcp-0923-am-war-room")
