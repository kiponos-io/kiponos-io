...
Hub: examples/agentic-mcp-1003-pm-claude-tool-search/tool-search (default on)
...
KEY = "tool-search"
DEFAULT = "on"
PATH = "examples/agentic-mcp-1003-pm-claude-tool-search/tool-search"
...
def decide(value: str | None) -> dict:
    ...
    return {"path": PATH, "key": KEY, "value": v, "action": "defer_schemas" if live else "dump_all_schemas", "proceed": live, "peers": PEERS}
...
def _live(d: dict) -> None:
    ...
    try:
        k.ensure_path("examples/agentic-mcp-1003-pm-claude-tool-search")
