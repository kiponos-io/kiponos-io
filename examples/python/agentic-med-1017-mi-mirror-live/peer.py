...
Hub: examples/agentic-med-1017-mi-mirror-live/device-live (default yes)
...
KEY = "device-live"
DEFAULT = "yes"
PATH = "examples/agentic-med-1017-mi-mirror-live/device-live"
...
def _live(d: dict) -> None:
    ...
    try:
        k.ensure_path("examples/agentic-med-1017-mi-mirror-live")
