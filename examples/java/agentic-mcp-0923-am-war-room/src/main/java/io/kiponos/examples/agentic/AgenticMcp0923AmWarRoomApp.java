 ...
 * Hub leaf: examples/agentic-mcp-0923-am-war-room/session-posture (default focus=admin-wall,shopping-pause=off)
...
public final class AgenticMcp0923AmWarRoomApp {
    ...
    public static void main(String[] args) throws Exception {
        ...
        try {
            ...
            k.afterValueUpdated((ConfigValUpdatedResponse ev) -> {
                ...
                // live leaf examples/agentic-mcp-0923-am-war-room — next decide() is in-memory, no MCP restart
            });
    ...
    private AgenticMcp0923AmWarRoomApp() {}
}
