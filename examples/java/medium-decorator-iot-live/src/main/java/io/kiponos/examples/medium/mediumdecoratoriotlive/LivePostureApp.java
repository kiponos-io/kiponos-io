package io.kiponos.examples.medium.mediumdecoratoriotlive;
 ...
 * Tree: examples / medium-decorator-iot-live / active
...
public final class LivePostureApp {
    public static void main(String[] args) throws Exception {
        ...
        try {
            ...
            System.out.println("  example: medium-decorator-iot-live");
    ...
    static Folder ensure(Kiponos k) {
        Folder f = k.getRootFolder().folderOrCreate("examples").folderOrCreate("medium-decorator-iot-live");
        if (!f.hasKey("active")) {
