package io.kiponos.examples.medium.mediumstrategysaaslive;
 ...
 * Tree: examples / medium-strategy-saas-live / active
...
public final class LivePostureApp {
    public static void main(String[] args) throws Exception {
        ...
        try {
            ...
            System.out.println("  example: medium-strategy-saas-live");
    ...
    static Folder ensure(Kiponos k) {
        Folder f = k.getRootFolder().folderOrCreate("examples").folderOrCreate("medium-strategy-saas-live");
        if (!f.hasKey("active")) {
