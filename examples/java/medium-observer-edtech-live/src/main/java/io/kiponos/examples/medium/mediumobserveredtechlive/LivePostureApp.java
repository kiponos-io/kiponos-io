package io.kiponos.examples.medium.mediumobserveredtechlive;
 ...
 * Tree: examples / medium-observer-edtech-live / active
...
public final class LivePostureApp {
    public static void main(String[] args) throws Exception {
        ...
        try {
            ...
            System.out.println("  example: medium-observer-edtech-live");
    ...
    static Folder ensure(Kiponos k) {
        Folder f = k.getRootFolder().folderOrCreate("examples").folderOrCreate("medium-observer-edtech-live");
        if (!f.hasKey("active")) {
