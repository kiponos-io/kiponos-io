 ...
 * Hub leaf: examples/agentic-mcp-0915-am-execute-gate/execute-gate (default plan)
 ...
 */
public final class AgenticMcp0915AmExecuteGateApp {
    public static final String KEY = "execute-gate";
    public static final String DEFAULT = "plan";
    public static final String FOLDER = "agentic-mcp-0915-am-execute-gate";
    ...
    public static void main(String[] args) throws Exception {
        ...
        try {
            ...
            k.afterValueUpdated((ConfigValUpdatedResponse ev) -> {
                ...
                // live leaf examples/agentic-mcp-0915-am-execute-gate — next decide() is in-memory, no MCP restart
            });
    ...
    public static Decision decide(String raw) {
        ...
        return new Decision(v, proceed ? "execute_allowed" : "stay_in_plan", proceed);
    }
    ...
    private AgenticMcp0915AmExecuteGateApp() {}
}
