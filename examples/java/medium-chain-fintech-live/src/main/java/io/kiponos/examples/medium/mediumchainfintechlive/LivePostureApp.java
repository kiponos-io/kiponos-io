package io.kiponos.examples.medium.mediumchainfintechlive;
 ...
 * Tree: examples / medium-chain-fintech-live / active
...
public final class LivePostureApp {
    public static void main(String[] args) throws Exception {
        ...
        try {
            ...
            System.out.println("  example: medium-chain-fintech-live");
    ...
    static Folder ensure(Kiponos k) {
        Folder f = k.getRootFolder().folderOrCreate("examples").folderOrCreate("medium-chain-fintech-live");
        if (!f.hasKey("active")) {
