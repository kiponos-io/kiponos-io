package io.kiponos.examples.medium.mediumproxyfintechlive;
 ...
 * Tree: examples / medium-proxy-fintech-live / active
...
public final class LivePostureApp {
    public static void main(String[] args) throws Exception {
        ...
        try {
            ...
            System.out.println("  example: medium-proxy-fintech-live");
    ...
    static Folder ensure(Kiponos k) {
        Folder f = k.getRootFolder().folderOrCreate("examples").folderOrCreate("medium-proxy-fintech-live");
        if (!f.hasKey("active")) {
