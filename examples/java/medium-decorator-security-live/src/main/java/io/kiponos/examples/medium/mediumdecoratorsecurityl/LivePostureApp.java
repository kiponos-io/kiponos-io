package io.kiponos.examples.medium.mediumdecoratorsecurityl;
 ...
 * Tree: examples / medium-decorator-security-live / active
...
public final class LivePostureApp {
    public static void main(String[] args) throws Exception {
        ...
        try {
            ...
            System.out.println("  example: medium-decorator-security-live");
    ...
    static Folder ensure(Kiponos k) {
        Folder f = k.getRootFolder().folderOrCreate("examples").folderOrCreate("medium-decorator-security-live");
        if (!f.hasKey("active")) {
