package io.kiponos.examples.medium.mediumstrategyedtechlive;
 ...
 * Tree: examples / medium-strategy-edtech-live / active
...
public final class LivePostureApp {
    public static void main(String[] args) throws Exception {
        ...
        try {
            ...
            System.out.println("  example: medium-strategy-edtech-live");
    ...
    static Folder ensure(Kiponos k) {
        Folder f = k.getRootFolder().folderOrCreate("examples").folderOrCreate("medium-strategy-edtech-live");
        if (!f.hasKey("active")) {
