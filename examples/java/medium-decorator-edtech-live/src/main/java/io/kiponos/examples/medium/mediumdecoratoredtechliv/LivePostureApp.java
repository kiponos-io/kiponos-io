package io.kiponos.examples.medium.mediumdecoratoredtechliv;
 ...
 * Tree: examples / medium-decorator-edtech-live / active
...
public final class LivePostureApp {
    public static void main(String[] args) throws Exception {
        ...
        try {
            ...
            System.out.println("  example: medium-decorator-edtech-live");
    ...
    static Folder ensure(Kiponos k) {
        Folder f = k.getRootFolder().folderOrCreate("examples").folderOrCreate("medium-decorator-edtech-live");
        if (!f.hasKey("active")) {
