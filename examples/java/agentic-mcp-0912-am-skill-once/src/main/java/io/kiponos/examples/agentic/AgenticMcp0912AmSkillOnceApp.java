 ...
 * Hub leaf: examples/agentic-mcp-0912-am-skill-once/enabled-set (default research,notify)
 ...
 */
public final class AgenticMcp0912AmSkillOnceApp {
    public static final String KEY = "enabled-set";
    public static final String DEFAULT = "research,notify";
    public static final String FOLDER = "agentic-mcp-0912-am-skill-once";
    ...
    public static void main(String[] args) throws Exception {
        ...
        try {
            ...
            k.afterValueUpdated((ConfigValUpdatedResponse ev) -> {
                ...
                // live leaf examples/agentic-mcp-0912-am-skill-once — next decide() is in-memory, no MCP restart
            });
    ...
    private AgenticMcp0912AmSkillOnceApp() {}
}
