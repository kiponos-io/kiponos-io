 ...
 * Hub leaf: examples/agentic-med-0828-af-skill-enable/enabled-set (default research,notify)
 ...
 */
public final class AgenticMed0828AfSkillEnableApp {
    public static final String KEY = "enabled-set";
    public static final String DEFAULT = "research,notify";
    public static final String FOLDER = "agentic-med-0828-af-skill-enable";
    ...
    public static void main(String[] args) throws Exception {
        ...
        try {
            ...
            k.afterValueUpdated((ConfigValUpdatedResponse ev) -> {
                ...
                // live leaf examples/agentic-med-0828-af-skill-enable — next decide() is in-memory, no MCP restart
            });
    ...
    private AgenticMed0828AfSkillEnableApp() {}
}
