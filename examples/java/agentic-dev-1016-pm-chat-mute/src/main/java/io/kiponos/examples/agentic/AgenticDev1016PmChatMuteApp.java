 ...
 * Hub leaf: examples/agentic-dev-1016-pm-chat-mute/chat-mute (default none)
 ...
 */
public final class AgenticDev1016PmChatMuteApp {
    public static final String KEY = "chat-mute";
    public static final String DEFAULT = "none";
    public static final String FOLDER = "agentic-dev-1016-pm-chat-mute";
    ...
    public static void main(String[] args) throws Exception {
        ...
        try {
            ...
            k.afterValueUpdated((ConfigValUpdatedResponse ev) -> {
                ...
                // live leaf examples/agentic-dev-1016-pm-chat-mute — next decide() is in-memory, no MCP restart
            });
    ...
    private AgenticDev1016PmChatMuteApp() {}
}
