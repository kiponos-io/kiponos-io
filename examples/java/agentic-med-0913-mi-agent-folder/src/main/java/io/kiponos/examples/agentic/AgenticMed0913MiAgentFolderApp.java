 ...
 * Hub leaf: examples/agentic-med-0913-mi-agent-folder/owner-agent (default travel-coordinator)
 ...
 */
public final class AgenticMed0913MiAgentFolderApp {
    public static final String KEY = "owner-agent";
    public static final String DEFAULT = "travel-coordinator";
    public static final String FOLDER = "agentic-med-0913-mi-agent-folder";
    ...
    private AgenticMed0913MiAgentFolderApp() {}
}
