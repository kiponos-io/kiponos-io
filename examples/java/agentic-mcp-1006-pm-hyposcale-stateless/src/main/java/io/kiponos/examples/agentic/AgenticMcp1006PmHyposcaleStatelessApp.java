 ...
 * Hub leaf: examples/agentic-mcp-1006-pm-hyposcale-stateless/shared-truth (default live)
 ...
 */
public final class AgenticMcp1006PmHyposcaleStatelessApp {
    public static final String KEY = "shared-truth";
    public static final String DEFAULT = "live";
    public static final String FOLDER = "agentic-mcp-1006-pm-hyposcale-stateless";
    ...
    public static void main(String[] args) throws Exception {
        ...
        try {
            ...
            k.afterValueUpdated((ConfigValUpdatedResponse ev) -> {
                ...
                // live leaf examples/agentic-mcp-1006-pm-hyposcale-stateless — next decide() is in-memory, no MCP restart
            });
    ...
    private AgenticMcp1006PmHyposcaleStatelessApp() {}
}
