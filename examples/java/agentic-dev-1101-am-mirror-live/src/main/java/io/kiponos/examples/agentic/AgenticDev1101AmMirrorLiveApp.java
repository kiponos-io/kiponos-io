 ...
 * Hub leaf: examples/agentic-dev-1101-am-mirror-live/device-live (default yes)
 ...
 */
public final class AgenticDev1101AmMirrorLiveApp {
    public static final String KEY = "device-live";
    public static final String DEFAULT = "yes";
    public static final String FOLDER = "agentic-dev-1101-am-mirror-live";
    ...
    public static void main(String[] args) throws Exception {
        ...
        try {
            ...
            k.afterValueUpdated((ConfigValUpdatedResponse ev) -> {
                ...
                // live leaf examples/agentic-dev-1101-am-mirror-live — next decide() is in-memory, no MCP restart
            });
    ...
    private AgenticDev1101AmMirrorLiveApp() {}
}
