package io.kiponos.examples.medium.mediumstrategyfintechliv;
 ...
 * Tree: examples / medium-strategy-fintech-live / active
...
public final class LivePostureApp {
    public static void main(String[] args) throws Exception {
        ...
        try {
            ...
            System.out.println("  example: medium-strategy-fintech-live");
    ...
    static Folder ensure(Kiponos k) {
        Folder f = k.getRootFolder().folderOrCreate("examples").folderOrCreate("medium-strategy-fintech-live");
        if (!f.hasKey("active")) {
