 ...
 * Hub leaf: examples/agent-budget-token-live/max-tokens-per-turn (default 4000)
 * Pain: runaway agent cost until someone kills the process
 */
public final class AgentBudgetTokenLiveApp {
    public static final String KEY = "max-tokens-per-turn";
    ...
    private AgentBudgetTokenLiveApp() {}
}
