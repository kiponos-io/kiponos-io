 ...
 * Hub leaf: examples/agentic-mcp-1007-pm-turn-clock/max-tokens (default 8000)
 ...
 */
public final class AgenticMcp1007PmTurnClockApp {
    public static final String KEY = "max-tokens";
    public static final String DEFAULT = "8000";
    public static final String FOLDER = "agentic-mcp-1007-pm-turn-clock";
    ...
    public static void main(String[] args) throws Exception {
        ...
        try {
            ...
            k.afterValueUpdated((ConfigValUpdatedResponse ev) -> {
                ...
                // live leaf examples/agentic-mcp-1007-pm-turn-clock — next decide() is in-memory, no MCP restart
            });
    ...
    private AgenticMcp1007PmTurnClockApp() {}
}
