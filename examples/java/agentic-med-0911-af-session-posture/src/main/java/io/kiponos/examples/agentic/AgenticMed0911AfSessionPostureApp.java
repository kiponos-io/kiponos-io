 ...
 * Hub leaf: examples/agentic-med-0911-af-session-posture/session-posture (default focus=admin-wall,shopping-pause=off)
 ...
 */
public final class AgenticMed0911AfSessionPostureApp {
    public static final String KEY = "session-posture";
    public static final String DEFAULT = "focus=admin-wall,shopping-pause=off";
    public static final String FOLDER = "agentic-med-0911-af-session-posture";
    ...
    public static void main(String[] args) throws Exception {
        ...
        try {
            ...
            k.afterValueUpdated((ConfigValUpdatedResponse ev) -> {
                ...
                // live leaf examples/agentic-med-0911-af-session-posture — next decide() is in-memory, no MCP restart
            });
    ...
    private AgenticMed0911AfSessionPostureApp() {}
}
