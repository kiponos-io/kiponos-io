 ...
 * Hub leaf: examples/agentic-med-1016-mi-shopping-pause/incident-pause (default off)
 ...
 */
public final class AgenticMed1016MiShoppingPauseApp {
    public static final String KEY = "incident-pause";
    public static final String DEFAULT = "off";
    public static final String FOLDER = "agentic-med-1016-mi-shopping-pause";
    ...
    public static void main(String[] args) throws Exception {
        ...
        try {
            ...
            k.afterValueUpdated((ConfigValUpdatedResponse ev) -> {
                ...
                // live leaf examples/agentic-med-1016-mi-shopping-pause — next decide() is in-memory, no MCP restart
            });
    ...
    private AgenticMed1016MiShoppingPauseApp() {}
}
