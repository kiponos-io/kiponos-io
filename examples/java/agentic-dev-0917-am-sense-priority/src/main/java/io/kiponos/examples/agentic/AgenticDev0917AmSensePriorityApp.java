 ...
 * Hub leaf: examples/agentic-dev-0917-am-sense-priority/priority (default P3)
 ...
 */
public final class AgenticDev0917AmSensePriorityApp {
    public static final String KEY = "priority";
    public static final String DEFAULT = "P3";
    public static final String FOLDER = "agentic-dev-0917-am-sense-priority";
    ...
    public static void main(String[] args) throws Exception {
        ...
        try {
            ...
            k.afterValueUpdated((ConfigValUpdatedResponse ev) -> {
                ...
                // live leaf examples/agentic-dev-0917-am-sense-priority — next decide() is in-memory, no MCP restart
            });
    ...
    private AgenticDev0917AmSensePriorityApp() {}
}
