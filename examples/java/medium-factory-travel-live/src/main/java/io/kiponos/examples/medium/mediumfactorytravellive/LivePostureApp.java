package io.kiponos.examples.medium.mediumfactorytravellive;
 ...
 * Tree: examples / medium-factory-travel-live / active
...
public final class LivePostureApp {
    public static void main(String[] args) throws Exception {
        ...
        try {
            ...
            System.out.println("  example: medium-factory-travel-live");
    ...
    static Folder ensure(Kiponos k) {
        Folder f = k.getRootFolder().folderOrCreate("examples").folderOrCreate("medium-factory-travel-live");
        if (!f.hasKey("active")) {
