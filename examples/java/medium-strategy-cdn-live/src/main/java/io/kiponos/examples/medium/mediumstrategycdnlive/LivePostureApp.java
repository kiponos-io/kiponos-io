package io.kiponos.examples.medium.mediumstrategycdnlive;
 ...
 * Tree: examples / medium-strategy-cdn-live / active
...
public final class LivePostureApp {
    public static void main(String[] args) throws Exception {
        ...
        try {
            ...
            System.out.println("  example: medium-strategy-cdn-live");
    ...
    static Folder ensure(Kiponos k) {
        Folder f = k.getRootFolder().folderOrCreate("examples").folderOrCreate("medium-strategy-cdn-live");
        if (!f.hasKey("active")) {
