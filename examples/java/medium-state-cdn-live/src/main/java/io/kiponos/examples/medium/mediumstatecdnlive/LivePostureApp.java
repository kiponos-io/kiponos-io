package io.kiponos.examples.medium.mediumstatecdnlive;
 ...
 * Tree: examples / medium-state-cdn-live / active
...
public final class LivePostureApp {
    public static void main(String[] args) throws Exception {
        ...
        try {
            ...
            System.out.println("  example: medium-state-cdn-live");
    ...
    static Folder ensure(Kiponos k) {
        Folder f = k.getRootFolder().folderOrCreate("examples").folderOrCreate("medium-state-cdn-live");
        if (!f.hasKey("active")) {
