package io.kiponos.examples.medium.mediumfactorymarketplace;
 ...
 * Tree: examples / medium-factory-marketplace-live / active
...
public final class LivePostureApp {
    public static void main(String[] args) throws Exception {
        ...
        try {
            ...
            System.out.println("  example: medium-factory-marketplace-live");
    ...
    static Folder ensure(Kiponos k) {
        Folder f = k.getRootFolder().folderOrCreate("examples").folderOrCreate("medium-factory-marketplace-live");
        if (!f.hasKey("active")) {
