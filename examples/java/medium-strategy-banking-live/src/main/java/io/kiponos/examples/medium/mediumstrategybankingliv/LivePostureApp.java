package io.kiponos.examples.medium.mediumstrategybankingliv;
 ...
 * Tree: examples / medium-strategy-banking-live / active
...
public final class LivePostureApp {
    public static void main(String[] args) throws Exception {
        ...
        try {
            ...
            System.out.println("  example: medium-strategy-banking-live");
    ...
    static Folder ensure(Kiponos k) {
        Folder f = k.getRootFolder().folderOrCreate("examples").folderOrCreate("medium-strategy-banking-live");
        if (!f.hasKey("active")) {
