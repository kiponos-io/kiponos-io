 ...
 * Hub leaf: examples/agentic-dev-1025-pm-session-posture/session-posture (default focus=admin-wall,shopping-pause=off)
 ...
 */
public final class AgenticDev1025PmSessionPostureApp {
    public static final String KEY = "session-posture";
    public static final String DEFAULT = "focus=admin-wall,shopping-pause=off";
    public static final String FOLDER = "agentic-dev-1025-pm-session-posture";
    ...
    public static void main(String[] args) throws Exception {
        ...
        try {
            ...
            k.afterValueUpdated((ConfigValUpdatedResponse ev) -> {
                ...
                // live leaf examples/agentic-dev-1025-pm-session-posture — next decide() is in-memory, no MCP restart
            });
    ...
    private AgenticDev1025PmSessionPostureApp() {}
}
