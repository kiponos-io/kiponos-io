package io.kiponos.examples.medium.mediumchainsaaslive;
 ...
 * Tree: examples / medium-chain-saas-live / active
...
public final class LivePostureApp {
    public static void main(String[] args) throws Exception {
        ...
        try {
            ...
            System.out.println("  example: medium-chain-saas-live");
    ...
    static Folder ensure(Kiponos k) {
        Folder f = k.getRootFolder().folderOrCreate("examples").folderOrCreate("medium-chain-saas-live");
        if (!f.hasKey("active")) {
