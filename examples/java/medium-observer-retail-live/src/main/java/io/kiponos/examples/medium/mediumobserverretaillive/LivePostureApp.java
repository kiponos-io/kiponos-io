package io.kiponos.examples.medium.mediumobserverretaillive;
 ...
 * Tree: examples / medium-observer-retail-live / active
...
public final class LivePostureApp {
    public static void main(String[] args) throws Exception {
        ...
        try {
            ...
            System.out.println("  example: medium-observer-retail-live");
    ...
    static Folder ensure(Kiponos k) {
        Folder f = k.getRootFolder().folderOrCreate("examples").folderOrCreate("medium-observer-retail-live");
        if (!f.hasKey("active")) {
