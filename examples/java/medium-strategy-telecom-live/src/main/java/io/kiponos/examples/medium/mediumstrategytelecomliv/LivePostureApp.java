package io.kiponos.examples.medium.mediumstrategytelecomliv;
 ...
 * Tree: examples / medium-strategy-telecom-live / active
...
public final class LivePostureApp {
    public static void main(String[] args) throws Exception {
        ...
        try {
            ...
            System.out.println("  example: medium-strategy-telecom-live");
    ...
    static Folder ensure(Kiponos k) {
        Folder f = k.getRootFolder().folderOrCreate("examples").folderOrCreate("medium-strategy-telecom-live");
        if (!f.hasKey("active")) {
