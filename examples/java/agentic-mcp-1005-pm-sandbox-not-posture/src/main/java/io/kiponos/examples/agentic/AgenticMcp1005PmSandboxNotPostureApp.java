 ...
 * Hub leaf: examples/agentic-mcp-1005-pm-sandbox-not-posture/execute-gate (default plan)
 ...
 */
public final class AgenticMcp1005PmSandboxNotPostureApp {
    public static final String KEY = "execute-gate";
    public static final String DEFAULT = "plan";
    public static final String FOLDER = "agentic-mcp-1005-pm-sandbox-not-posture";
    ...
    public static void main(String[] args) throws Exception {
        ...
        try {
            ...
            k.afterValueUpdated((ConfigValUpdatedResponse ev) -> {
                ...
                // live leaf examples/agentic-mcp-1005-pm-sandbox-not-posture — next decide() is in-memory, no MCP restart
            });
    ...
    private AgenticMcp1005PmSandboxNotPostureApp() {}
}
