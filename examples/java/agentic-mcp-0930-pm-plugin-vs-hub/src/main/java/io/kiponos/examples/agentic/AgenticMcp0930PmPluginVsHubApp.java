 ...
 * Hub leaf: examples/agentic-mcp-0930-pm-plugin-vs-hub/enabled-set (default research,notify)
 ...
 */
public final class AgenticMcp0930PmPluginVsHubApp {
    public static final String KEY = "enabled-set";
    public static final String DEFAULT = "research,notify";
    public static final String FOLDER = "agentic-mcp-0930-pm-plugin-vs-hub";
    ...
    public static void main(String[] args) throws Exception {
        ...
        try {
            ...
            k.afterValueUpdated((ConfigValUpdatedResponse ev) -> {
                ...
                // live leaf examples/agentic-mcp-0930-pm-plugin-vs-hub — next decide() is in-memory, no MCP restart
            });
    ...
    private AgenticMcp0930PmPluginVsHubApp() {}
}
