package io.kiponos.examples.medium.mediumdecoratortravelliv;
 ...
 * Tree: examples / medium-decorator-travel-live / active
...
public final class LivePostureApp {
    public static void main(String[] args) throws Exception {
        ...
        try {
            ...
            System.out.println("  example: medium-decorator-travel-live");
    ...
    static Folder ensure(Kiponos k) {
        Folder f = k.getRootFolder().folderOrCreate("examples").folderOrCreate("medium-decorator-travel-live");
        if (!f.hasKey("active")) {
