package io.kiponos.examples.medium.mediumproxysrelive;
 ...
 * Tree: examples / medium-proxy-sre-live / active
...
public final class LivePostureApp {
    public static void main(String[] args) throws Exception {
        ...
        try {
            ...
            System.out.println("  example: medium-proxy-sre-live");
    ...
    static Folder ensure(Kiponos k) {
        Folder f = k.getRootFolder().folderOrCreate("examples").folderOrCreate("medium-proxy-sre-live");
        if (!f.hasKey("active")) {
