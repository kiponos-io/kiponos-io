 ...
 * Hub leaf: examples/agentic-med-0914-af-mirror-live/device-live (default yes)
 ...
 */
public final class AgenticMed0914AfMirrorLiveApp {
    public static final String KEY = "device-live";
    public static final String DEFAULT = "yes";
    public static final String FOLDER = "agentic-med-0914-af-mirror-live";
    ...
    public static void main(String[] args) throws Exception {
        ...
        try {
            ...
            k.afterValueUpdated((ConfigValUpdatedResponse ev) -> {
                ...
                // live leaf examples/agentic-med-0914-af-mirror-live — next decide() is in-memory, no MCP restart
            });
    ...
    private AgenticMed0914AfMirrorLiveApp() {}
}
