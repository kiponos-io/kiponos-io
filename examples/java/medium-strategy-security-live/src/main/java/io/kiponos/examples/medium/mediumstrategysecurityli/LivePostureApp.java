package io.kiponos.examples.medium.mediumstrategysecurityli;
 ...
 * Tree: examples / medium-strategy-security-live / active
...
public final class LivePostureApp {
    public static void main(String[] args) throws Exception {
        ...
        try {
            ...
            System.out.println("  example: medium-strategy-security-live");
    ...
    static Folder ensure(Kiponos k) {
        Folder f = k.getRootFolder().folderOrCreate("examples").folderOrCreate("medium-strategy-security-live");
        if (!f.hasKey("active")) {
