package io.kiponos.examples.medium.mediumobserverinsurancel;
 ...
 * Tree: examples / medium-observer-insurance-live / active
...
public final class LivePostureApp {
    public static void main(String[] args) throws Exception {
        ...
        try {
            ...
            System.out.println("  example: medium-observer-insurance-live");
    ...
    static Folder ensure(Kiponos k) {
        Folder f = k.getRootFolder().folderOrCreate("examples").folderOrCreate("medium-observer-insurance-live");
        if (!f.hasKey("active")) {
