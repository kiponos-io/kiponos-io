package io.kiponos.examples.medium.mediumstrategyinsurancel;
 ...
 * Tree: examples / medium-strategy-insurance-live / active
...
public final class LivePostureApp {
    public static void main(String[] args) throws Exception {
        ...
        try {
            ...
            System.out.println("  example: medium-strategy-insurance-live");
    ...
    static Folder ensure(Kiponos k) {
        Folder f = k.getRootFolder().folderOrCreate("examples").folderOrCreate("medium-strategy-insurance-live");
        if (!f.hasKey("active")) {
