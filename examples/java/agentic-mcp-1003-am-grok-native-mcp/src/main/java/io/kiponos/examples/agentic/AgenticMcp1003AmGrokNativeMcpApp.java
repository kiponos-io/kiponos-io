 ...
 * Hub leaf: examples/agentic-mcp-1003-am-grok-native-mcp/tools-allow (default search,read)
 ...
 */
public final class AgenticMcp1003AmGrokNativeMcpApp {
    public static final String KEY = "tools-allow";
    public static final String DEFAULT = "search,read";
    public static final String FOLDER = "agentic-mcp-1003-am-grok-native-mcp";
    ...
    public static void main(String[] args) throws Exception {
        ...
        try {
            ...
            k.afterValueUpdated((ConfigValUpdatedResponse ev) -> {
                ...
                // live leaf examples/agentic-mcp-1003-am-grok-native-mcp — next decide() is in-memory, no MCP restart
            });
    ...
    private AgenticMcp1003AmGrokNativeMcpApp() {}
}
