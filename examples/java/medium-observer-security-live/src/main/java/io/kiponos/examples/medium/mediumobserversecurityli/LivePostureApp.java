package io.kiponos.examples.medium.mediumobserversecurityli;
 ...
 * Tree: examples / medium-observer-security-live / active
...
public final class LivePostureApp {
    public static void main(String[] args) throws Exception {
        ...
        try {
            ...
            System.out.println("  example: medium-observer-security-live");
    ...
    static Folder ensure(Kiponos k) {
        Folder f = k.getRootFolder().folderOrCreate("examples").folderOrCreate("medium-observer-security-live");
        if (!f.hasKey("active")) {
