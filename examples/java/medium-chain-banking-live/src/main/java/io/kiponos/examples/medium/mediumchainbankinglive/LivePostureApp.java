package io.kiponos.examples.medium.mediumchainbankinglive;
 ...
 * Tree: examples / medium-chain-banking-live / active
...
public final class LivePostureApp {
    public static void main(String[] args) throws Exception {
        ...
        try {
            ...
            System.out.println("  example: medium-chain-banking-live");
    ...
    static Folder ensure(Kiponos k) {
        Folder f = k.getRootFolder().folderOrCreate("examples").folderOrCreate("medium-chain-banking-live");
        if (!f.hasKey("active")) {
