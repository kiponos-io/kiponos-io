package io.kiponos.examples.medium.mediumstateadslive;
 ...
 * Tree: examples / medium-state-ads-live / active
...
public final class LivePostureApp {
    public static void main(String[] args) throws Exception {
        ...
        try {
            ...
            System.out.println("  example: medium-state-ads-live");
    ...
    static Folder ensure(Kiponos k) {
        Folder f = k.getRootFolder().folderOrCreate("examples").folderOrCreate("medium-state-ads-live");
        if (!f.hasKey("active")) {
