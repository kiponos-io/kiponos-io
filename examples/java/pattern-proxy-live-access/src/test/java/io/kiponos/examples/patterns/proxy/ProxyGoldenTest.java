...
class ProxyLiveAccessGoldenTest {
    ...
    void connectEnsureAndRun() {
        ...
        try {
            ...
            Folder policy = ProxyLiveAccessApp.ensure(kiponos);
            assertNotNull(policy);
            var r = ProxyLiveAccessApp.invoke(policy, "operator", "/x"); assertNotNull(r.detail());
            System.out.println("GOLDEN_OK ProxyLiveAccessApp");
