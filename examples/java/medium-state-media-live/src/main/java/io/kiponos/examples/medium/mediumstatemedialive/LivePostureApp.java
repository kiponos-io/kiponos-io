package io.kiponos.examples.medium.mediumstatemedialive;
 ...
 * Tree: examples / medium-state-media-live / active
...
public final class LivePostureApp {
    public static void main(String[] args) throws Exception {
        ...
        try {
            ...
            System.out.println("  example: medium-state-media-live");
    ...
    static Folder ensure(Kiponos k) {
        Folder f = k.getRootFolder().folderOrCreate("examples").folderOrCreate("medium-state-media-live");
        if (!f.hasKey("active")) {
