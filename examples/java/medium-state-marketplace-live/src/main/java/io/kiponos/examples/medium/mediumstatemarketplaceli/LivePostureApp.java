package io.kiponos.examples.medium.mediumstatemarketplaceli;
 ...
 * Tree: examples / medium-state-marketplace-live / active
...
public final class LivePostureApp {
    public static void main(String[] args) throws Exception {
        ...
        try {
            ...
            System.out.println("  example: medium-state-marketplace-live");
    ...
    static Folder ensure(Kiponos k) {
        Folder f = k.getRootFolder().folderOrCreate("examples").folderOrCreate("medium-state-marketplace-live");
        if (!f.hasKey("active")) {
