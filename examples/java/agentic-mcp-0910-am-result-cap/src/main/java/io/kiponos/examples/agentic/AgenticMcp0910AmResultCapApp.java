 ...
 * Hub leaf: examples/agentic-mcp-0910-am-result-cap/result-cap (default 2000)
 ...
 */
public final class AgenticMcp0910AmResultCapApp {
    public static final String KEY = "result-cap";
    public static final String DEFAULT = "2000";
    public static final String FOLDER = "agentic-mcp-0910-am-result-cap";
    ...
    public static void main(String[] args) throws Exception {
        ...
        try {
            ...
            k.afterValueUpdated((ConfigValUpdatedResponse ev) -> {
                ...
                // live leaf examples/agentic-mcp-0910-am-result-cap — next decide() is in-memory, no MCP restart
            });
    ...
    private AgenticMcp0910AmResultCapApp() {}
}
