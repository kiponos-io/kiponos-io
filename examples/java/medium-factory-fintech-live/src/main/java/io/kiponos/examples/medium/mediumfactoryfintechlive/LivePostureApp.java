package io.kiponos.examples.medium.mediumfactoryfintechlive;
 ...
 * Tree: examples / medium-factory-fintech-live / active
...
public final class LivePostureApp {
    public static void main(String[] args) throws Exception {
        ...
        try {
            ...
            System.out.println("  example: medium-factory-fintech-live");
    ...
    static Folder ensure(Kiponos k) {
        Folder f = k.getRootFolder().folderOrCreate("examples").folderOrCreate("medium-factory-fintech-live");
        if (!f.hasKey("active")) {
