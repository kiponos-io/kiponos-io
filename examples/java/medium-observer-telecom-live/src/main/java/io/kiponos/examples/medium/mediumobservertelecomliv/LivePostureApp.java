package io.kiponos.examples.medium.mediumobservertelecomliv;
 ...
 * Tree: examples / medium-observer-telecom-live / active
...
public final class LivePostureApp {
    public static void main(String[] args) throws Exception {
        ...
        try {
            ...
            System.out.println("  example: medium-observer-telecom-live");
    ...
    static Folder ensure(Kiponos k) {
        Folder f = k.getRootFolder().folderOrCreate("examples").folderOrCreate("medium-observer-telecom-live");
        if (!f.hasKey("active")) {
