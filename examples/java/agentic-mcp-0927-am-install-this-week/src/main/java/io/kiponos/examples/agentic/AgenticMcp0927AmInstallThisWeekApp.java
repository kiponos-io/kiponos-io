 ...
 * Hub leaf: examples/agentic-mcp-0927-am-install-this-week/tools-allow (default search,read)
 ...
 */
public final class AgenticMcp0927AmInstallThisWeekApp {
    public static final String KEY = "tools-allow";
    public static final String DEFAULT = "search,read";
    public static final String FOLDER = "agentic-mcp-0927-am-install-this-week";
    ...
    public static void main(String[] args) throws Exception {
        ...
        try {
            ...
            k.afterValueUpdated((ConfigValUpdatedResponse ev) -> {
                ...
                // live leaf examples/agentic-mcp-0927-am-install-this-week — next decide() is in-memory, no MCP restart
            });
    ...
    private AgenticMcp0927AmInstallThisWeekApp() {}
}
