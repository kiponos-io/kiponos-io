 ...
 * Hub leaf: examples/agentic-dev-1031-am-shopping-pause/incident-pause (default off)
 ...
 */
public final class AgenticDev1031AmShoppingPauseApp {
    public static final String KEY = "incident-pause";
    public static final String DEFAULT = "off";
    public static final String FOLDER = "agentic-dev-1031-am-shopping-pause";
    ...
    public static void main(String[] args) throws Exception {
        ...
        try {
            ...
            k.afterValueUpdated((ConfigValUpdatedResponse ev) -> {
                ...
                // live leaf examples/agentic-dev-1031-am-shopping-pause — next decide() is in-memory, no MCP restart
            });
    ...
    private AgenticDev1031AmShoppingPauseApp() {}
}
