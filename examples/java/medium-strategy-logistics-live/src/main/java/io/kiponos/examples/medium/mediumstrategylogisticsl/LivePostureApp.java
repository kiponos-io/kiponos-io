package io.kiponos.examples.medium.mediumstrategylogisticsl;
 ...
 * Tree: examples / medium-strategy-logistics-live / active
...
public final class LivePostureApp {
    public static void main(String[] args) throws Exception {
        ...
        try {
            ...
            System.out.println("  example: medium-strategy-logistics-live");
    ...
    static Folder ensure(Kiponos k) {
        Folder f = k.getRootFolder().folderOrCreate("examples").folderOrCreate("medium-strategy-logistics-live");
        if (!f.hasKey("active")) {
