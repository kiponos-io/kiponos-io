 ...
 * Hub leaf: examples/agentic-dev-1025-am-skill-enable/enabled-set (default research,notify)
 ...
 */
public final class AgenticDev1025AmSkillEnableApp {
    public static final String KEY = "enabled-set";
    public static final String DEFAULT = "research,notify";
    public static final String FOLDER = "agentic-dev-1025-am-skill-enable";
    ...
    public static void main(String[] args) throws Exception {
        ...
        try {
            ...
            k.afterValueUpdated((ConfigValUpdatedResponse ev) -> {
                ...
                // live leaf examples/agentic-dev-1025-am-skill-enable — next decide() is in-memory, no MCP restart
            });
    ...
    private AgenticDev1025AmSkillEnableApp() {}
}
