package io.kiponos.examples.medium.mediumstrategyretaillive;
 ...
 * Tree: examples / medium-strategy-retail-live / active
...
public final class LivePostureApp {
    public static void main(String[] args) throws Exception {
        ...
        try {
            ...
            System.out.println("  example: medium-strategy-retail-live");
    ...
    static Folder ensure(Kiponos k) {
        Folder f = k.getRootFolder().folderOrCreate("examples").folderOrCreate("medium-strategy-retail-live");
        if (!f.hasKey("active")) {
