package io.kiponos.examples.medium.mediumobservercdnlive;
 ...
 * Tree: examples / medium-observer-cdn-live / active
...
public final class LivePostureApp {
    public static void main(String[] args) throws Exception {
        ...
        try {
            ...
            System.out.println("  example: medium-observer-cdn-live");
    ...
    static Folder ensure(Kiponos k) {
        Folder f = k.getRootFolder().folderOrCreate("examples").folderOrCreate("medium-observer-cdn-live");
        if (!f.hasKey("active")) {
