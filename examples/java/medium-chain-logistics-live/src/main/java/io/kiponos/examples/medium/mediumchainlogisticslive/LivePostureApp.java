package io.kiponos.examples.medium.mediumchainlogisticslive;
 ...
 * Tree: examples / medium-chain-logistics-live / active
...
public final class LivePostureApp {
    public static void main(String[] args) throws Exception {
        ...
        try {
            ...
            System.out.println("  example: medium-chain-logistics-live");
    ...
    static Folder ensure(Kiponos k) {
        Folder f = k.getRootFolder().folderOrCreate("examples").folderOrCreate("medium-chain-logistics-live");
        if (!f.hasKey("active")) {
