 ...
 * Hub leaf: examples/agentic-med-1018-mi-admin-wall/wall-focus (default checkout)
 ...
 */
public final class AgenticMed1018MiAdminWallApp {
    public static final String KEY = "wall-focus";
    public static final String DEFAULT = "checkout";
    public static final String FOLDER = "agentic-med-1018-mi-admin-wall";
    ...
    public static void main(String[] args) throws Exception {
        ...
        try {
            ...
            k.afterValueUpdated((ConfigValUpdatedResponse ev) -> {
                ...
                // live leaf examples/agentic-med-1018-mi-admin-wall — next decide() is in-memory, no MCP restart
            });
    ...
    private AgenticMed1018MiAdminWallApp() {}
}
