package io.kiponos.examples.medium.mediumstrategygaminglive;
 ...
 * Tree: examples / medium-strategy-gaming-live / active
...
public final class LivePostureApp {
    public static void main(String[] args) throws Exception {
        ...
        try {
            ...
            System.out.println("  example: medium-strategy-gaming-live");
    ...
    static Folder ensure(Kiponos k) {
        Folder f = k.getRootFolder().folderOrCreate("examples").folderOrCreate("medium-strategy-gaming-live");
        if (!f.hasKey("active")) {
