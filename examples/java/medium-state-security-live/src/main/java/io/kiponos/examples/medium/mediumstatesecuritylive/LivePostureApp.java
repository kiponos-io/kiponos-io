package io.kiponos.examples.medium.mediumstatesecuritylive;
 ...
 * Tree: examples / medium-state-security-live / active
...
public final class LivePostureApp {
    public static void main(String[] args) throws Exception {
        ...
        try {
            ...
            System.out.println("  example: medium-state-security-live");
    ...
    static Folder ensure(Kiponos k) {
        Folder f = k.getRootFolder().folderOrCreate("examples").folderOrCreate("medium-state-security-live");
        if (!f.hasKey("active")) {
