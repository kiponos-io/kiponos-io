 ...
 * Hub leaf: examples/agentic-mcp-0930-am-namespace-tools/tools-allow (default search,read)
 ...
 */
public final class AgenticMcp0930AmNamespaceToolsApp {
    public static final String KEY = "tools-allow";
    public static final String DEFAULT = "search,read";
    public static final String FOLDER = "agentic-mcp-0930-am-namespace-tools";
    ...
    public static void main(String[] args) throws Exception {
        ...
        try {
            ...
            k.afterValueUpdated((ConfigValUpdatedResponse ev) -> {
                ...
                // live leaf examples/agentic-mcp-0930-am-namespace-tools — next decide() is in-memory, no MCP restart
            });
    ...
    private AgenticMcp0930AmNamespaceToolsApp() {}
}
