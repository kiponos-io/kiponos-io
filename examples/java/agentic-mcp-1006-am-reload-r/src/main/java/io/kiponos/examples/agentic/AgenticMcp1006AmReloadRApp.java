 ...
 * Hub leaf: examples/agentic-mcp-1006-am-reload-r/tools-allow (default search,read)
 ...
 */
public final class AgenticMcp1006AmReloadRApp {
    public static final String KEY = "tools-allow";
    public static final String DEFAULT = "search,read";
    public static final String FOLDER = "agentic-mcp-1006-am-reload-r";
    ...
    public static void main(String[] args) throws Exception {
        ...
        try {
            ...
            k.afterValueUpdated((ConfigValUpdatedResponse ev) -> {
                ...
                // live leaf examples/agentic-mcp-1006-am-reload-r — next decide() is in-memory, no MCP restart
            });
    ...
    private AgenticMcp1006AmReloadRApp() {}
}
