package io.kiponos.examples.medium.mediumdecoratortelecomli;
 ...
 * Tree: examples / medium-decorator-telecom-live / active
...
public final class LivePostureApp {
    public static void main(String[] args) throws Exception {
        ...
        try {
            ...
            System.out.println("  example: medium-decorator-telecom-live");
    ...
    static Folder ensure(Kiponos k) {
        Folder f = k.getRootFolder().folderOrCreate("examples").folderOrCreate("medium-decorator-telecom-live");
        if (!f.hasKey("active")) {
