package io.kiponos.examples.medium.mediumstatelogisticslive;
 ...
 * Tree: examples / medium-state-logistics-live / active
...
public final class LivePostureApp {
    public static void main(String[] args) throws Exception {
        ...
        try {
            ...
            System.out.println("  example: medium-state-logistics-live");
    ...
    static Folder ensure(Kiponos k) {
        Folder f = k.getRootFolder().folderOrCreate("examples").folderOrCreate("medium-state-logistics-live");
        if (!f.hasKey("active")) {
