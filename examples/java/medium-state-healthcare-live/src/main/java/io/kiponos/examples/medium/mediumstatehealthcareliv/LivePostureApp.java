package io.kiponos.examples.medium.mediumstatehealthcareliv;
 ...
 * Tree: examples / medium-state-healthcare-live / active
...
public final class LivePostureApp {
    public static void main(String[] args) throws Exception {
        ...
        try {
            ...
            System.out.println("  example: medium-state-healthcare-live");
    ...
    static Folder ensure(Kiponos k) {
        Folder f = k.getRootFolder().folderOrCreate("examples").folderOrCreate("medium-state-healthcare-live");
        if (!f.hasKey("active")) {
