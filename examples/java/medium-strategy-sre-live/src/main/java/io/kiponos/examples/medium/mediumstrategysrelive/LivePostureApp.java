package io.kiponos.examples.medium.mediumstrategysrelive;
 ...
 * Tree: examples / medium-strategy-sre-live / active
...
public final class LivePostureApp {
    public static void main(String[] args) throws Exception {
        ...
        try {
            ...
            System.out.println("  example: medium-strategy-sre-live");
    ...
    static Folder ensure(Kiponos k) {
        Folder f = k.getRootFolder().folderOrCreate("examples").folderOrCreate("medium-strategy-sre-live");
        if (!f.hasKey("active")) {
