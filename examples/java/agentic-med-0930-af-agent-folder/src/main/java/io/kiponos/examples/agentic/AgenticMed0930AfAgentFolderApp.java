 ...
 * Hub leaf: examples/agentic-med-0930-af-agent-folder/owner-agent (default travel-coordinator)
 ...
 */
public final class AgenticMed0930AfAgentFolderApp {
    public static final String KEY = "owner-agent";
    public static final String DEFAULT = "travel-coordinator";
    public static final String FOLDER = "agentic-med-0930-af-agent-folder";
    ...
    public static void main(String[] args) throws Exception {
        ...
        try {
            ...
            k.afterValueUpdated((ConfigValUpdatedResponse ev) -> {
                ...
                // live leaf examples/agentic-med-0930-af-agent-folder — next decide() is in-memory, no MCP restart
            });
    ...
    private AgenticMed0930AfAgentFolderApp() {}
}
