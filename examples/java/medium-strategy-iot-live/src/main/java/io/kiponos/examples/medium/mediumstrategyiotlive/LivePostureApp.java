package io.kiponos.examples.medium.mediumstrategyiotlive;
 ...
 * Tree: examples / medium-strategy-iot-live / active
...
public final class LivePostureApp {
    public static void main(String[] args) throws Exception {
        ...
        try {
            ...
            System.out.println("  example: medium-strategy-iot-live");
    ...
    static Folder ensure(Kiponos k) {
        Folder f = k.getRootFolder().folderOrCreate("examples").folderOrCreate("medium-strategy-iot-live");
        if (!f.hasKey("active")) {
