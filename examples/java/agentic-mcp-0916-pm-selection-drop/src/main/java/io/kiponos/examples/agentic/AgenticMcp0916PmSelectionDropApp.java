 ...
 * Hub leaf: examples/agentic-mcp-0916-pm-selection-drop/tools-allow (default search,read)
 ...
 */
public final class AgenticMcp0916PmSelectionDropApp {
    public static final String KEY = "tools-allow";
    public static final String DEFAULT = "search,read";
    public static final String FOLDER = "agentic-mcp-0916-pm-selection-drop";
    ...
    public static void main(String[] args) throws Exception {
        ...
        try {
            ...
            k.afterValueUpdated((ConfigValUpdatedResponse ev) -> {
                ...
                // live leaf examples/agentic-mcp-0916-pm-selection-drop — next decide() is in-memory, no MCP restart
            });
    ...
    private AgenticMcp0916PmSelectionDropApp() {}
}
