 ...
 * Hub leaf: examples/agentic-dev-0927-pm-shopping-pause/incident-pause (default off)
 ...
 */
public final class AgenticDev0927PmShoppingPauseApp {
    public static final String KEY = "incident-pause";
    public static final String DEFAULT = "off";
    public static final String FOLDER = "agentic-dev-0927-pm-shopping-pause";
    ...
    public static void main(String[] args) throws Exception {
        ...
        try {
            ...
            k.afterValueUpdated((ConfigValUpdatedResponse ev) -> {
                ...
                // live leaf examples/agentic-dev-0927-pm-shopping-pause — next decide() is in-memory, no MCP restart
            });
    ...
    private AgenticDev0927PmShoppingPauseApp() {}
}
