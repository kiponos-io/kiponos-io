package io.kiponos.examples.medium.mediumchainsrelive;
 ...
 * Tree: examples / medium-chain-sre-live / active
...
public final class LivePostureApp {
    public static void main(String[] args) throws Exception {
        ...
        try {
            ...
            System.out.println("  example: medium-chain-sre-live");
    ...
    static Folder ensure(Kiponos k) {
        Folder f = k.getRootFolder().folderOrCreate("examples").folderOrCreate("medium-chain-sre-live");
        if (!f.hasKey("active")) {
