 ...
 * Hub leaf: examples/agentic-med-1010-af-agent-folder/owner-agent (default travel-coordinator)
 ...
 */
public final class AgenticMed1010AfAgentFolderApp {
    public static final String KEY = "owner-agent";
    public static final String DEFAULT = "travel-coordinator";
    public static final String FOLDER = "agentic-med-1010-af-agent-folder";
    ...
    public static void main(String[] args) throws Exception {
        ...
        try {
            ...
            k.afterValueUpdated((ConfigValUpdatedResponse ev) -> {
                ...
                // live leaf examples/agentic-med-1010-af-agent-folder — next decide() is in-memory, no MCP restart
            });
    ...
    private AgenticMed1010AfAgentFolderApp() {}
}
