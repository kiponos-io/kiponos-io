package io.kiponos.examples.medium.mediumdecoratorhealthcar;
 ...
 * Tree: examples / medium-decorator-healthcare-live / active
...
public final class LivePostureApp {
    public static void main(String[] args) throws Exception {
        ...
        try {
            ...
            System.out.println("  example: medium-decorator-healthcare-live");
    ...
    static Folder ensure(Kiponos k) {
        Folder f = k.getRootFolder().folderOrCreate("examples").folderOrCreate("medium-decorator-healthcare-live");
        if (!f.hasKey("active")) {
