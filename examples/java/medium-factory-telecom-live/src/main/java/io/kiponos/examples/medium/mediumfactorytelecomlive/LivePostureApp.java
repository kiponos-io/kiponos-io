package io.kiponos.examples.medium.mediumfactorytelecomlive;
 ...
 * Tree: examples / medium-factory-telecom-live / active
...
public final class LivePostureApp {
    public static void main(String[] args) throws Exception {
        ...
        try {
            ...
            System.out.println("  example: medium-factory-telecom-live");
    ...
    static Folder ensure(Kiponos k) {
        Folder f = k.getRootFolder().folderOrCreate("examples").folderOrCreate("medium-factory-telecom-live");
        if (!f.hasKey("active")) {
