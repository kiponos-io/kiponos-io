 ...
 * Hub leaf: examples/agentic-med-1006-af-budget-turn/max-tokens (default 8000)
 ...
 */
public final class AgenticMed1006AfBudgetTurnApp {
    public static final String KEY = "max-tokens";
    public static final String DEFAULT = "8000";
    public static final String FOLDER = "agentic-med-1006-af-budget-turn";
    ...
    public static void main(String[] args) throws Exception {
        ...
        try {
            ...
            k.afterValueUpdated((ConfigValUpdatedResponse ev) -> {
                ...
                // live leaf examples/agentic-med-1006-af-budget-turn — next decide() is in-memory, no MCP restart
            });
    ...
    private AgenticMed1006AfBudgetTurnApp() {}
}
