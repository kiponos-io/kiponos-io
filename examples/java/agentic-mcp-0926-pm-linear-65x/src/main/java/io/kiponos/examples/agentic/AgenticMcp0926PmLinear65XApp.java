 ...
 * Hub leaf: examples/agentic-mcp-0926-pm-linear-65x/result-cap (default 2000)
 ...
 */
public final class AgenticMcp0926PmLinear65XApp {
    public static final String KEY = "result-cap";
    public static final String DEFAULT = "2000";
    public static final String FOLDER = "agentic-mcp-0926-pm-linear-65x";
    ...
    public static void main(String[] args) throws Exception {
        ...
        try {
            ...
            k.afterValueUpdated((ConfigValUpdatedResponse ev) -> {
                ...
                // live leaf examples/agentic-mcp-0926-pm-linear-65x — next decide() is in-memory, no MCP restart
            });
    ...
    private AgenticMcp0926PmLinear65XApp() {}
}
