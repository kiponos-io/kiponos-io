package io.kiponos.examples.medium.mediumchaininsurancelive;
 ...
 * Tree: examples / medium-chain-insurance-live / active
...
public final class LivePostureApp {
    public static void main(String[] args) throws Exception {
        ...
        try {
            ...
            System.out.println("  example: medium-chain-insurance-live");
    ...
    static Folder ensure(Kiponos k) {
        Folder f = k.getRootFolder().folderOrCreate("examples").folderOrCreate("medium-chain-insurance-live");
        if (!f.hasKey("active")) {
