package io.kiponos.examples.medium.mediumchaintravellive;
 ...
 * Tree: examples / medium-chain-travel-live / active
...
public final class LivePostureApp {
    public static void main(String[] args) throws Exception {
        ...
        try {
            ...
            System.out.println("  example: medium-chain-travel-live");
    ...
    static Folder ensure(Kiponos k) {
        Folder f = k.getRootFolder().folderOrCreate("examples").folderOrCreate("medium-chain-travel-live");
        if (!f.hasKey("active")) {
