package io.kiponos.examples.medium.mediumfactorysaaslive;
 ...
 * Tree: examples / medium-factory-saas-live / active
...
public final class LivePostureApp {
    public static void main(String[] args) throws Exception {
        ...
        try {
            ...
            System.out.println("  example: medium-factory-saas-live");
    ...
    static Folder ensure(Kiponos k) {
        Folder f = k.getRootFolder().folderOrCreate("examples").folderOrCreate("medium-factory-saas-live");
        if (!f.hasKey("active")) {
