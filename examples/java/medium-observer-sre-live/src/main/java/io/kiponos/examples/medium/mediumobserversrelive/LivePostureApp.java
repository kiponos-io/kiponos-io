package io.kiponos.examples.medium.mediumobserversrelive;
 ...
 * Tree: examples / medium-observer-sre-live / active
...
public final class LivePostureApp {
    public static void main(String[] args) throws Exception {
        ...
        try {
            ...
            System.out.println("  example: medium-observer-sre-live");
    ...
    static Folder ensure(Kiponos k) {
        Folder f = k.getRootFolder().folderOrCreate("examples").folderOrCreate("medium-observer-sre-live");
        if (!f.hasKey("active")) {
