 ...
 * Hub leaf: examples/agentic-mcp-0918-pm-oauth-not-knob/session-posture (default focus=admin-wall,shopping-pause=off)
 ...
 */
public final class AgenticMcp0918PmOauthNotKnobApp {
    public static final String KEY = "session-posture";
    public static final String DEFAULT = "focus=admin-wall,shopping-pause=off";
    public static final String FOLDER = "agentic-mcp-0918-pm-oauth-not-knob";
    ...
    public static void main(String[] args) throws Exception {
        ...
        try {
            ...
            k.afterValueUpdated((ConfigValUpdatedResponse ev) -> {
                ...
                // live leaf examples/agentic-mcp-0918-pm-oauth-not-knob — next decide() is in-memory, no MCP restart
            });
    ...
    private AgenticMcp0918PmOauthNotKnobApp() {}
}
