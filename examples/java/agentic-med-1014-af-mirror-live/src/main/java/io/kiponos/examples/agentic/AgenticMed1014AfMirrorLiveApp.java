 ...
 * Hub leaf: examples/agentic-med-1014-af-mirror-live/device-live (default yes)
 ...
 */
public final class AgenticMed1014AfMirrorLiveApp {
    public static final String KEY = "device-live";
    public static final String DEFAULT = "yes";
    public static final String FOLDER = "agentic-med-1014-af-mirror-live";
    ...
    public static void main(String[] args) throws Exception {
        ...
        try {
            ...
            k.afterValueUpdated((ConfigValUpdatedResponse ev) -> {
                ...
                // live leaf examples/agentic-med-1014-af-mirror-live — next decide() is in-memory, no MCP restart
            });
    ...
    private AgenticMed1014AfMirrorLiveApp() {}
}
