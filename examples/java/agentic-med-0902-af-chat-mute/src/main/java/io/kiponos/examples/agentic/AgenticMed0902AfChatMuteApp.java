 ...
 * Hub leaf: examples/agentic-med-0902-af-chat-mute/chat-mute (default none)
 ...
 */
public final class AgenticMed0902AfChatMuteApp {
    public static final String KEY = "chat-mute";
    public static final String DEFAULT = "none";
    public static final String FOLDER = "agentic-med-0902-af-chat-mute";
    ...
    public static void main(String[] args) throws Exception {
        ...
        try {
            ...
            k.afterValueUpdated((ConfigValUpdatedResponse ev) -> {
                ...
                // live leaf examples/agentic-med-0902-af-chat-mute — next decide() is in-memory, no MCP restart
            });
    ...
    private AgenticMed0902AfChatMuteApp() {}
}
