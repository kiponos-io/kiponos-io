 ...
 * Hub leaf: examples/agentic-mcp-1007-am-unaware-primitive/shared-truth (default live)
 ...
 */
public final class AgenticMcp1007AmUnawarePrimitiveApp {
    public static final String KEY = "shared-truth";
    public static final String DEFAULT = "live";
    public static final String FOLDER = "agentic-mcp-1007-am-unaware-primitive";
    ...
    public static void main(String[] args) throws Exception {
        ...
        try {
            ...
            k.afterValueUpdated((ConfigValUpdatedResponse ev) -> {
                ...
                // live leaf examples/agentic-mcp-1007-am-unaware-primitive — next decide() is in-memory, no MCP restart
            });
    ...
    private AgenticMcp1007AmUnawarePrimitiveApp() {}
}
