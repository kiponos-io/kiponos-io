package io.kiponos.examples.medium.mediumstatetravellive;
 ...
 * Tree: examples / medium-state-travel-live / active
...
public final class LivePostureApp {
    public static void main(String[] args) throws Exception {
        ...
        try {
            ...
            System.out.println("  example: medium-state-travel-live");
    ...
    static Folder ensure(Kiponos k) {
        Folder f = k.getRootFolder().folderOrCreate("examples").folderOrCreate("medium-state-travel-live");
        if (!f.hasKey("active")) {
