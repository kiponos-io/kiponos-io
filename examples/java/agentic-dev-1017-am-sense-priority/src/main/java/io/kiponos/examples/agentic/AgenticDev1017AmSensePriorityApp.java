 ...
 * Hub leaf: examples/agentic-dev-1017-am-sense-priority/priority (default P3)
 ...
 */
public final class AgenticDev1017AmSensePriorityApp {
    public static final String KEY = "priority";
    public static final String DEFAULT = "P3";
    public static final String FOLDER = "agentic-dev-1017-am-sense-priority";
    ...
    public static void main(String[] args) throws Exception {
        ...
        try {
            ...
            k.afterValueUpdated((ConfigValUpdatedResponse ev) -> {
                ...
                // live leaf examples/agentic-dev-1017-am-sense-priority — next decide() is in-memory, no MCP restart
            });
    ...
    private AgenticDev1017AmSensePriorityApp() {}
}
