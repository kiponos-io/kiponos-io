 ...
 * Hub leaf: examples/agentic-med-0907-mi-mirror-live/device-live (default yes)
 ...
 */
public final class AgenticMed0907MiMirrorLiveApp {
    public static final String KEY = "device-live";
    public static final String DEFAULT = "yes";
    public static final String FOLDER = "agentic-med-0907-mi-mirror-live";
    ...
    public static void main(String[] args) throws Exception {
        ...
        try {
            ...
            k.afterValueUpdated((ConfigValUpdatedResponse ev) -> {
                ...
                // live leaf examples/agentic-med-0907-mi-mirror-live — next decide() is in-memory, no MCP restart
            });
    ...
    private AgenticMed0907MiMirrorLiveApp() {}
}
