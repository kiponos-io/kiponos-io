package io.kiponos.examples.medium.mediumchainadslive;
 ...
 * Tree: examples / medium-chain-ads-live / active
...
public final class LivePostureApp {
    public static void main(String[] args) throws Exception {
        ...
        try {
            ...
            System.out.println("  example: medium-chain-ads-live");
    ...
    static Folder ensure(Kiponos k) {
        Folder f = k.getRootFolder().folderOrCreate("examples").folderOrCreate("medium-chain-ads-live");
        if (!f.hasKey("active")) {
