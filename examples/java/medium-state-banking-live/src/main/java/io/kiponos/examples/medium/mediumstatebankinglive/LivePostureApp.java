package io.kiponos.examples.medium.mediumstatebankinglive;
 ...
 * Tree: examples / medium-state-banking-live / active
...
public final class LivePostureApp {
    public static void main(String[] args) throws Exception {
        ...
        try {
            ...
            System.out.println("  example: medium-state-banking-live");
    ...
    static Folder ensure(Kiponos k) {
        Folder f = k.getRootFolder().folderOrCreate("examples").folderOrCreate("medium-state-banking-live");
        if (!f.hasKey("active")) {
