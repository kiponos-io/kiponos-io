package io.kiponos.examples.medium.mediumstrategyenergylive;
 ...
 * Tree: examples / medium-strategy-energy-live / active
...
public final class LivePostureApp {
    public static void main(String[] args) throws Exception {
        ...
        try {
            ...
            System.out.println("  example: medium-strategy-energy-live");
    ...
    static Folder ensure(Kiponos k) {
        Folder f = k.getRootFolder().folderOrCreate("examples").folderOrCreate("medium-strategy-energy-live");
        if (!f.hasKey("active")) {
