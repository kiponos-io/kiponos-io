 ...
 * Hub leaf: examples/agentic-mcp-1002-pm-embedded-native/shared-truth (default live)
 ...
 */
public final class AgenticMcp1002PmEmbeddedNativeApp {
    public static final String KEY = "shared-truth";
    public static final String DEFAULT = "live";
    public static final String FOLDER = "agentic-mcp-1002-pm-embedded-native";
    ...
    public static void main(String[] args) throws Exception {
        ...
        try {
            ...
            k.afterValueUpdated((ConfigValUpdatedResponse ev) -> {
                ...
                // live leaf examples/agentic-mcp-1002-pm-embedded-native — next decide() is in-memory, no MCP restart
            });
    ...
    private AgenticMcp1002PmEmbeddedNativeApp() {}
}
