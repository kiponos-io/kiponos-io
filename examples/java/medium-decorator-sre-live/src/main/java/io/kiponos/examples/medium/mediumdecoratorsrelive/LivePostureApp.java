package io.kiponos.examples.medium.mediumdecoratorsrelive;
 ...
 * Tree: examples / medium-decorator-sre-live / active
...
public final class LivePostureApp {
    public static void main(String[] args) throws Exception {
        ...
        try {
            ...
            System.out.println("  example: medium-decorator-sre-live");
    ...
    static Folder ensure(Kiponos k) {
        Folder f = k.getRootFolder().folderOrCreate("examples").folderOrCreate("medium-decorator-sre-live");
        if (!f.hasKey("active")) {
