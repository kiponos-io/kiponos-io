package io.kiponos.examples.medium.mediumchainhealthcareliv;
 ...
 * Tree: examples / medium-chain-healthcare-live / active
...
public final class LivePostureApp {
    public static void main(String[] args) throws Exception {
        ...
        try {
            ...
            System.out.println("  example: medium-chain-healthcare-live");
    ...
    static Folder ensure(Kiponos k) {
        Folder f = k.getRootFolder().folderOrCreate("examples").folderOrCreate("medium-chain-healthcare-live");
        if (!f.hasKey("active")) {
