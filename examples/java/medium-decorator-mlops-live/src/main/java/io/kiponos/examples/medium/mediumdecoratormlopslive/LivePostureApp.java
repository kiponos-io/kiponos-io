package io.kiponos.examples.medium.mediumdecoratormlopslive;
 ...
 * Tree: examples / medium-decorator-mlops-live / active
...
public final class LivePostureApp {
    public static void main(String[] args) throws Exception {
        ...
        try {
            ...
            System.out.println("  example: medium-decorator-mlops-live");
    ...
    static Folder ensure(Kiponos k) {
        Folder f = k.getRootFolder().folderOrCreate("examples").folderOrCreate("medium-decorator-mlops-live");
        if (!f.hasKey("active")) {
