 ...
 * Hub leaf: examples/agentic-mcp-0917-pm-code-mode/code-mode (default off)
 ...
 */
public final class AgenticMcp0917PmCodeModeApp {
    public static final String KEY = "code-mode";
    public static final String DEFAULT = "off";
    public static final String FOLDER = "agentic-mcp-0917-pm-code-mode";
    ...
    public static void main(String[] args) throws Exception {
        ...
        try {
            ...
            k.afterValueUpdated((ConfigValUpdatedResponse ev) -> {
                ...
                // live leaf examples/agentic-mcp-0917-pm-code-mode — next decide() is in-memory, no MCP restart
            });
    ...
    public static Decision decide(String raw) {
        ...
        return new Decision(v, live ? "code_mode_on" : "schema_dump_mode", live);
    }
    ...
    private AgenticMcp0917PmCodeModeApp() {}
}
