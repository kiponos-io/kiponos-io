 ...
 * Hub leaf: examples/agentic-med-0919-af-sense-priority/priority (default P3)
 ...
 */
public final class AgenticMed0919AfSensePriorityApp {
    public static final String KEY = "priority";
    public static final String DEFAULT = "P3";
    public static final String FOLDER = "agentic-med-0919-af-sense-priority";
    ...
    public static void main(String[] args) throws Exception {
        ...
        try {
            ...
            k.afterValueUpdated((ConfigValUpdatedResponse ev) -> {
                ...
                // live leaf examples/agentic-med-0919-af-sense-priority — next decide() is in-memory, no MCP restart
            });
    ...
    private AgenticMed0919AfSensePriorityApp() {}
}
