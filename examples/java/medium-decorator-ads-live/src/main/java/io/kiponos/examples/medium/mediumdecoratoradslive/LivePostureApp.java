package io.kiponos.examples.medium.mediumdecoratoradslive;
 ...
 * Tree: examples / medium-decorator-ads-live / active
...
public final class LivePostureApp {
    public static void main(String[] args) throws Exception {
        ...
        try {
            ...
            System.out.println("  example: medium-decorator-ads-live");
    ...
    static Folder ensure(Kiponos k) {
        Folder f = k.getRootFolder().folderOrCreate("examples").folderOrCreate("medium-decorator-ads-live");
        if (!f.hasKey("active")) {
