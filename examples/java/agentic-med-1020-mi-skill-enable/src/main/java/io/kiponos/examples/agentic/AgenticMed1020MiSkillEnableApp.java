 ...
 * Hub leaf: examples/agentic-med-1020-mi-skill-enable/enabled-set (default research,notify)
 ...
 */
public final class AgenticMed1020MiSkillEnableApp {
    public static final String KEY = "enabled-set";
    public static final String DEFAULT = "research,notify";
    public static final String FOLDER = "agentic-med-1020-mi-skill-enable";
    ...
    public static void main(String[] args) throws Exception {
        ...
        try {
            ...
            k.afterValueUpdated((ConfigValUpdatedResponse ev) -> {
                ...
                // live leaf examples/agentic-med-1020-mi-skill-enable — next decide() is in-memory, no MCP restart
            });
    ...
    private AgenticMed1020MiSkillEnableApp() {}
}
