package io.kiponos.examples.medium.mediumdecoratormedialive;
 ...
 * Tree: examples / medium-decorator-media-live / active
...
public final class LivePostureApp {
    public static void main(String[] args) throws Exception {
        ...
        try {
            ...
            System.out.println("  example: medium-decorator-media-live");
    ...
    static Folder ensure(Kiponos k) {
        Folder f = k.getRootFolder().folderOrCreate("examples").folderOrCreate("medium-decorator-media-live");
        if (!f.hasKey("active")) {
