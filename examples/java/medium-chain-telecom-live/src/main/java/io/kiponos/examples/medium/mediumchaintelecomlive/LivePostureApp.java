package io.kiponos.examples.medium.mediumchaintelecomlive;
 ...
 * Tree: examples / medium-chain-telecom-live / active
...
public final class LivePostureApp {
    public static void main(String[] args) throws Exception {
        ...
        try {
            ...
            System.out.println("  example: medium-chain-telecom-live");
    ...
    static Folder ensure(Kiponos k) {
        Folder f = k.getRootFolder().folderOrCreate("examples").folderOrCreate("medium-chain-telecom-live");
        if (!f.hasKey("active")) {
