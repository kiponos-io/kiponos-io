 ...
 * Hub leaf: examples/agentic-dev-0911-pm-skill-enable/enabled-set (default research,notify)
 ...
 */
public final class AgenticDev0911PmSkillEnableApp {
    public static final String KEY = "enabled-set";
    public static final String DEFAULT = "research,notify";
    public static final String FOLDER = "agentic-dev-0911-pm-skill-enable";
    ...
    public static void main(String[] args) throws Exception {
        ...
        try {
            ...
            k.afterValueUpdated((ConfigValUpdatedResponse ev) -> {
                ...
                // live leaf examples/agentic-dev-0911-pm-skill-enable — next decide() is in-memory, no MCP restart
            });
    ...
    private AgenticDev0911PmSkillEnableApp() {}
}
