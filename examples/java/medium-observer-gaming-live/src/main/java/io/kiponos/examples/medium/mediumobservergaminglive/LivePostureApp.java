package io.kiponos.examples.medium.mediumobservergaminglive;
 ...
 * Tree: examples / medium-observer-gaming-live / active
...
public final class LivePostureApp {
    public static void main(String[] args) throws Exception {
        ...
        try {
            ...
            System.out.println("  example: medium-observer-gaming-live");
    ...
    static Folder ensure(Kiponos k) {
        Folder f = k.getRootFolder().folderOrCreate("examples").folderOrCreate("medium-observer-gaming-live");
        if (!f.hasKey("active")) {
