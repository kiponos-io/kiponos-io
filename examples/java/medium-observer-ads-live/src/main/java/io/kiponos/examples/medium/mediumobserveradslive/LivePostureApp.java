package io.kiponos.examples.medium.mediumobserveradslive;
 ...
 * Tree: examples / medium-observer-ads-live / active
...
public final class LivePostureApp {
    public static void main(String[] args) throws Exception {
        ...
        try {
            ...
            System.out.println("  example: medium-observer-ads-live");
    ...
    static Folder ensure(Kiponos k) {
        Folder f = k.getRootFolder().folderOrCreate("examples").folderOrCreate("medium-observer-ads-live");
        if (!f.hasKey("active")) {
