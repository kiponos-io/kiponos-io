 ...
 * Hub leaf: examples/agentic-med-1021-mi-mcp-gate/tools-allow (default search,read)
 ...
 */
public final class AgenticMed1021MiMcpGateApp {
    public static final String KEY = "tools-allow";
    public static final String DEFAULT = "search,read";
    public static final String FOLDER = "agentic-med-1021-mi-mcp-gate";
    ...
    public static void main(String[] args) throws Exception {
        ...
        try {
            ...
            k.afterValueUpdated((ConfigValUpdatedResponse ev) -> {
                ...
                // live leaf examples/agentic-med-1021-mi-mcp-gate — next decide() is in-memory, no MCP restart
            });
    ...
    private AgenticMed1021MiMcpGateApp() {}
}
