package io.kiponos.examples.medium.mediumobserverbankingliv;
 ...
 * Tree: examples / medium-observer-banking-live / active
...
public final class LivePostureApp {
    public static void main(String[] args) throws Exception {
        ...
        try {
            ...
            System.out.println("  example: medium-observer-banking-live");
    ...
    static Folder ensure(Kiponos k) {
        Folder f = k.getRootFolder().folderOrCreate("examples").folderOrCreate("medium-observer-banking-live");
        if (!f.hasKey("active")) {
