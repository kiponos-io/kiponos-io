 ...
 * Hub leaf: examples/agentic-mcp-0909-pm-tool-space/tools-allow (default search,read)
 ...
 */
public final class AgenticMcp0909PmToolSpaceApp {
    public static final String KEY = "tools-allow";
    public static final String DEFAULT = "search,read";
    public static final String FOLDER = "agentic-mcp-0909-pm-tool-space";
    ...
    public static void main(String[] args) throws Exception {
        ...
        try {
            ...
            k.afterValueUpdated((ConfigValUpdatedResponse ev) -> {
                ...
                // live leaf examples/agentic-mcp-0909-pm-tool-space — next decide() is in-memory, no MCP restart
            });
    ...
    private AgenticMcp0909PmToolSpaceApp() {}
}
