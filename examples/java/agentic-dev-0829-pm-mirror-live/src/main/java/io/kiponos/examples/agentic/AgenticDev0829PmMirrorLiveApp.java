 ...
 * Hub leaf: examples/agentic-dev-0829-pm-mirror-live/device-live (default yes)
 ...
 */
public final class AgenticDev0829PmMirrorLiveApp {
    public static final String KEY = "device-live";
    public static final String DEFAULT = "yes";
    public static final String FOLDER = "agentic-dev-0829-pm-mirror-live";
    ...
    public static void main(String[] args) throws Exception {
        ...
        try {
            ...
            k.afterValueUpdated((ConfigValUpdatedResponse ev) -> {
                ...
                // live leaf examples/agentic-dev-0829-pm-mirror-live — next decide() is in-memory, no MCP restart
            });
    ...
    private AgenticDev0829PmMirrorLiveApp() {}
}
