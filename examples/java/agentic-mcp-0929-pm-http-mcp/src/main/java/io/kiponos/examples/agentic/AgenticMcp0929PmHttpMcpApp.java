 ...
 * Hub leaf: examples/agentic-mcp-0929-pm-http-mcp/tools-allow (default search,read)
 ...
 */
public final class AgenticMcp0929PmHttpMcpApp {
    public static final String KEY = "tools-allow";
    public static final String DEFAULT = "search,read";
    public static final String FOLDER = "agentic-mcp-0929-pm-http-mcp";
    ...
    public static void main(String[] args) throws Exception {
        ...
        try {
            ...
            k.afterValueUpdated((ConfigValUpdatedResponse ev) -> {
                ...
                // live leaf examples/agentic-mcp-0929-pm-http-mcp — next decide() is in-memory, no MCP restart
            });
    ...
    private AgenticMcp0929PmHttpMcpApp() {}
}
