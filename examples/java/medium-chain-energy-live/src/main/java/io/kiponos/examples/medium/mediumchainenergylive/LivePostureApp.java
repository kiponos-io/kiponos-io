package io.kiponos.examples.medium.mediumchainenergylive;
 ...
 * Tree: examples / medium-chain-energy-live / active
...
public final class LivePostureApp {
    public static void main(String[] args) throws Exception {
        ...
        try {
            ...
            System.out.println("  example: medium-chain-energy-live");
    ...
    static Folder ensure(Kiponos k) {
        Folder f = k.getRootFolder().folderOrCreate("examples").folderOrCreate("medium-chain-energy-live");
        if (!f.hasKey("active")) {
