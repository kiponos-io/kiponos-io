 ...
 * Hub leaf: examples/agentic-dev-0903-am-admin-wall/wall-focus (default checkout)
 ...
 */
public final class AgenticDev0903AmAdminWallApp {
    public static final String KEY = "wall-focus";
    public static final String DEFAULT = "checkout";
    public static final String FOLDER = "agentic-dev-0903-am-admin-wall";
    ...
    public static void main(String[] args) throws Exception {
        ...
        try {
            ...
            k.afterValueUpdated((ConfigValUpdatedResponse ev) -> {
                ...
                // live leaf examples/agentic-dev-0903-am-admin-wall — next decide() is in-memory, no MCP restart
            });
    ...
    private AgenticDev0903AmAdminWallApp() {}
}
