package io.kiponos.examples.medium.mediumfactorygaminglive;
 ...
 * Tree: examples / medium-factory-gaming-live / active
...
public final class LivePostureApp {
    public static void main(String[] args) throws Exception {
        ...
        try {
            ...
            System.out.println("  example: medium-factory-gaming-live");
    ...
    static Folder ensure(Kiponos k) {
        Folder f = k.getRootFolder().folderOrCreate("examples").folderOrCreate("medium-factory-gaming-live");
        if (!f.hasKey("active")) {
