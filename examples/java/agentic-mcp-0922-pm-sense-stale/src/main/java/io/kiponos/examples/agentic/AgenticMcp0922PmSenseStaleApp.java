 ...
 * Hub leaf: examples/agentic-mcp-0922-pm-sense-stale/priority (default P3)
 ...
 */
public final class AgenticMcp0922PmSenseStaleApp {
    public static final String KEY = "priority";
    public static final String DEFAULT = "P3";
    public static final String FOLDER = "agentic-mcp-0922-pm-sense-stale";
    ...
    public static void main(String[] args) throws Exception {
        ...
        try {
            ...
            k.afterValueUpdated((ConfigValUpdatedResponse ev) -> {
                ...
                // live leaf examples/agentic-mcp-0922-pm-sense-stale — next decide() is in-memory, no MCP restart
            });
    ...
    private AgenticMcp0922PmSenseStaleApp() {}
}
