package io.kiponos.examples.medium.mediumchainsecuritylive;
 ...
 * Tree: examples / medium-chain-security-live / active
...
public final class LivePostureApp {
    public static void main(String[] args) throws Exception {
        ...
        try {
            ...
            System.out.println("  example: medium-chain-security-live");
    ...
    static Folder ensure(Kiponos k) {
        Folder f = k.getRootFolder().folderOrCreate("examples").folderOrCreate("medium-chain-security-live");
        if (!f.hasKey("active")) {
