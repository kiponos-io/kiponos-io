package io.kiponos.examples.medium.mediumdecoratorretailliv;
 ...
 * Tree: examples / medium-decorator-retail-live / active
...
public final class LivePostureApp {
    public static void main(String[] args) throws Exception {
        ...
        try {
            ...
            System.out.println("  example: medium-decorator-retail-live");
    ...
    static Folder ensure(Kiponos k) {
        Folder f = k.getRootFolder().folderOrCreate("examples").folderOrCreate("medium-decorator-retail-live");
        if (!f.hasKey("active")) {
