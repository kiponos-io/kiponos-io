 ...
 * Hub leaf: examples/agentic-mcp-1005-am-owner-folder/owner-agent (default travel-coordinator)
 ...
 */
public final class AgenticMcp1005AmOwnerFolderApp {
    public static final String KEY = "owner-agent";
    public static final String DEFAULT = "travel-coordinator";
    public static final String FOLDER = "agentic-mcp-1005-am-owner-folder";
    ...
    public static void main(String[] args) throws Exception {
        ...
        try {
            ...
            k.afterValueUpdated((ConfigValUpdatedResponse ev) -> {
                ...
                // live leaf examples/agentic-mcp-1005-am-owner-folder — next decide() is in-memory, no MCP restart
            });
    ...
    private AgenticMcp1005AmOwnerFolderApp() {}
}
