package io.kiponos.examples.medium.mediumfactorybankinglive;
 ...
 * Tree: examples / medium-factory-banking-live / active
...
public final class LivePostureApp {
    public static void main(String[] args) throws Exception {
        ...
        try {
            ...
            System.out.println("  example: medium-factory-banking-live");
    ...
    static Folder ensure(Kiponos k) {
        Folder f = k.getRootFolder().folderOrCreate("examples").folderOrCreate("medium-factory-banking-live");
        if (!f.hasKey("active")) {
