package io.kiponos.examples.medium.mediumstrategymedialive;
 ...
 * Tree: examples / medium-strategy-media-live / active
...
public final class LivePostureApp {
    public static void main(String[] args) throws Exception {
        ...
        try {
            ...
            System.out.println("  example: medium-strategy-media-live");
    ...
    static Folder ensure(Kiponos k) {
        Folder f = k.getRootFolder().folderOrCreate("examples").folderOrCreate("medium-strategy-media-live");
        if (!f.hasKey("active")) {
