package io.kiponos.examples.medium.mediumfactorylogisticsli;
 ...
 * Tree: examples / medium-factory-logistics-live / active
...
public final class LivePostureApp {
    public static void main(String[] args) throws Exception {
        ...
        try {
            ...
            System.out.println("  example: medium-factory-logistics-live");
    ...
    static Folder ensure(Kiponos k) {
        Folder f = k.getRootFolder().folderOrCreate("examples").folderOrCreate("medium-factory-logistics-live");
        if (!f.hasKey("active")) {
