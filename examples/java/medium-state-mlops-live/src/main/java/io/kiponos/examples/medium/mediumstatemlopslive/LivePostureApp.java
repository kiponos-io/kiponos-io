package io.kiponos.examples.medium.mediumstatemlopslive;
 ...
 * Tree: examples / medium-state-mlops-live / active
...
public final class LivePostureApp {
    public static void main(String[] args) throws Exception {
        ...
        try {
            ...
            System.out.println("  example: medium-state-mlops-live");
    ...
    static Folder ensure(Kiponos k) {
        Folder f = k.getRootFolder().folderOrCreate("examples").folderOrCreate("medium-state-mlops-live");
        if (!f.hasKey("active")) {
