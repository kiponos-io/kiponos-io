package io.kiponos.examples.medium.mediumobservermarketplac;
 ...
 * Tree: examples / medium-observer-marketplace-live / active
...
public final class LivePostureApp {
    public static void main(String[] args) throws Exception {
        ...
        try {
            ...
            System.out.println("  example: medium-observer-marketplace-live");
    ...
    static Folder ensure(Kiponos k) {
        Folder f = k.getRootFolder().folderOrCreate("examples").folderOrCreate("medium-observer-marketplace-live");
        if (!f.hasKey("active")) {
