package io.kiponos.examples.medium.mediumstateedtechlive;
 ...
 * Tree: examples / medium-state-edtech-live / active
...
public final class LivePostureApp {
    public static void main(String[] args) throws Exception {
        ...
        try {
            ...
            System.out.println("  example: medium-state-edtech-live");
    ...
    static Folder ensure(Kiponos k) {
        Folder f = k.getRootFolder().folderOrCreate("examples").folderOrCreate("medium-state-edtech-live");
        if (!f.hasKey("active")) {
