 ...
 * Hub leaf: examples/agentic-mcp-0911-pm-write-gate/tools-allow (default search,read)
 ...
 */
public final class AgenticMcp0911PmWriteGateApp {
    public static final String KEY = "tools-allow";
    public static final String DEFAULT = "search,read";
    public static final String FOLDER = "agentic-mcp-0911-pm-write-gate";
    ...
    public static void main(String[] args) throws Exception {
        ...
        try {
            ...
            k.afterValueUpdated((ConfigValUpdatedResponse ev) -> {
                ...
                // live leaf examples/agentic-mcp-0911-pm-write-gate — next decide() is in-memory, no MCP restart
            });
    ...
    private AgenticMcp0911PmWriteGateApp() {}
}
