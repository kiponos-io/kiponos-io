package io.kiponos.examples.medium.mediumdecoratorsaaslive;
 ...
 * Tree: examples / medium-decorator-saas-live / active
...
public final class LivePostureApp {
    public static void main(String[] args) throws Exception {
        ...
        try {
            ...
            System.out.println("  example: medium-decorator-saas-live");
    ...
    static Folder ensure(Kiponos k) {
        Folder f = k.getRootFolder().folderOrCreate("examples").folderOrCreate("medium-decorator-saas-live");
        if (!f.hasKey("active")) {
