package io.kiponos.examples.medium.mediumfactorymlopslive;
 ...
 * Tree: examples / medium-factory-mlops-live / active
...
public final class LivePostureApp {
    public static void main(String[] args) throws Exception {
        ...
        try {
            ...
            System.out.println("  example: medium-factory-mlops-live");
    ...
    static Folder ensure(Kiponos k) {
        Folder f = k.getRootFolder().folderOrCreate("examples").folderOrCreate("medium-factory-mlops-live");
        if (!f.hasKey("active")) {
