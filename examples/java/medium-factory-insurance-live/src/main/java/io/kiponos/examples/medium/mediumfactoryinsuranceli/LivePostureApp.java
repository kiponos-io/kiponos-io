package io.kiponos.examples.medium.mediumfactoryinsuranceli;
 ...
 * Tree: examples / medium-factory-insurance-live / active
...
public final class LivePostureApp {
    public static void main(String[] args) throws Exception {
        ...
        try {
            ...
            System.out.println("  example: medium-factory-insurance-live");
    ...
    static Folder ensure(Kiponos k) {
        Folder f = k.getRootFolder().folderOrCreate("examples").folderOrCreate("medium-factory-insurance-live");
        if (!f.hasKey("active")) {
