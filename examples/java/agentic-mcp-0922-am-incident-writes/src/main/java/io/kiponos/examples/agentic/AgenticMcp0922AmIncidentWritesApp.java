 ...
 * Hub leaf: examples/agentic-mcp-0922-am-incident-writes/incident-pause (default off)
 ...
 */
public final class AgenticMcp0922AmIncidentWritesApp {
    public static final String KEY = "incident-pause";
    public static final String DEFAULT = "off";
    public static final String FOLDER = "agentic-mcp-0922-am-incident-writes";
    ...
    public static void main(String[] args) throws Exception {
        ...
        try {
            ...
            k.afterValueUpdated((ConfigValUpdatedResponse ev) -> {
                ...
                // live leaf examples/agentic-mcp-0922-am-incident-writes — next decide() is in-memory, no MCP restart
            });
    ...
    private AgenticMcp0922AmIncidentWritesApp() {}
}
