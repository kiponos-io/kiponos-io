 ...
 * Hub leaf: examples/agentic-dev-0918-am-agent-folder/owner-agent (default travel-coordinator)
 ...
 */
public final class AgenticDev0918AmAgentFolderApp {
    public static final String KEY = "owner-agent";
    public static final String DEFAULT = "travel-coordinator";
    public static final String FOLDER = "agentic-dev-0918-am-agent-folder";
    ...
    public static void main(String[] args) throws Exception {
        ...
        try {
            ...
            k.afterValueUpdated((ConfigValUpdatedResponse ev) -> {
                ...
                // live leaf examples/agentic-dev-0918-am-agent-folder — next decide() is in-memory, no MCP restart
            });
    ...
    private AgenticDev0918AmAgentFolderApp() {}
}
