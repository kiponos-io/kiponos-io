 ...
 * Hub leaf: examples/agentic-med-0905-mi-chat-mute/chat-mute (default none)
 ...
 */
public final class AgenticMed0905MiChatMuteApp {
    public static final String KEY = "chat-mute";
    public static final String DEFAULT = "none";
    public static final String FOLDER = "agentic-med-0905-mi-chat-mute";
    ...
    public static void main(String[] args) throws Exception {
        ...
        try {
            ...
            k.afterValueUpdated((ConfigValUpdatedResponse ev) -> {
                ...
                // live leaf examples/agentic-med-0905-mi-chat-mute — next decide() is in-memory, no MCP restart
            });
    ...
    private AgenticMed0905MiChatMuteApp() {}
}
