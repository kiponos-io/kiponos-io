 ...
 * Hub leaf: examples/agentic-dev-1005-am-skill-enable/enabled-set (default research,notify)
 ...
 */
public final class AgenticDev1005AmSkillEnableApp {
    public static final String KEY = "enabled-set";
    public static final String DEFAULT = "research,notify";
    public static final String FOLDER = "agentic-dev-1005-am-skill-enable";
    ...
    public static void main(String[] args) throws Exception {
        ...
        try {
            ...
            k.afterValueUpdated((ConfigValUpdatedResponse ev) -> {
                ...
                // live leaf examples/agentic-dev-1005-am-skill-enable — next decide() is in-memory, no MCP restart
            });
    ...
    private AgenticDev1005AmSkillEnableApp() {}
}
