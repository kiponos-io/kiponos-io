 ...
 * Hub leaf: examples/agentic-mcp-0919-pm-vector-not-posture/shared-truth (default live)
 ...
 */
public final class AgenticMcp0919PmVectorNotPostureApp {
    public static final String KEY = "shared-truth";
    public static final String DEFAULT = "live";
    public static final String FOLDER = "agentic-mcp-0919-pm-vector-not-posture";
    ...
    public static void main(String[] args) throws Exception {
        ...
        try {
            ...
            k.afterValueUpdated((ConfigValUpdatedResponse ev) -> {
                ...
                // live leaf examples/agentic-mcp-0919-pm-vector-not-posture — next decide() is in-memory, no MCP restart
            });
    ...
    private AgenticMcp0919PmVectorNotPostureApp() {}
}
