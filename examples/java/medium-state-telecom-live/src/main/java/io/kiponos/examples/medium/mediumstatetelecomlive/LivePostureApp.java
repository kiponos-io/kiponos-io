package io.kiponos.examples.medium.mediumstatetelecomlive;
 ...
 * Tree: examples / medium-state-telecom-live / active
...
public final class LivePostureApp {
    public static void main(String[] args) throws Exception {
        ...
        try {
            ...
            System.out.println("  example: medium-state-telecom-live");
    ...
    static Folder ensure(Kiponos k) {
        Folder f = k.getRootFolder().folderOrCreate("examples").folderOrCreate("medium-state-telecom-live");
        if (!f.hasKey("active")) {
