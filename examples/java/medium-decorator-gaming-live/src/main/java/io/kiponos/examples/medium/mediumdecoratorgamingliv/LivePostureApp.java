package io.kiponos.examples.medium.mediumdecoratorgamingliv;
 ...
 * Tree: examples / medium-decorator-gaming-live / active
...
public final class LivePostureApp {
    public static void main(String[] args) throws Exception {
        ...
        try {
            ...
            System.out.println("  example: medium-decorator-gaming-live");
    ...
    static Folder ensure(Kiponos k) {
        Folder f = k.getRootFolder().folderOrCreate("examples").folderOrCreate("medium-decorator-gaming-live");
        if (!f.hasKey("active")) {
