package io.kiponos.examples.medium.mediumfactorysecurityliv;
 ...
 * Tree: examples / medium-factory-security-live / active
...
public final class LivePostureApp {
    public static void main(String[] args) throws Exception {
        ...
        try {
            ...
            System.out.println("  example: medium-factory-security-live");
    ...
    static Folder ensure(Kiponos k) {
        Folder f = k.getRootFolder().folderOrCreate("examples").folderOrCreate("medium-factory-security-live");
        if (!f.hasKey("active")) {
