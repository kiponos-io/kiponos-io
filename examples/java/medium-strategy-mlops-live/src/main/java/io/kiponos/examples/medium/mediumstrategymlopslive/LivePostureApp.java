package io.kiponos.examples.medium.mediumstrategymlopslive;
 ...
 * Tree: examples / medium-strategy-mlops-live / active
...
public final class LivePostureApp {
    public static void main(String[] args) throws Exception {
        ...
        try {
            ...
            System.out.println("  example: medium-strategy-mlops-live");
    ...
    static Folder ensure(Kiponos k) {
        Folder f = k.getRootFolder().folderOrCreate("examples").folderOrCreate("medium-strategy-mlops-live");
        if (!f.hasKey("active")) {
