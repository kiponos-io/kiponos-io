package io.kiponos.examples.medium.mediumfactorymedialive;
 ...
 * Tree: examples / medium-factory-media-live / active
...
public final class LivePostureApp {
    public static void main(String[] args) throws Exception {
        ...
        try {
            ...
            System.out.println("  example: medium-factory-media-live");
    ...
    static Folder ensure(Kiponos k) {
        Folder f = k.getRootFolder().folderOrCreate("examples").folderOrCreate("medium-factory-media-live");
        if (!f.hasKey("active")) {
