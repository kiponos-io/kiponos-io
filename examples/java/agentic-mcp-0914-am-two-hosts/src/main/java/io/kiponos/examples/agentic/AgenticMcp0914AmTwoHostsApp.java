 ...
 * Hub leaf: examples/agentic-mcp-0914-am-two-hosts/session-posture (default focus=admin-wall,shopping-pause=off)
...
public final class AgenticMcp0914AmTwoHostsApp {
    ...
    public static void main(String[] args) throws Exception {
        ...
        try {
            ...
            k.afterValueUpdated((ConfigValUpdatedResponse ev) -> {
                ...
                // live leaf examples/agentic-mcp-0914-am-two-hosts — next decide() is in-memory, no MCP restart
            });
    ...
    private AgenticMcp0914AmTwoHostsApp() {}
}
