package io.kiponos.examples.medium.mediumchaincdnlive;
 ...
 * Tree: examples / medium-chain-cdn-live / active
...
public final class LivePostureApp {
    public static void main(String[] args) throws Exception {
        ...
        try {
            ...
            System.out.println("  example: medium-chain-cdn-live");
    ...
    static Folder ensure(Kiponos k) {
        Folder f = k.getRootFolder().folderOrCreate("examples").folderOrCreate("medium-chain-cdn-live");
        if (!f.hasKey("active")) {
