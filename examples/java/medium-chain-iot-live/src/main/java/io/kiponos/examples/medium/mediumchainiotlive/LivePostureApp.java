package io.kiponos.examples.medium.mediumchainiotlive;
 ...
 * Tree: examples / medium-chain-iot-live / active
...
public final class LivePostureApp {
    public static void main(String[] args) throws Exception {
        ...
        try {
            ...
            System.out.println("  example: medium-chain-iot-live");
    ...
    static Folder ensure(Kiponos k) {
        Folder f = k.getRootFolder().folderOrCreate("examples").folderOrCreate("medium-chain-iot-live");
        if (!f.hasKey("active")) {
