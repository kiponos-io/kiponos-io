...
class AbstractFactoryLiveRegionGoldenTest {
    ...
    void connectEnsureAndRun() {
        ...
        try {
            ...
            Folder policy = AbstractFactoryLiveRegionApp.ensure(kiponos);
            assertNotNull(policy);
            var f = AbstractFactoryLiveRegionApp.createFamily(policy); assertNotNull(f.currency().code());
            System.out.println("GOLDEN_OK AbstractFactoryLiveRegionApp");
