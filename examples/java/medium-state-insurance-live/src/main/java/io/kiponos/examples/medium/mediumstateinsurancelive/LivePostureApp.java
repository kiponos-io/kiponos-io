package io.kiponos.examples.medium.mediumstateinsurancelive;
 ...
 * Tree: examples / medium-state-insurance-live / active
...
public final class LivePostureApp {
    public static void main(String[] args) throws Exception {
        ...
        try {
            ...
            System.out.println("  example: medium-state-insurance-live");
    ...
    static Folder ensure(Kiponos k) {
        Folder f = k.getRootFolder().folderOrCreate("examples").folderOrCreate("medium-state-insurance-live");
        if (!f.hasKey("active")) {
