package io.kiponos.examples.medium.mediumchainmarketplaceli;
 ...
 * Tree: examples / medium-chain-marketplace-live / active
...
public final class LivePostureApp {
    public static void main(String[] args) throws Exception {
        ...
        try {
            ...
            System.out.println("  example: medium-chain-marketplace-live");
    ...
    static Folder ensure(Kiponos k) {
        Folder f = k.getRootFolder().folderOrCreate("examples").folderOrCreate("medium-chain-marketplace-live");
        if (!f.hasKey("active")) {
