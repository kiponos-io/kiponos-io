 ...
 * Hub leaf: examples/agentic-dev-1022-pm-mcp-gate/tools-allow (default search,read)
 ...
 */
public final class AgenticDev1022PmMcpGateApp {
    public static final String KEY = "tools-allow";
    public static final String DEFAULT = "search,read";
    public static final String FOLDER = "agentic-dev-1022-pm-mcp-gate";
    ...
    public static void main(String[] args) throws Exception {
        ...
        try {
            ...
            k.afterValueUpdated((ConfigValUpdatedResponse ev) -> {
                ...
                // live leaf examples/agentic-dev-1022-pm-mcp-gate — next decide() is in-memory, no MCP restart
            });
    ...
    private AgenticDev1022PmMcpGateApp() {}
}
