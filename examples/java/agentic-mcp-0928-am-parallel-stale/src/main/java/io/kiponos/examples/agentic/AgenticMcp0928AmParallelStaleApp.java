 ...
 * Hub leaf: examples/agentic-mcp-0928-am-parallel-stale/inherit-posture (default on)
 ...
 */
public final class AgenticMcp0928AmParallelStaleApp {
    public static final String KEY = "inherit-posture";
    public static final String DEFAULT = "on";
    public static final String FOLDER = "agentic-mcp-0928-am-parallel-stale";
    ...
    public static void main(String[] args) throws Exception {
        ...
        try {
            ...
            k.afterValueUpdated((ConfigValUpdatedResponse ev) -> {
                ...
                // live leaf examples/agentic-mcp-0928-am-parallel-stale — next decide() is in-memory, no MCP restart
            });
    ...
    private AgenticMcp0928AmParallelStaleApp() {}
}
