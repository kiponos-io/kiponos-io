package io.kiponos.examples.medium.mediumfactorysrelive;
 ...
 * Tree: examples / medium-factory-sre-live / active
...
public final class LivePostureApp {
    public static void main(String[] args) throws Exception {
        ...
        try {
            ...
            System.out.println("  example: medium-factory-sre-live");
    ...
    static Folder ensure(Kiponos k) {
        Folder f = k.getRootFolder().folderOrCreate("examples").folderOrCreate("medium-factory-sre-live");
        if (!f.hasKey("active")) {
