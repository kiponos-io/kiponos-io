 ...
 * Hub leaf: examples/agentic-mcp-0924-am-cursor-cap/tools-allow (default search,read)
 ...
 */
public final class AgenticMcp0924AmCursorCapApp {
    public static final String KEY = "tools-allow";
    public static final String DEFAULT = "search,read";
    public static final String FOLDER = "agentic-mcp-0924-am-cursor-cap";
    ...
    public static void main(String[] args) throws Exception {
        ...
        try {
            ...
            k.afterValueUpdated((ConfigValUpdatedResponse ev) -> {
                ...
                // live leaf examples/agentic-mcp-0924-am-cursor-cap — next decide() is in-memory, no MCP restart
            });
    ...
    private AgenticMcp0924AmCursorCapApp() {}
}
