 ...
 * Hub leaf: examples/agentic-mcp-0925-pm-perplexity-exit/shared-truth (default live)
 ...
 */
public final class AgenticMcp0925PmPerplexityExitApp {
    public static final String KEY = "shared-truth";
    public static final String DEFAULT = "live";
    public static final String FOLDER = "agentic-mcp-0925-pm-perplexity-exit";
    ...
    public static void main(String[] args) throws Exception {
        ...
        try {
            ...
            k.afterValueUpdated((ConfigValUpdatedResponse ev) -> {
                ...
                // live leaf examples/agentic-mcp-0925-pm-perplexity-exit — next decide() is in-memory, no MCP restart
            });
    ...
    private AgenticMcp0925PmPerplexityExitApp() {}
}
