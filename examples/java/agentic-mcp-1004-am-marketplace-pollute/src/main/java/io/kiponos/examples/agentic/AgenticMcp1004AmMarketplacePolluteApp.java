 ...
 * Hub leaf: examples/agentic-mcp-1004-am-marketplace-pollute/skill-trust (default core,reviewed)
 ...
 */
public final class AgenticMcp1004AmMarketplacePolluteApp {
    public static final String KEY = "skill-trust";
    public static final String DEFAULT = "core,reviewed";
    public static final String FOLDER = "agentic-mcp-1004-am-marketplace-pollute";
    ...
    public static void main(String[] args) throws Exception {
        ...
        try {
            ...
            k.afterValueUpdated((ConfigValUpdatedResponse ev) -> {
                ...
                // live leaf examples/agentic-mcp-1004-am-marketplace-pollute — next decide() is in-memory, no MCP restart
            });
    ...
    private AgenticMcp1004AmMarketplacePolluteApp() {}
}
