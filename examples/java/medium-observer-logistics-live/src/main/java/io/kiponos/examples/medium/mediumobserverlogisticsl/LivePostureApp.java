package io.kiponos.examples.medium.mediumobserverlogisticsl;
 ...
 * Tree: examples / medium-observer-logistics-live / active
...
public final class LivePostureApp {
    public static void main(String[] args) throws Exception {
        ...
        try {
            ...
            System.out.println("  example: medium-observer-logistics-live");
    ...
    static Folder ensure(Kiponos k) {
        Folder f = k.getRootFolder().folderOrCreate("examples").folderOrCreate("medium-observer-logistics-live");
        if (!f.hasKey("active")) {
