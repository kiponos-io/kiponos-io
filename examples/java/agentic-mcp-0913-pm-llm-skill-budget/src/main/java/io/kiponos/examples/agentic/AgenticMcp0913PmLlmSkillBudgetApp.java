 ...
 * Hub leaf: examples/agentic-mcp-0913-pm-llm-skill-budget/skill-budget (default on)
 ...
 */
public final class AgenticMcp0913PmLlmSkillBudgetApp {
    public static final String KEY = "skill-budget";
    public static final String DEFAULT = "on";
    public static final String FOLDER = "agentic-mcp-0913-pm-llm-skill-budget";
    ...
    public static void main(String[] args) throws Exception {
        ...
        try {
            ...
            k.afterValueUpdated((ConfigValUpdatedResponse ev) -> {
                ...
                // live leaf examples/agentic-mcp-0913-pm-llm-skill-budget — next decide() is in-memory, no MCP restart
            });
    ...
    public static Decision decide(String raw) {
        ...
        return new Decision(v, paused ? "generated_skills_blocked" : "generated_skills_ok", !paused);
    }
    ...
    private AgenticMcp0913PmLlmSkillBudgetApp() {}
}
