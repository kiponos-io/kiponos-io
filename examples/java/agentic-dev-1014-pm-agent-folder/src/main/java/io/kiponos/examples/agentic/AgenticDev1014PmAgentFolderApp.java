 ...
 * Hub leaf: examples/agentic-dev-1014-pm-agent-folder/owner-agent (default travel-coordinator)
 ...
 */
public final class AgenticDev1014PmAgentFolderApp {
    public static final String KEY = "owner-agent";
    public static final String DEFAULT = "travel-coordinator";
    public static final String FOLDER = "agentic-dev-1014-pm-agent-folder";
    ...
    public static void main(String[] args) throws Exception {
        ...
        try {
            ...
            k.afterValueUpdated((ConfigValUpdatedResponse ev) -> {
                ...
                // live leaf examples/agentic-dev-1014-pm-agent-folder — next decide() is in-memory, no MCP restart
            });
    ...
    private AgenticDev1014PmAgentFolderApp() {}
}
