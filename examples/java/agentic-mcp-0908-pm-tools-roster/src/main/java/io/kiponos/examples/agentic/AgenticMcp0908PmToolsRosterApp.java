 ...
 * Hub leaf: examples/agentic-mcp-0908-pm-tools-roster/tools-allow (default search,read)
 ...
 */
public final class AgenticMcp0908PmToolsRosterApp {
    public static final String KEY = "tools-allow";
    public static final String DEFAULT = "search,read";
    public static final String FOLDER = "agentic-mcp-0908-pm-tools-roster";
    ...
    public static void main(String[] args) throws Exception {
        ...
        try {
            ...
            k.afterValueUpdated((ConfigValUpdatedResponse ev) -> {
                ...
                // live leaf examples/agentic-mcp-0908-pm-tools-roster — next decide() is in-memory, no MCP restart
            });
    ...
    private AgenticMcp0908PmToolsRosterApp() {}
}
