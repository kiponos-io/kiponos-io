package io.kiponos.examples.medium.mediumstrategytravellive;
 ...
 * Tree: examples / medium-strategy-travel-live / active
...
public final class LivePostureApp {
    public static void main(String[] args) throws Exception {
        ...
        try {
            ...
            System.out.println("  example: medium-strategy-travel-live");
    ...
    static Folder ensure(Kiponos k) {
        Folder f = k.getRootFolder().folderOrCreate("examples").folderOrCreate("medium-strategy-travel-live");
        if (!f.hasKey("active")) {
