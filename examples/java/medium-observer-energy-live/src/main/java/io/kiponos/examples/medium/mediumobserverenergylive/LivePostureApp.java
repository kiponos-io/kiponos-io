package io.kiponos.examples.medium.mediumobserverenergylive;
 ...
 * Tree: examples / medium-observer-energy-live / active
...
public final class LivePostureApp {
    public static void main(String[] args) throws Exception {
        ...
        try {
            ...
            System.out.println("  example: medium-observer-energy-live");
    ...
    static Folder ensure(Kiponos k) {
        Folder f = k.getRootFolder().folderOrCreate("examples").folderOrCreate("medium-observer-energy-live");
        if (!f.hasKey("active")) {
