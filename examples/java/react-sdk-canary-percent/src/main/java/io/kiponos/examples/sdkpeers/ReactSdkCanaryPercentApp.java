         ...
         * Pain: canary percent frozen in SPA builds and YAML until the next train
         * Peers: Java + Python + @kiponos/react (Node server)
         */
        public final class ReactSdkCanaryPercentApp {
        ...
        // hot path: honor live live canary traffic percent without restart
        Thread.sleep(1200L);
                } finally {
                    k.disconnect();
                }
...
static int readInt(Folder p, String key, int def) {
    try {
        ...
        return def;
            ...
            private ReactSdkCanaryPercentApp() {}
        }
