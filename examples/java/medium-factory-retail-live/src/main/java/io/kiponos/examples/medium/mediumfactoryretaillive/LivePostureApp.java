package io.kiponos.examples.medium.mediumfactoryretaillive;
 ...
 * Tree: examples / medium-factory-retail-live / active
...
public final class LivePostureApp {
    public static void main(String[] args) throws Exception {
        ...
        try {
            ...
            System.out.println("  example: medium-factory-retail-live");
    ...
    static Folder ensure(Kiponos k) {
        Folder f = k.getRootFolder().folderOrCreate("examples").folderOrCreate("medium-factory-retail-live");
        if (!f.hasKey("active")) {
