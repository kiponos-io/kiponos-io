package io.kiponos.examples.medium.mediumproxyretaillive;
 ...
 * Tree: examples / medium-proxy-retail-live / active
...
public final class LivePostureApp {
    public static void main(String[] args) throws Exception {
        ...
        try {
            ...
            System.out.println("  example: medium-proxy-retail-live");
    ...
    static Folder ensure(Kiponos k) {
        Folder f = k.getRootFolder().folderOrCreate("examples").folderOrCreate("medium-proxy-retail-live");
        if (!f.hasKey("active")) {
