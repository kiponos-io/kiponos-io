package io.kiponos.examples.medium.mediumproxytravellive;
 ...
 * Tree: examples / medium-proxy-travel-live / active
...
public final class LivePostureApp {
    public static void main(String[] args) throws Exception {
        ...
        try {
            ...
            System.out.println("  example: medium-proxy-travel-live");
    ...
    static Folder ensure(Kiponos k) {
        Folder f = k.getRootFolder().folderOrCreate("examples").folderOrCreate("medium-proxy-travel-live");
        if (!f.hasKey("active")) {
