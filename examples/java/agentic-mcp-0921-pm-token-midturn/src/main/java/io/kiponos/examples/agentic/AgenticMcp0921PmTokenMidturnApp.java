 ...
 * Hub leaf: examples/agentic-mcp-0921-pm-token-midturn/max-tokens (default 8000)
 ...
 */
public final class AgenticMcp0921PmTokenMidturnApp {
    public static final String KEY = "max-tokens";
    public static final String DEFAULT = "8000";
    public static final String FOLDER = "agentic-mcp-0921-pm-token-midturn";
    ...
    public static void main(String[] args) throws Exception {
        ...
        try {
            ...
            k.afterValueUpdated((ConfigValUpdatedResponse ev) -> {
                ...
                // live leaf examples/agentic-mcp-0921-pm-token-midturn — next decide() is in-memory, no MCP restart
            });
    ...
    private AgenticMcp0921PmTokenMidturnApp() {}
}
