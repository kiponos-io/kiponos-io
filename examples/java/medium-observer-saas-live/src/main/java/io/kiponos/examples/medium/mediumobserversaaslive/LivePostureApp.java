package io.kiponos.examples.medium.mediumobserversaaslive;
 ...
 * Tree: examples / medium-observer-saas-live / active
...
public final class LivePostureApp {
    public static void main(String[] args) throws Exception {
        ...
        try {
            ...
            System.out.println("  example: medium-observer-saas-live");
    ...
    static Folder ensure(Kiponos k) {
        Folder f = k.getRootFolder().folderOrCreate("examples").folderOrCreate("medium-observer-saas-live");
        if (!f.hasKey("active")) {
