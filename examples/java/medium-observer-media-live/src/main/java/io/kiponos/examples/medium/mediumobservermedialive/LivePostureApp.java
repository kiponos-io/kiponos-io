package io.kiponos.examples.medium.mediumobservermedialive;
 ...
 * Tree: examples / medium-observer-media-live / active
...
public final class LivePostureApp {
    public static void main(String[] args) throws Exception {
        ...
        try {
            ...
            System.out.println("  example: medium-observer-media-live");
    ...
    static Folder ensure(Kiponos k) {
        Folder f = k.getRootFolder().folderOrCreate("examples").folderOrCreate("medium-observer-media-live");
        if (!f.hasKey("active")) {
