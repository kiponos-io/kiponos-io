package io.kiponos.examples.medium.mediumfactoryadslive;
 ...
 * Tree: examples / medium-factory-ads-live / active
...
public final class LivePostureApp {
    public static void main(String[] args) throws Exception {
        ...
        try {
            ...
            System.out.println("  example: medium-factory-ads-live");
    ...
    static Folder ensure(Kiponos k) {
        Folder f = k.getRootFolder().folderOrCreate("examples").folderOrCreate("medium-factory-ads-live");
        if (!f.hasKey("active")) {
