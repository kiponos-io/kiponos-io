package io.kiponos.examples.medium.mediumstatesrelive;
 ...
 * Tree: examples / medium-state-sre-live / active
...
public final class LivePostureApp {
    public static void main(String[] args) throws Exception {
        ...
        try {
            ...
            System.out.println("  example: medium-state-sre-live");
    ...
    static Folder ensure(Kiponos k) {
        Folder f = k.getRootFolder().folderOrCreate("examples").folderOrCreate("medium-state-sre-live");
        if (!f.hasKey("active")) {
