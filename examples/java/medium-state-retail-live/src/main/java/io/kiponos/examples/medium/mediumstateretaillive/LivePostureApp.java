package io.kiponos.examples.medium.mediumstateretaillive;
 ...
 * Tree: examples / medium-state-retail-live / active
...
public final class LivePostureApp {
    public static void main(String[] args) throws Exception {
        ...
        try {
            ...
            System.out.println("  example: medium-state-retail-live");
    ...
    static Folder ensure(Kiponos k) {
        Folder f = k.getRootFolder().folderOrCreate("examples").folderOrCreate("medium-state-retail-live");
        if (!f.hasKey("active")) {
