 ...
 * Hub leaf: examples/agentic-dev-0919-pm-admin-wall/wall-focus (default checkout)
 ...
 */
public final class AgenticDev0919PmAdminWallApp {
    public static final String KEY = "wall-focus";
    public static final String DEFAULT = "checkout";
    public static final String FOLDER = "agentic-dev-0919-pm-admin-wall";
    ...
    public static void main(String[] args) throws Exception {
        ...
        try {
            ...
            k.afterValueUpdated((ConfigValUpdatedResponse ev) -> {
                ...
                // live leaf examples/agentic-dev-0919-pm-admin-wall — next decide() is in-memory, no MCP restart
            });
    ...
    private AgenticDev0919PmAdminWallApp() {}
}
