 ...
 * Hub leaf: examples/agentic-mcp-1001-pm-exact-count/result-cap (default 2000)
 ...
 */
public final class AgenticMcp1001PmExactCountApp {
    public static final String KEY = "result-cap";
    public static final String DEFAULT = "2000";
    public static final String FOLDER = "agentic-mcp-1001-pm-exact-count";
    ...
    public static void main(String[] args) throws Exception {
        ...
        try {
            ...
            k.afterValueUpdated((ConfigValUpdatedResponse ev) -> {
                ...
                // live leaf examples/agentic-mcp-1001-pm-exact-count — next decide() is in-memory, no MCP restart
            });
    ...
    private AgenticMcp1001PmExactCountApp() {}
}
