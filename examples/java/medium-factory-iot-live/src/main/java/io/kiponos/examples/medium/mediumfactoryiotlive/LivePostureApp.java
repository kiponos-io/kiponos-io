package io.kiponos.examples.medium.mediumfactoryiotlive;
 ...
 * Tree: examples / medium-factory-iot-live / active
...
public final class LivePostureApp {
    public static void main(String[] args) throws Exception {
        ...
        try {
            ...
            System.out.println("  example: medium-factory-iot-live");
    ...
    static Folder ensure(Kiponos k) {
        Folder f = k.getRootFolder().folderOrCreate("examples").folderOrCreate("medium-factory-iot-live");
        if (!f.hasKey("active")) {
