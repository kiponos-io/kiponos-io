 ...
 * Hub leaf: examples/agentic-dev-0903-pm-sense-priority/priority (default P3)
 ...
 */
public final class AgenticDev0903PmSensePriorityApp {
    public static final String KEY = "priority";
    public static final String DEFAULT = "P3";
    public static final String FOLDER = "agentic-dev-0903-pm-sense-priority";
    ...
    public static void main(String[] args) throws Exception {
        ...
        try {
            ...
            k.afterValueUpdated((ConfigValUpdatedResponse ev) -> {
                ...
                // live leaf examples/agentic-dev-0903-pm-sense-priority — next decide() is in-memory, no MCP restart
            });
    ...
    private AgenticDev0903PmSensePriorityApp() {}
}
