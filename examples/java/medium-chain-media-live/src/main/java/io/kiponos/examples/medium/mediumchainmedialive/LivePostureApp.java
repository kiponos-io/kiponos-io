package io.kiponos.examples.medium.mediumchainmedialive;
 ...
 * Tree: examples / medium-chain-media-live / active
...
public final class LivePostureApp {
    public static void main(String[] args) throws Exception {
        ...
        try {
            ...
            System.out.println("  example: medium-chain-media-live");
    ...
    static Folder ensure(Kiponos k) {
        Folder f = k.getRootFolder().folderOrCreate("examples").folderOrCreate("medium-chain-media-live");
        if (!f.hasKey("active")) {
