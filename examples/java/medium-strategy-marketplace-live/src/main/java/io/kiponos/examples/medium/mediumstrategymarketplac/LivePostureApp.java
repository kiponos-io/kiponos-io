package io.kiponos.examples.medium.mediumstrategymarketplac;
 ...
 * Tree: examples / medium-strategy-marketplace-live / active
...
public final class LivePostureApp {
    public static void main(String[] args) throws Exception {
        ...
        try {
            ...
            System.out.println("  example: medium-strategy-marketplace-live");
    ...
    static Folder ensure(Kiponos k) {
        Folder f = k.getRootFolder().folderOrCreate("examples").folderOrCreate("medium-strategy-marketplace-live");
        if (!f.hasKey("active")) {
