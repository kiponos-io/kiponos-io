 ...
 * Hub leaf: examples/agentic-dev-0929-am-session-posture/session-posture (default focus=admin-wall,shopping-pause=off)
 ...
 */
public final class AgenticDev0929AmSessionPostureApp {
    public static final String KEY = "session-posture";
    public static final String DEFAULT = "focus=admin-wall,shopping-pause=off";
    public static final String FOLDER = "agentic-dev-0929-am-session-posture";
    ...
    public static void main(String[] args) throws Exception {
        ...
        try {
            ...
            k.afterValueUpdated((ConfigValUpdatedResponse ev) -> {
                ...
                // live leaf examples/agentic-dev-0929-am-session-posture — next decide() is in-memory, no MCP restart
            });
    ...
    private AgenticDev0929AmSessionPostureApp() {}
}
