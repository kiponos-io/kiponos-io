package io.kiponos.examples.medium.mediumfactorycdnlive;
 ...
 * Tree: examples / medium-factory-cdn-live / active
...
public final class LivePostureApp {
    public static void main(String[] args) throws Exception {
        ...
        try {
            ...
            System.out.println("  example: medium-factory-cdn-live");
    ...
    static Folder ensure(Kiponos k) {
        Folder f = k.getRootFolder().folderOrCreate("examples").folderOrCreate("medium-factory-cdn-live");
        if (!f.hasKey("active")) {
