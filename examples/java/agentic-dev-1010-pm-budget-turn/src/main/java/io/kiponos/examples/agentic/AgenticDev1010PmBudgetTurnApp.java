 ...
 * Hub leaf: examples/agentic-dev-1010-pm-budget-turn/max-tokens (default 8000)
 ...
 */
public final class AgenticDev1010PmBudgetTurnApp {
    public static final String KEY = "max-tokens";
    public static final String DEFAULT = "8000";
    public static final String FOLDER = "agentic-dev-1010-pm-budget-turn";
    ...
    public static void main(String[] args) throws Exception {
        ...
        try {
            ...
            k.afterValueUpdated((ConfigValUpdatedResponse ev) -> {
                ...
                // live leaf examples/agentic-dev-1010-pm-budget-turn — next decide() is in-memory, no MCP restart
            });
    ...
    private AgenticDev1010PmBudgetTurnApp() {}
}
