package io.kiponos.examples.medium.mediumobserveriotlive;
 ...
 * Tree: examples / medium-observer-iot-live / active
...
public final class LivePostureApp {
    public static void main(String[] args) throws Exception {
        ...
        try {
            ...
            System.out.println("  example: medium-observer-iot-live");
    ...
    static Folder ensure(Kiponos k) {
        Folder f = k.getRootFolder().folderOrCreate("examples").folderOrCreate("medium-observer-iot-live");
        if (!f.hasKey("active")) {
