package io.kiponos.examples.medium.mediumfactoryhealthcarel;
 ...
 * Tree: examples / medium-factory-healthcare-live / active
...
public final class LivePostureApp {
    public static void main(String[] args) throws Exception {
        ...
        try {
            ...
            System.out.println("  example: medium-factory-healthcare-live");
    ...
    static Folder ensure(Kiponos k) {
        Folder f = k.getRootFolder().folderOrCreate("examples").folderOrCreate("medium-factory-healthcare-live");
        if (!f.hasKey("active")) {
