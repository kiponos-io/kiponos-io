 ...
 * Hub leaf: examples/agentic-mcp-0928-pm-host-ceremony/tools-allow (default search,read)
 ...
 */
public final class AgenticMcp0928PmHostCeremonyApp {
    public static final String KEY = "tools-allow";
    public static final String DEFAULT = "search,read";
    public static final String FOLDER = "agentic-mcp-0928-pm-host-ceremony";
    ...
    public static void main(String[] args) throws Exception {
        ...
        try {
            ...
            k.afterValueUpdated((ConfigValUpdatedResponse ev) -> {
                ...
                // live leaf examples/agentic-mcp-0928-pm-host-ceremony — next decide() is in-memory, no MCP restart
            });
    ...
    private AgenticMcp0928PmHostCeremonyApp() {}
}
