package io.kiponos.examples.medium.mediumobserverfintechliv;
 ...
 * Tree: examples / medium-observer-fintech-live / active
...
public final class LivePostureApp {
    public static void main(String[] args) throws Exception {
        ...
        try {
            ...
            System.out.println("  example: medium-observer-fintech-live");
    ...
    static Folder ensure(Kiponos k) {
        Folder f = k.getRootFolder().folderOrCreate("examples").folderOrCreate("medium-observer-fintech-live");
        if (!f.hasKey("active")) {
