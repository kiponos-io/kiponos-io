 ...
 * Hub leaf: examples/agentic-mcp-0923-pm-lazy-schema/schema-budget (default 4000)
 ...
 */
public final class AgenticMcp0923PmLazySchemaApp {
    public static final String KEY = "schema-budget";
    public static final String DEFAULT = "4000";
    public static final String FOLDER = "agentic-mcp-0923-pm-lazy-schema";
    ...
    public static void main(String[] args) throws Exception {
        ...
        try {
            ...
            k.afterValueUpdated((ConfigValUpdatedResponse ev) -> {
                ...
                // live leaf examples/agentic-mcp-0923-pm-lazy-schema — next decide() is in-memory, no MCP restart
            });
    ...
    private AgenticMcp0923PmLazySchemaApp() {}
}
