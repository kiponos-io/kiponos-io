 ...
 * Hub leaf: examples/agentic-mcp-1002-am-midturn-flip/tools-allow (default search,read)
 ...
 */
public final class AgenticMcp1002AmMidturnFlipApp {
    public static final String KEY = "tools-allow";
    public static final String DEFAULT = "search,read";
    public static final String FOLDER = "agentic-mcp-1002-am-midturn-flip";
    ...
    public static void main(String[] args) throws Exception {
        ...
        try {
            ...
            k.afterValueUpdated((ConfigValUpdatedResponse ev) -> {
                ...
                // live leaf examples/agentic-mcp-1002-am-midturn-flip — next decide() is in-memory, no MCP restart
            });
    ...
    private AgenticMcp1002AmMidturnFlipApp() {}
}
