package io.kiponos.examples.medium.mediumstateenergylive;
 ...
 * Tree: examples / medium-state-energy-live / active
...
public final class LivePostureApp {
    public static void main(String[] args) throws Exception {
        ...
        try {
            ...
            System.out.println("  example: medium-state-energy-live");
    ...
    static Folder ensure(Kiponos k) {
        Folder f = k.getRootFolder().folderOrCreate("examples").folderOrCreate("medium-state-energy-live");
        if (!f.hasKey("active")) {
