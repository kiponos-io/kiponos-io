package io.kiponos.examples.medium.mediumchainmlopslive;
 ...
 * Tree: examples / medium-chain-mlops-live / active
...
public final class LivePostureApp {
    public static void main(String[] args) throws Exception {
        ...
        try {
            ...
            System.out.println("  example: medium-chain-mlops-live");
    ...
    static Folder ensure(Kiponos k) {
        Folder f = k.getRootFolder().folderOrCreate("examples").folderOrCreate("medium-chain-mlops-live");
        if (!f.hasKey("active")) {
