package io.kiponos.examples.medium.mediumstategaminglive;
 ...
 * Tree: examples / medium-state-gaming-live / active
...
public final class LivePostureApp {
    public static void main(String[] args) throws Exception {
        ...
        try {
            ...
            System.out.println("  example: medium-state-gaming-live");
    ...
    static Folder ensure(Kiponos k) {
        Folder f = k.getRootFolder().folderOrCreate("examples").folderOrCreate("medium-state-gaming-live");
        if (!f.hasKey("active")) {
