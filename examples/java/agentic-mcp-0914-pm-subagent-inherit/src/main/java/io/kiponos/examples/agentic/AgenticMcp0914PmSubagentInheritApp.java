 ...
 * Hub leaf: examples/agentic-mcp-0914-pm-subagent-inherit/inherit-posture (default on)
 ...
 */
public final class AgenticMcp0914PmSubagentInheritApp {
    public static final String KEY = "inherit-posture";
    public static final String DEFAULT = "on";
    public static final String FOLDER = "agentic-mcp-0914-pm-subagent-inherit";
    ...
    public static void main(String[] args) throws Exception {
        ...
        try {
            ...
            k.afterValueUpdated((ConfigValUpdatedResponse ev) -> {
                ...
                // live leaf examples/agentic-mcp-0914-pm-subagent-inherit — next decide() is in-memory, no MCP restart
            });
    ...
    public static Decision decide(String raw) {
        ...
        return new Decision(v, live ? "child_reads_hub" : "child_frozen_argv", live);
    }
    ...
    private AgenticMcp0914PmSubagentInheritApp() {}
}
