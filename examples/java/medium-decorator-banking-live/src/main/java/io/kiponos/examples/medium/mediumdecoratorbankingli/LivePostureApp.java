package io.kiponos.examples.medium.mediumdecoratorbankingli;
 ...
 * Tree: examples / medium-decorator-banking-live / active
...
public final class LivePostureApp {
    public static void main(String[] args) throws Exception {
        ...
        try {
            ...
            System.out.println("  example: medium-decorator-banking-live");
    ...
    static Folder ensure(Kiponos k) {
        Folder f = k.getRootFolder().folderOrCreate("examples").folderOrCreate("medium-decorator-banking-live");
        if (!f.hasKey("active")) {
