 ...
 * Hub leaf: examples/agentic-med-1023-mi-agent-folder/owner-agent (default travel-coordinator)
 ...
 */
public final class AgenticMed1023MiAgentFolderApp {
    public static final String KEY = "owner-agent";
    public static final String DEFAULT = "travel-coordinator";
    public static final String FOLDER = "agentic-med-1023-mi-agent-folder";
    ...
    public static void main(String[] args) throws Exception {
        ...
        try {
            ...
            k.afterValueUpdated((ConfigValUpdatedResponse ev) -> {
                ...
                // live leaf examples/agentic-med-1023-mi-agent-folder — next decide() is in-memory, no MCP restart
            });
    ...
    private AgenticMed1023MiAgentFolderApp() {}
}
