package io.kiponos.examples.medium.mediumdecoratorinsurance;
 ...
 * Tree: examples / medium-decorator-insurance-live / active
...
public final class LivePostureApp {
    public static void main(String[] args) throws Exception {
        ...
        try {
            ...
            System.out.println("  example: medium-decorator-insurance-live");
    ...
    static Folder ensure(Kiponos k) {
        Folder f = k.getRootFolder().folderOrCreate("examples").folderOrCreate("medium-decorator-insurance-live");
        if (!f.hasKey("active")) {
