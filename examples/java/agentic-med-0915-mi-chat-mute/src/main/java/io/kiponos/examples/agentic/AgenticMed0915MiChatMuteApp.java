 ...
 * Hub leaf: examples/agentic-med-0915-mi-chat-mute/chat-mute (default none)
 ...
 */
public final class AgenticMed0915MiChatMuteApp {
    public static final String KEY = "chat-mute";
    public static final String DEFAULT = "none";
    public static final String FOLDER = "agentic-med-0915-mi-chat-mute";
    ...
    public static void main(String[] args) throws Exception {
        ...
        try {
            ...
            k.afterValueUpdated((ConfigValUpdatedResponse ev) -> {
                ...
                // live leaf examples/agentic-med-0915-mi-chat-mute — next decide() is in-memory, no MCP restart
            });
    ...
    private AgenticMed0915MiChatMuteApp() {}
}
