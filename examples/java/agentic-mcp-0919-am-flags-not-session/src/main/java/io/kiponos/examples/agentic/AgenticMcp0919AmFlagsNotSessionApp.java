 ...
 * Hub leaf: examples/agentic-mcp-0919-am-flags-not-session/tools-allow (default search,read)
 ...
 */
public final class AgenticMcp0919AmFlagsNotSessionApp {
    public static final String KEY = "tools-allow";
    public static final String DEFAULT = "search,read";
    public static final String FOLDER = "agentic-mcp-0919-am-flags-not-session";
    ...
    public static void main(String[] args) throws Exception {
        ...
        try {
            ...
            k.afterValueUpdated((ConfigValUpdatedResponse ev) -> {
                ...
                // live leaf examples/agentic-mcp-0919-am-flags-not-session — next decide() is in-memory, no MCP restart
            });
    ...
    private AgenticMcp0919AmFlagsNotSessionApp() {}
}
