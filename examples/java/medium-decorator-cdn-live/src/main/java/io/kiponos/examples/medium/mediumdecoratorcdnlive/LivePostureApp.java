package io.kiponos.examples.medium.mediumdecoratorcdnlive;
 ...
 * Tree: examples / medium-decorator-cdn-live / active
...
public final class LivePostureApp {
    public static void main(String[] args) throws Exception {
        ...
        try {
            ...
            System.out.println("  example: medium-decorator-cdn-live");
    ...
    static Folder ensure(Kiponos k) {
        Folder f = k.getRootFolder().folderOrCreate("examples").folderOrCreate("medium-decorator-cdn-live");
        if (!f.hasKey("active")) {
