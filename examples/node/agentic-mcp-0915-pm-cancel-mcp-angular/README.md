# agentic-mcp-0915-pm-cancel-mcp
...
```text
examples/agentic-mcp-0915-pm-cancel-mcp/cancel-token = off
```
...
| SDK | Path | How to run |
|-----|------|------------|
| Java | `examples/java/agentic-mcp-0915-pm-cancel-mcp` | `./gradlew test run` |
| Python | `examples/python/agentic-mcp-0915-pm-cancel-mcp` | `python3 -m pytest -q && python3 peer.py` |
| React (Node BFF) | `examples/node/agentic-mcp-0915-pm-cancel-mcp-react` | `npm install && npm test && node peer.mjs` |
| Angular (Node BFF) | `examples/node/agentic-mcp-0915-pm-cancel-mcp-angular` | `npm install && npm test && node peer.mjs` |
...
```bash
cd examples/node/agentic-mcp-0915-pm-cancel-mcp-angular
npm install
npm test
node peer.mjs
