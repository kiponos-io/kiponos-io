# agentic-med-1004-mi-session-posture
...
```text
examples/agentic-med-1004-mi-session-posture/session-posture = focus=admin-wall,shopping-pause=off
```
...
| SDK | Path | How to run |
|-----|------|------------|
| Java | `examples/java/agentic-med-1004-mi-session-posture` | `./gradlew test run` |
| Python | `examples/python/agentic-med-1004-mi-session-posture` | `python3 -m pytest -q && python3 peer.py` |
| React (Node BFF) | `examples/node/agentic-med-1004-mi-session-posture-react` | `npm install && npm test && node peer.mjs` |
| Angular (Node BFF) | `examples/node/agentic-med-1004-mi-session-posture-angular` | `npm install && npm test && node peer.mjs` |
...
```bash
cd examples/node/agentic-med-1004-mi-session-posture-angular
npm install
npm test
node peer.mjs
