...
```text
examples/agentic-dev-1027-pm-shopping-pause/incident-pause = off
```
...
| SDK | Path | How to run |
|-----|------|------------|
| Java | `examples/java/agentic-dev-1027-pm-shopping-pause` | `./gradlew test run` |
| Python | `examples/python/agentic-dev-1027-pm-shopping-pause` | `python3 -m pytest -q && python3 peer.py` |
| React (Node BFF) | `examples/node/agentic-dev-1027-pm-shopping-pause-react` | `npm install && npm test && node peer.mjs` |
| Angular (Node BFF) | `examples/node/agentic-dev-1027-pm-shopping-pause-angular` | `npm install && npm test && node peer.mjs` |
...
```bash
cd examples/node/agentic-dev-1027-pm-shopping-pause-angular
npm install
npm test
node peer.mjs
