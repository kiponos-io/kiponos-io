# agentic-med-0830-af-sense-priority

I Restarted MCP host to Flip Sense priority mid-turn — The Shopping Wall Already Knew
...
```text
examples/agentic-med-0830-af-sense-priority/priority = P3
```
...
| SDK | Path | How to run |
|-----|------|------------|
| Java | `examples/java/agentic-med-0830-af-sense-priority` | `./gradlew test run` |
| Python | `examples/python/agentic-med-0830-af-sense-priority` | `python3 -m pytest -q && python3 peer.py` |
| React (Node BFF) | `examples/node/agentic-med-0830-af-sense-priority-react` | `npm install && npm test && node peer.mjs` |
| Angular (Node BFF) | `examples/node/agentic-med-0830-af-sense-priority-angular` | `npm install && npm test && node peer.mjs` |
...
```bash
cd examples/node/agentic-med-0830-af-sense-priority-angular
npm install
npm test
node peer.mjs
