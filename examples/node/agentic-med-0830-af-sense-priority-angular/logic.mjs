/**
 * Pure hot-path for agentic-med-0830-af-sense-priority (angular Node BFF).
 * No tokens here — tests run offline.
 */
export const KEY = "priority";
export const DEFAULT = "P3";
export const FOLDER = "agentic-med-0830-af-sense-priority";
export const PATH = "examples/agentic-med-0830-af-sense-priority/priority";
