# agentic-mcp-0911-am-zombie-drain
...
```text
examples/agentic-mcp-0911-am-zombie-drain/mcp-drain = off
```
...
| SDK | Path | How to run |
|-----|------|------------|
| Java | `examples/java/agentic-mcp-0911-am-zombie-drain` | `./gradlew test run` |
| Python | `examples/python/agentic-mcp-0911-am-zombie-drain` | `python3 -m pytest -q && python3 peer.py` |
| React (Node BFF) | `examples/node/agentic-mcp-0911-am-zombie-drain-react` | `npm install && npm test && node peer.mjs` |
| Angular (Node BFF) | `examples/node/agentic-mcp-0911-am-zombie-drain-angular` | `npm install && npm test && node peer.mjs` |
...
```bash
cd examples/node/agentic-mcp-0911-am-zombie-drain-angular
npm install
npm test
node peer.mjs
