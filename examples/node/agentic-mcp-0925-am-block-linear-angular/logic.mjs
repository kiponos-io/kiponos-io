/**
 * Pure hot-path for agentic-mcp-0925-am-block-linear (angular Node BFF).
 * No tokens here — tests run offline.
 */
export const KEY = "result-cap";
export const DEFAULT = "2000";
export const FOLDER = "agentic-mcp-0925-am-block-linear";
export const PATH = "examples/agentic-mcp-0925-am-block-linear/result-cap";
