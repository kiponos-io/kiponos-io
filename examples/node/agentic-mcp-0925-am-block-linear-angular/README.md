# agentic-mcp-0925-am-block-linear
...
```text
examples/agentic-mcp-0925-am-block-linear/result-cap = 2000
```
...
| SDK | Path | How to run |
|-----|------|------------|
| Java | `examples/java/agentic-mcp-0925-am-block-linear` | `./gradlew test run` |
| Python | `examples/python/agentic-mcp-0925-am-block-linear` | `python3 -m pytest -q && python3 peer.py` |
| React (Node BFF) | `examples/node/agentic-mcp-0925-am-block-linear-react` | `npm install && npm test && node peer.mjs` |
| Angular (Node BFF) | `examples/node/agentic-mcp-0925-am-block-linear-angular` | `npm install && npm test && node peer.mjs` |
...
```bash
cd examples/node/agentic-mcp-0925-am-block-linear-angular
npm install
npm test
node peer.mjs
