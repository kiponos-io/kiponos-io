...
```text
examples/agentic-dev-1012-am-mirror-live/device-live = yes
```
...
| SDK | Path | How to run |
|-----|------|------------|
| Java | `examples/java/agentic-dev-1012-am-mirror-live` | `./gradlew test run` |
| Python | `examples/python/agentic-dev-1012-am-mirror-live` | `python3 -m pytest -q && python3 peer.py` |
| React (Node BFF) | `examples/node/agentic-dev-1012-am-mirror-live-react` | `npm install && npm test && node peer.mjs` |
| Angular (Node BFF) | `examples/node/agentic-dev-1012-am-mirror-live-angular` | `npm install && npm test && node peer.mjs` |
...
```bash
cd examples/node/agentic-dev-1012-am-mirror-live-angular
npm install
npm test
node peer.mjs
