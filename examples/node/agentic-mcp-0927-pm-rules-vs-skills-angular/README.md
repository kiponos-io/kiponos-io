# agentic-mcp-0927-pm-rules-vs-skills
...
```text
examples/agentic-mcp-0927-pm-rules-vs-skills/enabled-set = research,notify
```
...
| SDK | Path | How to run |
|-----|------|------------|
| Java | `examples/java/agentic-mcp-0927-pm-rules-vs-skills` | `./gradlew test run` |
| Python | `examples/python/agentic-mcp-0927-pm-rules-vs-skills` | `python3 -m pytest -q && python3 peer.py` |
| React (Node BFF) | `examples/node/agentic-mcp-0927-pm-rules-vs-skills-react` | `npm install && npm test && node peer.mjs` |
| Angular (Node BFF) | `examples/node/agentic-mcp-0927-pm-rules-vs-skills-angular` | `npm install && npm test && node peer.mjs` |
...
```bash
cd examples/node/agentic-mcp-0927-pm-rules-vs-skills-angular
npm install
npm test
node peer.mjs
