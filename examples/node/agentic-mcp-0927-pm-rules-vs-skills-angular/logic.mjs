/**
 * Pure hot-path for agentic-mcp-0927-pm-rules-vs-skills (angular Node BFF).
 * No tokens here — tests run offline.
 */
export const KEY = "enabled-set";
export const DEFAULT = "research,notify";
export const FOLDER = "agentic-mcp-0927-pm-rules-vs-skills";
export const PATH = "examples/agentic-mcp-0927-pm-rules-vs-skills/enabled-set";
