# agentic-mcp-0925-pm-perplexity-exit

Perplexity Walked Away From MCP Over Overhead. The Hub Still Has to Exist
...
```text
examples/agentic-mcp-0925-pm-perplexity-exit/shared-truth = live
```
...
| SDK | Path | How to run |
|-----|------|------------|
| Java | `examples/java/agentic-mcp-0925-pm-perplexity-exit` | `./gradlew test run` |
| Python | `examples/python/agentic-mcp-0925-pm-perplexity-exit` | `python3 -m pytest -q && python3 peer.py` |
| React (Node BFF) | `examples/node/agentic-mcp-0925-pm-perplexity-exit-react` | `npm install && npm test && node peer.mjs` |
| Angular (Node BFF) | `examples/node/agentic-mcp-0925-pm-perplexity-exit-angular` | `npm install && npm test && node peer.mjs` |
...
```bash
cd examples/node/agentic-mcp-0925-pm-perplexity-exit-angular
npm install
npm test
node peer.mjs
