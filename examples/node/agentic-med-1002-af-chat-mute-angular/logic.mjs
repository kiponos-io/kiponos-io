/**
 * Pure hot-path for agentic-med-1002-af-chat-mute (angular Node BFF).
 * No tokens here — tests run offline.
 */
export const KEY = "chat-mute";
export const DEFAULT = "none";
export const FOLDER = "agentic-med-1002-af-chat-mute";
export const PATH = "examples/agentic-med-1002-af-chat-mute/chat-mute";
