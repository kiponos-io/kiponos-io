...
| SDK | Path | How to run |
|-----|------|------------|
| Java | `examples/java/agentic-dev-1020-pm-budget-turn` | `./gradlew test run` |
| Python | `examples/python/agentic-dev-1020-pm-budget-turn` | `python3 -m pytest -q && python3 peer.py` |
| React (Node BFF) | `examples/node/agentic-dev-1020-pm-budget-turn-react` | `npm install && npm test && node peer.mjs` |
| Angular (Node BFF) | `examples/node/agentic-dev-1020-pm-budget-turn-angular` | `npm install && npm test && node peer.mjs` |
...
```bash
cd examples/node/agentic-dev-1020-pm-budget-turn-angular
npm install
npm test
node peer.mjs
