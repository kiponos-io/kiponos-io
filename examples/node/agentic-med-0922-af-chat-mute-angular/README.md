# agentic-med-0922-af-chat-mute

I Restarted Claude Code to Flip Group-chat mute without host kill — The Admin Dashboard Wall Already Knew
...
```text
examples/agentic-med-0922-af-chat-mute/chat-mute = none
```
...
| SDK | Path | How to run |
|-----|------|------------|
| Java | `examples/java/agentic-med-0922-af-chat-mute` | `./gradlew test run` |
| Python | `examples/python/agentic-med-0922-af-chat-mute` | `python3 -m pytest -q && python3 peer.py` |
| React (Node BFF) | `examples/node/agentic-med-0922-af-chat-mute-react` | `npm install && npm test && node peer.mjs` |
| Angular (Node BFF) | `examples/node/agentic-med-0922-af-chat-mute-angular` | `npm install && npm test && node peer.mjs` |
...
```bash
cd examples/node/agentic-med-0922-af-chat-mute-angular
npm install
npm test
node peer.mjs
