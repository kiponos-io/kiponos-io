# agentic-mcp-0910-am-result-cap

One MCP Tool Returned 557k Tokens and Swamped the Rest of the Turn
...
```text
examples/agentic-mcp-0910-am-result-cap/result-cap = 2000
```
...
| SDK | Path | How to run |
|-----|------|------------|
| Java | `examples/java/agentic-mcp-0910-am-result-cap` | `./gradlew test run` |
| Python | `examples/python/agentic-mcp-0910-am-result-cap` | `python3 -m pytest -q && python3 peer.py` |
| React (Node BFF) | `examples/node/agentic-mcp-0910-am-result-cap-react` | `npm install && npm test && node peer.mjs` |
| Angular (Node BFF) | `examples/node/agentic-mcp-0910-am-result-cap-angular` | `npm install && npm test && node peer.mjs` |
...
```bash
cd examples/node/agentic-mcp-0910-am-result-cap-angular
npm install
npm test
node peer.mjs
