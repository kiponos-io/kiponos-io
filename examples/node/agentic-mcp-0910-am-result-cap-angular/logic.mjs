/**
 * Pure hot-path for agentic-mcp-0910-am-result-cap (angular Node BFF).
 * No tokens here — tests run offline.
 */
export const KEY = "result-cap";
export const DEFAULT = "2000";
export const FOLDER = "agentic-mcp-0910-am-result-cap";
export const PATH = "examples/agentic-mcp-0910-am-result-cap/result-cap";
