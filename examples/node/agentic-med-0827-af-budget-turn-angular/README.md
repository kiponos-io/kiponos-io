# agentic-med-0827-af-budget-turn

I Restarted Grok Build to Flip Token budget mid-session — The Mirror Phone Wall Already Knew
...
```text
examples/agentic-med-0827-af-budget-turn/max-tokens = 8000
```
...
| SDK | Path | How to run |
|-----|------|------------|
| Java | `examples/java/agentic-med-0827-af-budget-turn` | `./gradlew test run` |
| Python | `examples/python/agentic-med-0827-af-budget-turn` | `python3 -m pytest -q && python3 peer.py` |
| React (Node BFF) | `examples/node/agentic-med-0827-af-budget-turn-react` | `npm install && npm test && node peer.mjs` |
| Angular (Node BFF) | `examples/node/agentic-med-0827-af-budget-turn-angular` | `npm install && npm test && node peer.mjs` |
...
```bash
cd examples/node/agentic-med-0827-af-budget-turn-angular
npm install
npm test
node peer.mjs
