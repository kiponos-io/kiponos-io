/**
 * Pure hot-path for agentic-mcp-live-tools (angular Node BFF).
 * No tokens here — tests run offline.
 */
export const KEY = "tools-allow";
export const DEFAULT = "search,read";
export const FOLDER = "agentic-mcp-live-tools";
export const PATH = "examples/agentic-mcp-live-tools/tools-allow";
