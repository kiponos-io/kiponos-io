# agentic-mcp-1003-pm-claude-tool-search
...
```text
examples/agentic-mcp-1003-pm-claude-tool-search/tool-search = on
```
...
| SDK | Path | How to run |
|-----|------|------------|
| Java | `examples/java/agentic-mcp-1003-pm-claude-tool-search` | `./gradlew test run` |
| Python | `examples/python/agentic-mcp-1003-pm-claude-tool-search` | `python3 -m pytest -q && python3 peer.py` |
| React (Node BFF) | `examples/node/agentic-mcp-1003-pm-claude-tool-search-react` | `npm install && npm test && node peer.mjs` |
| Angular (Node BFF) | `examples/node/agentic-mcp-1003-pm-claude-tool-search-angular` | `npm install && npm test && node peer.mjs` |
...
```bash
cd examples/node/agentic-mcp-1003-pm-claude-tool-search-angular
npm install
npm test
node peer.mjs
