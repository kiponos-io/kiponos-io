# agentic-mcp-0916-pm-selection-drop

Tool Selection Accuracy Fell from 43% to 14% When I Connected 'Just One More' Server
...
```text
examples/agentic-mcp-0916-pm-selection-drop/tools-allow = search,read
```
...
| SDK | Path | How to run |
|-----|------|------------|
| Java | `examples/java/agentic-mcp-0916-pm-selection-drop` | `./gradlew test run` |
| Python | `examples/python/agentic-mcp-0916-pm-selection-drop` | `python3 -m pytest -q && python3 peer.py` |
| React (Node BFF) | `examples/node/agentic-mcp-0916-pm-selection-drop-react` | `npm install && npm test && node peer.mjs` |
| Angular (Node BFF) | `examples/node/agentic-mcp-0916-pm-selection-drop-angular` | `npm install && npm test && node peer.mjs` |
...
```bash
cd examples/node/agentic-mcp-0916-pm-selection-drop-angular
npm install
npm test
node peer.mjs
