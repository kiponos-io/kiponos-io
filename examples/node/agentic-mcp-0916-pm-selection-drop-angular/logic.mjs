/**
 * Pure hot-path for agentic-mcp-0916-pm-selection-drop (angular Node BFF).
 * No tokens here — tests run offline.
 */
export const KEY = "tools-allow";
export const DEFAULT = "search,read";
export const FOLDER = "agentic-mcp-0916-pm-selection-drop";
export const PATH = "examples/agentic-mcp-0916-pm-selection-drop/tools-allow";
