/**
 * Pure hot-path for agentic-mcp-0908-pm-tools-roster (angular Node BFF).
 * No tokens here — tests run offline.
 */
export const KEY = "tools-allow";
export const DEFAULT = "search,read";
export const FOLDER = "agentic-mcp-0908-pm-tools-roster";
export const PATH = "examples/agentic-mcp-0908-pm-tools-roster/tools-allow";
