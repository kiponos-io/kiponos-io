# agentic-mcp-0908-pm-tools-roster

Cursor Caps at 40 Tools. I Still Restarted MCP to Hide the 41st
...
```text
examples/agentic-mcp-0908-pm-tools-roster/tools-allow = search,read
```
...
| SDK | Path | How to run |
|-----|------|------------|
| Java | `examples/java/agentic-mcp-0908-pm-tools-roster` | `./gradlew test run` |
| Python | `examples/python/agentic-mcp-0908-pm-tools-roster` | `python3 -m pytest -q && python3 peer.py` |
| React (Node BFF) | `examples/node/agentic-mcp-0908-pm-tools-roster-react` | `npm install && npm test && node peer.mjs` |
| Angular (Node BFF) | `examples/node/agentic-mcp-0908-pm-tools-roster-angular` | `npm install && npm test && node peer.mjs` |
...
```bash
cd examples/node/agentic-mcp-0908-pm-tools-roster-angular
npm install
npm test
node peer.mjs
