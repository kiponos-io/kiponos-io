...
```text
examples/agentic-dev-1019-pm-admin-wall/wall-focus = checkout
```
...
| SDK | Path | How to run |
|-----|------|------------|
| Java | `examples/java/agentic-dev-1019-pm-admin-wall` | `./gradlew test run` |
| Python | `examples/python/agentic-dev-1019-pm-admin-wall` | `python3 -m pytest -q && python3 peer.py` |
| React (Node BFF) | `examples/node/agentic-dev-1019-pm-admin-wall-react` | `npm install && npm test && node peer.mjs` |
| Angular (Node BFF) | `examples/node/agentic-dev-1019-pm-admin-wall-angular` | `npm install && npm test && node peer.mjs` |
...
```bash
cd examples/node/agentic-dev-1019-pm-admin-wall-angular
npm install
npm test
node peer.mjs
