/**
 * Pure hot-path for agentic-med-0928-af-mcp-gate (angular Node BFF).
 * No tokens here — tests run offline.
 */
export const KEY = "tools-allow";
export const DEFAULT = "search,read";
export const FOLDER = "agentic-med-0928-af-mcp-gate";
export const PATH = "examples/agentic-med-0928-af-mcp-gate/tools-allow";
