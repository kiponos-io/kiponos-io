# agentic-med-1002-mi-sense-priority
...
```text
examples/agentic-med-1002-mi-sense-priority/priority = P3
```
...
| SDK | Path | How to run |
|-----|------|------------|
| Java | `examples/java/agentic-med-1002-mi-sense-priority` | `./gradlew test run` |
| Python | `examples/python/agentic-med-1002-mi-sense-priority` | `python3 -m pytest -q && python3 peer.py` |
| React (Node BFF) | `examples/node/agentic-med-1002-mi-sense-priority-react` | `npm install && npm test && node peer.mjs` |
| Angular (Node BFF) | `examples/node/agentic-med-1002-mi-sense-priority-angular` | `npm install && npm test && node peer.mjs` |
...
```bash
cd examples/node/agentic-med-1002-mi-sense-priority-angular
npm install
npm test
node peer.mjs
