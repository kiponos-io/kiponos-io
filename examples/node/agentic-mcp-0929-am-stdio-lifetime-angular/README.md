# agentic-mcp-0929-am-stdio-lifetime
...
```text
examples/agentic-mcp-0929-am-stdio-lifetime/mcp-drain = off
```
...
| SDK | Path | How to run |
|-----|------|------------|
| Java | `examples/java/agentic-mcp-0929-am-stdio-lifetime` | `./gradlew test run` |
| Python | `examples/python/agentic-mcp-0929-am-stdio-lifetime` | `python3 -m pytest -q && python3 peer.py` |
| React (Node BFF) | `examples/node/agentic-mcp-0929-am-stdio-lifetime-react` | `npm install && npm test && node peer.mjs` |
| Angular (Node BFF) | `examples/node/agentic-mcp-0929-am-stdio-lifetime-angular` | `npm install && npm test && node peer.mjs` |
...
```bash
cd examples/node/agentic-mcp-0929-am-stdio-lifetime-angular
npm install
npm test
node peer.mjs
