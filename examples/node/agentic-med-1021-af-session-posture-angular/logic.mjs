/**
 * Pure hot-path for agentic-med-1021-af-session-posture (angular Node BFF).
 * No tokens here — tests run offline.
 */
export const KEY = "session-posture";
export const DEFAULT = "focus=admin-wall,shopping-pause=off";
export const FOLDER = "agentic-med-1021-af-session-posture";
export const PATH = "examples/agentic-med-1021-af-session-posture/session-posture";
