# agentic-med-1004-af-mirror-live
...
```text
examples/agentic-med-1004-af-mirror-live/device-live = yes
```
...
| SDK | Path | How to run |
|-----|------|------------|
| Java | `examples/java/agentic-med-1004-af-mirror-live` | `./gradlew test run` |
| Python | `examples/python/agentic-med-1004-af-mirror-live` | `python3 -m pytest -q && python3 peer.py` |
| React (Node BFF) | `examples/node/agentic-med-1004-af-mirror-live-react` | `npm install && npm test && node peer.mjs` |
| Angular (Node BFF) | `examples/node/agentic-med-1004-af-mirror-live-angular` | `npm install && npm test && node peer.mjs` |
...
```bash
cd examples/node/agentic-med-1004-af-mirror-live-angular
npm install
npm test
node peer.mjs
