# agentic-mcp-0909-am-context-rot
...
```text
examples/agentic-mcp-0909-am-context-rot/compact-mode = off
```
...
| SDK | Path | How to run |
|-----|------|------------|
| Java | `examples/java/agentic-mcp-0909-am-context-rot` | `./gradlew test run` |
| Python | `examples/python/agentic-mcp-0909-am-context-rot` | `python3 -m pytest -q && python3 peer.py` |
| React (Node BFF) | `examples/node/agentic-mcp-0909-am-context-rot-react` | `npm install && npm test && node peer.mjs` |
| Angular (Node BFF) | `examples/node/agentic-mcp-0909-am-context-rot-angular` | `npm install && npm test && node peer.mjs` |
...
```bash
cd examples/node/agentic-mcp-0909-am-context-rot-angular
npm install
npm test
node peer.mjs
