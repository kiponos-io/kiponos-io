# agentic-mcp-0919-am-flags-not-session

LaunchDarkly Does Not Restart Grok Build. It Also Does Not Sit on the Tool Call.
...
```text
examples/agentic-mcp-0919-am-flags-not-session/tools-allow = search,read
```
...
| SDK | Path | How to run |
|-----|------|------------|
| Java | `examples/java/agentic-mcp-0919-am-flags-not-session` | `./gradlew test run` |
| Python | `examples/python/agentic-mcp-0919-am-flags-not-session` | `python3 -m pytest -q && python3 peer.py` |
| React (Node BFF) | `examples/node/agentic-mcp-0919-am-flags-not-session-react` | `npm install && npm test && node peer.mjs` |
| Angular (Node BFF) | `examples/node/agentic-mcp-0919-am-flags-not-session-angular` | `npm install && npm test && node peer.mjs` |
...
```bash
cd examples/node/agentic-mcp-0919-am-flags-not-session-angular
npm install
npm test
node peer.mjs
