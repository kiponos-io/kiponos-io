/**
 * Pure hot-path for agentic-mcp-0919-am-flags-not-session (angular Node BFF).
 * No tokens here — tests run offline.
 */
export const KEY = "tools-allow";
export const DEFAULT = "search,read";
export const FOLDER = "agentic-mcp-0919-am-flags-not-session";
export const PATH = "examples/agentic-mcp-0919-am-flags-not-session/tools-allow";
