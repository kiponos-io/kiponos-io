/**
 * Pure hot-path for agentic-mcp-0927-am-install-this-week (angular Node BFF).
 * No tokens here — tests run offline.
 */
export const KEY = "tools-allow";
export const DEFAULT = "search,read";
export const FOLDER = "agentic-mcp-0927-am-install-this-week";
export const PATH = "examples/agentic-mcp-0927-am-install-this-week/tools-allow";
