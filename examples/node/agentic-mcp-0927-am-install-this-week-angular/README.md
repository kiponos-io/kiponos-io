# agentic-mcp-0927-am-install-this-week

The Cardinal Rule Is Install Only What This Week Needs. I Needed It Live on Monday
...
```text
examples/agentic-mcp-0927-am-install-this-week/tools-allow = search,read
```
...
| SDK | Path | How to run |
|-----|------|------------|
| Java | `examples/java/agentic-mcp-0927-am-install-this-week` | `./gradlew test run` |
| Python | `examples/python/agentic-mcp-0927-am-install-this-week` | `python3 -m pytest -q && python3 peer.py` |
| React (Node BFF) | `examples/node/agentic-mcp-0927-am-install-this-week-react` | `npm install && npm test && node peer.mjs` |
| Angular (Node BFF) | `examples/node/agentic-mcp-0927-am-install-this-week-angular` | `npm install && npm test && node peer.mjs` |
...
```bash
cd examples/node/agentic-mcp-0927-am-install-this-week-angular
npm install
npm test
node peer.mjs
