# agentic-mcp-1001-am-bloat-confusion
...
```text
examples/agentic-mcp-1001-am-bloat-confusion/schema-budget = 4000
```
...
| SDK | Path | How to run |
|-----|------|------------|
| Java | `examples/java/agentic-mcp-1001-am-bloat-confusion` | `./gradlew test run` |
| Python | `examples/python/agentic-mcp-1001-am-bloat-confusion` | `python3 -m pytest -q && python3 peer.py` |
| React (Node BFF) | `examples/node/agentic-mcp-1001-am-bloat-confusion-react` | `npm install && npm test && node peer.mjs` |
| Angular (Node BFF) | `examples/node/agentic-mcp-1001-am-bloat-confusion-angular` | `npm install && npm test && node peer.mjs` |
...
```bash
cd examples/node/agentic-mcp-1001-am-bloat-confusion-angular
npm install
npm test
node peer.mjs
