...
```text
examples/agentic-med-0829-af-mcp-gate/tools-allow = search,read
```
...
| SDK | Path | How to run |
|-----|------|------------|
| Java | `examples/java/agentic-med-0829-af-mcp-gate` | `./gradlew test run` |
| Python | `examples/python/agentic-med-0829-af-mcp-gate` | `python3 -m pytest -q && python3 peer.py` |
| React (Node BFF) | `examples/node/agentic-med-0829-af-mcp-gate-react` | `npm install && npm test && node peer.mjs` |
| Angular (Node BFF) | `examples/node/agentic-med-0829-af-mcp-gate-angular` | `npm install && npm test && node peer.mjs` |
...
```bash
cd examples/node/agentic-med-0829-af-mcp-gate-angular
npm install
npm test
node peer.mjs
