...
```text
examples/agentic-mcp-0917-am-doom-loop/retry-max = 2
```
...
| SDK | Path | How to run |
|-----|------|------------|
| Java | `examples/java/agentic-mcp-0917-am-doom-loop` | `./gradlew test run` |
| Python | `examples/python/agentic-mcp-0917-am-doom-loop` | `python3 -m pytest -q && python3 peer.py` |
| React (Node BFF) | `examples/node/agentic-mcp-0917-am-doom-loop-react` | `npm install && npm test && node peer.mjs` |
| Angular (Node BFF) | `examples/node/agentic-mcp-0917-am-doom-loop-angular` | `npm install && npm test && node peer.mjs` |
...
```bash
cd examples/node/agentic-mcp-0917-am-doom-loop-angular
npm install
npm test
node peer.mjs
