# agentic-mcp-1006-am-reload-r

The TUI Said Press r to Refresh MCP. That Is Not Multi-Tab Live State
...
```text
examples/agentic-mcp-1006-am-reload-r/tools-allow = search,read
```
...
| SDK | Path | How to run |
|-----|------|------------|
| Java | `examples/java/agentic-mcp-1006-am-reload-r` | `./gradlew test run` |
| Python | `examples/python/agentic-mcp-1006-am-reload-r` | `python3 -m pytest -q && python3 peer.py` |
| React (Node BFF) | `examples/node/agentic-mcp-1006-am-reload-r-react` | `npm install && npm test && node peer.mjs` |
| Angular (Node BFF) | `examples/node/agentic-mcp-1006-am-reload-r-angular` | `npm install && npm test && node peer.mjs` |
...
```bash
cd examples/node/agentic-mcp-1006-am-reload-r-angular
npm install
npm test
node peer.mjs
