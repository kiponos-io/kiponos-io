/**
 * Pure hot-path for agentic-mcp-1006-am-reload-r (angular Node BFF).
 * No tokens here — tests run offline.
 */
export const KEY = "tools-allow";
export const DEFAULT = "search,read";
export const FOLDER = "agentic-mcp-1006-am-reload-r";
export const PATH = "examples/agentic-mcp-1006-am-reload-r/tools-allow";
