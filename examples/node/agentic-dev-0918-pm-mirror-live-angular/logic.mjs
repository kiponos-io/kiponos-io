/**
 * Pure hot-path for agentic-dev-0918-pm-mirror-live (angular Node BFF).
 * No tokens here — tests run offline.
 */
export const KEY = "device-live";
export const DEFAULT = "yes";
export const FOLDER = "agentic-dev-0918-pm-mirror-live";
export const PATH = "examples/agentic-dev-0918-pm-mirror-live/device-live";
