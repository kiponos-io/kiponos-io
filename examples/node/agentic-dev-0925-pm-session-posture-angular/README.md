...
Grok Build Finished the Turn Blind — Session posture shared across hosts on the Senses Path
...
```text
examples/agentic-dev-0925-pm-session-posture/session-posture = focus=admin-wall,shopping-pause=off
```
...
| SDK | Path | How to run |
|-----|------|------------|
| Java | `examples/java/agentic-dev-0925-pm-session-posture` | `./gradlew test run` |
| Python | `examples/python/agentic-dev-0925-pm-session-posture` | `python3 -m pytest -q && python3 peer.py` |
| React (Node BFF) | `examples/node/agentic-dev-0925-pm-session-posture-react` | `npm install && npm test && node peer.mjs` |
| Angular (Node BFF) | `examples/node/agentic-dev-0925-pm-session-posture-angular` | `npm install && npm test && node peer.mjs` |
...
```bash
cd examples/node/agentic-dev-0925-pm-session-posture-angular
npm install
npm test
node peer.mjs
