# agentic-med-1009-mi-budget-turn
...
```text
examples/agentic-med-1009-mi-budget-turn/max-tokens = 8000
```
...
| SDK | Path | How to run |
|-----|------|------------|
| Java | `examples/java/agentic-med-1009-mi-budget-turn` | `./gradlew test run` |
| Python | `examples/python/agentic-med-1009-mi-budget-turn` | `python3 -m pytest -q && python3 peer.py` |
| React (Node BFF) | `examples/node/agentic-med-1009-mi-budget-turn-react` | `npm install && npm test && node peer.mjs` |
| Angular (Node BFF) | `examples/node/agentic-med-1009-mi-budget-turn-angular` | `npm install && npm test && node peer.mjs` |
...
```bash
cd examples/node/agentic-med-1009-mi-budget-turn-angular
npm install
npm test
node peer.mjs
