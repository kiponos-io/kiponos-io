# agentic-mcp-1007-am-unaware-primitive

The Part the Dev Community Has Not Named Yet: Live Nested State as a Language Primitive
...
```text
examples/agentic-mcp-1007-am-unaware-primitive/shared-truth = live
```
...
| SDK | Path | How to run |
|-----|------|------------|
| Java | `examples/java/agentic-mcp-1007-am-unaware-primitive` | `./gradlew test run` |
| Python | `examples/python/agentic-mcp-1007-am-unaware-primitive` | `python3 -m pytest -q && python3 peer.py` |
| React (Node BFF) | `examples/node/agentic-mcp-1007-am-unaware-primitive-react` | `npm install && npm test && node peer.mjs` |
| Angular (Node BFF) | `examples/node/agentic-mcp-1007-am-unaware-primitive-angular` | `npm install && npm test && node peer.mjs` |
...
```bash
cd examples/node/agentic-mcp-1007-am-unaware-primitive-angular
npm install
npm test
node peer.mjs
