/**
 * Pure hot-path for agentic-mcp-1007-am-unaware-primitive (angular Node BFF).
 * No tokens here — tests run offline.
 */
export const KEY = "shared-truth";
export const DEFAULT = "live";
export const FOLDER = "agentic-mcp-1007-am-unaware-primitive";
export const PATH = "examples/agentic-mcp-1007-am-unaware-primitive/shared-truth";
