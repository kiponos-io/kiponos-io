/**
 * Pure hot-path for agentic-mcp-0930-am-namespace-tools (angular Node BFF).
 * No tokens here — tests run offline.
 */
export const KEY = "tools-allow";
export const DEFAULT = "search,read";
export const FOLDER = "agentic-mcp-0930-am-namespace-tools";
export const PATH = "examples/agentic-mcp-0930-am-namespace-tools/tools-allow";
