# agentic-mcp-0930-am-namespace-tools

Grok Namespaces MCP as server__tool. The Allow-List Must Be Live at That Grain
...
```text
examples/agentic-mcp-0930-am-namespace-tools/tools-allow = search,read
```
...
| SDK | Path | How to run |
|-----|------|------------|
| Java | `examples/java/agentic-mcp-0930-am-namespace-tools` | `./gradlew test run` |
| Python | `examples/python/agentic-mcp-0930-am-namespace-tools` | `python3 -m pytest -q && python3 peer.py` |
| React (Node BFF) | `examples/node/agentic-mcp-0930-am-namespace-tools-react` | `npm install && npm test && node peer.mjs` |
| Angular (Node BFF) | `examples/node/agentic-mcp-0930-am-namespace-tools-angular` | `npm install && npm test && node peer.mjs` |
...
```bash
cd examples/node/agentic-mcp-0930-am-namespace-tools-angular
npm install
npm test
node peer.mjs
