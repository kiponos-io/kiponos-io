...
```text
examples/agentic-dev-0901-pm-skill-enable/enabled-set = research,notify
```
...
| SDK | Path | How to run |
|-----|------|------------|
| Java | `examples/java/agentic-dev-0901-pm-skill-enable` | `./gradlew test run` |
| Python | `examples/python/agentic-dev-0901-pm-skill-enable` | `python3 -m pytest -q && python3 peer.py` |
| React (Node BFF) | `examples/node/agentic-dev-0901-pm-skill-enable-react` | `npm install && npm test && node peer.mjs` |
| Angular (Node BFF) | `examples/node/agentic-dev-0901-pm-skill-enable-angular` | `npm install && npm test && node peer.mjs` |
...
```bash
cd examples/node/agentic-dev-0901-pm-skill-enable-angular
npm install
npm test
node peer.mjs
