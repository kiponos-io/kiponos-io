/**
 * Pure hot-path for agentic-cursor-session-shared-state (angular Node BFF).
 * No tokens here — tests run offline.
 */
export const KEY = "session-posture";
export const DEFAULT = "focus=admin-wall,shopping-pause=off";
export const FOLDER = "agentic-cursor-session-shared-state";
export const PATH = "examples/agentic-cursor-session-shared-state/session-posture";
