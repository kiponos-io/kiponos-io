/**
 * Pure hot-path for agentic-dev-1016-am-mcp-gate (angular Node BFF).
 * No tokens here — tests run offline.
 */
export const KEY = "tools-allow";
export const DEFAULT = "search,read";
export const FOLDER = "agentic-dev-1016-am-mcp-gate";
export const PATH = "examples/agentic-dev-1016-am-mcp-gate/tools-allow";
