...
```text
examples/agentic-dev-0926-pm-chat-mute/chat-mute = none
```
...
| SDK | Path | How to run |
|-----|------|------------|
| Java | `examples/java/agentic-dev-0926-pm-chat-mute` | `./gradlew test run` |
| Python | `examples/python/agentic-dev-0926-pm-chat-mute` | `python3 -m pytest -q && python3 peer.py` |
| React (Node BFF) | `examples/node/agentic-dev-0926-pm-chat-mute-react` | `npm install && npm test && node peer.mjs` |
| Angular (Node BFF) | `examples/node/agentic-dev-0926-pm-chat-mute-angular` | `npm install && npm test && node peer.mjs` |
...
```bash
cd examples/node/agentic-dev-0926-pm-chat-mute-angular
npm install
npm test
node peer.mjs
