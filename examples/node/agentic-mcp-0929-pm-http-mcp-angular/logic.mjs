/**
 * Pure hot-path for agentic-mcp-0929-pm-http-mcp (angular Node BFF).
 * No tokens here — tests run offline.
 */
export const KEY = "tools-allow";
export const DEFAULT = "search,read";
export const FOLDER = "agentic-mcp-0929-pm-http-mcp";
export const PATH = "examples/agentic-mcp-0929-pm-http-mcp/tools-allow";
