# agentic-mcp-0929-pm-http-mcp

Remote HTTP MCP Authenticated Fine. I Still Restarted to Hide One Tool
...
```text
examples/agentic-mcp-0929-pm-http-mcp/tools-allow = search,read
```
...
| SDK | Path | How to run |
|-----|------|------------|
| Java | `examples/java/agentic-mcp-0929-pm-http-mcp` | `./gradlew test run` |
| Python | `examples/python/agentic-mcp-0929-pm-http-mcp` | `python3 -m pytest -q && python3 peer.py` |
| React (Node BFF) | `examples/node/agentic-mcp-0929-pm-http-mcp-react` | `npm install && npm test && node peer.mjs` |
| Angular (Node BFF) | `examples/node/agentic-mcp-0929-pm-http-mcp-angular` | `npm install && npm test && node peer.mjs` |
...
```bash
cd examples/node/agentic-mcp-0929-pm-http-mcp-angular
npm install
npm test
node peer.mjs
