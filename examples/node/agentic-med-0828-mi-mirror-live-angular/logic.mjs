/**
 * Pure hot-path for agentic-med-0828-mi-mirror-live (angular Node BFF).
 * No tokens here — tests run offline.
 */
export const KEY = "device-live";
export const DEFAULT = "yes";
export const FOLDER = "agentic-med-0828-mi-mirror-live";
export const PATH = "examples/agentic-med-0828-mi-mirror-live/device-live";
