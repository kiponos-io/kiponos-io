# agentic-mcp-0928-pm-host-ceremony

The Ceremony Is Always the Same: Kill Host, Edit JSON, Restart, Lose the Turn
...
```text
examples/agentic-mcp-0928-pm-host-ceremony/tools-allow = search,read
```
...
| SDK | Path | How to run |
|-----|------|------------|
| Java | `examples/java/agentic-mcp-0928-pm-host-ceremony` | `./gradlew test run` |
| Python | `examples/python/agentic-mcp-0928-pm-host-ceremony` | `python3 -m pytest -q && python3 peer.py` |
| React (Node BFF) | `examples/node/agentic-mcp-0928-pm-host-ceremony-react` | `npm install && npm test && node peer.mjs` |
| Angular (Node BFF) | `examples/node/agentic-mcp-0928-pm-host-ceremony-angular` | `npm install && npm test && node peer.mjs` |
...
```bash
cd examples/node/agentic-mcp-0928-pm-host-ceremony-angular
npm install
npm test
node peer.mjs
