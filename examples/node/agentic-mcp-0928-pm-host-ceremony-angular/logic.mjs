/**
 * Pure hot-path for agentic-mcp-0928-pm-host-ceremony (angular Node BFF).
 * No tokens here — tests run offline.
 */
export const KEY = "tools-allow";
export const DEFAULT = "search,read";
export const FOLDER = "agentic-mcp-0928-pm-host-ceremony";
export const PATH = "examples/agentic-mcp-0928-pm-host-ceremony/tools-allow";
