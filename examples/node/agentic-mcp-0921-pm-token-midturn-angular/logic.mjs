/**
 * Pure hot-path for agentic-mcp-0921-pm-token-midturn (angular Node BFF).
 * No tokens here — tests run offline.
 */
export const KEY = "max-tokens";
export const DEFAULT = "8000";
export const FOLDER = "agentic-mcp-0921-pm-token-midturn";
export const PATH = "examples/agentic-mcp-0921-pm-token-midturn/max-tokens";
