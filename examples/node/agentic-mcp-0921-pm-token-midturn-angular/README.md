# agentic-mcp-0921-pm-token-midturn

The Turn Budget Hit Zero Because GitHub MCP Already Spent It on Schemas
...
```text
examples/agentic-mcp-0921-pm-token-midturn/max-tokens = 8000
```
...
| SDK | Path | How to run |
|-----|------|------------|
| Java | `examples/java/agentic-mcp-0921-pm-token-midturn` | `./gradlew test run` |
| Python | `examples/python/agentic-mcp-0921-pm-token-midturn` | `python3 -m pytest -q && python3 peer.py` |
| React (Node BFF) | `examples/node/agentic-mcp-0921-pm-token-midturn-react` | `npm install && npm test && node peer.mjs` |
| Angular (Node BFF) | `examples/node/agentic-mcp-0921-pm-token-midturn-angular` | `npm install && npm test && node peer.mjs` |
...
```bash
cd examples/node/agentic-mcp-0921-pm-token-midturn-angular
npm install
npm test
node peer.mjs
