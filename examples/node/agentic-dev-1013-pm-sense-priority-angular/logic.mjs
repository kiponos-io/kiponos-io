/**
 * Pure hot-path for agentic-dev-1013-pm-sense-priority (angular Node BFF).
 * No tokens here — tests run offline.
 */
export const KEY = "priority";
export const DEFAULT = "P3";
export const FOLDER = "agentic-dev-1013-pm-sense-priority";
export const PATH = "examples/agentic-dev-1013-pm-sense-priority/priority";
