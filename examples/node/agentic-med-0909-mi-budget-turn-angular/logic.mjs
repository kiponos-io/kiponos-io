/**
 * Pure hot-path for agentic-med-0909-mi-budget-turn (angular Node BFF).
 * No tokens here — tests run offline.
 */
export const KEY = "max-tokens";
export const DEFAULT = "8000";
export const FOLDER = "agentic-med-0909-mi-budget-turn";
export const PATH = "examples/agentic-med-0909-mi-budget-turn/max-tokens";
