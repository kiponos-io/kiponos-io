...
| SDK | Path | How to run |
|-----|------|------------|
| Java | `examples/java/agentic-mcp-0917-pm-code-mode` | `./gradlew test run` |
| Python | `examples/python/agentic-mcp-0917-pm-code-mode` | `python3 -m pytest -q && python3 peer.py` |
| React (Node BFF) | `examples/node/agentic-mcp-0917-pm-code-mode-react` | `npm install && npm test && node peer.mjs` |
| Angular (Node BFF) | `examples/node/agentic-mcp-0917-pm-code-mode-angular` | `npm install && npm test && node peer.mjs` |
...
```bash
cd examples/node/agentic-mcp-0917-pm-code-mode-angular
npm install
npm test
node peer.mjs
