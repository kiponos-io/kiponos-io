# agentic-med-0927-af-skill-enable

I Restarted MCP host to Flip Skill enable set without restart — The Admin Dashboard Wall Already Knew
...
```text
examples/agentic-med-0927-af-skill-enable/enabled-set = research,notify
```
...
| SDK | Path | How to run |
|-----|------|------------|
| Java | `examples/java/agentic-med-0927-af-skill-enable` | `./gradlew test run` |
| Python | `examples/python/agentic-med-0927-af-skill-enable` | `python3 -m pytest -q && python3 peer.py` |
| React (Node BFF) | `examples/node/agentic-med-0927-af-skill-enable-react` | `npm install && npm test && node peer.mjs` |
| Angular (Node BFF) | `examples/node/agentic-med-0927-af-skill-enable-angular` | `npm install && npm test && node peer.mjs` |
...
```bash
cd examples/node/agentic-med-0927-af-skill-enable-angular
npm install
npm test
node peer.mjs
