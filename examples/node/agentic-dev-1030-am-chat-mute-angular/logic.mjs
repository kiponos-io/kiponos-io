/**
 * Pure hot-path for agentic-dev-1030-am-chat-mute (angular Node BFF).
 * No tokens here — tests run offline.
 */
export const KEY = "chat-mute";
export const DEFAULT = "none";
export const FOLDER = "agentic-dev-1030-am-chat-mute";
export const PATH = "examples/agentic-dev-1030-am-chat-mute/chat-mute";
