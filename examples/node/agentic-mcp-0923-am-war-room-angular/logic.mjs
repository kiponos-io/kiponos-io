/**
 * Pure hot-path for agentic-mcp-0923-am-war-room (angular Node BFF).
 * No tokens here — tests run offline.
 */
export const KEY = "session-posture";
export const DEFAULT = "focus=admin-wall,shopping-pause=off";
export const FOLDER = "agentic-mcp-0923-am-war-room";
export const PATH = "examples/agentic-mcp-0923-am-war-room/session-posture";
