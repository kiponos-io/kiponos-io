# agentic-mcp-0913-am-skill-trust
...
```text
examples/agentic-mcp-0913-am-skill-trust/skill-trust = core,reviewed
```
...
| SDK | Path | How to run |
|-----|------|------------|
| Java | `examples/java/agentic-mcp-0913-am-skill-trust` | `./gradlew test run` |
| Python | `examples/python/agentic-mcp-0913-am-skill-trust` | `python3 -m pytest -q && python3 peer.py` |
| React (Node BFF) | `examples/node/agentic-mcp-0913-am-skill-trust-react` | `npm install && npm test && node peer.mjs` |
| Angular (Node BFF) | `examples/node/agentic-mcp-0913-am-skill-trust-angular` | `npm install && npm test && node peer.mjs` |
...
```bash
cd examples/node/agentic-mcp-0913-am-skill-trust-angular
npm install
npm test
node peer.mjs
