/**
 * Pure hot-path for agentic-mcp-0923-pm-lazy-schema (angular Node BFF).
 * No tokens here — tests run offline.
 */
export const KEY = "schema-budget";
export const DEFAULT = "4000";
export const FOLDER = "agentic-mcp-0923-pm-lazy-schema";
export const PATH = "examples/agentic-mcp-0923-pm-lazy-schema/schema-budget";
