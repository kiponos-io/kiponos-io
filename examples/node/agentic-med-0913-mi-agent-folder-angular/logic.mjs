/**
 * Pure hot-path for agentic-med-0913-mi-agent-folder (angular Node BFF).
 * No tokens here — tests run offline.
 */
export const KEY = "owner-agent";
export const DEFAULT = "travel-coordinator";
export const FOLDER = "agentic-med-0913-mi-agent-folder";
export const PATH = "examples/agentic-med-0913-mi-agent-folder/owner-agent";
