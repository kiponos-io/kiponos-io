# agentic-med-0913-mi-agent-folder

I Restarted Grok Build to Flip Agents choose a metadata folder — The Mirror Phone Wall Already Knew
...
```text
examples/agentic-med-0913-mi-agent-folder/owner-agent = travel-coordinator
```
...
| SDK | Path | How to run |
|-----|------|------------|
| Java | `examples/java/agentic-med-0913-mi-agent-folder` | `./gradlew test run` |
| Python | `examples/python/agentic-med-0913-mi-agent-folder` | `python3 -m pytest -q && python3 peer.py` |
| React (Node BFF) | `examples/node/agentic-med-0913-mi-agent-folder-react` | `npm install && npm test && node peer.mjs` |
| Angular (Node BFF) | `examples/node/agentic-med-0913-mi-agent-folder-angular` | `npm install && npm test && node peer.mjs` |
...
```bash
cd examples/node/agentic-med-0913-mi-agent-folder-angular
npm install
npm test
node peer.mjs
