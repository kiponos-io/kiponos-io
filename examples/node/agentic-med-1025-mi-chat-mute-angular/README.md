...
```text
examples/agentic-med-1025-mi-chat-mute/chat-mute = none
```
...
| SDK | Path | How to run |
|-----|------|------------|
| Java | `examples/java/agentic-med-1025-mi-chat-mute` | `./gradlew test run` |
| Python | `examples/python/agentic-med-1025-mi-chat-mute` | `python3 -m pytest -q && python3 peer.py` |
| React (Node BFF) | `examples/node/agentic-med-1025-mi-chat-mute-react` | `npm install && npm test && node peer.mjs` |
| Angular (Node BFF) | `examples/node/agentic-med-1025-mi-chat-mute-angular` | `npm install && npm test && node peer.mjs` |
...
```bash
cd examples/node/agentic-med-1025-mi-chat-mute-angular
npm install
npm test
node peer.mjs
