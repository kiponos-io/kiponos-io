/**
 * Pure hot-path for agentic-med-0902-af-chat-mute (angular Node BFF).
 * No tokens here — tests run offline.
 */
export const KEY = "chat-mute";
export const DEFAULT = "none";
export const FOLDER = "agentic-med-0902-af-chat-mute";
export const PATH = "examples/agentic-med-0902-af-chat-mute/chat-mute";
