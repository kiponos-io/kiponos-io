# agentic-mcp-0918-pm-oauth-not-knob

MCP OAuth Hurt. I Almost Put the Token in a Live Key. Don't.
...
```text
examples/agentic-mcp-0918-pm-oauth-not-knob/session-posture = focus=admin-wall,shopping-pause=off
```
...
| SDK | Path | How to run |
|-----|------|------------|
| Java | `examples/java/agentic-mcp-0918-pm-oauth-not-knob` | `./gradlew test run` |
| Python | `examples/python/agentic-mcp-0918-pm-oauth-not-knob` | `python3 -m pytest -q && python3 peer.py` |
| React (Node BFF) | `examples/node/agentic-mcp-0918-pm-oauth-not-knob-react` | `npm install && npm test && node peer.mjs` |
| Angular (Node BFF) | `examples/node/agentic-mcp-0918-pm-oauth-not-knob-angular` | `npm install && npm test && node peer.mjs` |
...
```bash
cd examples/node/agentic-mcp-0918-pm-oauth-not-knob-angular
npm install
npm test
node peer.mjs
