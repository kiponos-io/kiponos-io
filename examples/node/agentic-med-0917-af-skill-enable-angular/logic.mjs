/**
 * Pure hot-path for agentic-med-0917-af-skill-enable (angular Node BFF).
 * No tokens here — tests run offline.
 */
export const KEY = "enabled-set";
export const DEFAULT = "research,notify";
export const FOLDER = "agentic-med-0917-af-skill-enable";
export const PATH = "examples/agentic-med-0917-af-skill-enable/enabled-set";
