/**
 * Pure hot-path for agentic-metadata-chosen-tree (angular Node BFF).
 * No tokens here — tests run offline.
 */
export const KEY = "owner-agent";
export const DEFAULT = "travel-coordinator";
export const FOLDER = "agentic-metadata-chosen-tree";
export const PATH = "examples/agentic-metadata-chosen-tree/owner-agent";
