# agentic-mcp-1005-am-owner-folder

Two Agents, One Repo, Two MCP Writes. Nobody Owned the Folder
...
```text
examples/agentic-mcp-1005-am-owner-folder/owner-agent = travel-coordinator
```
...
| SDK | Path | How to run |
|-----|------|------------|
| Java | `examples/java/agentic-mcp-1005-am-owner-folder` | `./gradlew test run` |
| Python | `examples/python/agentic-mcp-1005-am-owner-folder` | `python3 -m pytest -q && python3 peer.py` |
| React (Node BFF) | `examples/node/agentic-mcp-1005-am-owner-folder-react` | `npm install && npm test && node peer.mjs` |
| Angular (Node BFF) | `examples/node/agentic-mcp-1005-am-owner-folder-angular` | `npm install && npm test && node peer.mjs` |
...
```bash
cd examples/node/agentic-mcp-1005-am-owner-folder-angular
npm install
npm test
node peer.mjs
