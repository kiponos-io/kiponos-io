/**
 * Pure hot-path for agentic-med-1024-af-mirror-live (angular Node BFF).
 * No tokens here — tests run offline.
 */
export const KEY = "device-live";
export const DEFAULT = "yes";
export const FOLDER = "agentic-med-1024-af-mirror-live";
export const PATH = "examples/agentic-med-1024-af-mirror-live/device-live";
