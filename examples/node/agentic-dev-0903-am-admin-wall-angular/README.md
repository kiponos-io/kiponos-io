...
```text
examples/agentic-dev-0903-am-admin-wall/wall-focus = checkout
```
...
| SDK | Path | How to run |
|-----|------|------------|
| Java | `examples/java/agentic-dev-0903-am-admin-wall` | `./gradlew test run` |
| Python | `examples/python/agentic-dev-0903-am-admin-wall` | `python3 -m pytest -q && python3 peer.py` |
| React (Node BFF) | `examples/node/agentic-dev-0903-am-admin-wall-react` | `npm install && npm test && node peer.mjs` |
| Angular (Node BFF) | `examples/node/agentic-dev-0903-am-admin-wall-angular` | `npm install && npm test && node peer.mjs` |
...
```bash
cd examples/node/agentic-dev-0903-am-admin-wall-angular
npm install
npm test
node peer.mjs
