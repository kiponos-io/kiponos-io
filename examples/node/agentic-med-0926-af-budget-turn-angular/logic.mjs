/**
 * Pure hot-path for agentic-med-0926-af-budget-turn (angular Node BFF).
 * No tokens here — tests run offline.
 */
export const KEY = "max-tokens";
export const DEFAULT = "8000";
export const FOLDER = "agentic-med-0926-af-budget-turn";
export const PATH = "examples/agentic-med-0926-af-budget-turn/max-tokens";
