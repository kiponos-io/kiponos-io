# agentic-mcp-0908-am-schema-budget
...
```text
examples/agentic-mcp-0908-am-schema-budget/schema-budget = 4000
```
...
| SDK | Path | How to run |
|-----|------|------------|
| Java | `examples/java/agentic-mcp-0908-am-schema-budget` | `./gradlew test run` |
| Python | `examples/python/agentic-mcp-0908-am-schema-budget` | `python3 -m pytest -q && python3 peer.py` |
| React (Node BFF) | `examples/node/agentic-mcp-0908-am-schema-budget-react` | `npm install && npm test && node peer.mjs` |
| Angular (Node BFF) | `examples/node/agentic-mcp-0908-am-schema-budget-angular` | `npm install && npm test && node peer.mjs` |
...
```bash
cd examples/node/agentic-mcp-0908-am-schema-budget-angular
npm install
npm test
node peer.mjs
