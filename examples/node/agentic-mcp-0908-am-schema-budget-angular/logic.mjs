/**
 * Pure hot-path for agentic-mcp-0908-am-schema-budget (angular Node BFF).
 * No tokens here — tests run offline.
 */
export const KEY = "schema-budget";
export const DEFAULT = "4000";
export const FOLDER = "agentic-mcp-0908-am-schema-budget";
export const PATH = "examples/agentic-mcp-0908-am-schema-budget/schema-budget";
