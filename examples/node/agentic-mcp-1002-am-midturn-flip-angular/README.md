# agentic-mcp-1002-am-midturn-flip

The User Said Mid-Turn: No More Writes. MCP Did Not Hear Until Restart
...
```text
examples/agentic-mcp-1002-am-midturn-flip/tools-allow = search,read
```
...
| SDK | Path | How to run |
|-----|------|------------|
| Java | `examples/java/agentic-mcp-1002-am-midturn-flip` | `./gradlew test run` |
| Python | `examples/python/agentic-mcp-1002-am-midturn-flip` | `python3 -m pytest -q && python3 peer.py` |
| React (Node BFF) | `examples/node/agentic-mcp-1002-am-midturn-flip-react` | `npm install && npm test && node peer.mjs` |
| Angular (Node BFF) | `examples/node/agentic-mcp-1002-am-midturn-flip-angular` | `npm install && npm test && node peer.mjs` |
...
```bash
cd examples/node/agentic-mcp-1002-am-midturn-flip-angular
npm install
npm test
node peer.mjs
