/**
 * Pure hot-path for agentic-mcp-1002-am-midturn-flip (angular Node BFF).
 * No tokens here — tests run offline.
 */
export const KEY = "tools-allow";
export const DEFAULT = "search,read";
export const FOLDER = "agentic-mcp-1002-am-midturn-flip";
export const PATH = "examples/agentic-mcp-1002-am-midturn-flip/tools-allow";
