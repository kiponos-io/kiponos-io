/**
 * Pure hot-path for agentic-mcp-0911-pm-write-gate (angular Node BFF).
 * No tokens here — tests run offline.
 */
export const KEY = "tools-allow";
export const DEFAULT = "search,read";
export const FOLDER = "agentic-mcp-0911-pm-write-gate";
export const PATH = "examples/agentic-mcp-0911-pm-write-gate/tools-allow";
