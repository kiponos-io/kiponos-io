# agentic-mcp-0911-pm-write-gate

I Restarted Grok Build to Deny the MCP Write Tool Mid-Incident
...
```text
examples/agentic-mcp-0911-pm-write-gate/tools-allow = search,read
```
...
| SDK | Path | How to run |
|-----|------|------------|
| Java | `examples/java/agentic-mcp-0911-pm-write-gate` | `./gradlew test run` |
| Python | `examples/python/agentic-mcp-0911-pm-write-gate` | `python3 -m pytest -q && python3 peer.py` |
| React (Node BFF) | `examples/node/agentic-mcp-0911-pm-write-gate-react` | `npm install && npm test && node peer.mjs` |
| Angular (Node BFF) | `examples/node/agentic-mcp-0911-pm-write-gate-angular` | `npm install && npm test && node peer.mjs` |
...
```bash
cd examples/node/agentic-mcp-0911-pm-write-gate-angular
npm install
npm test
node peer.mjs
