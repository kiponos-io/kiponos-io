# agentic-med-1003-af-shopping-pause

I Restarted Cursor to Flip Shopping incident pause as a leaf — The Senses Wall Already Knew
...
```text
examples/agentic-med-1003-af-shopping-pause/incident-pause = off
```
...
| SDK | Path | How to run |
|-----|------|------------|
| Java | `examples/java/agentic-med-1003-af-shopping-pause` | `./gradlew test run` |
| Python | `examples/python/agentic-med-1003-af-shopping-pause` | `python3 -m pytest -q && python3 peer.py` |
| React (Node BFF) | `examples/node/agentic-med-1003-af-shopping-pause-react` | `npm install && npm test && node peer.mjs` |
| Angular (Node BFF) | `examples/node/agentic-med-1003-af-shopping-pause-angular` | `npm install && npm test && node peer.mjs` |
...
```bash
cd examples/node/agentic-med-1003-af-shopping-pause-angular
npm install
npm test
node peer.mjs
