...
```text
examples/agentic-dev-0917-am-sense-priority/priority = P3
```
...
| SDK | Path | How to run |
|-----|------|------------|
| Java | `examples/java/agentic-dev-0917-am-sense-priority` | `./gradlew test run` |
| Python | `examples/python/agentic-dev-0917-am-sense-priority` | `python3 -m pytest -q && python3 peer.py` |
| React (Node BFF) | `examples/node/agentic-dev-0917-am-sense-priority-react` | `npm install && npm test && node peer.mjs` |
| Angular (Node BFF) | `examples/node/agentic-dev-0917-am-sense-priority-angular` | `npm install && npm test && node peer.mjs` |
...
```bash
cd examples/node/agentic-dev-0917-am-sense-priority-angular
npm install
npm test
node peer.mjs
