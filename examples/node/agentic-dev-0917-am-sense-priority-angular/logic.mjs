/**
 * Pure hot-path for agentic-dev-0917-am-sense-priority (angular Node BFF).
 * No tokens here — tests run offline.
 */
export const KEY = "priority";
export const DEFAULT = "P3";
export const FOLDER = "agentic-dev-0917-am-sense-priority";
export const PATH = "examples/agentic-dev-0917-am-sense-priority/priority";
