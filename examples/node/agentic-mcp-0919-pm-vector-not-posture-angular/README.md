# agentic-mcp-0919-pm-vector-not-posture

We Embedded Every Agent Turn. The Write-Gate Still Lived in argv
...
```text
examples/agentic-mcp-0919-pm-vector-not-posture/shared-truth = live
```
...
| SDK | Path | How to run |
|-----|------|------------|
| Java | `examples/java/agentic-mcp-0919-pm-vector-not-posture` | `./gradlew test run` |
| Python | `examples/python/agentic-mcp-0919-pm-vector-not-posture` | `python3 -m pytest -q && python3 peer.py` |
| React (Node BFF) | `examples/node/agentic-mcp-0919-pm-vector-not-posture-react` | `npm install && npm test && node peer.mjs` |
| Angular (Node BFF) | `examples/node/agentic-mcp-0919-pm-vector-not-posture-angular` | `npm install && npm test && node peer.mjs` |
...
```bash
cd examples/node/agentic-mcp-0919-pm-vector-not-posture-angular
npm install
npm test
node peer.mjs
