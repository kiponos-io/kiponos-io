# agentic-med-0905-af-admin-wall
...
```text
examples/agentic-med-0905-af-admin-wall/wall-focus = checkout
```
...
| SDK | Path | How to run |
|-----|------|------------|
| Java | `examples/java/agentic-med-0905-af-admin-wall` | `./gradlew test run` |
| Python | `examples/python/agentic-med-0905-af-admin-wall` | `python3 -m pytest -q && python3 peer.py` |
| React (Node BFF) | `examples/node/agentic-med-0905-af-admin-wall-react` | `npm install && npm test && node peer.mjs` |
| Angular (Node BFF) | `examples/node/agentic-med-0905-af-admin-wall-angular` | `npm install && npm test && node peer.mjs` |
...
```bash
cd examples/node/agentic-med-0905-af-admin-wall-angular
npm install
npm test
node peer.mjs
