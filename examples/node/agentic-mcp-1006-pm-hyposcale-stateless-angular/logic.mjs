/**
 * Pure hot-path for agentic-mcp-1006-pm-hyposcale-stateless (angular Node BFF).
 * No tokens here — tests run offline.
 */
export const KEY = "shared-truth";
export const DEFAULT = "live";
export const FOLDER = "agentic-mcp-1006-pm-hyposcale-stateless";
export const PATH = "examples/agentic-mcp-1006-pm-hyposcale-stateless/shared-truth";
