# agentic-mcp-1006-pm-hyposcale-stateless

MCP Wants Stateless Transport at Hyperscale. Your Agent Still Has Sticky Process Memory
...
```text
examples/agentic-mcp-1006-pm-hyposcale-stateless/shared-truth = live
```
...
| SDK | Path | How to run |
|-----|------|------------|
| Java | `examples/java/agentic-mcp-1006-pm-hyposcale-stateless` | `./gradlew test run` |
| Python | `examples/python/agentic-mcp-1006-pm-hyposcale-stateless` | `python3 -m pytest -q && python3 peer.py` |
| React (Node BFF) | `examples/node/agentic-mcp-1006-pm-hyposcale-stateless-react` | `npm install && npm test && node peer.mjs` |
| Angular (Node BFF) | `examples/node/agentic-mcp-1006-pm-hyposcale-stateless-angular` | `npm install && npm test && node peer.mjs` |
...
```bash
cd examples/node/agentic-mcp-1006-pm-hyposcale-stateless-angular
npm install
npm test
node peer.mjs
