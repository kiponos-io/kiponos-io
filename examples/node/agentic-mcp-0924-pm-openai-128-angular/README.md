# agentic-mcp-0924-pm-openai-128

128 Tools Is a Hard API Max. Production Needed 12, Live
...
```text
examples/agentic-mcp-0924-pm-openai-128/tools-allow = search,read
```
...
| SDK | Path | How to run |
|-----|------|------------|
| Java | `examples/java/agentic-mcp-0924-pm-openai-128` | `./gradlew test run` |
| Python | `examples/python/agentic-mcp-0924-pm-openai-128` | `python3 -m pytest -q && python3 peer.py` |
| React (Node BFF) | `examples/node/agentic-mcp-0924-pm-openai-128-react` | `npm install && npm test && node peer.mjs` |
| Angular (Node BFF) | `examples/node/agentic-mcp-0924-pm-openai-128-angular` | `npm install && npm test && node peer.mjs` |
...
```bash
cd examples/node/agentic-mcp-0924-pm-openai-128-angular
npm install
npm test
node peer.mjs
