/**
 * Pure hot-path for agentic-mcp-0924-pm-openai-128 (angular Node BFF).
 * No tokens here — tests run offline.
 */
export const KEY = "tools-allow";
export const DEFAULT = "search,read";
export const FOLDER = "agentic-mcp-0924-pm-openai-128";
export const PATH = "examples/agentic-mcp-0924-pm-openai-128/tools-allow";
