# agentic-mcp-1003-am-grok-native-mcp

Grok Build Speaks MCP Natively. It Still Starts With a Frozen Server List
...
```text
examples/agentic-mcp-1003-am-grok-native-mcp/tools-allow = search,read
```
...
| SDK | Path | How to run |
|-----|------|------------|
| Java | `examples/java/agentic-mcp-1003-am-grok-native-mcp` | `./gradlew test run` |
| Python | `examples/python/agentic-mcp-1003-am-grok-native-mcp` | `python3 -m pytest -q && python3 peer.py` |
| React (Node BFF) | `examples/node/agentic-mcp-1003-am-grok-native-mcp-react` | `npm install && npm test && node peer.mjs` |
| Angular (Node BFF) | `examples/node/agentic-mcp-1003-am-grok-native-mcp-angular` | `npm install && npm test && node peer.mjs` |
...
```bash
cd examples/node/agentic-mcp-1003-am-grok-native-mcp-angular
npm install
npm test
node peer.mjs
