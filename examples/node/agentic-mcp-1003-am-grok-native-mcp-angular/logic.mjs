/**
 * Pure hot-path for agentic-mcp-1003-am-grok-native-mcp (angular Node BFF).
 * No tokens here — tests run offline.
 */
export const KEY = "tools-allow";
export const DEFAULT = "search,read";
export const FOLDER = "agentic-mcp-1003-am-grok-native-mcp";
export const PATH = "examples/agentic-mcp-1003-am-grok-native-mcp/tools-allow";
