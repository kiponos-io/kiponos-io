# agentic-mcp-1004-pm-streaming-noise
...
```text
examples/agentic-mcp-1004-pm-streaming-noise/result-cap = 2000
```
...
| SDK | Path | How to run |
|-----|------|------------|
| Java | `examples/java/agentic-mcp-1004-pm-streaming-noise` | `./gradlew test run` |
| Python | `examples/python/agentic-mcp-1004-pm-streaming-noise` | `python3 -m pytest -q && python3 peer.py` |
| React (Node BFF) | `examples/node/agentic-mcp-1004-pm-streaming-noise-react` | `npm install && npm test && node peer.mjs` |
| Angular (Node BFF) | `examples/node/agentic-mcp-1004-pm-streaming-noise-angular` | `npm install && npm test && node peer.mjs` |
...
```bash
cd examples/node/agentic-mcp-1004-pm-streaming-noise-angular
npm install
npm test
node peer.mjs
