/**
 * Pure hot-path for agentic-dev-1014-pm-agent-folder (angular Node BFF).
 * No tokens here — tests run offline.
 */
export const KEY = "owner-agent";
export const DEFAULT = "travel-coordinator";
export const FOLDER = "agentic-dev-1014-pm-agent-folder";
export const PATH = "examples/agentic-dev-1014-pm-agent-folder/owner-agent";
