# agentic-med-0827-mi-shopping-pause
...
```text
examples/agentic-med-0827-mi-shopping-pause/incident-pause = off
```
...
| SDK | Path | How to run |
|-----|------|------------|
| Java | `examples/java/agentic-med-0827-mi-shopping-pause` | `./gradlew test run` |
| Python | `examples/python/agentic-med-0827-mi-shopping-pause` | `python3 -m pytest -q && python3 peer.py` |
| React (Node BFF) | `examples/node/agentic-med-0827-mi-shopping-pause-react` | `npm install && npm test && node peer.mjs` |
| Angular (Node BFF) | `examples/node/agentic-med-0827-mi-shopping-pause-angular` | `npm install && npm test && node peer.mjs` |
...
```bash
cd examples/node/agentic-med-0827-mi-shopping-pause-angular
npm install
npm test
node peer.mjs
