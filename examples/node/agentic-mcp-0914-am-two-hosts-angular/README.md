# agentic-mcp-0914-am-two-hosts

Cursor Had the New Tool Roster. Grok Build Started Earlier and Still Called Write
...
```text
examples/agentic-mcp-0914-am-two-hosts/session-posture = focus=admin-wall,shopping-pause=off
```
...
| SDK | Path | How to run |
|-----|------|------------|
| Java | `examples/java/agentic-mcp-0914-am-two-hosts` | `./gradlew test run` |
| Python | `examples/python/agentic-mcp-0914-am-two-hosts` | `python3 -m pytest -q && python3 peer.py` |
| React (Node BFF) | `examples/node/agentic-mcp-0914-am-two-hosts-react` | `npm install && npm test && node peer.mjs` |
| Angular (Node BFF) | `examples/node/agentic-mcp-0914-am-two-hosts-angular` | `npm install && npm test && node peer.mjs` |
...
```bash
cd examples/node/agentic-mcp-0914-am-two-hosts-angular
npm install
npm test
node peer.mjs
