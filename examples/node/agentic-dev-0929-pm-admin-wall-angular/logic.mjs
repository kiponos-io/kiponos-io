/**
 * Pure hot-path for agentic-dev-0929-pm-admin-wall (angular Node BFF).
 * No tokens here — tests run offline.
 */
export const KEY = "wall-focus";
export const DEFAULT = "checkout";
export const FOLDER = "agentic-dev-0929-pm-admin-wall";
export const PATH = "examples/agentic-dev-0929-pm-admin-wall/wall-focus";
