...
Cursor Finished the Turn Blind — Session posture shared across hosts on the Shopping Path
...
```text
examples/agentic-dev-1019-am-session-posture/session-posture = focus=admin-wall,shopping-pause=off
```
...
| SDK | Path | How to run |
|-----|------|------------|
| Java | `examples/java/agentic-dev-1019-am-session-posture` | `./gradlew test run` |
| Python | `examples/python/agentic-dev-1019-am-session-posture` | `python3 -m pytest -q && python3 peer.py` |
| React (Node BFF) | `examples/node/agentic-dev-1019-am-session-posture-react` | `npm install && npm test && node peer.mjs` |
| Angular (Node BFF) | `examples/node/agentic-dev-1019-am-session-posture-angular` | `npm install && npm test && node peer.mjs` |
...
```bash
cd examples/node/agentic-dev-1019-am-session-posture-angular
npm install
npm test
node peer.mjs
