# agentic-mcp-0909-pm-tool-space

Tool-Space Interference: Adding Slack MCP Made GitHub Calls Worse
...
```text
examples/agentic-mcp-0909-pm-tool-space/tools-allow = search,read
```
...
| SDK | Path | How to run |
|-----|------|------------|
| Java | `examples/java/agentic-mcp-0909-pm-tool-space` | `./gradlew test run` |
| Python | `examples/python/agentic-mcp-0909-pm-tool-space` | `python3 -m pytest -q && python3 peer.py` |
| React (Node BFF) | `examples/node/agentic-mcp-0909-pm-tool-space-react` | `npm install && npm test && node peer.mjs` |
| Angular (Node BFF) | `examples/node/agentic-mcp-0909-pm-tool-space-angular` | `npm install && npm test && node peer.mjs` |
...
```bash
cd examples/node/agentic-mcp-0909-pm-tool-space-angular
npm install
npm test
node peer.mjs
