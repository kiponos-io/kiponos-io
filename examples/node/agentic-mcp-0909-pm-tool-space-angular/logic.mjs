/**
 * Pure hot-path for agentic-mcp-0909-pm-tool-space (angular Node BFF).
 * No tokens here — tests run offline.
 */
export const KEY = "tools-allow";
export const DEFAULT = "search,read";
export const FOLDER = "agentic-mcp-0909-pm-tool-space";
export const PATH = "examples/agentic-mcp-0909-pm-tool-space/tools-allow";
