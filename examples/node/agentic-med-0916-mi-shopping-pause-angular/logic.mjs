/**
 * Pure hot-path for agentic-med-0916-mi-shopping-pause (angular Node BFF).
 * No tokens here — tests run offline.
 */
export const KEY = "incident-pause";
export const DEFAULT = "off";
export const FOLDER = "agentic-med-0916-mi-shopping-pause";
export const PATH = "examples/agentic-med-0916-mi-shopping-pause/incident-pause";
