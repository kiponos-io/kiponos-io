/**
 * Pure hot-path for agentic-senses-mid-turn (angular Node BFF).
 * No tokens here — tests run offline.
 */
export const KEY = "priority";
export const DEFAULT = "P3";
export const FOLDER = "agentic-senses-mid-turn";
export const PATH = "examples/agentic-senses-mid-turn/priority";
