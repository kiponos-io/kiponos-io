...
```text
examples/agentic-dev-1015-am-skill-enable/enabled-set = research,notify
```
...
| SDK | Path | How to run |
|-----|------|------------|
| Java | `examples/java/agentic-dev-1015-am-skill-enable` | `./gradlew test run` |
| Python | `examples/python/agentic-dev-1015-am-skill-enable` | `python3 -m pytest -q && python3 peer.py` |
| React (Node BFF) | `examples/node/agentic-dev-1015-am-skill-enable-react` | `npm install && npm test && node peer.mjs` |
| Angular (Node BFF) | `examples/node/agentic-dev-1015-am-skill-enable-angular` | `npm install && npm test && node peer.mjs` |
...
```bash
cd examples/node/agentic-dev-1015-am-skill-enable-angular
npm install
npm test
node peer.mjs
