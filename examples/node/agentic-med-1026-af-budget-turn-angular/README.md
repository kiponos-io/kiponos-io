# agentic-med-1026-af-budget-turn
...
```text
examples/agentic-med-1026-af-budget-turn/max-tokens = 8000
```
...
| SDK | Path | How to run |
|-----|------|------------|
| Java | `examples/java/agentic-med-1026-af-budget-turn` | `./gradlew test run` |
| Python | `examples/python/agentic-med-1026-af-budget-turn` | `python3 -m pytest -q && python3 peer.py` |
| React (Node BFF) | `examples/node/agentic-med-1026-af-budget-turn-react` | `npm install && npm test && node peer.mjs` |
| Angular (Node BFF) | `examples/node/agentic-med-1026-af-budget-turn-angular` | `npm install && npm test && node peer.mjs` |
...
```bash
cd examples/node/agentic-med-1026-af-budget-turn-angular
npm install
npm test
node peer.mjs
