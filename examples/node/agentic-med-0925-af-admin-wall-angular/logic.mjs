/**
 * Pure hot-path for agentic-med-0925-af-admin-wall (angular Node BFF).
 * No tokens here — tests run offline.
 */
export const KEY = "wall-focus";
export const DEFAULT = "checkout";
export const FOLDER = "agentic-med-0925-af-admin-wall";
export const PATH = "examples/agentic-med-0925-af-admin-wall/wall-focus";
