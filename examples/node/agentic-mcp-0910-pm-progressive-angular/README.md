# agentic-mcp-0910-pm-progressive
...
```text
examples/agentic-mcp-0910-pm-progressive/tool-search = on
```
...
| SDK | Path | How to run |
|-----|------|------------|
| Java | `examples/java/agentic-mcp-0910-pm-progressive` | `./gradlew test run` |
| Python | `examples/python/agentic-mcp-0910-pm-progressive` | `python3 -m pytest -q && python3 peer.py` |
| React (Node BFF) | `examples/node/agentic-mcp-0910-pm-progressive-react` | `npm install && npm test && node peer.mjs` |
| Angular (Node BFF) | `examples/node/agentic-mcp-0910-pm-progressive-angular` | `npm install && npm test && node peer.mjs` |
...
```bash
cd examples/node/agentic-mcp-0910-pm-progressive-angular
npm install
npm test
node peer.mjs
