# agentic-mcp-0915-am-execute-gate

Plan Mode Was Fine. Execute Needed a Live Gate When MCP Write Came Back
...
```text
examples/agentic-mcp-0915-am-execute-gate/execute-gate = plan
```
...
| SDK | Path | How to run |
|-----|------|------------|
| Java | `examples/java/agentic-mcp-0915-am-execute-gate` | `./gradlew test run` |
| Python | `examples/python/agentic-mcp-0915-am-execute-gate` | `python3 -m pytest -q && python3 peer.py` |
| React (Node BFF) | `examples/node/agentic-mcp-0915-am-execute-gate-react` | `npm install && npm test && node peer.mjs` |
| Angular (Node BFF) | `examples/node/agentic-mcp-0915-am-execute-gate-angular` | `npm install && npm test && node peer.mjs` |
...
```bash
cd examples/node/agentic-mcp-0915-am-execute-gate-angular
npm install
npm test
node peer.mjs
