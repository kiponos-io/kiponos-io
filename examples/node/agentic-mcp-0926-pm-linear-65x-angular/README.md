# agentic-mcp-0926-pm-linear-65x

Looking Up One Linear Issue via MCP Cost 65× a curl. I Capped It Live
...
```text
examples/agentic-mcp-0926-pm-linear-65x/result-cap = 2000
```
...
| SDK | Path | How to run |
|-----|------|------------|
| Java | `examples/java/agentic-mcp-0926-pm-linear-65x` | `./gradlew test run` |
| Python | `examples/python/agentic-mcp-0926-pm-linear-65x` | `python3 -m pytest -q && python3 peer.py` |
| React (Node BFF) | `examples/node/agentic-mcp-0926-pm-linear-65x-react` | `npm install && npm test && node peer.mjs` |
| Angular (Node BFF) | `examples/node/agentic-mcp-0926-pm-linear-65x-angular` | `npm install && npm test && node peer.mjs` |
...
```bash
cd examples/node/agentic-mcp-0926-pm-linear-65x-angular
npm install
npm test
node peer.mjs
