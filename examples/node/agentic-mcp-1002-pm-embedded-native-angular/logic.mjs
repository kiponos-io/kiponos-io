/**
 * Pure hot-path for agentic-mcp-1002-pm-embedded-native (angular Node BFF).
 * No tokens here — tests run offline.
 */
export const KEY = "shared-truth";
export const DEFAULT = "live";
export const FOLDER = "agentic-mcp-1002-pm-embedded-native";
export const PATH = "examples/agentic-mcp-1002-pm-embedded-native/shared-truth";
