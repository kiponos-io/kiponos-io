# agentic-mcp-1002-pm-embedded-native

Stop Bolting State Onto Agents. Real-Time Nested Config Is Native Now
...
```text
examples/agentic-mcp-1002-pm-embedded-native/shared-truth = live
```
...
| SDK | Path | How to run |
|-----|------|------------|
| Java | `examples/java/agentic-mcp-1002-pm-embedded-native` | `./gradlew test run` |
| Python | `examples/python/agentic-mcp-1002-pm-embedded-native` | `python3 -m pytest -q && python3 peer.py` |
| React (Node BFF) | `examples/node/agentic-mcp-1002-pm-embedded-native-react` | `npm install && npm test && node peer.mjs` |
| Angular (Node BFF) | `examples/node/agentic-mcp-1002-pm-embedded-native-angular` | `npm install && npm test && node peer.mjs` |
...
```bash
cd examples/node/agentic-mcp-1002-pm-embedded-native-angular
npm install
npm test
node peer.mjs
