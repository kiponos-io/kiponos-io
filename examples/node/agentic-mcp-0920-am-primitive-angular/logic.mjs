/**
 * Pure hot-path for agentic-mcp-0920-am-primitive (angular Node BFF).
 * No tokens here — tests run offline.
 */
export const KEY = "shared-truth";
export const DEFAULT = "live";
export const FOLDER = "agentic-mcp-0920-am-primitive";
export const PATH = "examples/agentic-mcp-0920-am-primitive/shared-truth";
