...
```text
examples/agentic-mcp-0920-am-primitive/shared-truth = live
```
...
| SDK | Path | How to run |
|-----|------|------------|
| Java | `examples/java/agentic-mcp-0920-am-primitive` | `./gradlew test run` |
| Python | `examples/python/agentic-mcp-0920-am-primitive` | `python3 -m pytest -q && python3 peer.py` |
| React (Node BFF) | `examples/node/agentic-mcp-0920-am-primitive-react` | `npm install && npm test && node peer.mjs` |
| Angular (Node BFF) | `examples/node/agentic-mcp-0920-am-primitive-angular` | `npm install && npm test && node peer.mjs` |
...
```bash
cd examples/node/agentic-mcp-0920-am-primitive-angular
npm install
npm test
node peer.mjs
