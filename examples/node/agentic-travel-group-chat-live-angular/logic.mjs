/**
 * Pure hot-path for agentic-travel-group-chat-live (angular Node BFF).
 * No tokens here — tests run offline.
 */
export const KEY = "chat-mute";
export const DEFAULT = "none";
export const FOLDER = "agentic-travel-group-chat-live";
export const PATH = "examples/agentic-travel-group-chat-live/chat-mute";
