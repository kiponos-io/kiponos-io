/**
 * Pure hot-path for agentic-dev-0910-pm-budget-turn (angular Node BFF).
 * No tokens here — tests run offline.
 */
export const KEY = "max-tokens";
export const DEFAULT = "8000";
export const FOLDER = "agentic-dev-0910-pm-budget-turn";
export const PATH = "examples/agentic-dev-0910-pm-budget-turn/max-tokens";
