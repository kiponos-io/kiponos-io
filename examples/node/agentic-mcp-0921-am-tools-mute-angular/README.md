# agentic-mcp-0921-am-tools-mute
...
```text
examples/agentic-mcp-0921-am-tools-mute/tools-mute = none
```
...
| SDK | Path | How to run |
|-----|------|------------|
| Java | `examples/java/agentic-mcp-0921-am-tools-mute` | `./gradlew test run` |
| Python | `examples/python/agentic-mcp-0921-am-tools-mute` | `python3 -m pytest -q && python3 peer.py` |
| React (Node BFF) | `examples/node/agentic-mcp-0921-am-tools-mute-react` | `npm install && npm test && node peer.mjs` |
| Angular (Node BFF) | `examples/node/agentic-mcp-0921-am-tools-mute-angular` | `npm install && npm test && node peer.mjs` |
...
```bash
cd examples/node/agentic-mcp-0921-am-tools-mute-angular
npm install
npm test
node peer.mjs
