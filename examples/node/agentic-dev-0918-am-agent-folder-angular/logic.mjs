/**
 * Pure hot-path for agentic-dev-0918-am-agent-folder (angular Node BFF).
 * No tokens here — tests run offline.
 */
export const KEY = "owner-agent";
export const DEFAULT = "travel-coordinator";
export const FOLDER = "agentic-dev-0918-am-agent-folder";
export const PATH = "examples/agentic-dev-0918-am-agent-folder/owner-agent";
