/**
 * Pure hot-path for agentic-mcp-0918-am-client-blame (angular Node BFF).
 * No tokens here — tests run offline.
 */
export const KEY = "tool-search";
export const DEFAULT = "on";
export const FOLDER = "agentic-mcp-0918-am-client-blame";
export const PATH = "examples/agentic-mcp-0918-am-client-blame/tool-search";
