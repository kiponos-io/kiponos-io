# agentic-mcp-0918-am-client-blame
...
```text
examples/agentic-mcp-0918-am-client-blame/tool-search = on
```
...
| SDK | Path | How to run |
|-----|------|------------|
| Java | `examples/java/agentic-mcp-0918-am-client-blame` | `./gradlew test run` |
| Python | `examples/python/agentic-mcp-0918-am-client-blame` | `python3 -m pytest -q && python3 peer.py` |
| React (Node BFF) | `examples/node/agentic-mcp-0918-am-client-blame-react` | `npm install && npm test && node peer.mjs` |
| Angular (Node BFF) | `examples/node/agentic-mcp-0918-am-client-blame-angular` | `npm install && npm test && node peer.mjs` |
...
```bash
cd examples/node/agentic-mcp-0918-am-client-blame-angular
npm install
npm test
node peer.mjs
