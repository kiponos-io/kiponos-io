# agentic-mcp-0928-am-parallel-stale

Eight Parallel Subagents, Eight Frozen Copies of tools-allow
...
```text
examples/agentic-mcp-0928-am-parallel-stale/inherit-posture = on
```
...
| SDK | Path | How to run |
|-----|------|------------|
| Java | `examples/java/agentic-mcp-0928-am-parallel-stale` | `./gradlew test run` |
| Python | `examples/python/agentic-mcp-0928-am-parallel-stale` | `python3 -m pytest -q && python3 peer.py` |
| React (Node BFF) | `examples/node/agentic-mcp-0928-am-parallel-stale-react` | `npm install && npm test && node peer.mjs` |
| Angular (Node BFF) | `examples/node/agentic-mcp-0928-am-parallel-stale-angular` | `npm install && npm test && node peer.mjs` |
...
```bash
cd examples/node/agentic-mcp-0928-am-parallel-stale-angular
npm install
npm test
node peer.mjs
