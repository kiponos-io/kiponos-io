...
```text
examples/agentic-dev-1008-am-agent-folder/owner-agent = travel-coordinator
```
...
| SDK | Path | How to run |
|-----|------|------------|
| Java | `examples/java/agentic-dev-1008-am-agent-folder` | `./gradlew test run` |
| Python | `examples/python/agentic-dev-1008-am-agent-folder` | `python3 -m pytest -q && python3 peer.py` |
| React (Node BFF) | `examples/node/agentic-dev-1008-am-agent-folder-react` | `npm install && npm test && node peer.mjs` |
| Angular (Node BFF) | `examples/node/agentic-dev-1008-am-agent-folder-angular` | `npm install && npm test && node peer.mjs` |
...
```bash
cd examples/node/agentic-dev-1008-am-agent-folder-angular
npm install
npm test
node peer.mjs
