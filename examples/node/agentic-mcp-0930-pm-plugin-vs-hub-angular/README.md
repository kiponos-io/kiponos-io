# agentic-mcp-0930-pm-plugin-vs-hub

I Installed a Grok Plugin for MCP. Enabling It Still Required a Restart
...
```text
examples/agentic-mcp-0930-pm-plugin-vs-hub/enabled-set = research,notify
```
...
| SDK | Path | How to run |
|-----|------|------------|
| Java | `examples/java/agentic-mcp-0930-pm-plugin-vs-hub` | `./gradlew test run` |
| Python | `examples/python/agentic-mcp-0930-pm-plugin-vs-hub` | `python3 -m pytest -q && python3 peer.py` |
| React (Node BFF) | `examples/node/agentic-mcp-0930-pm-plugin-vs-hub-react` | `npm install && npm test && node peer.mjs` |
| Angular (Node BFF) | `examples/node/agentic-mcp-0930-pm-plugin-vs-hub-angular` | `npm install && npm test && node peer.mjs` |
...
```bash
cd examples/node/agentic-mcp-0930-pm-plugin-vs-hub-angular
npm install
npm test
node peer.mjs
