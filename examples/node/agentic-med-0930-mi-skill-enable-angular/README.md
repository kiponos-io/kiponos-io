# agentic-med-0930-mi-skill-enable
...
```text
examples/agentic-med-0930-mi-skill-enable/enabled-set = research,notify
```
...
| SDK | Path | How to run |
|-----|------|------------|
| Java | `examples/java/agentic-med-0930-mi-skill-enable` | `./gradlew test run` |
| Python | `examples/python/agentic-med-0930-mi-skill-enable` | `python3 -m pytest -q && python3 peer.py` |
| React (Node BFF) | `examples/node/agentic-med-0930-mi-skill-enable-react` | `npm install && npm test && node peer.mjs` |
| Angular (Node BFF) | `examples/node/agentic-med-0930-mi-skill-enable-angular` | `npm install && npm test && node peer.mjs` |
...
```bash
cd examples/node/agentic-med-0930-mi-skill-enable-angular
npm install
npm test
node peer.mjs
