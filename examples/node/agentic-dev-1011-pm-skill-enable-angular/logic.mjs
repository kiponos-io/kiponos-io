/**
 * Pure hot-path for agentic-dev-1011-pm-skill-enable (angular Node BFF).
 * No tokens here — tests run offline.
 */
export const KEY = "enabled-set";
export const DEFAULT = "research,notify";
export const FOLDER = "agentic-dev-1011-pm-skill-enable";
export const PATH = "examples/agentic-dev-1011-pm-skill-enable/enabled-set";
