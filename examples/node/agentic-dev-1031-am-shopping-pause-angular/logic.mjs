/**
 * Pure hot-path for agentic-dev-1031-am-shopping-pause (angular Node BFF).
 * No tokens here — tests run offline.
 */
export const KEY = "incident-pause";
export const DEFAULT = "off";
export const FOLDER = "agentic-dev-1031-am-shopping-pause";
export const PATH = "examples/agentic-dev-1031-am-shopping-pause/incident-pause";
