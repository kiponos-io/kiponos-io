# agentic-mcp-1001-pm-exact-count

I Asked MCP How Many Jira Tickets. It Pasted Them All and Guessed 47
...
```text
examples/agentic-mcp-1001-pm-exact-count/result-cap = 2000
```
...
| SDK | Path | How to run |
|-----|------|------------|
| Java | `examples/java/agentic-mcp-1001-pm-exact-count` | `./gradlew test run` |
| Python | `examples/python/agentic-mcp-1001-pm-exact-count` | `python3 -m pytest -q && python3 peer.py` |
| React (Node BFF) | `examples/node/agentic-mcp-1001-pm-exact-count-react` | `npm install && npm test && node peer.mjs` |
| Angular (Node BFF) | `examples/node/agentic-mcp-1001-pm-exact-count-angular` | `npm install && npm test && node peer.mjs` |
...
```bash
cd examples/node/agentic-mcp-1001-pm-exact-count-angular
npm install
npm test
node peer.mjs
