/**
 * Pure hot-path for agentic-mcp-1001-pm-exact-count (angular Node BFF).
 * No tokens here — tests run offline.
 */
export const KEY = "result-cap";
export const DEFAULT = "2000";
export const FOLDER = "agentic-mcp-1001-pm-exact-count";
export const PATH = "examples/agentic-mcp-1001-pm-exact-count/result-cap";
