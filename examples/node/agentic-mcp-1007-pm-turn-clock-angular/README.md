# agentic-mcp-1007-pm-turn-clock

The Incident Clock Is the Turn Budget. MCP Schemas Should Not Be Allowed to Steal It
...
```text
examples/agentic-mcp-1007-pm-turn-clock/max-tokens = 8000
```
...
| SDK | Path | How to run |
|-----|------|------------|
| Java | `examples/java/agentic-mcp-1007-pm-turn-clock` | `./gradlew test run` |
| Python | `examples/python/agentic-mcp-1007-pm-turn-clock` | `python3 -m pytest -q && python3 peer.py` |
| React (Node BFF) | `examples/node/agentic-mcp-1007-pm-turn-clock-react` | `npm install && npm test && node peer.mjs` |
| Angular (Node BFF) | `examples/node/agentic-mcp-1007-pm-turn-clock-angular` | `npm install && npm test && node peer.mjs` |
...
```bash
cd examples/node/agentic-mcp-1007-pm-turn-clock-angular
npm install
npm test
node peer.mjs
