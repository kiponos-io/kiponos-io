/**
 * Pure hot-path for agentic-mcp-1007-pm-turn-clock (angular Node BFF).
 * No tokens here — tests run offline.
 */
export const KEY = "max-tokens";
export const DEFAULT = "8000";
export const FOLDER = "agentic-mcp-1007-pm-turn-clock";
export const PATH = "examples/agentic-mcp-1007-pm-turn-clock/max-tokens";
