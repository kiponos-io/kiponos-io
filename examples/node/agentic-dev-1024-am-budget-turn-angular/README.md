...
| SDK | Path | How to run |
|-----|------|------------|
| Java | `examples/java/agentic-dev-1024-am-budget-turn` | `./gradlew test run` |
| Python | `examples/python/agentic-dev-1024-am-budget-turn` | `python3 -m pytest -q && python3 peer.py` |
| React (Node BFF) | `examples/node/agentic-dev-1024-am-budget-turn-react` | `npm install && npm test && node peer.mjs` |
| Angular (Node BFF) | `examples/node/agentic-dev-1024-am-budget-turn-angular` | `npm install && npm test && node peer.mjs` |
...
```bash
cd examples/node/agentic-dev-1024-am-budget-turn-angular
npm install
npm test
node peer.mjs
