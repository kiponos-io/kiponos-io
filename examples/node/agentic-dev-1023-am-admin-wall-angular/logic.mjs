/**
 * Pure hot-path for agentic-dev-1023-am-admin-wall (angular Node BFF).
 * No tokens here — tests run offline.
 */
export const KEY = "wall-focus";
export const DEFAULT = "checkout";
export const FOLDER = "agentic-dev-1023-am-admin-wall";
export const PATH = "examples/agentic-dev-1023-am-admin-wall/wall-focus";
