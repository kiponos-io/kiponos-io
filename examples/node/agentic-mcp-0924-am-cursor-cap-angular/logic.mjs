/**
 * Pure hot-path for agentic-mcp-0924-am-cursor-cap (angular Node BFF).
 * No tokens here — tests run offline.
 */
export const KEY = "tools-allow";
export const DEFAULT = "search,read";
export const FOLDER = "agentic-mcp-0924-am-cursor-cap";
export const PATH = "examples/agentic-mcp-0924-am-cursor-cap/tools-allow";
