# agentic-mcp-0924-am-cursor-cap

Cursor's 40-Tool Cap Is a Hint. Treat It as a Live Ceiling, Not a Surprise
...
```text
examples/agentic-mcp-0924-am-cursor-cap/tools-allow = search,read
```
...
| SDK | Path | How to run |
|-----|------|------------|
| Java | `examples/java/agentic-mcp-0924-am-cursor-cap` | `./gradlew test run` |
| Python | `examples/python/agentic-mcp-0924-am-cursor-cap` | `python3 -m pytest -q && python3 peer.py` |
| React (Node BFF) | `examples/node/agentic-mcp-0924-am-cursor-cap-react` | `npm install && npm test && node peer.mjs` |
| Angular (Node BFF) | `examples/node/agentic-mcp-0924-am-cursor-cap-angular` | `npm install && npm test && node peer.mjs` |
...
```bash
cd examples/node/agentic-mcp-0924-am-cursor-cap-angular
npm install
npm test
node peer.mjs
