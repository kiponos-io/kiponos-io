# agentic-mcp-0913-pm-llm-skill-budget

The Agent Wrote Itself a Skill and Doubled Token Use Without Improving Accuracy

**Product scene:** mirror phone  
**Agent host:** Claude Code  
**Pain:** LLM-written skills burned tokens without accuracy

Hub leaf (same Team tree for every SDK):

```text
examples/agentic-mcp-0913-pm-llm-skill-budget/skill-budget = on
```
...
| SDK | Path | How to run |
|-----|------|------------|
| Java | `examples/java/agentic-mcp-0913-pm-llm-skill-budget` | `./gradlew test run` |
| Python | `examples/python/agentic-mcp-0913-pm-llm-skill-budget` | `python3 -m pytest -q && python3 peer.py` |
| React (Node BFF) | `examples/node/agentic-mcp-0913-pm-llm-skill-budget-react` | `npm install && npm test && node peer.mjs` |
| Angular (Node BFF) | `examples/node/agentic-mcp-0913-pm-llm-skill-budget-angular` | `npm install && npm test && node peer.mjs` |
...
```bash
cd examples/node/agentic-mcp-0913-pm-llm-skill-budget-angular
npm install
npm test
node peer.mjs
