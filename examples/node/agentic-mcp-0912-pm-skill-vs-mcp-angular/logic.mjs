/**
 * Pure hot-path for agentic-mcp-0912-pm-skill-vs-mcp (angular Node BFF).
 * No tokens here — tests run offline.
 */
export const KEY = "shared-truth";
export const DEFAULT = "live";
export const FOLDER = "agentic-mcp-0912-pm-skill-vs-mcp";
export const PATH = "examples/agentic-mcp-0912-pm-skill-vs-mcp/shared-truth";
