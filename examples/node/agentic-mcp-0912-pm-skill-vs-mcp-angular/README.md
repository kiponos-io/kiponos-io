# agentic-mcp-0912-pm-skill-vs-mcp
...
```text
examples/agentic-mcp-0912-pm-skill-vs-mcp/shared-truth = live
```
...
| SDK | Path | How to run |
|-----|------|------------|
| Java | `examples/java/agentic-mcp-0912-pm-skill-vs-mcp` | `./gradlew test run` |
| Python | `examples/python/agentic-mcp-0912-pm-skill-vs-mcp` | `python3 -m pytest -q && python3 peer.py` |
| React (Node BFF) | `examples/node/agentic-mcp-0912-pm-skill-vs-mcp-react` | `npm install && npm test && node peer.mjs` |
| Angular (Node BFF) | `examples/node/agentic-mcp-0912-pm-skill-vs-mcp-angular` | `npm install && npm test && node peer.mjs` |
...
```bash
cd examples/node/agentic-mcp-0912-pm-skill-vs-mcp-angular
npm install
npm test
node peer.mjs
