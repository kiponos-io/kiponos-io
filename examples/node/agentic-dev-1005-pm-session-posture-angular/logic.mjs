/**
 * Pure hot-path for agentic-dev-1005-pm-session-posture (angular Node BFF).
 * No tokens here — tests run offline.
 */
export const KEY = "session-posture";
export const DEFAULT = "focus=admin-wall,shopping-pause=off";
export const FOLDER = "agentic-dev-1005-pm-session-posture";
export const PATH = "examples/agentic-dev-1005-pm-session-posture/session-posture";
