# agentic-med-0907-mi-mirror-live
...
```text
examples/agentic-med-0907-mi-mirror-live/device-live = yes
```
...
| SDK | Path | How to run |
|-----|------|------------|
| Java | `examples/java/agentic-med-0907-mi-mirror-live` | `./gradlew test run` |
| Python | `examples/python/agentic-med-0907-mi-mirror-live` | `python3 -m pytest -q && python3 peer.py` |
| React (Node BFF) | `examples/node/agentic-med-0907-mi-mirror-live-react` | `npm install && npm test && node peer.mjs` |
| Angular (Node BFF) | `examples/node/agentic-med-0907-mi-mirror-live-angular` | `npm install && npm test && node peer.mjs` |
...
```bash
cd examples/node/agentic-med-0907-mi-mirror-live-angular
npm install
npm test
node peer.mjs
