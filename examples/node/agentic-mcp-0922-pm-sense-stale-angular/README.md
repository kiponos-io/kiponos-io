# agentic-mcp-0922-pm-sense-stale

Senses Fired P1 Mid-Turn. Grok Build Finished the MCP Call Anyway
...
```text
examples/agentic-mcp-0922-pm-sense-stale/priority = P3
```
...
| SDK | Path | How to run |
|-----|------|------------|
| Java | `examples/java/agentic-mcp-0922-pm-sense-stale` | `./gradlew test run` |
| Python | `examples/python/agentic-mcp-0922-pm-sense-stale` | `python3 -m pytest -q && python3 peer.py` |
| React (Node BFF) | `examples/node/agentic-mcp-0922-pm-sense-stale-react` | `npm install && npm test && node peer.mjs` |
| Angular (Node BFF) | `examples/node/agentic-mcp-0922-pm-sense-stale-angular` | `npm install && npm test && node peer.mjs` |
...
```bash
cd examples/node/agentic-mcp-0922-pm-sense-stale-angular
npm install
npm test
node peer.mjs
