# agentic-med-0831-af-agent-folder
...
```text
examples/agentic-med-0831-af-agent-folder/owner-agent = travel-coordinator
```
...
| SDK | Path | How to run |
|-----|------|------------|
| Java | `examples/java/agentic-med-0831-af-agent-folder` | `./gradlew test run` |
| Python | `examples/python/agentic-med-0831-af-agent-folder` | `python3 -m pytest -q && python3 peer.py` |
| React (Node BFF) | `examples/node/agentic-med-0831-af-agent-folder-react` | `npm install && npm test && node peer.mjs` |
| Angular (Node BFF) | `examples/node/agentic-med-0831-af-agent-folder-angular` | `npm install && npm test && node peer.mjs` |
...
```bash
cd examples/node/agentic-med-0831-af-agent-folder-angular
npm install
npm test
node peer.mjs
