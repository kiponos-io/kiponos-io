# agentic-mcp-0916-am-argv-frozen
...
```text
examples/agentic-mcp-0916-am-argv-frozen/tools-allow = search,read
```
...
| SDK | Path | How to run |
|-----|------|------------|
| Java | `examples/java/agentic-mcp-0916-am-argv-frozen` | `./gradlew test run` |
| Python | `examples/python/agentic-mcp-0916-am-argv-frozen` | `python3 -m pytest -q && python3 peer.py` |
| React (Node BFF) | `examples/node/agentic-mcp-0916-am-argv-frozen-react` | `npm install && npm test && node peer.mjs` |
| Angular (Node BFF) | `examples/node/agentic-mcp-0916-am-argv-frozen-angular` | `npm install && npm test && node peer.mjs` |
...
```bash
cd examples/node/agentic-mcp-0916-am-argv-frozen-angular
npm install
npm test
node peer.mjs
