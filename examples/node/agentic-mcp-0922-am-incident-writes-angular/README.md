# agentic-mcp-0922-am-incident-writes

Shopping Freeze Was On. The MCP Write Tool Did Not Get the Memo
...
```text
examples/agentic-mcp-0922-am-incident-writes/incident-pause = off
```
...
| SDK | Path | How to run |
|-----|------|------------|
| Java | `examples/java/agentic-mcp-0922-am-incident-writes` | `./gradlew test run` |
| Python | `examples/python/agentic-mcp-0922-am-incident-writes` | `python3 -m pytest -q && python3 peer.py` |
| React (Node BFF) | `examples/node/agentic-mcp-0922-am-incident-writes-react` | `npm install && npm test && node peer.mjs` |
| Angular (Node BFF) | `examples/node/agentic-mcp-0922-am-incident-writes-angular` | `npm install && npm test && node peer.mjs` |
...
```bash
cd examples/node/agentic-mcp-0922-am-incident-writes-angular
npm install
npm test
node peer.mjs
