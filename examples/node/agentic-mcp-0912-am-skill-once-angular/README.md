# agentic-mcp-0912-am-skill-once

The Skill File Was the Source of Truth Until the Host Had Already Started
...
```text
examples/agentic-mcp-0912-am-skill-once/enabled-set = research,notify
```
...
| SDK | Path | How to run |
|-----|------|------------|
| Java | `examples/java/agentic-mcp-0912-am-skill-once` | `./gradlew test run` |
| Python | `examples/python/agentic-mcp-0912-am-skill-once` | `python3 -m pytest -q && python3 peer.py` |
| React (Node BFF) | `examples/node/agentic-mcp-0912-am-skill-once-react` | `npm install && npm test && node peer.mjs` |
| Angular (Node BFF) | `examples/node/agentic-mcp-0912-am-skill-once-angular` | `npm install && npm test && node peer.mjs` |
...
```bash
cd examples/node/agentic-mcp-0912-am-skill-once-angular
npm install
npm test
node peer.mjs
