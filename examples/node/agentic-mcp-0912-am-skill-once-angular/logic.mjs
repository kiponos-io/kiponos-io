/**
 * Pure hot-path for agentic-mcp-0912-am-skill-once (angular Node BFF).
 * No tokens here — tests run offline.
 */
export const KEY = "enabled-set";
export const DEFAULT = "research,notify";
export const FOLDER = "agentic-mcp-0912-am-skill-once";
export const PATH = "examples/agentic-mcp-0912-am-skill-once/enabled-set";
