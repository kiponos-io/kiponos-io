/**
 * Pure hot-path for agentic-dev-1005-am-skill-enable (angular Node BFF).
 * No tokens here — tests run offline.
 */
export const KEY = "enabled-set";
export const DEFAULT = "research,notify";
export const FOLDER = "agentic-dev-1005-am-skill-enable";
export const PATH = "examples/agentic-dev-1005-am-skill-enable/enabled-set";
